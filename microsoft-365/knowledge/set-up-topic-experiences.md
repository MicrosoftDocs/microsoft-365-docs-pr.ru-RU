...
Вы можете использовать Центр администрирования Microsoft 365 для настройки и настройки [тем.](knowledge-management-overview.md) 
...
5. В разделе **"Исключить разделы** по имени" можно добавить имена разделов, которые нужно исключить из обнаружения тем. Используйте этот параметр, чтобы не включать конфиденциальную информацию в качестве разделов. Доступны следующие варианты:
    ...
    Если нужно исключить темы, после выбора разделов "Исключить" по имени выберите скачивание шаблона CSV и обновите его в списке тем, которые нужно исключить из результатов обнаружения.
...
6. На странице **"Кто может видеть разделы** и где они могут их видеть", вы настроите видимость темы. В разделе **"Кто может** видеть разделы в параметре сети знаний" вы выбираете, кто будет иметь доступ к сведениям о теме, например к выделенной теме, карточкам тем, ответам на темы в поиске и страницам тем. Можно выбрать:
...
[Обзор управления знаниями](knowledge-management-overview.md)
