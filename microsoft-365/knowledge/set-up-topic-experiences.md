...
4. В **приложениях** убедитесь, что Graph соединители поиск с **помощью Index (Viva Topics)** и **Viva Topics.**
   ...
   > ![Лицензии Microsoft Viva Topics в центре Microsoft 365 администрирования](../media/topic-experiences-licenses.png)
...
1. В центре [администрирования Microsoft 365](https://admin.microsoft.com) **настройка,** а затем просмотреть раздел Файлы **и контент.**
