...
11. **Отобразит** активированную страницу сети знаний, подтверждая, что система начнет анализировать выбранные сайты для разделов и создавать сайт центра знаний. Нажмите кнопку **Готово**.
...
После настройки тем необходимо назначить лицензии пользователям, которые будут использовать эти темы. Только пользователи с лицензией могут видеть сведения по темам, включая выделения, карточки тем, страницы тем и центр тем. 
...
4. В **разделе "Лицензии"** выберите **"Темы".**
