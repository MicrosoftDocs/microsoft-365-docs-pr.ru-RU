...
- Отклонение темы: делает эту тему неоткрытой для конечных пользователей. Тема перемещается на вкладку **Отклонено** и может быть подтверждена позже, если это необходимо. 
