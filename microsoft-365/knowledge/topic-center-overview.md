...
В Microsoft Viva Topics тематический центр — это современный сайт SharePoint, который служит центром знаний для вашей организации. Он создан во время настройки [Viva Topics](set-up-topic-experiences.md) в центре администрирования Microsoft 365.
