...
Когда идентифицированный раздел и ИИ определяет, что в нем достаточно  сведений, чтобы стать рекомендуемой темой, для него создается страница темы, содержаная сведения, собранные с помощью индексации тем, например:
...
- У контролировать, какой пользователь сможет просматривать разделы.
