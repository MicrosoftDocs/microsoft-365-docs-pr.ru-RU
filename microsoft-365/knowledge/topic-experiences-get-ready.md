...
- Просмотрите использование "все", "все, кроме внешних пользователей" или широких групп безопасности. Эти значения могут быть неправильно добавлены к содержимому. Чтобы просмотреть использование этих групп, вы можете:
  ...
  - Если в этой учетной записи отображается несоответствующее содержимое с помощью поиска, вы можете вместе с владельцами сайтов исправить конфигурацию разрешений.
...
- В списке тем лучше всего засеть разделы. Качество и количество разделов основаны на контенте. Он будет создан как раздел, только если он включен в контент, который находится в области действия. Если для этой темы достаточно информации и свидетельств, она будет создана и ИИ. В темах, где может помочь менеджер по знаниям и эксперты по предметам. Объединение знаний о человеке с ИИ — лучший маршрут для разделов о качестве. Поэтому если есть темы, которые вы ожидаете, вы можете вручную создать их в Центре тем. Это даст ИИ мощный сигнал о релевантности этой темы и определит ресурсы и людей, которых необходимо связать с этим разделом.
