...
---
# <a name="manage-topic-visibility-in-microsoft-viva-topics"></a>Управление видимостью тем в microsoft Viva Topics
...
1. На **вкладке "Видимость раздела"** в разделе **"Кто может видеть разделы"** выберите **"Изменить".**
2. На странице **"Кто может** видеть темы" выберите, кто будет иметь доступ к сведениям о теме, например к темам, карточкам тем, ответам на вопросы в поиске и страницам тем. Можно выбрать:
    - **Все в организации**
