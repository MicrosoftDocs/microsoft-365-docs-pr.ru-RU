...
3. После просмотра темы перейдите на страницу **Управление темами.** Для выбранной темы можно сделать следующее:

   - Нажать галочку, чтобы проверить тему.
...
Проверка подтвержденной темы:

1. На вкладке **Подтвержденные** выберите тему, чтобы открыть страницу этой темы.
...
## <a name="topic-count-dashboard"></a>Панель мониторинга подсчета тем

Эта диаграмма в представлении панели мониторинга позволяет просмотреть количество тем в центре тем Viva Topics. На диаграмме показана графа темы на этапе жизненного цикла темы, а также показано, как со временем количество данной темы имеет тенденцию. Менеджеры знаний могут визуально отслеживать скорость обнаружения ИИ новых тем и скорость подтверждения или публикации тем менеджером знаний или действиями пользователей.

Руководители знаний могут видеть другое количество тем, представленных в списке тем на странице **Управление** темами, чем на панели мониторинга. Это потому, что менеджер знаний может не иметь доступа ко всем темам. Граф, представленный в представлении панели мониторинга, засчитываются перед использованием разрешения-обрезки. 
