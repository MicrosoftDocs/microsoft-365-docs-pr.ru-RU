...
При индексации сайтов SharePoint или всей организации для Viva Topics может возникнуть множество тем. Когда это произойдет, и вы увидите тысячи предлагаемых тем на странице **Управление** темами, может быть сложно узнать, с чего начать. В этой статье описывается, как Viva Topics помогает оптимизировать, какие темы и сведения показаны пользователям, которые ищут информацию, даже в крупных организациях с большим количеством тем.

Во-первых, напоминание о четырех состояниях для тем:
...
-   Пользователи увидят параметр **Edit** на страницах темы и смогут изменять страницы в том же опыте, что и другие современные страницы SharePoint.
