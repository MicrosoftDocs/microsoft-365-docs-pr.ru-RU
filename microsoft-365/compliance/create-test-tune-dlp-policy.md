...
После нажатия кнопку Далее*** вам  будет представлена дополнительная страница Параметры политики с дополнительными настройками. Для политики, которую вы только тестируете, здесь можно приступить к внесению некоторых изменений.
