...
Быстрый способ определить приложения Office 365, которые люди в вашей организации используют для создания данных клиента, - это определить, какие приложения включены в подписку Office 365 вашей организации. Для этого вы можете получить доступ к учетным записям пользователей на административном портале Office 365 и просмотреть информацию о лицензировании продукта. См. [Назначение лицензий пользователям](../admin/manage/assign-licenses-to-users.md).
...
При поиске личных данных в большем наборе данных, которые ваша организация создает и хранит в Office 365, вы можете сначала подумать, какие приложения люди чаще всего использовали для создания данных, которые вы ищете. По оценкам Microsoft, более 90% данных организации, хранящихся в Office 365, созданы в Word, Excel, PowerPoint, OneNote и Outlook. Документы, созданные в этих приложениях Office, даже если они приобретены через Office 365 ProPlus или бессрочную лицензию Office, скорее всего, хранятся на сайте SharePoint Online, в учетной записи OneDrive для бизнеса пользователя или в почтовом ящике Exchange Online пользователя. Это означает, что вы можете использовать инструмент eDiscovery для поиска контента для поиска (и выполнения других действий, связанных с DSR) среди сайтов SharePoint Online, учетных записей OneDrive для бизнеса и почтовых ящиков Exchange Online (включая сайты и почтовые ящики, связанные с группами Office 365, командами Microsoft, Назначения EDU), чтобы найти документы и элементы почтового ящика, которые могут иметь отношение к DSR, которую вы исследуете. Вы также можете использовать инструмент поиска контента для обнаружения данных клиента, созданных в других приложениях Office 365.
...
В то время как большая часть данных клиента создается и создается с использованием приложений, описанных в предыдущем разделе, Office 365 также предлагает множество других приложений, которые клиенты могут использовать для создания и хранения данных клиента. Однако в настоящее время поиск контента не позволяет находить данные, созданные в этих других приложениях Office 365. Чтобы найти данные, сгенерированные этими приложениями, вы или владелец данных должны использовать функциональные возможности или функции, имеющиеся в продукте, для поиска данных, которые могут иметь отношение к DSR. В следующей таблице перечислены эти приложения Office 365. Щелкните значок приложения, чтобы перейти к разделу этого руководства, в котором описано, как отвечать на запросы DSR на данные, созданные в приложении.
...
После того, как счет создан и отправлен, он не может быть удален из-за законов о бухгалтерском учете. Владелец счета-фактуры может попросить Microsoft удалить часть или всю свою информацию из Office 365.

Кроме того, вы можете удалить учетную запись пользователя владельца счета в Office 365. См. Раздел [Удаление пользователя](#deleting-a-user).
...
Планы в Планировщике сопоставлены с группой Office 365, и файлы для групп Office 365 хранятся на сайте SharePoint Online, сопоставленном с группой. Это означает, что вы можете использовать средство "Поиск контента", чтобы найти файлы Планировщика, выполнив поиск на сайте для группы Office 365. Чтобы сделать это, вам потребуется URL-адрес для группы Office 365. См. [Поиск Microsoft Teams и групп Office 365](https://support.office.com/article/Content-Search-in-Office-365-53390468-eec6-45cb-b6cd-7511f9c909e4) в разделе справки «Поиск контента в Office 365», где приведены советы по получению информации о группах Office 365, которая поможет вам найти файлы Планировщика на соответствующем сайте SharePoint Online.
...
1. Определите, использует ли ваша организация Workplace Analytics. Для получения дополнительной информации см. [Назначение лицензий пользователям](../admin/manage/assign-licenses-to-users.md). Если ваша организация не использует Workplace Analytics, дальнейших действий не предпринимается.
