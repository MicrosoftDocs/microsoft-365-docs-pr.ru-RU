...
Чтобы понять, как организация подвержена частично индексации элементов, можно выполнить поиск всего контента во всех почтовых ящиках (с помощью пустого запроса на ключевое слово). В следующем примере имеется 1 629 904 (146,46 ГБ) полностью индексных элементов и 10 025 элементов (10,27 ГБ).
...
С помощью результатов поиска из предыдущего примера частично индексируется 0,62% всех элементов почтовых ящиков.
...
Таким образом, в предыдущем примере 7% от общего размера элементов почтовых ящиков из частично индексных элементов. Как уже говорилось ранее, большинство клиентов организаций имеют менее 1% контента по объему и менее 12% контента по размеру, который частично индексировали.
...
2. [Подключение к Центру безопасности и соответствия требованиям Windows PowerShell](/powershell/exchange/exchange-online-powershell).
