...
2. Вы можете добавить другие шаблоны с уникальными основными и вспомогательными элементами, доверительными уровнями, расстоянием между символами и дополнительными проверками, а также редактировать либо удалить уже существующие. Дополнительные сведения см. в статье [Создание пользовательского типа конфиденциальной информации](#create-a-custom-sensitive-information-type).
