...
При создании метки хранения в центре соответствия требованиям Microsoft 365, центре безопасности Microsoft 365 или центре безопасности & соответствия требованиям можно выбрать активацию расстановки в конце периода хранения. При проверке ликвидации:
...
> [!NOTE]
> При указании параметра **уведомлять этих пользователей о наличии элементов, готовых к просмотру**, укажите пользователя. Для этого параметра не поддерживаются группы Microsoft 365.
...
Кроме того, обратите внимание на то, что все действия по размещению подлежат аудиту. Для этого необходимо включить аудит по крайней мере на один день перед первым действием, чтобы получить дополнительные сведения, [в статье Поиск в журнале аудита в центре безопасности &amp; и соответствия требованиям](search-the-audit-log-in-security-and-compliance.md). 
...
- Группы Microsoft 365 не поддерживаются для этой роли. Вместо этого назначьте почтовые ящики пользователей или почтовых пользователей.
