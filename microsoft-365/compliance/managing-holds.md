...
При размещении групп Office 365 и Microsoft Teams на удержании учитывайте следующие моменты.
...
- Чтобы получить список членов группы Office 365 или Microsoft Team, можно просмотреть свойства на странице " **домашние > группы** " в центре администрирования Microsoft 365. Или можно выполнить следующую команду в Exchange Online PowerShell:
