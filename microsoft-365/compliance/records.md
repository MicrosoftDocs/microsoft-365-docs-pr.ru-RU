...
Вы используете [метки хранения](labels.md), чтобы классифицировать контент как запись. После создания меток хранения, которые объявляют записи, вы можете либо опубликовать эти метки, чтобы пользователи могли применять их к контенту, либо автоматически применять эти метки к контенту, который вы хотите классифицировать как запись. Инструкции см. в разделе [Создание, публикация и автоматическое применение меток хранения](create-retention-labels.md).
...
Когда вы создаете метку хранения, у вас есть возможность использовать метку хранения, чтобы классифицировать контент как запись:
