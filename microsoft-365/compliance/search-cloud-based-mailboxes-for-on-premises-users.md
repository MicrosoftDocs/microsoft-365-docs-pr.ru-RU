...
- Флажок **Добавить контент приложения Office для локальных пользователей** находится в разделе **Расположения** в области поиска контента. Установите этот флажок, чтобы включить облачное хранилище для локального пользователя в поиск контента.
...
2. На панели **Поиски** выберите ![Добавить значок](../media/8ee52980-254b-440b-99a2-18d068de62d3.gif) **Новый поиск**.
