...
6. В разделе **Применить это правило, если** выберите условия, при которых шифрование должно быть удалено из сообщений, добавьте **отправителя** \> **в организацию**. Теперь добавьте дополнительные условия для определенных получателей, например получателя, **расположенного за прерядом** \> **Организации**.
