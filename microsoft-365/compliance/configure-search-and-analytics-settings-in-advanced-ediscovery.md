...
- При добавлении в дело [хранителей](non-custodial-data-sources.md) и источников данных, не в отношении хранения. Обработка OCR выполняется в процессе предварительной индексации. Это означает, что текст в файлах изображений, который соответствует критериям поиска, будет возвращен в поиске коллекции.
