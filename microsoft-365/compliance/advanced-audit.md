...
Пользователям, для которых выполнены необходимые условия, не нужно предпринимать никаких действий для получения доступа к важным событиям аудита. Однако, как указывалось ранее в этой статье, из-за задержки с активацией лицензии поиск важных событий в журнале аудита может не давать результатов. В этом случае следуйте инструкциям, приведенным в предыдущем разделе "Часто задаваемые вопросы о временной проблеме с активацией лицензии".
