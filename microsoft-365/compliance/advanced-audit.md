...
3. В разделе **Лицензии** проверьте, назначена ли пользователю лицензия E5.

4. Разверните раздел **Приложение** и убедитесь, что установлен флажок **Расширенный аудит Microsoft 365**.

5. Если флажок не установлен, установите его и нажмите **Сохранить изменения.**
