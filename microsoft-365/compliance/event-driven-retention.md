...
Чтобы применять метку на основе событий к документам и сообщениям электронной почты, такую метку, как и любую метку хранения, необходимо [опубликовать или автоматически применять](create-retention-labels.md).
