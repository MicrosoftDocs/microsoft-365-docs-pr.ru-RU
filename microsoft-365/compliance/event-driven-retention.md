...
### <a name="step-3-publish-the-event-based-retention-labels"></a>Шаг 3. Публикация меток хранения на основе событий

Опубликуйте свои метки хранения на основе событий, чтобы их можно было вручную применить к контенту. Вы не можете выбрать метку хранения на основе событий для политики автоматического применения. 

Чтобы опубликовать свои метки хранения на основе событий, перейдите на страницу **Классификация** > **Метки хранения**.
