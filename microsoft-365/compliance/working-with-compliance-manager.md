...
3. В портале доверия службы рекомендуется выбрать **Диспетчер соответствия требованиям**, который является ознакомительной версией с самыми актуальными функциями. **Диспетчер соответствия требованиям (классическое)** позволяет вернуться к предыдущей версии диспетчера соответствия требованиям.

4. При отображении соглашения о недоразглашении прочтите его и нажмите кнопку **согласиться**, после чего откроется панель мониторинга диспетчера соответствия требованиям.
...
2. В верхней строке меню портала доверия службы выберите пункт Администратор **, а**затем **** выберите пункт **Параметры**.
...
> [!NOTE]
> Рекомендуем определить стратегию группировки для Организации, *прежде чем* добавлять новые оценки. По умолчанию для начальной оценки доступна группа с именем "группа по умолчанию".

### <a name="how-to-create-a-group"></a>Создание группы

Группы нельзя создавать как отдельные субъекты. Группа всегда должна содержать по крайней мере одну оценку, поэтому для создания группы необходимо сначала создать оценку для помещения в группу. Чтобы создать группу, выполните указанные ниже действия.
...
5. Нажмите кнопку **Сохранить**. После завершения всплывающая панель закрывается, а новая группа автоматически отображается на панели мониторинга.
