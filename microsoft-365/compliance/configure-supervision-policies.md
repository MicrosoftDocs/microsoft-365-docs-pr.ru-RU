...
>[!IMPORTANT]
>Эта статья относится к настройке политик контроля для подписки на Office 365. Если вы хотите настроить обеспечение соответствия требованиям для подписки на Microsoft 365, ознакомьтесь со статьей [Настройка обеспечения соответствия для обмена данными в microsoft 365](communication-compliance-configure.md).
...
>[!NOTE]
>Пользователи, отслеживаемые политиками контроля, должны иметь лицензию на соответствие корпорации Майкрософт 365, лицензия на Office 365 корпоративный E3 с дополнительным соответствием требованиям, а также включить в подписку на Office 365 корпоративный, а также включить в Microsoft 365 подписки.
...
3. Войдите в свой клиент Office 365 как проверяющий, назначенный в политике контроля взаимодействия. Перейдите к **Supervision** > разделу контроль*настраиваемой политики* > ,**открытой** для просмотра отчета о политике.
