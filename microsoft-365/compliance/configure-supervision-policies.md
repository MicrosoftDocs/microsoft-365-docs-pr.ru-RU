...
ms.locfileid: "43632374"
---
# <a name="configure-supervision-policies-in-office-365"></a>Настройка политик контроля для Office 365

>[!IMPORTANT]
>Эта статья относится к настройке политик контроля в подписке Microsoft 365. Если вы хотите настроить обеспечение соответствия требованиям для подписки на Microsoft 365, ознакомьтесь со статьей [Настройка обеспечения соответствия для обмена данными в microsoft 365](communication-compliance-configure.md).
