...
1. На **вкладке "Тег \>** релевантности" по умолчанию в левой области отображается области тегов, а примеры файлов отображаются по одному для тегов. 
...
|**Параметр тегов**|**Описание**|**Сочетания клавиш**|**Для нескольких проблем — массовое теги сочетания клавиш**|
|-----|-----|-----|-----|
