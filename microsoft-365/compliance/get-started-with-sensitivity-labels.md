...
|Информация о том, как и где используются метки конфиденциальности, детализация содержимого, к которому применены метки|[Изучайте свои данные — общие сведения о классификации данных (предварительная версия)](data-classification-overview.md)|
