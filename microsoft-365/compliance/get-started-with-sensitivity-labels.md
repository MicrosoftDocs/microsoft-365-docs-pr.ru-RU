...
Участникам вашей команды по обеспечению соответствия требованиям, создающим метки конфиденциальности, необходимы разрешения на доступ к Центру соответствия требованиям Microsoft 365 или к более ранней версии Центра безопасности и соответствия требованиям. 
...
|Запрещать или предупреждать пользователей о предоставлении общего доступа к файлам и сообщениям с определенными метками конфиденциальности |[Использование меток конфиденциальности в качестве условия в политиках защиты от потери данных](dlp-sensitivity-label-as-condition.md) |
...
- Для встроенных меток используется меню: **Подробнее**.
- Для вызова клиента унифицированных меток Azure Information Protection выберите параметр меню **Справка и отзывы** и в диалоговом окне Microsoft Azure Information Protection перейдите по ссылке **Дополнительные сведения**.

Обеспечить настраиваемую документацию вам поможет следующая страница и загрузки для обучения пользователей: [Обучение конечных пользователей работе с метками конфиденциальности](https://microsoft.github.io/ComplianceCxE/enduser/sensitivity/). 
