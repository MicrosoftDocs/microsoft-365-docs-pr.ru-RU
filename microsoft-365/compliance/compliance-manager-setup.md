...
1. Перейдите в [центр Microsoft 365 соответствия](https://compliance.microsoft.com/) требованиям и **войдите** в Microsoft 365 учетную запись глобального администратора.
...
Лицо, у которого глобальная роль администратора для организации, может устанавливать разрешения пользователей для диспетчера соответствия требованиям. Разрешения можно установить в центре Office 365 безопасности &, а также в Azure Active Directory Azure AD.
...
Чтобы задать разрешения и назначить роли в центре Office 365 безопасности & соответствия требованиям, выполните следующие действия:

1. Перейдите в [центр Office 365 безопасности & и](https://protection.office.com/) выберите **разрешения** на левой навигации.
...
##### <a name="more-about-the-office-365-security--compliance-center"></a>Дополнительные информацию о центре Office 365 безопасности & соответствия требованиям

Дополнительные новости [о разрешениях](../security/office-365-security/permissions-in-the-security-and-compliance-center.md)в центре Office 365 безопасности & соответствия требованиям.

Если у вас нет доступа к центру Office 365 безопасности и соответствия требованиям, или если вам необходимо получить доступ к классической версии диспетчера соответствия требованиям на[](meet-data-protection-and-regulatory-reqs-using-microsoft-cloud.md#assigning-compliance-manager-roles-to-users)портале доверия Службы Майкрософт, параметры администратора на портале доверия службы предоставляют другой способ назначения ролей (см. инструкции). Следует помнить, что такие роли более ограничены в их функциональных возможностях.
...
Пользователи с удостоверениями Azure AD, у которых нет Office 365 или Microsoft 365 подписки, не смогут получить доступ к диспетчеру соответствия требованиям в центре Microsoft 365 соответствия требованиям. Чтобы получить помощь в доступе к диспетчеру соответствия требованиям, свяжитесь [с cmresearch@microsoft.com](mailto:cmresearch@microsoft.com).
...
1. Выберите **Параметры** в левой навигации из любой точки [Microsoft 365 центра соответствия](https://compliance.microsoft.com/)требованиям.
...
### <a name="compliance-score-breakdown"></a>Распределение баллов рейтинга соответствия требованиям
