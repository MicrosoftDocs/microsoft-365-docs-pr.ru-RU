...
1. Перейдите к [Центр соответствия требованиям Microsoft 365](https://compliance.microsoft.com/compliancemanager) и **выберите Разрешения** в левой навигации.

2. В центре **выпадания соответствия** выберите **Роли**. 

3. Найдите группу ролей, в которую нужно добавить одного или несколько пользователей, и проверьте поле слева от имени группы. (См. [список ролей и связанных функций ниже](#role-types). Имена групп ролей имитируют имя роли.)
...
Если вам необходимо получить доступ к классической версии диспетчера соответствия требованиям на портале доверия службы Майкрософт, параметры администратора на портале доверия к службам предоставляют другой способ назначения ролей (просмотр[инструкций).](meet-data-protection-and-regulatory-reqs-using-microsoft-cloud.md#assigning-compliance-manager-roles-to-users) Следует помнить, что такие роли более ограничены в их функциональных возможностях.
