...
Когда вы выбираете **Просмотр всех ожидающих расстановки**, вы перейдете на страницу " **положение** ". Пример:
...
Используйте вкладку " **положение** " со страницы " **Управление записями** ", чтобы определить записи, которые сейчас были удалены, как автоматически, так и после проверки ликвидации. Эти элементы отображают **записи** , которые удалены в столбце **тип** . Пример:
