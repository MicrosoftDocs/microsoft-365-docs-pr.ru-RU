...
Все действия ликвидации можно подвергать аудиту.
...
Используйте вкладку " **расстановка** " на странице " **Управление записями** ", чтобы определить записи, которые автоматически удаляются. Эти элементы отображают **записи** , которые удалены в столбце **тип** . При сравнении списанные записи, которые утверждены для удаления с помощью проверки ликвидации, **ожидаются**. Пример.
