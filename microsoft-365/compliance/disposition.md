...
Для успешного доступа к вкладке " **положение** " в центре соответствия требованиям Microsoft 365 пользователям необходимо иметь роль **управления расстановкой** и " **журналы аудита только для просмотра** ". Несмотря на то, что стандартный Совет состоит в добавлении пользователей в группы ролей по умолчанию, в этом случае рекомендуется создать новую группу ролей с названием " **расстановка проверяющих** " с этими двумя ролями и при необходимости добавить пользователей в эту группу. Одна группа ролей для ликвидации уменьшает количество заголовков администрирования и упрощает для пользователей совместные разрешения, которые им нужны.

> [!NOTE]
> Даже глобальному администратору должна быть назначена роль **управления расстановкой** . Поэтому, если глобальным администраторам требуется доступ к вкладке "положение", они входят в группу ролей **рецензентов расстановки** . 
...
Используйте вкладку " **расстановка** " на странице " **Управление записями** ", чтобы определить записи, которые автоматически удаляются. Эти элементы отображают **записи** , которые удалены в столбце **тип** . Пример:
