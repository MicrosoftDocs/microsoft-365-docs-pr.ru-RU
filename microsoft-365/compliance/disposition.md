...
Для успешного доступа к вкладке " **положение** " в центре соответствия требованиям Microsoft 365 необходимо быть участником роли **управления ликвидацией** и ролью " **журналы аудита только для просмотра** ". Мы рекомендуем создать новую группу ролей с именем **проверяющих**и добавить эти две роли в эту группу ролей. Даже если вы являетесь **глобальным пользователем администратора** , вам потребуется участие в роли **управления ликвидацией** , чтобы получить доступ к вкладке ликвидации.
