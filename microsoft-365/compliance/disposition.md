...
> [!NOTE]
> Возможность просматривать записи, которые были автоматически удалены без проверки на месте, по-прежнему выполняется для клиентов, поэтому в течение этого периода развертывания могут отображаться не все удаленные элементы.
