...
> [!NOTE]
> Развертывание для подтверждения выбытия записей в SharePoint и OneDrive завершено. Вы увидите список меток хранения, которые помечены как записи для SharePoint и OneDrive в разделе "расположение" страницы "Управление записями" в центре соответствия требованиям Microsoft 365. В разделе эти метки можно просмотреть список элементов в SharePoint и OneDrive, которые были удалены автоматически или после проверки ликвидации.
>
> Подтверждение выбытия записей в Exchange пока еще не активно. Когда начинается этот выпуск и когда он будет завершен, мы будем обновлять эту заметку.
