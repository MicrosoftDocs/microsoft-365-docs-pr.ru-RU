...
- **При запуске оповещения** можно настроить параметр, определяющий частоту выполнения действия до запуска оповещения. Это позволяет настроить политику для создания оповещения каждый раз, когда действие соответствует условиям политики, при превышении определенного порогового значения или при возникновении события, которое оповещение становится нетипичным для вашей организации.
    ...
    > [!NOTE]
    > Для настройки политик оповещений, основанных на пороговом значении или на основе необычных действий, требуется подписка "1/G5", либо подписка E1/F1/G1 или E3/G3 с защитником Майкрософт для Office 365 P2, Microsoft 365 о несоответствии требованиям или подписки на надстройки Майкрософт 365. Организации с подпиской E1/F1/G1 и E3/G3 могут создавать только политики оповещений, при которых оповещение инициируется каждый раз при возникновении действия.
...
|:-----|:-----|:-----|:-----|
|**Обнаружен потенциально вредоносный URL-адрес.**|Создает оповещение, когда пользователь, защищенный с помощью [безопасных ссылок](../security/office-365-security/atp-safe-links.md) в вашей организации, щелкает вредоносную ссылку. Это событие инициируется, когда вредоносности URL-адресов задаются защитником Майкрософт для Office 365, или когда пользователи переопределяют страницы безопасных ссылок (в соответствии с политикой безопасной связи Microsoft 365 для бизнеса). Для этой политики оповещений задана **Высокая** степень серьезности. Для защитника для Office 365 P2, а не для клиентов, а в случае с последующим оповещением автоматически включается автоматическое [исследование и ответ в office 365](https://docs.microsoft.com/microsoft-365/security/office-365-security/office-365-air). Дополнительные сведения о событиях, инициирующих это оповещение, приведены в разделе [Настройка политик безопасных ссылок](../security/office-365-security/set-up-atp-safe-links-policies.md).|Управление угрозами|Подписка на надстройку "/G5" или "защитник для Office 365 P2"|
...
|**Администратор инициировал ручное исследование электронной почты**|Создает оповещение, когда администратор запускает ручное исследование сообщений электронной почты в обозревателе угроз. Дополнительные сведения см. в статье [пример: администратор безопасности запускает исследование в обозревателе угроз] ( https://docs.microsoft.com/microsoft-365/security/office-365-security/automated-investigation-response-office#example-a-security-administrator-triggers-an-investigation-from-threat-explorer) . Это оповещение уведомляет Организацию о том, что исследование было запущено. Оповещение содержит сведения о том, кто активировал его и содержит ссылку на исследование. Эта политика имеет **информационный** уровень серьезности.|Управление угрозами| Подписка на надстройку Office 365 P2 или Microsoft Defender для Office P2| 
...
- **Тегами.** Используйте этот фильтр для отображения оповещений из одного или нескольких тегов пользователя. Теги отображаются на основе почтовых ящиков с тегами или пользователей, которые отображаются в оповещениях. Дополнительные сведения см. [в разделе User tagss in Office 356 ATP](..\security\office-365-security\user-tags.md) .
...
|:---------|:---------:|
|Office 365 или Microsoft 365 (/G5)|1 минута|
|Защитник для Office 365, план 2 |1 минута|
|Надстройка, обнаружение и аудит|1 минута|
...
|Role|Управление сведениями|Защита от потери данных|Поток обработки почты|Permissions|Управление угрозами|Другие|
|:---------|:---------:|:---------:|:---------:|:---------:|:---------:|:---------:|
|Журналы аудита|||||||
|Управление обращениями|||||||
|Администратор соответствия|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|
|Поиск соответствия|||||||
|Управление устройствами|||||||
|Управление ликвидацией|||||||
|Управление соответствием DLP||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|||||
|Экспорт|||||||
|Hold|||||||
|Управление оповещениями||||||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|
|Конфигурация организации||||||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|
|Предварительная версия|||||||
|Управление записями|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)||||||
|Управление хранением|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)||||||
|Проверка|||||||
|Расшифровка RMS|||||||
|Управление ролями||||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|||
|Поиск и очистка|||||||
|Администратор безопасности||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|
|Читатель сведений о безопасности||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)
|Представление "гарантия обслуживания"|||||||
|Администратор супервизорной проверки|||||||
|View-Only журналов аудита|||||||
|Управление устройствами View-Only|||||||
|View-Only управления соответствием DLP||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|||||
|View-Only Управление оповещениями||||||![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)|
|Получатели только для чтения|||  ![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)||||
|View-Only управления записями|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)||||||
|View-Only управление хранением|![Галочка](../media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)||||||
|||||||

> [!TIP]
> Чтобы просмотреть роли, назначенные каждой из групп ролей по умолчанию, выполните следующие команды в консоли безопасности & "PowerShell" центра соответствия требованиям:
> 
> ```powershell
