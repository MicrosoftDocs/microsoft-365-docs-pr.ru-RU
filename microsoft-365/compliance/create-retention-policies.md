...
Несмотря на то, что в группе Microsoft 365 есть почтовый ящик Exchange, политика хранения, включающая все расположение **электронной почты Exchange** , не будет включать содержимое в почтовые ящики группы Microsoft 365. Чтобы сохранить содержимое в этих почтовых ящиках, выберите расположение **Группы Microsoft 365** .
