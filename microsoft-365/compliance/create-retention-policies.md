...
Когда политика хранения применяется к любому сочетанию целых расположений, то отсутствует ограничение количества получателей, сайтов, учетных записей, групп и т.д., которые может охватывать политика.
