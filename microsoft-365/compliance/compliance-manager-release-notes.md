...
- Результаты безопасной оценки недоступны для некоторых элементов Action в некоторых подписках Microsoft 365 и Office 365. В таких случаях невозможно **обнаружить** результаты оценки безопасности.
