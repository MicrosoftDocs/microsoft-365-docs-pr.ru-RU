...
|Я хочу…|Документация|
|----------------|---------------|
|Эффективно задавайте действия хранения и удаления для организации или по местоположению: <br />Exchange  <br />- SharePoint  <br />- OneDrive  <br />- Группы Microsoft 365 <br />- Skype для бизнеса  <br />- Teams  |[Создание и настройка политик хранения](create-retention-policies.md)|
...
|Подтверждайте ликвидацию контента, который удаляется по истечении периода его хранения|[Ликвидация записей](disposition.md#disposition-of-records) |
