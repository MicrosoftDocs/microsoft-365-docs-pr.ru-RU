...
Во всех этих случаях метки хранения в Microsoft 365 помогут выполнить нужные действия с нужным содержимым. Метки хранения дают возможность классифицировать данные во всей организации для управления и применять правила хранения на основе этой классификации.
...
Создавать метки хранения можно в Центре соответствия требованиям Microsoft 365, Центре безопасности Microsoft 365 или Центре безопасности и соответствия требованиям.
...
- запускать проверку перед ликвидацией в конце периода хранения, чтобы перед удалением документов SharePoint и OneDrive их требовалось проверять. Дополнительные сведения см. в статье [Ликвидация содержимого](disposition.md).
...
Когда вы публикуете метки хранения в группе Microsoft 365, они отображаются как на сайте группы, так и в почтовом ящике группы в Outlook в Интернете. Процесс применения метки хранения к контенту идентичен показанному выше процессу для электронных сообщений и документов.

Чтобы хранить содержимое для группы Microsoft 365, необходимо использовать расположение групп Microsoft 365. Хотя у группы Microsoft 365 есть почтовый ящик Exchange, политика хранения, включающая все расположение Exchange, не будет содержать контент из почтовых ящиков групп Microsoft 365.
...
Метки хранения легко сделать доступными для всей организации и ее содержимого в Office 365, включая Exchange, SharePoint, OneDrive и группы Microsoft 365. Если вам нужно классифицировать содержимое или управлять записями в какой-либо службе из Microsoft 365, рекомендуем использовать метки хранения.
