...
1. В своем центре администрирования меток перейдите к меткам конфиденциальности.
    ...
    - Центр соответствия требованиям Microsoft 365: 
        - **Решения** > **Защита информации (предварительная версия)**
...
Чтобы изменить существующую метку, выберите ее и нажмите кнопку **Изменить метку**. В результате запустится мастер **Изменить метку конфиденциальности**, позволяющий поменять любые параметры из действия 3. Если метка уже опубликована с помощью политики меток, дополнительные действия не требуются, но может потребоваться до 24 часов, чтобы изменения реплицировались для пользователей и расположений.
...
1. В своем центре администрирования меток выберите **Классификация** > **Метки конфиденциальности**.
