...
3. Следуйте инструкциям мастера для настройки параметров метки.
...
При нажатии этой кнопки запустится мастер **изменения метки конфиденциальности**, позволяющий изменить любые параметры на шаге 3.
