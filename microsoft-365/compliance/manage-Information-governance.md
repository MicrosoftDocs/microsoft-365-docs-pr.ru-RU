...
Требования к лицензиям для решения "Управление информацией" (Майкрософт) зависят от используемых сценариев и компонентов, а не от заданных требований к лицензированию каждой функции, перечисленных на этой страницы. Чтобы узнать о требованиях к лицензированию и доступных возможностях, см. разделы [Управление информацией](/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance#information-governance) и [Управление записями](/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance#records-management) в документации по лицензированию Microsoft 365. Скачайте соответствующий файл PDF или Excel.