...
Администраторы управления правами субъектов могут использовать мастер управления конфиденциальностью для создания запросов. Мастер поможет вам в процессе поиска персональных данных о субъекте данных и выполнения их запроса.
