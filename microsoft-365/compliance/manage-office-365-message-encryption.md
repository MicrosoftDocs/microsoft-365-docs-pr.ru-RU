...
После завершения настройки шифрование сообщений Office 365 (OME) можно настроить конфигурацию развертывания несколькими способами. Например, можно настроить, включить ли одно время коды пропусков, отобразить кнопку **Шифрование** в Outlook в Интернете и другие. Задачи в этой статье описывают, как.

## <a name="manage-whether-google-yahoo-and-microsoft-account-recipients-can-use-these-accounts-to-sign-in-to-the-office-365-message-encryption-portal"></a>Управление тем, могут ли получатели учетных записей Google, Yahoo и Microsoft Использовать эти учетные записи для входов на шифрование сообщений Office 365 портала
...
## <a name="manage-the-use-of-one-time-pass-codes-for-the-office-365-message-encryption-portal"></a>Управление использованием кодов одновеких пропусков для шифрование сообщений Office 365 портала
...
### <a name="to-manage-whether-the-encrypt-button-appears-in-outlook-on-the-web"></a>Управление тем, появится ли кнопка Шифрование в Outlook в Интернете
...
Дополнительные сведения и сведения о клиентских впечатлениях см. в обзоре зашифрованных сообщений в [iPhone или iPad.](https://support.microsoft.com/en-us/office/view-protected-messages-on-your-iphone-or-ipad-4d631321-0d26-4bcc-a483-d294dd0b1caf)
  
### <a name="to-manage-whether-ios-mail-app-users-can-view-messages-protected-by-office-365-message-encryption"></a>Управление тем, могут ли пользователи почтовых приложений iOS просматривать сообщения, защищенные шифрование сообщений Office 365
...
Обычно при использовании шифрования Office 365 сообщений вложения автоматически шифруются. В качестве администратора можно применять расшифровку на стороне службы для вложений электронной почты, скачиваемых пользователями из веб-браузера.
  
При использовании расшифровки на стороне службы служба отправляет расшифрованную копию файла на устройство. Сообщение по-прежнему шифруется. Вложение электронной почты также хранит сведения о правах на использование, даже если браузер не применяет к пользователю права использования на стороне клиента. Пользователь может копировать или печатать вложение электронной почты, даже если у него изначально не было прав на это. Однако если пользователь пытается выполнить действие, которое требует Microsoft 365 почтового сервера, например пересылание вложения, сервер не разрешит действие, если пользователь изначально не имеет права на использование.
...
Дополнительные сведения о том, как Microsoft 365 шифрование для электронных писем и вложений электронной почты с помощью Encrypt-Only, см. в варианте [Encrypt-Only для электронных сообщений.](/azure/information-protection/deploy-use/configure-usage-rights#encrypt-only-option-for-emails)
...
2. Если вы включили кнопку **Шифрование** Outlook в Интернете, отключим ее, запуская Set-IRMConfiguration с параметром SimplifiedClientAccessEnabled. В противном случае пропустите этот шаг.
