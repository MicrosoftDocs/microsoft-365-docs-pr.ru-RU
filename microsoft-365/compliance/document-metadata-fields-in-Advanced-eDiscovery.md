...
|Идентификатор группы| GroupID|  |Идентификатор группы для сгруппированного контента.|
...
|— Современное вложение| исмодернаттачмент|  |Этот файл является современным вложением или связанным файлом.|
|Относится к версии документа | исфромдокументверсион |  |Текущий документ относится к другой версии другого документа.|
|Вложение электронной почты | исемаилаттачмент|  |Этот элемент получен из вложения электронной почты, которое отображается как вложенный элемент сообщения.|
|Встроенное вложение| исинлинеаттачмент|  |Этот параметр был подключен в тексте и отображается в тексте сообщения.|
