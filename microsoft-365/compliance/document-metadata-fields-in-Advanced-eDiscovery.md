...
- **Имя поля** и **имя отображаемого поля:** имя поля метаданных и имя поля, которое отображается при просмотре метаданных файла выбранного документа в наборе рецензирования. Обратите внимание, что некоторые поля метаданных не включаются при просмотре метаданных файла документа. Эти поля выделяются звездочкой (*).
...
|Емаилсреад *||Email_thread|Позиция сообщения в наборе электронной почты; состоит из идентификаторов узлов из корня к текущему сообщению; с разделением точками.|
...
|Неизменяемый идентификатор|Значения свойств ImmutableId|Immutable_ID|Неизменяемый идентификатор, хранящийся в Office 365.|
...
|Сортировка по ND/ET: исключение вложений|ндетсортексклаттач|ND_ET_sort_excl_attach|Объединение набора электронной почты и набора ND для эффективной сортировки во время проверки; **D** добавляется в качестве префикса к наборам ND, а **E** добавляется к наборам электронной почты.|
|Сортировка по ND/ET: включение вложений|ндетсортинклаттач|ND_ET_sort_incl_attach|Объединение набора электронной почты и набора ND для эффективной сортировки во время проверки; **D** добавляется в качестве префикса к наборам ND, а **E** добавляется к наборам электронной почты. Каждое сообщение электронной почты в наборе электронной почты сопровождается соответствующими вложениями.|
...
|Tags|Tags|Tags|Теги, применяемые в наборе рецензирования.|
