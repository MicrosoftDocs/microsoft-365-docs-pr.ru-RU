...
| Роль | Администратор соответствия | Менеджер по обнаружению электронных & администратора | Управление организацией | Reviewer |
|:-----|:-----:|:-----:|:-----:|:-----:|
