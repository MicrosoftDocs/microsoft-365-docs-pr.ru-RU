...
---
# <a name="compliance-offering-multi-tier-cloud-security-mtcs-standard-for-singapore"></a>Предложение для соответствия требованиям: стандарт многоуровневой облачной безопасности (MTCS) для Сингапура
