...
ms.locfileid: "41233770"
---
# <a name="customer-lockbox-in-office-365"></a>Защищенное хранилище для клиентов в Office 365

В этой статье представлены рекомендации по развертыванию и настройке функции, которая в настоящее время доступна только для организаций, у которых есть Microsoft 365 а, Office 365, "информационная защита", "безопасность и соответствие требованиям" или "Расширенная подписка на надстройку соответствия требованиям". Служба защищенного хранилища поддерживает запросы на доступ к данным в Exchange Online, SharePoint Online и OneDrive для бизнеса. Чтобы рекомендовать поддержку других служб Office 365, отправьте запрос на сайте [office 365 UserVoice](https://office365.uservoice.com/).
...
1. Кто-то в Организации испытывает неисправность своего почтового ящика Office 365.
...
6. Утверждающий подписывается в центр администрирования Microsoft 365 и утверждает запрос. На этом этапе запускается создание записи аудита, которую можно искать в журнале аудита Office 365. Дополнительные [сведения см.](#auditing-customer-lockbox-requests)
...
> [!NOTE]
> Все действия, выполняемые инженером Майкрософт, записываются в журнал аудита Office 365. Вы можете искать и просматривать эти записи аудита.
...
Записи аудита, соответствующие запросам хранилища клиентов, записываются в журнал аудита Office 365. Вы можете получить доступ к этим журналам с помощью [средства поиска журнала аудита](search-the-audit-log-in-security-and-compliance.md) в центре безопасности Office 365 & соответствия требованиям. Действия, связанные с принятием или отправкой запроса на доступ к защищенному доступу клиентов и действий, выполняемых инженерами Майкрософт (при утверждении запросов на доступ), также регистрируются в журнале аудита Office 365. Вы можете искать и просматривать эти записи аудита.
...
Прежде чем использовать журнал аудита для отслеживания запросов для защищенного почтового ящика, необходимо выполнить некоторые действия для настройки ведения журнала аудита. Дополнительные сведения см. в статье [Поиск по журналу аудита в Центре безопасности и соответствия требованиям Office 365](https://docs.microsoft.com/office365/securitycompliance/search-the-audit-log-in-security-and-compliance#before-you-begin). После завершения установки выполните указанные ниже действия, чтобы создать поисковый запрос журнала аудита, чтобы получить записи аудита, связанные с защищенным хранилищем данных клиентов.
...
| Пользователь       | Учетная запись службы\[BOXServiceAccount@\]кустомерфорест. prod.Outlook.com.            |
