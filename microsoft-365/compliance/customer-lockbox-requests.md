...
3. Выберите **службы Служба**  >  **защищенного хранилища клиентов**  >  **Edit**, а затем установите переключатель в положение **включено** или **выключено** , чтобы включить или отключить эту функцию.
