...
## <a name="cjis-status-in-the-united-states"></a>Состояние CJIS в США

36 состояниями и округом Колумбия с помощью соглашений управления, выделенных на карте зеленым цветом, являются:
...
Приверженность корпорации Майкрософт по обеспечению соответствия нормативным требованиям CJIS позволяет уголовным организациям реализовать облачные решения и соответствовать политике безопасности CJIS V 5.7.
