...
2. Перейдите **на** вкладку "Соединители", а затем выберите соединиталь **Yieldbroker,** чтобы отобразить на экране страницу с свойствами и сведениями о соединителе.
