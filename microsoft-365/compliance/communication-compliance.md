---
title: Соответствие коммуникациям
...
- **Оскорбительный язык и борьба за защиту**: Используйте этот шаблон, чтобы быстро создать политику, использующую встроенную угрозу, ненормативную лексику и классификаторы преследования для автоматического обнаружения контента, который может считаться оскорбительным или оскорбительным.
...
- **Настраиваемая политика**: Используйте этот шаблон, чтобы настроить конкретные каналы связи, классификаторы, индивидуальные условия обнаружения и объем контента, который необходимо проанализировать для контроля в Организации.
