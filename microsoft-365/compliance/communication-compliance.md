...
- **Новая поддержка машинного обучения**: встроенная угроза, преследования, ненормативность и [классификаторы](classifier-getting-started-with.md) изображений помогают сократить ложные срабатывания в отсканированных сообщениях, сохранив время рецензентов во время расследования и исправления.
