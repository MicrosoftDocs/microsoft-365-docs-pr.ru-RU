...
На этом этапе необходимо подробнее рассмотреть проблемы, обнаруженные в соответствии с используемыми вами политиками соответствия требованиям к обмену данными. Этот шаг включает следующие действия, доступные в центре Microsoft 365 соответствия требованиям:
...
- **Разрешение**: после проверки проблемы можно исправить ее, разрешив тем самым оповещение. При разрешении оповещения оно будет удалено из очереди ожидающих оповещений, а действие будет сохранено в виде записи в очереди Разрешенные для соответствующий политики. Оповещения автоматически решаются после маркировки оповещений как ложного срабатывания, отправки уведомления пользователю об оповещении или открытия нового случая оповещения.
...
- **Присвоение метки "ложное срабатывание"**: иногда процесс проверки проходят сообщения, для которых ошибочно обнаружено соответствие условиям срабатывания политик соответствия требованиям. Эти типы оповещений можно пометить как ложные срабатыва;
