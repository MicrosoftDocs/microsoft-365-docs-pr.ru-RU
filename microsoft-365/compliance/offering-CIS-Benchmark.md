...
ms.locfileid: "39233612"
---
# <a name="compliance-offering-center-for-internet-security-cis-benchmarks"></a>Предложение по соответствию требованиям: контрольные показатели Center for Internet Security (CIS)
