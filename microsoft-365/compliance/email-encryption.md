---
title: Шифрование электронной почты
f1.keywords:
- NOCSH
ms.author: krowley
author: kccross
...
## <a name="what-is-email-encryption-and-how-does-microsoft-365-use-it"></a>Что такое шифрование электронной почты и как оно используется в Microsoft 365?

Шифрование — это процесс кодирования информации таким образом, чтобы только авторизованный получатель мог декодировать и использовать ее. В Microsoft 365 шифрование используется двумя способами: в работе службы и в качестве пользовательского элемента управления. В работе службы шифрование используется в Microsoft 365 по умолчанию. Вам не нужно ничего настраивать. Например, в Microsoft 365 протокол TLS используется для шифрования подключения (сеанса) между двумя серверами. 
