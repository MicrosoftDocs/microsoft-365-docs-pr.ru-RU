...
1. В Центре соответствия &amp; требованиям безопасности перейдите к отчету о **шифровании сообщений.** Сведения об этом отчете см. в обзоре отчетов о безопасности электронной почты [в Центре соответствия требованиям &amp; безопасности.](../security/office-365-security/view-email-security-reports.md)
...
### <a name="step-2-verify-that-the-mail-is-revocable"></a>Этап 2. Убедитесь, что почта является отзывной
