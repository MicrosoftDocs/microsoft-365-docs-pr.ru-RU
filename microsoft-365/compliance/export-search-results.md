...
7. В **статье Экспорт Exchange как** выберите один из следующих вариантов:
    ...
    - **Один PST-файл, содержащий все сообщения:** Экспортирует один PST-файл *(Exchange.pst),* содержащий результаты поиска из всех исходных почтовых ящиков, включенных в поиск. Этот параметр воспроизводит структуру папок почтовых ящиков для каждого сообщения.
...
8. Чтобы **исключить дубликат** сообщений, нажмите кнопку Включить дубликат. Этот параметр отображается только в том случае, если источники контента поиска включают Exchange почтовые ящики или общедоступные папки. 
...
9. Нажмите **кнопку Включить версии для SharePoint документов,** чтобы экспортировать все версии SharePoint документов. Этот параметр отображается только в том случае, если источники контента поиска включают SharePoint или OneDrive для бизнеса сайты. 
...
11. Нажмите кнопку **Начать экспорт**. Результаты поиска готовы к загрузке, а это значит, что они загружаются в служба хранилища Azure в облаке Майкрософт. Это может занять несколько минут.
