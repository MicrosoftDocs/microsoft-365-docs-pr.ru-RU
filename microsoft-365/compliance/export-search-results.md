...
- Мы рекомендуем скачать результаты поиска на локальный компьютер. Тем не менее, чтобы избежать проблем при загрузке результатов поиска, чтобы избежать проблем с брандмауэром или инфраструктурой прокси-сервера компании, можно скачать результаты поиска на виртуальном рабочем столе вне вашей сети. Это может привести к уменьшению времени ожидания в подключениях к данным Azure при экспорте большого количества файлов. Дополнительные сведения о виртуальных рабочих столах можно найти в статье [виртуальный рабочий стол Windows](https://azure.microsoft.com/services/virtual-desktop). 

- Чтобы увеличить производительность при загрузке результатов поиска, рассмотрите возможность разделения результатов поиска, возвращающих большой набор результатов, на небольшие поисковые запросы. Например, вы можете использовать диапазоны дат в поисковых запросах, чтобы получить уменьшенный набор результатов, который можно скачать быстрее.
...
- При загрузке результатов поиска с помощью средства экспорта eDiscovery возможно возникновение следующей ошибки: `System.Net.WebException: The remote server returned an error: (412) The condition specified using HTTP conditional header(s) is not met.` это временная ошибка, которая обычно возникает в расположении хранилища Azure. Чтобы устранить эту проблему, повторно попытайтесь [скачать результаты поиска](#step-2-download-the-search-results), перезапустите средство экспорта eDiscovery.
