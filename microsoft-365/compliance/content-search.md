...
1. Перейдите на сайт [https://compliance.microsoft.com](https://compliance.microsoft.com) и войдите с помощью адреса электронной почты Microsoft и пароля.
...
3. На странице **Поиск контента** выберите **Новый поиск**.
    ...
    Кроме того, вы можете выбрать один из других вариантов поиска:
...
4. В разделе **Поисковый запрос** укажите следующие элементы.
   ...
   4. **Добавление содержимого приложения для пользователей локальной системы.** Установите этот флажок, чтобы включить в поиск контент Teams для локального пользователя. Например, если вы проводите поиск по всем почтовым ящикам Exchange в организации и у вас установлен этот параметр, облачное хранилище, используемое для хранения данных чата Teams для локальных пользователей, будет включено в область поиска. Дополнительные сведения см. в статье [Поиск данных в чате Teams для локальных пользователей](search-cloud-based-mailboxes-for-on-premises-users.md).

5. После настройки поискового запроса нажмите кнопку **Сохранить и выполнить**.
    
6. На странице **Сохранить поисковый запрос** введите название поискового запроса и необязательное описание, помогающее определить его. Название поискового запроса должно быть уникальным в пределах организации. 
    
7. Нажмите кнопку **Сохранить**, чтобы начать поиск. 
...
1. **Автоматический предварительный просмотр результатов.** Этот параметр отображает результаты поиска после выполнения поискового запроса.
...
2. На всплывающей странице выберите **Экспорт результатов**. Вы также можете экспортировать отчет о результатах поиска.
...
[Поиск в Microsoft Teams и группах Microsoft 365](#searching-microsoft-teams-and-microsoft-365-groups)

[Поиск в группах Yammer](#searching-yammer-groups)
...
- Майкрософт собирает данные о скорости выполнения запросов на поиск контента, создаваемых во всех организациях. Хотя сложность запроса тоже влияет на скорость его выполнения, главным фактором, определяющим время поиска, является число почтовых ящиков, в которых он ведется. Хотя время поиска не подкрепляется соглашением об уровне обслуживания, доступны примерные результаты для разного числа почтовых ящиков, включенных в запрос.
