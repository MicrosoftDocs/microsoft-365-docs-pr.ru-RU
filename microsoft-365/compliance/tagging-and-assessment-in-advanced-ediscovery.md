...
Поле текущей ошибки оценки — это поле ошибки, рекомендуемое Advanced eDiscovery. Число, отображаемого для "Необходимы дополнительных файлов оценки", соответствует этой рекомендации.
...
На развернутом мониторе Track показаны рекомендуемый следующий шаг, статистика оценки и доступ к подробным результатам.
