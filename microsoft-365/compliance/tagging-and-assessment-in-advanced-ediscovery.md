...
4. Щелкните **"Изменить"**  справа от окна оценки, чтобы просмотреть и указать параметры оценки для каждого вопроса. Отображается **диалоговое окно** уровня оценки для каждой проблемы, как показано в следующем примере: 
...
8. Щелкните **"Update values" (Обновить),** чтобы увидеть влияние изменений. 
...
9. Щелкните **"Дополнительно"** в диалоговом окте "Уровень оценки", чтобы увидеть следующие дополнительные параметры и сведения:  
    ...
    - **Ожидаемое поле** ошибки "Насыщенность": с учетом обновленных значений это ожидаемое поле ошибки разности после проверки всех дополнительных файлов оценки.
...
Когда индикатор хода выполнения оценки показывает, что оценка завершена, это означает, что проверка примера оценки завершена, а соответствующие файлы были помечены. 
...
> [!TIP]
> На **вкладке \> "Отслеживание** релевантности" отображаются проблемы, доступные следующие параметры просмотра: 
> 
