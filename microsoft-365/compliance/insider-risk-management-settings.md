...
| Категория | Категория оповещения — *инсидеррискманажемент*. Эту категорию можно использовать для различения оповещений от других оповещений о соответствии & безопасности. |
