...
Многие этапы реализации, необходимые для архивации сетевых данных Bell, являются внешними по отношению к Microsoft 365 и должны быть завершены, прежде чем можно будет создать соединитель в центре соответствия требованиям.
