 ...
 **Примеры данных на REST** включают файлы, которые вы отправили в библиотеку SharePoint, данные Project Online, документы, которые вы отправили в собрании Skype для бизнеса, сообщения электронной почты и вложения, сохраненные в папках почтового ящика Office 365, и файлы, которые вы отправили в OneDrive для бизнеса.
