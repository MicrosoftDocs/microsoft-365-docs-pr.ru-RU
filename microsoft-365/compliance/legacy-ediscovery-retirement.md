...
- [обнаружение электронных данных на месте](/exchange/security-and-compliance/in-place-ediscovery/in-place-ediscovery) и на месте [удерживает](/exchange/security-and-compliance/create-or-remove-in-place-holds) в центре Exchange администрирования.
...
<td>Основные случаи проверки электронных данных в центре Microsoft 365 соответствия требованиям </td>
...
<td>Политики хранения в центре Microsoft 365 соответствия требованиям</td>
...
Центр Microsoft 365 также использует границы [](set-up-compliance-boundaries.md) соответствия требованиям для управления расположениями контента, которые может искать диспетчер по поиску электронных данных. Границы соответствия требованиям являются полезными для государственных организаций, которые должны находиться в пределах границ учреждений или многонациональных корпораций, необходимых для соблюдения географических границ.

**Как переместить текущий поиск и удерживание в центре Microsoft 365 соответствия требованиям?**

С помощью PowerShell можно перенести In-Place поиск и удерживает их из EAC. Инструкции см. в [инструкции Перенос](./migrate-legacy-ediscovery-searches-and-holds.md)поиска и удерживания из Центра обработки данных в центр Microsoft 365 соответствия требованиям.
...
<p> </p></td>
<td><p>Чтобы помочь поиску и экспорту контента, совместно работают между собой cmdlets ComplianceSearch и ComplianceSearchAction. Вы можете создать новый поиск и просмотреть оценку поиска с помощью кодлетов <strong>New-</strong>, <strong>Get-</strong>и <strong>Start-ComplianceSearch.</strong> Затем вы можете экспортировать результаты поиска с помощью <strong>cmdlet New-ComplianceSearchAction.</strong> Для загрузки этих результатов поиска на локальный компьютер вам все равно придется использовать основной инструмент для Microsoft 365 для проверки соответствия требованиям.</p>
<p>
<p><strong>Примечание:</strong> Если вы используете эти кодлеты для создания поисков, не связанных с основным делом об <strong></strong> обнаружении электронных данных, эти поиски будут расположены на странице поиска контента в центре Microsoft 365 соответствия требованиям.</p></td>
</tr>
<tr class="even">
...
<p><a href="/powershell/module/exchange/get-compliancecase"><span class="underline">*-ComplianceCase</span></a></p>
<p> </p></td>
<td><p>Удерживание в центре Microsoft 365 должно быть связано с complianceCase. Сначала создайте случай соответствия требованиям, а затем создайте CaseHoldPolicy и CaseHoldRule.</p>
...
**Как перенести поиск и удерживание в центре Microsoft 365 соответствия требованиям?**

С помощью скрипта PowerShell можно перенести In-Place поиск и удерживает их из центра администрирования Exchange. Дополнительные сведения см. в [дополнительных](migrate-legacy-eDiscovery-searches-and-holds.md)сведениях о переносе устаревших поисков электронных данных и удерживает их в центре Microsoft 365 соответствия требованиям.
...
<p><a href="/powershell/module/exchange/get-compliancesearchaction"><span class="underline">*-ComplianceSearchAction</span></a></p>
<p></a></p></td>
<td><p>Чтобы помочь поиску и экспорту контента, совместно работают между собой cmdlets ComplianceSearch и ComplianceSearchAction. Вы можете создать новый поиск и просмотреть оценку поиска с помощью кодлетов <strong>New-</strong>, <strong>Get-</strong>и <strong>Start-ComplianceSearch.</strong> Затем вы можете использовать команду <strong>New-ComplianceSearchAction-Export</strong> для экспорта результатов поиска. Для загрузки этих результатов поиска на локальный компьютер вам все равно придется использовать основной инструмент для Microsoft 365 для проверки соответствия требованиям.</p></p>
</td>
</tr>
<tr class="even">
<td>Удаление массовой электронной почты из почтового ящика</td>
<td><p><a href="/microsoft-365/compliance/set-up-an-archive-and-deletion-policy-for-mailboxes?view=o365-worldwide"><span class="underline">Настройка политики архивации и удаления для почтовых ящиков</span></a></p>
<p></p></td>
...
Решение [Advanced eDiscovery в](./overview-ediscovery-20.md) центре Microsoft 365 соответствия требованиям.