...
- [Поиск и удаление сообщений электронной почты](search-for-and-delete-messages-in-your-organization.md) , например сообщений о вирусе, опасных вложениях или фишинговых сообщениях.
...
- [Поиск определенных папок и почтовых ящиков сайтов](use-content-search-for-targeted-collections.md) (называемых * целевой коллекцией), когда вы уверены, что элементы, реагирующие на обращение, находятся в этой папке.
