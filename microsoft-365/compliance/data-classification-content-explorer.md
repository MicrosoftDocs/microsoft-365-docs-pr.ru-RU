...
Существуют две роли, разрешающие доступ к обозревателю содержимого. Доступ предоставляется через [Центр безопасности и соответствия требованиям Майкрософт](https://protection.office.com/permissions).
