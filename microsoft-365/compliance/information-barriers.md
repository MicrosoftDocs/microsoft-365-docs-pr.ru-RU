---
title: Узнайте о барьерах информации в Microsoft 365
f1.keywords:
- NOCSH
ms.author: chrfox
author: chrfox
...
ms.locfileid: "49613101"
---
# <a name="learn-about-information-barriers-in-microsoft-365"></a>Узнайте о барьерах информации в Microsoft 365
...
> [!IMPORTANT]
> Information барьеры ***поддерживает только** два ограничения: _. Один из таких ограничений, например маркетинг, может общаться с днями недели, но день не может поддерживать обмен данными с маркетингом _ *_не поддерживается_* *.
