...
- Сайт для группы "День" не должен совместно использовать любой другой сайт или получать к нему доступ
...
В SharePoint Online и OneDrive политики информационных барьеров определяют и предотвращают следующие виды несанкционированной совместной работы:
...
Дополнительные сведения о пользовательском интерфейсе с информационными барьерами см. в информационных [барьерах в SharePoint Online](https://docs.microsoft.com/sharepoint/information-barriers)
