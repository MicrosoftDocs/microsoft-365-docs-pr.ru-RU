...
DLP сканирует электронную почту иначе, чем элементы в SharePoint Online или OneDrive для бизнеса. В SharePoint Online и OneDrive для бизнеса DLP сканирует как существующие, так и новые элементы и генерирует отчет об инцидентах при обнаружении совпадения. В Exchange Online защита от потери данных сканирует только новые сообщения электронной почты и формирует отчет при совпадении политик. Защита от потери данных * *_не_* _ сканирует и не сопоставляет ранее существующие элементы электронной почты, которые хранятся в почтовом ящике или архиве.
