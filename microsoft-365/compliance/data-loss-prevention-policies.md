...
> [!NOTE]
> OneDrive для просмотра бизнес-политики с помощью учетных записей пользователей или групп. 
...
По умолчанию глобальные администраторы, администраторы безопасности и администраторы соответствия требованиям будут иметь доступ к созданию и применении политики DLP. Другим членам группы соответствия требованиям, которые будут создавать политики DLP, необходимы разрешения Центра соответствия &amp; требованиям безопасности. По умолчанию администратор клиента будет иметь доступ к этому расположению и может предоставить сотрудникам по обеспечению соответствия требованиям и другим людям доступ к Центру соответствия требованиям безопасности, не предоставляя им все разрешения администратора &amp; клиента. Для этого рекомендуется:
