...
- Подготовить страницу [центров подписок](https://docs.microsoft.com/dynamics365/customer-engagement/marketing/set-up-subscription-center) с несколькими редактируемыми полями контактов. Эта страница позволяет конечному пользователю обновлять информацию о себе столько раз, сколько потребуется.
