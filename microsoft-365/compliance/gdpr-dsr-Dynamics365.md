...
Окончательное удаление учетной записи пользователя удаляет данные пользователя из системных журналов почти во всех службах Dynamics 365 в течение 30 дней.
