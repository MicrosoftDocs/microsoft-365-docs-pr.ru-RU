...
> [!IMPORTANT]
> Сторонние приложения, которые сканируют и изменяют почту, могут предотвратить правильное применение брендинга OME.
...
- Если сообщение было зашифровано вручную конечным пользователем с помощью Outlook или Outlook в Интернете, то Outlook Web App
