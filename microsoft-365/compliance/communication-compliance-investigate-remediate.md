...
- **Домашняя страница соответствия требованиям к общению**: [https://compliance.microsoft.com](https://compliance.microsoft.com) при входе в учетную запись администратора в организации Microsoft 365 выберите "**Обзор** **соответствия требованиям** > ", чтобы отобразить домашнюю страницу соответствия информации. Здесь вы увидите следующее:
...
6. Выберите один или несколько флажков, чтобы включить фильтры для этих оповещений.
