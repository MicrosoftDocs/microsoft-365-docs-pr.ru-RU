...
ms.custom:
- seo-marvel-apr2020
description: Настройте соединитель для импорта данных из Bloomberg в Microsoft 365, чтобы можно было использовать различные средства обеспечения соответствия требованиям.
