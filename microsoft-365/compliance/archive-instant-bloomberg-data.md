...
5. На странице " **Выбор типов данных для импорта** " выберите типы данных, которые требуется импортировать отдельно от **сообщений**
