...
- MET150
- MOE150
description: С помощью средства поиска журнала аудита можно устранять распространенные проблемы, такие как исследование скомпрометированных учетных записей, определение того, кто настраивает переадресацию электронной почты для почтового ящика, или определение причины успешного входа внешнего пользователя в организацию.
ms.openlocfilehash: 8eaff1fa3eea6a0fa60edcfd43f4f2aedb5a5ffc
ms.sourcegitcommit: 2614f8b81b332f8dab461f4f64f3adaa6703e0d6
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/21/2020
ms.locfileid: "43636387"
---
...
- Поиск действий общего доступа к SharePoint, указывающих на то, что общий доступ к файлу предоставлен внешнему пользователю, указанному **пользователем, вошедшим в** запись аудита. Дополнительные сведения см в разделе [Использование аудита общего доступа в журнале аудита](use-sharing-auditing.md).
