...
[Блокировка клиентов](/office365/admin/manage/customer-lockbox-requests) обеспечивает уровень управления доступом для организаций при доступе к данным корпорацией Майкрософт. Управление привилегированным доступом позволяет детально управлять доступом в организации для всех привилегированных задач Microsoft 365.
