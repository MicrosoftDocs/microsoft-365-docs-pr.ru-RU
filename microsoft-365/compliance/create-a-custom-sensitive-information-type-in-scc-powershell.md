...
2. [Подключение к центру соответствия требованиям PowerShell](https://go.microsoft.com/fwlink/p/?LinkID=799771)
...
- При использовании командлета PowerShell максимальный размер возвращаемых десериализованных данных составляет примерно 1 мегабайт.   Это влияет на размер XML-файла. Не следует превышать рекомендуемый лимит максимального размера загруженного файла (512 мегабайт) для получения стабильных результатов без ошибок при обработке.

- Структура XML не требует символов форматирования, таких как пробелы, табуляция или записи возврата каретки или перевода строки.  Обратите внимание на это при оптимизации места для загрузки.
...
1. [Подключение к центру соответствия требованиям PowerShell](https://go.microsoft.com/fwlink/p/?LinkID=799771)
...
Чтобы подключиться к центру соответствия требованиям PowerShell, см. статью [Подключение к центру соответствия требованиям PowerShell](https://go.microsoft.com/fwlink/p/?LinkID=799771).
