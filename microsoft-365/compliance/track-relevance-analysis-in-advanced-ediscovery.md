...
> [!NOTE]
> После **Issue** \> семи циклов обучения, оценивающих после оценки, можно просмотреть согласованность тегов в **подробных результатах** \> **Training progress** **отслеживания** \> **релевантности** \> . Эта проверка выполняется по одной ошибке за раз. 
