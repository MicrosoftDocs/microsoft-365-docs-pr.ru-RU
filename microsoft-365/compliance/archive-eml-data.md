...
- Создайте учетную запись Глобанет Merge1, приняв условия и условия для соединителя EML. Для этого обратитесь в [службу поддержки клиентов глобанет](https://globanet.com/contact-us). Вы должны войти в эту учетную запись, когда вы создадите соединитель на шаге 1.
