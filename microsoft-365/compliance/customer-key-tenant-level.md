...
Создав политику шифрования на уровне клиента, вы зашифруете все данные для рабочих нагрузок Microsoft Teams и Exchange Online в Microsoft 365. Эта политика не мешает точно настроенным DEP, уже созданным в ключе клиента.

Примеры:

Файлы Microsoft Teams и некоторые записи вызовов и собраний Teams, сохраненные в OneDrive для бизнеса и SharePoint, шифруются deP в SharePoint Online. Один deP в SharePoint Online шифрует контент в одном географическом области.
