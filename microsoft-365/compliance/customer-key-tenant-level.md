...
Для Microsoft Information Protection и Microsoft Teams ключ клиента на уровне клиента шифрует новые данные с того времени, как вы назначите клиенту deP. Общедоступный предварительный просмотр не поддерживает шифрование прошлых данных. Для Exchange Online ключ клиента шифрует все существующие и новые данные.
...
Ключ клиента не шифрует следующие типы данных на уровне клиента. Вместо этого Microsoft 365 использует другие типы шифрования для защиты этих данных.

- Обмен почтовыми ящиками в Интернете, которые вы уже зашифрованы с помощью DEP ключа клиента на уровне приложений. Почтовые ящики, у которых нет назначенного им DEP ключа клиента, будут шифроваться с помощью deP уровня клиента. Это расположение означает, что некоторые почтовые ящики зашифрованы с deP уровня клиента, а некоторые почтовые ящики зашифрованы с dePs уровня приложений.
- SharePoint и OneDrive для бизнеса используют ключ клиента на уровне приложений. Один deP шифрует контент в SharePoint для одного гео.
- Файлы Microsoft Teams и некоторые записи вызовов и собраний Teams, сохраненные в OneDrive для бизнеса и SharePoint, шифруются deP SharePoint Online.

Любые рабочие нагрузки или сценарии, которые в настоящее время не поддерживаются ключом клиента для Microsoft 365.

- Другие рабочие нагрузки Microsoft 365, такие как Yammer, Planner и так далее.
...
Microsoft 365 требует, чтобы подписка На хранилище ключей Azure была установлена подписка "Не отменяйте", а ключи, используемые клиентской клавишей, имеют возможность мягкого удаления. Эти параметры можно подтвердить, посмотрев уровень восстановления на клавишах.
...
|----------|----------|---------|
|Выбор названия|Удобное имя политики шифрования данных|N|
...
Когда вы включаете ключ клиента на уровне клиента, вы не можете создать новую команду в Microsoft Teams.
