...
Узнать больше о профессиональных услугах Майкрософт можно здесь (<https://www.microsoft.com/microsoftservices/professional_services.aspx>) и в разделе центра управления безопасностью (Майкрософт), посвященном этим услугам (<https://www.microsoft.com/trustcenter/cloudservices/commercialsupport>). Отдел, оказывающий профессиональные услуги Майкрософт, серьезно относится к своим обязательствам по Общему регламенту о защите данных (GDPR). Сведения, представленные в этом документе, призваны ответить на вопросы клиентов о том, как службы поддержки и консультационные службы Майкрософт отвечают на запросы субъектов данных (DSR) и помогают клиентам отвечать на них с соблюдением требований GDPR.<span id="_Toc508792502" class="anchor"><span id="_Toc510704608" class="anchor"></span></span>
...
#### <a name="additional-terms-and-definitions-that-may-helpful-in-understanding-this-guide"></a>Дополнительные термины и определения, которые могут быть полезны для понимания этого руководства
...
## <a name="dsr-for-a-customer-contact-engaging-microsoft"></a>DSR для контактного лица клиента, связывающегося с корпорацией Майкрософт
...
## <a name="dsr-for-an-end-user-engaging-microsoft"></a>DSR для пользователя, связывающегося с корпорацией Майкрософт
...
## <a name="dsr-for-customer-provided-data-commercial-support"></a>DSR для предоставленных пользователем данных: коммерческая поддержка
...
## <a name="dsr-for-customer-provided-data-consulting-services-including-fasttrack-migration-services"></a>DSR для предоставленных клиентами данных: консультационные услуги с использованием служб миграции FastTrack 
