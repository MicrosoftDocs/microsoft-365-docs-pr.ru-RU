...
3. Соединитель Pivot, который вы создаете в центре соответствия требованиям Microsoft 365, подключается к сайту Veritas Merge1 каждый день и передает элементы Pivot в безопасное хранилище Azure в облаке Microsoft.
