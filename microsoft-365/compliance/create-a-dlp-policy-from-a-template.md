...
10. Чтобы добавить тип конфиденциальной информации, в \> разделе **условия** **добавьте или измените типы**. Затем в разделе **Добавить или изменить типы** \> выберите **добавить** \> выберите **номер банковского счета США** и **Add** \> **Done** \> **номер водительского удостоверения для драйвера США** .
