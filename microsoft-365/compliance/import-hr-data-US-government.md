...
ms.locfileid: "45205033"
---
# <a name="set-up-a-connector-to-import-hr-data-in-us-government-preview"></a>Настройка соединителя для импорта данных отдела кадров в США (Предварительная версия)
