...
15. В текстовом поле введите или вставьте одну из следующих подсказок в зависимости от того, используются ли необязательные метки конфиденциальности, чтобы защитить конфиденциальные файлы:
