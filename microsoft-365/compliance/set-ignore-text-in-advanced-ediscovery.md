...
Например, если текст имеет следующий текст: "ДЕНИСА Боб Марии канун", вот примеры игнорируемых текстовых записей и результатов, которые создает эти записи:

|**Игнорировать текстовые записи** <br/> |**Results** <br/> |
|:-----|:-----|
|"АЛИСА", "БОБ, ИВАН"  <br/> |"КАНУН ДЕНИСА"  <br/> |
|"АЛИСА", "БОБ ALICE"  <br/> |"ДЕНИСА ИВАН, КАНУН"  <br/> |
