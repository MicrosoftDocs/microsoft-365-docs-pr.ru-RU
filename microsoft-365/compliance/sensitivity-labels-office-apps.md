...
- Для документа: защита **файла** > **** > **Защита документа** > **ограничить доступ**
...
Для более согласованной работы с метками с осмысленными отчетами предоставьте соответствующие метки и рекомендации, чтобы пользователи применяли только метки. Пример.
