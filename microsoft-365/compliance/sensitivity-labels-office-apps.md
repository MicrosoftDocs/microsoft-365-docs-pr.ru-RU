...
|[Предоставление пользователям возможности назначать разрешения](encryption-sensitivity-labels.md#let-users-assign-permissions)                     | Предварительный просмотр: при развертывании в [программе предварительной оценки Office](https://office.com/insider)            | Предварительный просмотр: при развертывании в [программе предварительной оценки Office](https://office.com/insider)        | Раздел "Рецензирование"   | Раздел "Рецензирование"         | Раздел "Рецензирование"                                                        |
