...
- Дополнительные ресурсы, которые помогут пользователям в вашей организации начать использовать метки конфиденциальности.
...
|[Предоставление пользователям возможности назначать разрешения](encryption-sensitivity-labels.md#let-users-assign-permissions)                     | Предварительная версия: развертывание [Office для участников программы предварительной оценки](https://office.com/insider)            | Предварительная версия: развертывание [Office для участников программы предварительной оценки](https://office.com/insider)        | Раздел "Рецензирование"   | Раздел "Рецензирование"         | Раздел "Рецензирование"                                                        |
...
## <a name="when-office-365-applies-content-marking-and-encryption-to-content"></a>Когда Office 365 применяет маркировку и шифрование содержимого к содержимому
