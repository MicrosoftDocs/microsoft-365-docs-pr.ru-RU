...
- Режим имитации:
    ...
    - Чтобы просмотреть содержимое файлов в исходном представлении у вас должна быть роль **просматривающего контент в обозревателе содержимого**. По умолчанию глобальному администратору не назначается эта роль. Если у вас нет такого разрешения, при выборе элемента на вкладке **Соответствующие элементы** вы не увидите область просмотра.
