...
- Классические версии Приложений Microsoft 365 для предприятий на платформе Windows в рамках [программы предварительной оценки Office](https://office.com/insider):
    - Word
    - Excel
    - PowerPoint
...
- Для режима имитации необходимо включить аудит в Microsoft 365. Чтобы включить аудит или проверить, включен ли он, см. статью [Включение и отключение поиска в журнале аудита](turn-audit-log-search-on-or-off.md).
