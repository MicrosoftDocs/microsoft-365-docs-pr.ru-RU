...
> [!NOTE]
> Политики автодобавления подписей на основе пользовательских типов конфиденциальной информации применяются только к только что созданному или измененному содержимому в OneDrive и SharePoint. 
