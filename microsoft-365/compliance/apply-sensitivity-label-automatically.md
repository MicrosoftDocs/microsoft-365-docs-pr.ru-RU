...
|Условия: исключения|Нет |Да (только электронная почта) |
...
> [!NOTE]
> Политики автоматического присвоения меток, основанные на пользовательских типах конфиденциальной информации, применяются только к созданному или измененному содержимому в OneDrive и SharePoint, а не к существующему содержимому. 
...
- Если вы планируете использовать [пользовательские типы конфиденциальной информации](sensitive-information-type-learn-about.md) вместо встроенных типов: 
    - Пользовательские типы конфиденциальной информации применяются только на наличие содержимого, которое добавляется или изменяется в SharePoint или OneDrive после сохранения этих.
...
7. На странице **Настройка общих или расширенных правил**: оставьте значение по умолчанию **Общие правила**, чтобы определить правила идентификации содержимого для применения меток во всех выбранных расположениях. Если для каждого расположения нужны разные правила, выберите **Расширенные правила**. Нажмите кнопку **Далее**.
    ...
    Для каждого из этих условий можно указать исключения.
