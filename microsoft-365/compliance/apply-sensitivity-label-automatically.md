...
- **Применение меток на стороне службы, когда содержимое уже сохранено (в SharePoint Online или в OneDrive для бизнеса) или отправлено по электронной почте (обрабатывается в Exchange Online)**: используйте политику автоматического применения меток — в настоящий момент на этапе предварительной версии. 
    ...
    > [!NOTE]
    > См. объявление о предварительной версии [Объявление об общедоступной предварительной версии автоматической классификации с использованием меток конфиденциальности в службах Microsoft 365](https://techcommunity.microsoft.com/t5/security-privacy-and-compliance/announcing-public-preview-of-auto-classification-with/ba-p/1279961) и вебинар [Введение в автоматическое применение меток SharePoint и OneDrive с использованием меток конфиденциальности](https://aka.ms/SPOAutoLabelWebinar-Recording).
...
> [!NOTE]
> Параметр **Обучаемые классификаторы** в настоящее время развертывается в клиентах в виде общедоступной предварительной версии. Если этот параметр не отображается, повторите попытку через несколько дней.
