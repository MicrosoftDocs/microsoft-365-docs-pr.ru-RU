...
2. Следуйте указаниям мастера. Если используется управление записями:
    ...
    - Дополнительные сведения о дескрипторах плана хранения, см. в статье [Общие сведения о диспетчере плана хранения](file-plan-manager.md)
...
Чтобы изменить существующую метку, выберите ее и нажмите **Изменить метку**. При этом запускается тот же мастер, который позволяет изменить описания и параметры метки на шаге 2.
...
2. Следуйте указаниям мастера.
    ...
    Сведения о настройке расположений, см. в разделе [Метки хранения и расположения](#retention-labels-and-locations) на этой странице. 
...
2. Следуйте указаниям мастера.
    ...
    Сведения о настройке расположений, см. в следующем разделе [Метки хранения и расположения](#retention-labels-and-locations) на этой странице.

## <a name="retention-labels-and-locations"></a>Метки хранения и расположения
...
При изменении меток хранения, их политику или политику авто-применения когда метка хранения уже применена к контенту, ваши обновленные параметры автоматически применяются к этому контенту, в дополнение к уже помеченному.
