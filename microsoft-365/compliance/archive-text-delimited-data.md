...
3. Соединители с текстовыми делениями, которые создаются в Центре соответствия требованиям Microsoft 365, каждый день подключаются к сайту Globanet Merge1 и переносятся в безопасное хранилище Azure в Облаке Майкрософт.

4. Соединиталь импортирует преобразованные элементы сообщений в почтовые ящики определенных пользователей, используя значение свойства *"Электронная* почта" автоматического сопоставления пользователей, как описано в шаге 3. Новая вложенная папка в папке "Входящие" с именем **Text-Delimited** создается в почтовых ящиках пользователей, и элементы сообщения импортированы в эту папку. Соединиталь определяет, в какой почтовый ящик импортировать элементы, используя значение свойства *Email.* Каждое сообщение содержит это свойство, которое заполняется адресом электронной почты каждого участника.
...
## <a name="step-4-monitor-the-text-delimited-connector"></a>Шаг 4. Отслеживание соединители с текстом

После создания соединители с текстом с делегированный можно просмотреть состояние соединители в Центре соответствия требованиям Microsoft 365.

1. Go to [https://compliance.microsoft.com](https://compliance.microsoft.com) and click **Data connectors** in the left nav.

2. Щелкните **вкладку "Соединители",** а затем выберите соединители с делегировками "Текст", чтобы отобразить страницу отображения.  На этой странице содержатся свойства и сведения о соединители.
