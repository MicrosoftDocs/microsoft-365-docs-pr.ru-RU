...
description: В этой статье представлены ответы на часто задающие администраторам вопросы об импорте PST-файлов в Microsoft 365 с помощью службы импорта Office 365.
...
ms.locfileid: "46860704"
---
# <a name="faq-about-importing-pst-files"></a>Вопросы и ответы об импорте PST-файлов

**Эта статья для администраторов. Вы хотите импортировать PST-файлы в свой почтовый ящик? См. ["Импорт электронной почты, контактов и календаря из PST-файла Outlook"](https://go.microsoft.com/fwlink/p/?LinkID=785075)**
   
Вот некоторые часто задающие вопросы об использовании службы импорта Office 365 для массового импорта PST-файлов в почтовые ящики Microsoft 365. Дополнительные сведения об импорте PST-файлов см. в обзоре импорта [PST-файлов в Office 365.](https://docs.microsoft.com/microsoft-365/compliance/importing-pst-files-to-office-365)
  
## <a name="using-network-upload-to-import-pst-files"></a>Импорт PST-файлов с помощью отправки по сети

Пошаговая инструкция по импорту PST-файлов в [Office 365:](use-network-upload-to-import-pst-files.md)с помощью отправки по сети.
...
Существуют две версии формата PST-файлов: ANSI и Юникод. Мы рекомендуем импортировать PST-файлы в формате Юникода. Однако PST-файлы в формате ANSI, например используемые для языков с двухбайтовой кодировкой (DBCS), также можно импортировать в Office 365. Дополнительные сведения об импорте PST-файлов ANSI см. в шаге 4. Использование отправки по сети для импорта PST-файлов организации в [Office 365.](use-network-upload-to-import-pst-files.md#step-4-create-the-pst-import-mapping-file)
...
Пошаговая инструкция по импорту PST-файлов в [Office 365:](use-drive-shipping-to-import-pst-files-to-office-365.md)с помощью доставки дисков.
...
После того как жесткий диск будет получен в центре обработки данных Майкрософт, отправка PST-файлов в хранилище Azure для вашей организации займет от 7 до 10 дней. PST-файлы будут загружены в контейнер BLOB-объектов Azure с именем `ingestiondata`. 
...
Существуют две версии формата PST-файлов: ANSI и Юникод. Мы рекомендуем импортировать PST-файлы в формате Юникода. Однако файлы, использующие формат файлов ANSI PST, например, для языков, использующих двухбайтовый набор символов (DBCS), также можно импортировать в Microsoft 365. Дополнительные сведения об импорте PST-файлов ANSI см. в шаге 3. Использование доставки дисков для импорта [PST-файлов в Office 365.](use-drive-shipping-to-import-pst-files-to-office-365.md#step-3-create-the-pst-import-mapping-file)
