...
description: В этой статье содержатся ответы на часто задамые администраторам вопросы о импорте PST-файлов в Microsoft 365 с помощью службы импорта Office 365.
ms.openlocfilehash: d775e7cadb71e47cc916a064386971ecd3d08afc
ms.sourcegitcommit: c75aac39ee8d93218a79585113ef6b36f47c9ddf
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/29/2021
ms.locfileid: "51408638"
---
# <a name="faq-about-importing-pst-files"></a>Вопросы и ответы об импорте PST-файлов

**Эта статья для администраторов. Вы хотите импортировать PST-файлы в собственный почтовый ящик? См. [импорт электронной почты, контактов и календаря из файла Outlook .pst](https://go.microsoft.com/fwlink/p/?LinkID=785075)**

Вот несколько часто задамые вопросы об использовании службы импорта Office 365 для массового импорта PST-файлов в почтовые ящики Microsoft 365. Дополнительные сведения о импорте PST-файлов см. в обзоре импорта [PST-файлов в Office 365.](./importing-pst-files-to-office-365.md)
  
## <a name="using-network-upload-to-import-pst-files"></a>Импорт PST-файлов с помощью отправки по сети

Инструкции пошаговая, см. в руб. Использование сетевой загрузки для [импорта PST-файлов в Office 365.](use-network-upload-to-import-pst-files.md)
  
 **Какие разрешения необходимы для создания заданий импорта в службе импорта Office365?**
  
Для импорта файлов PST в почтовые ящики Microsoft 365 необходимо назначить роль экспорта-импорта почтовых ящиков в Exchange Online. По умолчанию эта роль не назначена ни одной группе ролей в Exchange Online. Вы можете добавить роль "Импорт и экспорт почтовых ящиков" в группу ролей "Управление организацией". Можно также создать группу ролей, назначить ей роль "Импорт и экспорт почтовых ящиков" и добавить себя или других пользователей в качестве участников. Дополнительные сведения см. в разделах "Добавление роли в группу ролей" или "Создание группы ролей" статьи [Управление группами ролей в Exchange Online](/Exchange/permissions-exo/role-groups).
...
Существуют две версии формата PST-файлов: ANSI и Юникод. Мы рекомендуем импортировать PST-файлы в формате Юникода. Однако PST-файлы в формате ANSI, например используемые для языков с двухбайтовой кодировкой (DBCS), также можно импортировать в Office 365. Дополнительные сведения об импорте PST-файлов ANSI см. в примере Шаг 4 в использовании сетевой загрузки для импорта PST-файлов организации в [Office 365.](use-network-upload-to-import-pst-files.md#step-4-create-the-pst-import-mapping-file)
...
Да. Если PST-файл содержит элемент почтового ящика размером более 150 МБ, он будет пропущен и не импортируется в процессе импорта. Элементы размером более 150 МБ не импортируется, так как 150 МБ — это ограничение размера сообщений в Exchange Online. Дополнительные сведения см. в [рублях Ограничения сообщений в Exchange Online.](/office365/servicedescriptions/exchange-online-service-description/exchange-online-limits#message-limits)
...
Пошаговая инструкция см. в инструкции По использованию доставки дисков для [импорта PST-файлов в Office 365.](use-drive-shipping-to-import-pst-files-to-office-365.md)
...
После того, как жесткий диск будет получен в центре обработки данных Майкрософт, для отправки PST-файлов в область хранения Azure для вашей организации может уйма от 7 до 10 дней. PST-файлы будут загружены в контейнер BLOB-объектов Azure с именем `ingestiondata`.
...
Существуют две версии формата PST-файлов: ANSI и Юникод. Мы рекомендуем импортировать PST-файлы в формате Юникода. Однако файлы, использующие формат файлов ANSI PST, например, для языков, использующих двухбайтовый набор символов (DBCS), также можно импортировать в Microsoft 365. Дополнительные сведения о импорте PST-файлов ANSI см. в шаге 3 в области отправки дисков для импорта [PST-файлов в Office 365.](use-drive-shipping-to-import-pst-files-to-office-365.md#step-3-create-the-pst-import-mapping-file)
...
The hard drive that you ship to Microsoft might have to cross international borders. Если это так, вы несете ответственность за то, чтобы жесткий диск и данные, которые он содержит, импортируются и/или экспортируются в соответствии с применимыми законами. Before shipping a hard drive, check with your advisors to verify that your drive and data can legally be shipped to the specified Microsoft data center. This will help to ensure that it reaches Microsoft in a timely manner.