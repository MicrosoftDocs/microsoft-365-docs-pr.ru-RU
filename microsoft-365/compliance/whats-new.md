...
|**Новое решение**|**Description**|**Подробнее**|
|:-----|:-----|:-----|
...
|Поиск в журнале аудита|Поиск > поиска в журнале аудита <br/> https://protection.office.com/unifiedauditlog |В настоящее время можно выполнить поиск только в журнале аудита в центре безопасности Office 365 & соответствия требованиям.| [Поиск в журнале аудита в центре безопасности & соответствия требованиям](search-the-audit-log-in-security-and-compliance.md)|
