...
|Yammer|Беседы и комментарии в сообществе Yammer связаны с почтовым ящиком группы Microsoft 365, а также с почтовым ящиком пользователя автора и любыми именованными получателями (@mentioned или пользователей копий). Конфиденциальные сообщения, отправляемые за пресылаемые данные из сообщества Yammer, хранятся в почтовом ящике пользователей, участвующих в частном сообщении.|  
||||
