...
ms.locfileid: "48409143"
---
# <a name="set-up-a-connector-to-archive-webpage-data-preview"></a>Настройка соединителя для архивации данных веб-страницы (Предварительная версия)
...
2. Перейдите на вкладку **соединители** и выберите соединитель **захвата веб-страницы** , чтобы отобразить всплывающую страницу, содержащую свойства и сведения о соединителе.
