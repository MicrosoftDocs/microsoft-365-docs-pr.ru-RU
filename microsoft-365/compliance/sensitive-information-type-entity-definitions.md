...
description: Предотвращение потери данных (DLP) в Центре обеспечения соответствия требованиям безопасности включает 80 типов конфиденциальной информации, которые готовы к использованию в &amp; политиках DLP. В этой статье перечислены все эти типы конфиденциальной информации и показано, что ищет политика DLP при обнаружении каждого типа.
ms.openlocfilehash: 341ded0c4c7f6ff31074d17624c029e7f6187480
ms.sourcegitcommit: 27b2b2e5c41934b918cac2c171556c45e36661bf
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/19/2021
ms.locfileid: "50919715"
---
# <a name="sensitive-information-type-entity-definitions"></a>Определения типов конфиденциальной информации

Предотвращение потери данных (DLP) в Центре соответствия требованиям включает множество типов конфиденциальной информации, которые готовы использовать в политиках DLP. В этой статье перечислены все эти типы конфиденциальной информации и показано, что ищет политика DLP при обнаружении каждого типа. Тип конфиденциальной информации определяется шаблоном, который можно идентифицировать регулярным выражением или функцией. Подтверждающие данные, такие как ключевые слова и контрольные списки, можно использовать для определения типа конфиденциальной информации. Уровень вероятности и расположение слов и знаков также используются в процессе оценки.

Типы конфиденциальных сведений требуют одной из этих подписок:
- Microsoft 365 E3
- Microsoft 365 E5
...
Unformatted: девять последовательных цифр, начиная с 0, 1, 2, 3, 6, 7 или 8 
...
шесть-десять цифр с номером филиала банковского филиала или без него
...
- Девять цифр — это контрольная цифра
...
Письмо (не чувствительное к делу) с семью цифрами
...
- Найдено ключевое слово Keyword_passport или Keyword_australia_passport_number.
...
## <a name="azure-storage-account-key-generic"></a>Ключ учетной записи Azure Storage (общий)
...
Сложный и надежный шаблон, который обнаруживает карты всех крупных брендов по всему миру, включая карты Visa, MasterCard, Discover Card, JCB, American Express, подарочные карты и карточки для посетителей.
...
Этот тип конфиденциальной информации входит в тип конфиденциальной информации о номере национальной идентификации ЕС. Он доступен в виде отдельного объекта типа конфиденциальной информации.
...
Этот тип конфиденциальной информации доступен в типе конфиденциальной информации номера паспорта ЕС и доступен в качестве отдельного объекта типа конфиденциальной информации.
...
Этот объект типа конфиденциальной информации доступен в типе конфиденциальной информации номер лицензии водителя ЕС и доступен в качестве отдельного объекта типа конфиденциальной информации.
...
Этот тип конфиденциальной информации доступен в типе конфиденциальной информации номера паспорта ЕС. Он доступен в виде отдельного объекта типа конфиденциальной информации.
...
Этот тип конфиденциальной информации входит в тип конфиденциальной информации номер лицензии водителя ЕС. Он доступен в виде отдельного объекта типа конфиденциальной информации.
...
Этот объект типа конфиденциальной информации входит в тип конфиденциальной информации номера паспорта ЕС и доступен в качестве отдельного объекта типа конфиденциальной информации.
...
Этот объект типа конфиденциальной информации входит в тип конфиденциальной информации номер лицензии водителя ЕС и доступен в качестве отдельного объекта типа конфиденциальной информации.
...
Одиннадцать цифр без пробелов и делимитеров
  
### <a name="pattern"></a>Шаблон

- 6 цифр как дата рождения YYMMDD
- 4 цифры
- контрольная цифра
...
- Одна цифра, соответствующая полу (1-мужская, 2-женская, другие номера также возможны для граждан, родившихся до 1900 г. или граждан с двойным гражданством) 
- Шесть цифр, соответствующих дате рождения (YYMMDD)
- Три цифры, соответствующие серийному номеру
- Одна контрольная цифра
...
- две цифры, соответствующие дню месяца рождения, для того чтобы различать полы, 40 добавляется в день рождения для женщин
...
десять цифр без пробелов и делимитеров
...
Этот тип конфиденциальной информации входит в тип конфиденциальной информации номера паспорта ЕС. Он доступен в виде отдельного объекта типа конфиденциальной информации.
...
девять или десять цифр, содержащих необязательный ответный ответ
...
(Обратите внимание, что технически этот тип конфиденциальной информации определяет эти ключевые слова с помощью регулярного выражения, а не списка ключевых слов.)
