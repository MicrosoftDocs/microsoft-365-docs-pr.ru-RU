...
При покупке шаблона премиум-класса и создании из него оценки этот шаблон активен в течение одного года. Покупка будет автоматически возобновляться, если вы не отмените.
...
## <a name="extend-an-assessment-template"></a>Расширение шаблона оценки
