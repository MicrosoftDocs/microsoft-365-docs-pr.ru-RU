...
| **Срок действия не ранее** | 04 августа 12:00:00 2015 UTC |
| **Срок действия не после** | 04 августа 12:00:00 2030 UTC |
...
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 22 октября 00:00:00 2013 UTC |
| **Срок действия не после** | 22 октября 00:00:00 2028 UTC |
| **Идентификатор ключа субъекта** | 3D:D3:50:A5:D6:A0:AD:EE:F3:4A:60:0A:65:D3:21:D4:F8:F8:D6:0F |
| **Идентификатор ключа полномочия** | keyID:b1:3e:c3:69:03:f8:bf:47:01:d4:98:26:1a:08:02:ef:63:64:2b:c3 |
...
| **Длина открытого ключа** | RSA 2048 бит |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 8 марта 2013 г. 04:00 |
| **Срок действия : "Не до"** | Среда, 8 марта 2023 г., 4:00 |
...
### <a name="entrust-root-certification-authority"></a>**Корневой сертификационный орган корневого корневого сертификата корне**

| **Тема** | CN=Root Certification Authority<br>OU="(c) 2006 Инк.<br>OU=www.entrust.net/CPS включается по ссылке<br>OU=See www.entrust.net/legal-terms<br>O= &quot; Доверенный, Inc.&quot;<br>C=US |
| --- | --- |
| **Серийный номер** | 45:6B:50:54 |
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha1RSA |
| **Срок действия не ранее** | 27 ноября 12:23:42 2006 UTC |
| **Срок действия не после** | 27 ноября 12:53:42 2026 UTC |
| **Идентификатор ключа субъекта** | 68:90:E4:67:A4:A6:53:80:C7:86:66:A4:F1:F7:4B:43:FB:84:BD:6D |
| **Идентификатор ключа полномочия** | keyID:68:90:e4:67:a4:a6:53:80:c7:86:66:a4:f1:f7:4b:43:fb:84:bd:6d |
...
| **Срок действия не после** | 11 ноября 02:51:17 2021 UTC |
...
### <a name="entrust-certification-authority---l1e"></a>**Надзорный орган сертификации — L1E**

| **Тема** | CN=Certification Authority - L1E<br>OU= &quot; (c) 2009 Доверенный, Inc.&quot;<br>OU=www.entrust.net/rpa включается по ссылке<br>O= &quot; Доверенный, Inc.&quot;<br>C=US |
| --- | --- |
| **Издатель** | CN=Certification Authority .net (2048)<br>OU=(c) 1999 Entrust.net Limited<br>OU=www.entrust.net/CPS \_ 2048 incorp. по ref. (ограничивает liab.)<br>O=ИТ-компания.net |
...
| **Срок действия не ранее** | 11 ноября 15:40:40 2011 UTC |
| **Срок действия не после** | 11 ноября 02:51:17 2021 UTC |
| **Идентификатор ключа субъекта** | 5B:41:8A:B2:C4:43:C1:BD:BF:C8:54:41:55:9D:E0:96:AD:FF:B9:A1 |
| **Идентификатор ключа полномочия** | keyid:68:90:e4:67:a4:a6:53:80:c7:86:66:a4:f1:f7:4b:43:fb:84:bd:6d |
...
### <a name="entrust-certification-authority---l1m"></a>**Надзорный орган сертификации — L1M**

| **Тема** | CN=Certification Authority - L1M, OU= &quot; (c) 2014 Инк. Для авторизованного использования&quot;<br>OU=See www.entrust.net/legal-terms<br>O= &quot; Доверенный, Inc.&quot;<br>C=US |
| --- | --- |
| **Издатель** | CN=Root Certification Authority ( Корневой ЦС по надзору за корневыми сертификатами) — G2<br>OU= &quot; (c) 2009 Доверенное, Inc. — только для авторизованного использования&quot;<br>OU=See www.entrust.net/legal-terms<br>O= &quot; Доверенный, Inc.&quot;<br>C=US |
| **Серийный номер** | 61:A1:E7:D2:00:00:00:00:51:D3:66:A6 |
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 15 декабря 07:25:03 2014 UTC |
| **Срок действия не после** | 15 октября 08:55:03 2030 UTC |
| **Идентификатор ключа субъекта** | C3:F7:D0:B5:2A:30:AD:AF:0D:91:21:70:39:54:DD:BC:89:70:C7:3A |
| **Идентификатор ключа полномочия** | keyid:6a:72:26:7a:d0:1e:ef:7d:e7:3b:69:51:d4:6c:8d:9f:90:12:66:ab |
