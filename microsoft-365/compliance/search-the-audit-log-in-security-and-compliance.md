...
В таблице ниже перечислены связанные с карантином действия, которые можно искать в журнале аудита. Дополнительную информацию о карантине см. в статье [Карантин сообщений электронной почты в Office 365](../security/office-365-security/quarantine-email-messages.md).
