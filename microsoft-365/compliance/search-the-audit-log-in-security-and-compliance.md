...
> [!NOTE]
> В настоящее время мы изучаем проблему, из-за которой действия Azure AD недоступны в средстве поиска в журнале аудита. Эта проблема возникла приблизительно 26 октября 2020 г. К этим действиям относятся действия администрирования пользователей Azure AD, администрирования групп, администрирования приложений, администрирования ролей и администрирования каталога. Мы предоставим обновление, когда проблема будет устранена.
...
|Удалена метка "Запись" политики соответствия требованиям|ComplianceRecordDelete|Документ, помеченный как запись, был удален. Документ считается записью, если к нему применена метка хранения, которая помечает содержимое как запись.|
