...
## <a name="step-1-connect-to-the-security--compliance-center-powershell"></a>Шаг 1. Подключение к центру & безопасности PowerShell

Первым шагом является подключение к центру & безопасности PowerShell для вашей организации. Пошаговые инструкции см. в статье [Подключение к PowerShell в Центре безопасности и соответствия требованиям](/powershell/exchange/connect-to-scc-powershell).
...
1. Сохраните следующий текст в Windows PowerShell скрипта с помощью суффикса .ps1; например, CaseHoldsReport.ps1.
