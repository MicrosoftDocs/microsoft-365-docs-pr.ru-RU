...
ms.locfileid: "49002799"
---
# <a name="set-up-a-connector-to-archive-data-from-ms-sql-database-preview"></a>Настройка соединителя для архивации данных из базы данных MS SQL (Предварительная версия)
