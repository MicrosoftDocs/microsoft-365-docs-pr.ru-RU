...
> [!CAUTION]
> Включение этого параметра является односторонним действием. Пока функция представлена в предварительной версии, тестируйте ее только в нерабочей среде и только после ознакомления с изменениями метаданных, предварительными требованиями, ограничениями и известными проблемами, описанными на этой странице.
