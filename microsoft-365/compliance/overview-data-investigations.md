...
> [!IMPORTANT]
> После большого количества разблокирования и обсуждений с нашими клиентами мы решили не выпустить средство расследования данных в общем доступе. В результате мы удалим это средство и все данные, связанные с существующими вариантами расследования данных, на 31 декабря 2020 г.  Для управления расследованиями данных в организации рекомендуется использовать базовые случаи обнаружения электронных данных. Если вам нужно найти и очистить контент от Microsoft 365, ознакомьтесь со следующими статьями: 
> - [серия решений обнаружения электронных данных: сценарий для переноса данных — поиск и очистка](data-spillage-scenariosearch-and-purge.md)
