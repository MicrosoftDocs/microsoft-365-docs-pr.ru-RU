...
- Политики поддерживают языки мониторинга, отличные от английского, в пользовательских политиках обеспечения соответствия требованиям. Создайте [настраиваемый словарь ключевых](communication-compliance-feature-reference.md#custom-keyword-dictionaries) слов оскорбительных слов на выбранном языке или создайте собственную модель машинного обучения с помощью [классификаторов](classifier-get-started-with.md) в Microsoft 365.
