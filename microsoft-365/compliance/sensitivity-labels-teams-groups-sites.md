...
---
# <a name="use-sensitivity-labels-with-microsoft-teams-office-365-groups-and-sharepoint-sites-public-preview"></a>Использование меток конфиденциальности в Microsoft Teams, группах Office 365 и SharePoint (общедоступная предварительная версия)
...
Общедоступная Предварительная версия не работает с сетями доставки содержимого Office 365 (сети CDN).
...
## <a name="set-site-and-group-settings-when-you-create-or-edit-sensitivity-labels"></a>Настройка параметров сайтов и групп при создании или изменении меток конфиденциальности

После включения предварительного просмотра выполните следующие действия, чтобы создать метки чувствительности. Для изменения этих параметров может потребоваться до 24 часов.
