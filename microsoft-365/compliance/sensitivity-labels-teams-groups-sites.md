...
2. Затем на странице **Задайте параметры защиты для групп и сайтов** выберите один из доступных вариантов:
    ...
    - **Параметры доступа устройства и внешнего доступа**, чтобы настроить параметр **Доступ с неуправляемых устройств**.

3. Если вы выбрали **Параметры конфиденциальности и доступа внешних пользователей**, задайте следующие параметры:
