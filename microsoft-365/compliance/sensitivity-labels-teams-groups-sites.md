...
Чтобы запретить автоматическое создание сообщения, используйте следующую команду PowerShell из [Set-SPOSite](/powershell/module/sharepoint-online/set-sposite):
