...
- **Неуправляемые устройства**. Для этого параметра вы также должны настроить функцию SharePoint, использующую условный доступ Azure AD для блокировки или ограничения доступа к контенту SharePoint и OneDrive с неуправляемых устройств. Инструкции см. в статье [Управление доступом с неуправляемых устройств](/sharepoint/control-access-from-unmanaged-devices). Вариант, настраиваемый для этого параметра метки, аналогичен [блокировке или ограничению доступа к определенному сайту SharePoint или OneDrive](https://docs.microsoft.com/sharepoint/control-access-from-unmanaged-devices#block-or-limit-access-to-a-specific-sharepoint-site-or-onedrive).
    
    Если не настроить зависимую функцию SharePoint, указанный вами параметр не будет действовать. Кроме того, он не будет работать, если он менее строгий, чем настроенный параметр на уровне клиента. Выберите параметр метки, соответствующий параметру на уровне клиента, или более строгий.
    ...
    Так как вы можете настроить функцию SharePoint независимо от конфигурации метки, в мастере меток конфиденциальности отсутствует проверка наличия зависимостей.
...
2. Если вы не знаете GUID метки: [подключитесь к PowerShell Центра безопасности и соответствия требованиям](https://docs.microsoft.com/powershell/exchange/office-365-scc/connect-to-scc-powershell/connect-to-scc-powershell?view=exchange-ps) и получите список меток конфиденциальности с их идентификаторами GUID.
...
4. Теперь [подключитесь к Exchange Online PowerShell](https://docs.microsoft.com/powershell/exchange/exchange-online/connect-to-exchange-online-powershell/connect-to-exchange-online-powershell?view=exchange-ps) в отдельном окне Windows PowerShell.
