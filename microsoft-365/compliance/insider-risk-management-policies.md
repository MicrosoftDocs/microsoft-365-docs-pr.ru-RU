...
9. На странице **Содержимое для назначения приоритетов** можно назначить (при необходимости) источники для назначения приоритетов, что повышает вероятность создания оповещений с высокой степенью серьезности для этих источников. Выберите один из указанных вариантов:
