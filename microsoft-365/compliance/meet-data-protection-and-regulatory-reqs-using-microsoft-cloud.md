...
ms.locfileid: "53330993"
---
# <a name="microsoft-compliance-manager-classic"></a>Диспетчер соответствия требованиям Майкрософт (классический)

> [!IMPORTANT]
> **Диспетчер соответствия требованиям (классический) скоро будет удален с портала Microsoft Service Trust Portal.** Рекомендуется перейти на новый [диспетчер соответствия требованиям в Центре соответствия требованиям Microsoft 365](https://compliance.microsoft.com/), обеспечивающий расширенные возможности пользовательского интерфейса и сопоставление обновленных средств контроля. Пользователям с оценками в классической версии потребуется создать новые оценки в новом диспетчере соответствия требованиям. Любые существующие данные, в том числе оценки, средства контроля и другие данные, не переносятся в новый диспетчер соответствия требованиям. [Дополнительные сведения о переходе](compliance-manager-faq.yml#what-s-happening-to-compliance-manager--classic--in-the-service-trust-portal-).
...
- **Средства контроля под управлением Майкрософт.** Для каждой облачной службы корпорация Майкрософт реализует набор *средств контроля*, призванных обеспечить соблюдение различных стандартов и нормативов, и управляет им. Эти средства контроля делятся на *семейства*, соответствующие структуре стандарта сертификации или норматива, к которому относится оценка. Для каждого средства контроля под управлением Майкрософт в диспетчере соответствия требованиям представлены сведения о том, как корпорация Майкрософт реализовала средство контроля, а также как и когда реализация была проверена и подтверждена независимым сторонним аудитором.
  ...
  1. Здесь указывается информация из сертификации или нормативного акта, которые соответствуют средству контроля под управлением Майкрософт.
  ...
  1. Рейтинг соответствия требованиям для средства контроля, который обозначает уровень риска (из-за несоответствия или отсутствия внедрения средства контроля) для каждого средства контроля, управляемого Майкрософт. Дополнительные сведения см. в разделе [Сведения о рейтинге соответствия требованиям](#understanding-the-compliance-score). Обратите внимание, что рейтинг соответствия требованиям принимает значение от 1 до 10 и обозначен цветом. Желтый цвет указывает на низкий уровень риска средств контроля, оранжевый — на средний уровень, красный — на высокий уровень риска.

  1. Сведения о статусе внедрения средства контроля, дате его тестирования, о том, кто выполнил тест, и о результатах тестирования.

  1. Для каждого средства можно щелкнуть **Дополнительно**, чтобы посмотреть дополнительные сведения, включая данные о его внедрении корпорацией Майкрософт, а также его тестировании и проверке независимым сторонним аудитором.
...
|Разрешение|Compliance Manager Reader (Читатель диспетчера соответствия требованиям)|Compliance Manager Contributor (Участник диспетчера соответствия требованиям)|Compliance Manager Assessor (Аудитор диспетчера соответствия требованиям)|Compliance Manager Administrator (Администратор диспетчера соответствия требованиям)|Администратор портала|
|---|:---:|:---:|:---:|:---:|:---:|
|**Чтение данных.** Пользователи могут читать данные, но не могут редактировать их.|![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|
|**Изменение данных.** Пользователи могут редактировать все поля, кроме полей "Результат теста" и "Дата теста".||![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|
|**Изменение результатов тестов.** Пользователи могут редактировать поля "Результат теста" и "Дата теста".|||![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|
|**Управление оценками.** Пользователи могут создавать, архивировать и удалять оценки.||||![Флажок](../media/checkmark.png)|![Флажок](../media/checkmark.png)|
|**Управление пользователями.** Пользователи могут добавлять других пользователей в своей организации к ролям "Читатель", "Участник", "Аудитор" и "Администратор". Только пользователи с ролью "Глобальный администратор" в организации могут добавлять и удалять пользователей из роли "Администратор портала".|||||![Флажок](../media/checkmark.png)|
|
...
|Средство контроля|Обязательное|Независимое|
|---|---|----|
|**Профилактическое**|Высокая степень риска|Средняя степень риска|
|**Обнаруживающее**|Средняя степень риска|Низкая степень риска|
|**Корректирующее**|Средняя степень риска|Низкая степень риска|
...
|Множитель|Внутренний|Внутренний|Внешний|Внешний|
|---|---|---|---|----|
||*Злоумышленная*|*Непреднамеренная*|*Злоумышленная*|*Непреднамеренная*|
|**Конфиденциальность**|(В, С или Н)|(В, С или Н)|(В, С или Н)|(В, С или Н)|
|**Целостность**|(В, С или Н)|(В, С или Н)|(В, С или Н)|(В, С или Н)|
|**Доступность**|(В, С или Н)|(В, С или Н)|(В, С или Н)|(В, С или Н)|
|

**Внешние драйверы**:

|Контракты|Нормативные акты|Обязательства перед общественностью|
|---|---|---|
|(В, С или Н)|(В, С или Н)|(В, С или Н)|
...
|Уровень риска|Значение средства контроля|
|---|:---:|
|Низкий|1–3|
|Средний|6|
|Высокий|8|
...
Определив учетную запись пользователя, вы можете создать отчет об имеющихся зависимостях, связанных с этой ней. Эти сведения помогут переназначить открытые поручения или обеспечить доступ к отправленным ранее свидетельствам.
...
3. Откроется диалоговое окно подтверждения с текстом "Все поручения текущего пользователя будут назначены выбранному пользователю. Это действие невозможно отменить.Продолжить?"
...
2. Если вы хотите продолжить, нажмите кнопку **ОК**. В противном случае нажмите кнопку **Отмена**.
...
3. Нажмите кнопку **Далее** и выполните указанные ниже действия.
   ...
   1. Выберите облачную службу Майкрософт для оценки соответствия требованиям в раскрывающемся списке **Выбор продукта**.

   1. Выберите сертификацию для оценки выбранной облачной службы в раскрывающемся списке **Выбор сертификации**.
...
2. В этом разделе показаны сводные данные об оценке, в том числе имя группы и оценки, а также количество средств контроля.

3. В этом разделе показаны элементы фильтрации оценок. Подробные инструкции по использованию элементов фильтрации оценок см. в разделе [Управление процессом оценки](#managing-the-assessment-process).

4. В этом разделе показаны отдельные облачные службы, на которые распространяется оценка.

5. В этом разделе показаны средства контроля под управлением Майкрософт. Взаимосвязанные средства контроля упорядочены по семействам. Выберите семейство средств контроля, чтобы развернуть его и просмотреть отдельные средства контроля.

6. В этом разделе показаны средства контроля под управлением клиента, упорядоченные по семействам. Выберите семейство средств контроля, чтобы развернуть его и просмотреть отдельные средства.

7. Общее число средств контроля в семействе и количество оцениваемых средств. Примечательная особенность диспетчера соответствия требованиям — возможность отслеживать ход оценки средств контроля, управляемых клиентом. Дополнительные сведения см. в разделе [Сведения о рейтинге соответствия требованиям](#understanding-the-compliance-score).
...
3. Если вы хотите продолжить архивацию, нажмите **Архивировать**. В противном случае нажмите кнопку **Отмена**.
...
|Идентификатор правила|Оценка|Тип изменения|Описание изменения|Рекомендуемые действия|
|---|---|---|---|---|---|---|---|---|
|45 C.F.R. § 164.308(a)(7)(ii)(A)|Office 365: HIPAA|Значительное|Добавлено средство контроля HITECH к оценке HIPAA для Office 365 |Проверьте добавленное средство контроля и рекомендуемые действия клиента.|
|45 C.F.R.  164.312(a)(6)(ii)|Office 365: HIPAA|Значительное|Добавлено средство контроля HITECH к оценке HIPAA для Office 365|Проверьте добавленное средство контроля и рекомендуемые действия клиента.|
45 C.F.R. § 164.312(c)(1)| Office 365: HIPAA|Значительное| Добавлено средство контроля HITECH к оценке HIPAA для Office 365 |Проверьте добавленное средство контроля и рекомендуемые действия клиента.|
45 C.F.R.  § 164.316(b)(2)(iii)| Office 365: HIPAA|Значительное|Добавлено средство контроля HITECH к оценке HIPAA для Office 365|Проверьте добавленное средство контроля и рекомендуемые действия клиента.|
|
...
|GDPR|HIPAA|ISO 27001|ISO 27018|NIST 800-53|NIST 800-171|Тип изменения|Описание изменения|Рекомендуемые действия|
|---|---|---|---|---|---|---|---|---|
|6.13.2|||C.16.1.1|||Значительное|Предыдущий номер: 6.12.1.1. <p> В рекомендации добавлены подробности.|Повторно оцените средство контроля: ознакомьтесь с обновленными рекомендациями по действиям клиента и выполните рекомендации по реализации и оценке средства контроля.|
||||||3.1.6|Значительное|В рекомендации добавлены действия по включению аудита и поиску в журнале аудита.|Ознакомьтесь с обновленными рекомендациями по действиям клиента.|
|6.8.2|||A.10.2|||Значительное|Предыдущий номер: 6.7.2.9. <p> Добавлены новые рекомендации и поручения.|Повторно оцените средство контроля: ознакомьтесь с обновленными рекомендациями по действиям клиента и выполните рекомендации по реализации и оценке средства контроля.|
|6.6.4|45 C.F.R. § 164.312(a)(2)(i) <p> 45 C.F.R. § 164.312(d)|A.9.4.2||IA-2|3.5.1|Значительное|Предыдущий номер: 6.5.2.3. <p> Добавлены новые рекомендации и поручения.|Повторно оцените средство контроля: ознакомьтесь с обновленными рекомендациями по действиям клиента и выполните рекомендации по реализации и оценке средства контроля.|
|6.13.1|45 C.F.R. § 164.308(a)(1)(i)|A.16.1|C.16.1|IR-4(a)|3.6.1|Значительное|Предыдущий номер: 6.12.1. <p> Добавлены новые рекомендации и поручения.|Повторно оцените средство контроля: ознакомьтесь с обновленными рекомендациями по действиям клиента и выполните рекомендации по реализации и оценке средства контроля.|
|6.7||||||Значительное|Предыдущий номер: 6.6.1.1.<p> Добавлены новые рекомендации и поручения.|Повторно оцените средство контроля: ознакомьтесь с обновленными рекомендациями по действиям клиента и выполните рекомендации по реализации и оценке средства контроля.|
|6.6.5|||A.10.8|IA-3|3.5.2|Значительное|Предыдущий номер: 6.5.4.2. <p> Добавлены новые рекомендации и поручения.|Повторно оцените средство контроля: ознакомьтесь с обновленными рекомендациями по действиям клиента и выполните рекомендации по реализации и оценке средства контроля.|
|6.15.1||||||Значительное|Предыдущий номер: 6.14.1.3. <p> Добавлены новые рекомендации и поручения.|Повторно оцените средство контроля: ознакомьтесь с обновленными рекомендациями по действиям клиента и выполните рекомендации по реализации и оценке средства контроля.|
|||||AC-2(h)(2)||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
|||||AC-2(7)(b)||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
|||||AC-2(h)(1)||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
||45 C.F.R. § 164.308(a)(5)(ii)(C)|||AC-2(g)||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
|||||AC-2(12)||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
||45 C.F.R. § 164.312(b)|A.12.4.3||AU-2(d)||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
|||||AC-2(4)||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
||||||3.1.7|Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
|||A.16.1.7|C.12.4.2, часть 2|||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
|||||AC-2(h)(3)||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
|||A.12.4.2||||Незначительное|Добавлена ссылка на колонку "Включить аудит".|Никаких действий не требуется.|
|||A.7.2.8||||Незначительное|Добавлены ссылки на колонку "Поиск контента" и портал DSR.|Никаких действий не требуется.|
||45 C.F.R. § 164.308(a)(3)(ii)(C)|||||Незначительное|Добавлены ссылки на колонку "Включить аудит" и справочные статьи по роли администратора Office 365.|Никаких действий не требуется.|
|5.2.1||||||Незначительное|Предыдущий номер: 5.2.2. <p> В рекомендациях уточнены обязанности клиента.|Ознакомьтесь с обновленными рекомендациями по действиям клиента.|
|6.11.1|45 C.F.R. § 164.312(e)(2)(ii)|A.10.1.1 <br> A.10.1.2 <br> A.18.1.5|C.10.1.1|SC-13|3.13.11|Незначительное|Предыдущий номер: 6.10.1.2. <p> Исправлена опечатка.|Никаких действий не требуется.|
|7.5.1||||||Незначительное|Предыдущий номер: A.7.4.1. <p> Исправлена опечатка.|Никаких действий не требуется.|
|||A.8.2.3|||3.1.3|Незначительное|Удалено лишнее предложение.|Никаких действий не требуется.|
||45 C.F.R. § 164.308(a)(4)(i)|A.6.1.2||AC-5(a)|3.1.2  <br> 3.1.4|Незначительное|Добавлены новые рекомендации и поручения.|Ознакомьтесь с обновленными рекомендациями по действиям клиента.|
||45 C.F.R. § 164.308(a)(7)(ii)(E)|||RA-2(a)||Незначительное|Ссылка на раздел справки, посвященный службе импорта, обновлена с использованием FWLink.|Никаких действий не требуется.|
|
...
|Предыдущий идентификатор средства контроля<br>(Предварительная версия ноябрь 2017)|Новый идентификатор средства контроля<br>(Общедоступный выпуск за февраль 2018 г.)|
|---|---|
|5.2.2|5.2.1|
|5.2.3|5.2.2|
|5.2.4|5.2.3|
