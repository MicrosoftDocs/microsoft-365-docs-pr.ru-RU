...
---
# <a name="set-up-a-connector-to-archive-facebook-data-preview"></a>Настройка соединители для архива данных Facebook (предварительная версия)
...
Выполните следующие необходимые условия, прежде чем настраивать соединители в Центре соответствия требованиям Microsoft 365 для импорта и архива данных со страниц Facebook бизнес вашей организации. 
...
Сначала необходимо зарегистрировать новое приложение в Azure Active Directory (AAD). Это приложение соответствует ресурсу веб-приложения, реализованного в шагах 4 и 5 для соединители Facebook. 
...
Во время выполнения этого шага (используя предыдущие пошаговая инструкции) вы сохраните следующие сведения в текстовом файле. Эти значения используются на последующих шагах процесса развертывания.
...
- TenantId: ИД клиента вашей организации Microsoft 365, скопированные после создания приложения соединители Facebook в Azure Active Directory на шаге 1.
...
Пошаговая инструкция см. в подключении ["Настройка соединители Facebook".](archive-facebook-data-with-sample-connector.md#step-4-configure-the-facebook-connector-app)
...
Последний шаг — настройка соединитела в Центре соответствия требованиям Microsoft 365, который будет импортировать данные со страниц Facebook для бизнеса в указанный почтовый ящик в Microsoft 365. После выполнения этого шага служба импорта Microsoft 365 начнет импортировать данные со страниц Facebook business в Microsoft 365.
...
Во время выполнения этого шага (следуя пошаговой инструкции), необходимо предоставить следующие сведения (которые были скопированы в текстовый файл после выполнения этих действий).
