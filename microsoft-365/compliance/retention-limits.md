...
- Exchange (любая конфигурация): 1 800
...
- Почтовые ящики Exchange: 1000
- Группы Microsoft 365: 1000
- Сообщения каналов Teams: 1000
- Чаты Teams: 1000
- Сообщения сообщества Yammer: 1000
- Сообщения пользователей Yammer: 1000
- Сайты SharePoint: 100
- Учетные записи OneDrive: 100

Область действия Skype для бизнеса должна ограничиваться определенными пользователями, а максимальное количество поддерживаемых политик — 1000.
