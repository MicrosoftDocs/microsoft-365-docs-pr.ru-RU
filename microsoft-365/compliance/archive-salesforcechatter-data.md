...
2. Каждые 24 часа элементы Salesforce Chatter копируется на сайт Globanet Merge1. Соединителичные элементы также подключаются к формату сообщений электронной почты.
