...
На следующих снимках экрана показан список папок до и после перемещения сообщений в автоматически развернутом архиве.
...
- **Импорт:* служб*** вы можете использовать службу импорта Office 365, чтобы импортировать PST-файлы в автоматически развертываемый архив пользователя. Вы можете импортировать до 100 ГБ данных из PST-файлов в архивный почтовый ящик пользователя. 
