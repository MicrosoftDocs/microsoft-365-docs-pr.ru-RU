...
1. Архивация включена для почтового ящика пользователя или общего почтового ящика. Архивный почтовый ящик с размером 100 ГБ (также называется *основным архивом*), а квота предупреждения для архивного почтового ящика — 90 ГБ.

2. Администратор включает автоматическое расширение архивации для почтового ящика. Когда архивный почтовый ящик (включая папку "элементы с возможностью восстановления") достигнет размера 90 ГБ, он преобразуется в автоматически расширяемый Архив, а Office 365 добавляет место для хранения в архив. Это дополнительное хранилище архивов также называется *вспомогательным архивом*. Для подготовки дополнительного дискового пространства может потребоваться до 30 дней.

   > [!NOTE]
   > Если почтовый ящик размещается на удержании или назначенной политике хранения Office 365, квота хранилища для архивного почтового ящика увеличивается до 110 ГБ при включенном автоматическом развертывании архивации. Аналогично, квота предупреждения о архиве увеличивается до 100 ГБ.

3. Office 365 автоматически добавляет дополнительное место для хранения в вспомогательный Архив при необходимости.

> [!IMPORTANT]
> Автоматическое расширение архивации поддерживается только для почтовых ящиков, используемых для отдельных пользователей (или общих почтовых ящиков) с частотой роста, которая не превышает 1 ГБ в день. Архивный почтовый ящик пользователя предназначен только для этого пользователя. Использование ведения журнала, правил транспорта или правил автоматической пересылки для копирования сообщений в архивный почтовый ящик не разрешено. Корпорация Майкрософт оставляет за собой право отказаться от неограниченного архивирования в случаях, когда архивный почтовый ящик пользователя используется для хранения архивных данных для других пользователей или в других случаях недопустимого использования.
...
Для эффективного использования автоматически развертываемого архивного хранилища папки могут быть перемещены. Office 365 определяет, какие папки перемещаются, когда в архив добавляется дополнительное хранилище. Иногда при перемещении папки автоматически создаются одна или несколько вложенных папок, а элементы из исходной папки распространяются в эти папки для упрощения процесса перемещения. При просмотре части "Архив" списка папок в Outlook эти подпапки отображаются в исходной папке.  В соответствии с соглашением об именовании, которое Office 365 использует для именования этих вложенных папок, используется ** \<имя\>папки _yyyy (создано в MMM DD, гггг h_mm)**, где:
...
> [!NOTE]
> Как описывалось ранее, Office 365 перемещает элементы в подпапки (с использованием описанного выше соглашения об именовании) для распространения контента в вспомогательный Архив. Но перемещение элементов в подпапки может быть не всегда. Иногда в вспомогательный Архив можно переместить всю папку. В этом случае папка сохранит исходное имя.  Она не будет очевидна в списке папок в Outlook, что папка была перемещена в вспомогательный Архив.
...
При использовании Outlook или Outlook в Интернете для доступа к сообщениям, хранящимся в автоматически развертываемом архиве, следует учитывать следующее.
...
- Можно удалить элементы во вложенной папке, указывающие на автоматически развернутую область хранения, но саму папку невозможно удалить. На самом деле, если включено автоматическое расширение архивации для почтового ящика, вы не можете удалить какие-либо папки из основного архива или автоматически расширенной области хранения.
