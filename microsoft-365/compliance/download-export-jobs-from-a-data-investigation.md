...
При экспорте документов из свидетельства в расследования данных документы передаются в хранилище Azure, предоставленное Майкрософт, или в место хранения Azure, управляемое вашей организацией. Тип используемого расположения хранилища Azure зависит от того, какой параметр был выбран при экспорте документов. 
...
1. На странице **расследования данных** перейдите к разделу исследование, а затем щелкните вкладку **экспорты** .
