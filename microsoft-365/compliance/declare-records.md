...
Чтобы объявить элементы в качестве записей, используйте [метки хранения](retention.md#retention-labels), помечающие содержимое как запись. Вы можете либо опубликовать эти метки, чтобы пользователи и администраторы могли вручную применить их к содержимому, либо автоматически применить эти метки к содержимому, которое вы хотите пометить как запись.

## <a name="configuring-retention-labels-to-declare-records"></a>Настройка меток хранения для объявления элементов записями

Когда вы создаете или настраиваете метку хранения, выберите вариант пометки содержимого как записи.
