...
- [Information Protection](information-protection.md): обнаруживает, классифицирует и защищает конфиденциальный и критически важный для бизнеса контент в течение всего жизненного цикла Организации.
...
- **Посетите диспетчер соответствия требованиям Майкрософт** , который поможет вам определить состояние соответствия Организации требованиям основных стандартов и нормативных требований. Здесь представлены Рекомендуемые действия, которые можно предпринять, чтобы усилить общую возможность обеспечения соответствия требованиям, а также предоставляет возможности рабочих процессов, помогающие эффективно выполнять эти действия. Чтобы узнать больше, ознакомьтесь со статьей [Диспетчер соответствия требованиям](compliance-manager.md).
