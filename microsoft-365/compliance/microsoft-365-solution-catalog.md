...
Раздел " **Управление рисками** на домашней странице" показывает, как ваша организация может определить, проанализировать и исправить внутренние риски, прежде чем они будут причинить вред.

![Раздел "Управление рисками" в каталоге решений Microsoft 365](media/m365-solution-catalog-internal-risk-management.png)

Отсюда вы можете перейти к карточке для следующего решения:

- [Соответствие требованиям](communication-compliance.md): сводит к минимуму риски при общении, помогая автоматически собирать ненужные сообщения, проверять возможные нарушения политики и выполнять действия по исправлению.
