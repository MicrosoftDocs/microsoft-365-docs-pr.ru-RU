...
- В шаге 2 необходимо указать SFTP-сервер организации. Это необходимо, чтобы globanet Merge1 можно было связаться с ней для сбора данных Redtail Speak через SFTP.
