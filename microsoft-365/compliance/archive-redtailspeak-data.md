...
Используйте соединитель Veritas в центре соответствия требованиям Microsoft 365 для импорта и архива данных из Redtail Speak к почтовым ящикам пользователей в организации Microsoft 365. Veritas предоставляет вам соединитель [Redtail Speak,](https://globanet.com/redtail/) настроенный для захвата элементов на SFTP-сервере организации, где они получаются из Redtail. Соединитель преобразует содержимое из Redtail Speak в формат сообщений электронной почты, а затем импортирует эти элементы в почтовый ящик пользователя в Microsoft 365.
...
3. Соединитель Redtail Speak, который вы создаете в центре соответствия требованиям Microsoft 365, ежедневно подключается к сайту Veritas Merge1 и передает сообщения в безопасное хранилище Azure в облаке Microsoft.
