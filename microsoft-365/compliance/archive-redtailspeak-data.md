...
---
# <a name="set-up-a-connector-to-archive-redtail-speak-data-preview"></a>Настройка соединителя для архива данных Redtail Speak (предварительная версия)
...
1. Ваша организация работает с Redtail Speak для настройки шлюза SMTP, в который ежедневно переадтрансляются сообщения с Redtail Speak на сервер SFTP вашей организации.
...
- На шаге вам необходимо указать SFTP-сервер вашей организации. Это необходимо, чтобы globanet Merge1 можно было связаться с ней для сбора данных Redtail Speak через SFTP.
...
2. На странице **описания продукта Redtail Speak** нажмите кнопку **"Добавить новый соединитель".**
...
Второй этап — настройка соединителя Redtail Speak на сайте Merge1. Сведения о настройке соединителя Redtail Speak см. в руководстве пользователя [Merge1 Third-Party Connectors.](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Redtail%20Speak%20User%20Guide%20.pdf)
...
2. Щелкните **вкладку "Соединитель",** а затем выберите соединитель **Redtail Speak,** чтобы отобразить страницу отображения. На этой странице отображаются свойства и сведения о соединители.
