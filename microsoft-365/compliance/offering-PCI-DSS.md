...
Важно понимать, что статус соответствия требованиям PCI DSS для Azure, OneDrive для бизнеса и SharePoint Online не подразумевает автоматическую сертификацию PCI DSS для служб, которые клиенты создают или размещают на этих платформах. Клиенты обязаны обеспечить соответствие требованиям PCI DSS.
...
Создавайте и выполняйте развертывание своего решения PCI DSS в облаке еще быстрее со схемой безопасности и соответствия Azure PCI DSS. Получите эталонные архитектуры, руководство по развертыванию, сопоставления средств реализации управления, автоматизированные сценарии и многое другое. [Начало работы со схемой Azure PCI DSS](https://aka.ms/pciblueprint).

## <a name="frequently-asked-questions"></a>Вопросы и ответы

**Почему на титульной странице "Аттестация соответствия (AoC)" указана дата "Июнь 2018 г."?**

Дата "Июнь 2018 г." на титульной странице соответствует дате публикации шаблона AoC. Дата оценки приведена в разделе 2.

**Почему существует несколько аттестаций соответствия для Azure (AoC)?**

Пакет Azure AoC содержит аттестации соответствия (AoC) для следующих облаков: общедоступное облако Azure, Germany и облако государственных учреждений. Пользователям следует использовать аттестацию AoC, соответствующую их среде Azure.  

**Как соотносятся PA DSS и PCI DSS??**

Стандарт безопасности данных платежного приложения (PA DSS) — это набор требований, соответствующих PCI DSS, который заменяет рекомендации Visa для платежных приложений и объединяет требования соответствия других основных эмитентов карт. PA DSS позволяет поставщикам программного обеспечения разрабатывать приложения сторонних разработчиков, которые хранят, обрабатывают или передают платежные данные владельца карты в рамках процедуры авторизации или расчета. Розничные продавцы должны использовать сертифицированные приложения PA DSS для эффективного обеспечения соответствия требованиям PCI DSS. PA DSS не применяется к Azure.
...
**Планируется ли, что OneDrive для бизнеса и SharePoint Online должны соответствовать PCI DSS за пределами Соединенных Штатов?**
