...
- [Ваша организация использует в основном диспетчер соответствия требованиям (как классическая, так и общедоступную ознакомительную версию), расположенную на портале доверия службы Майкрософт.](#your-organization-regularly-used-compliance-manger-in-the-service-trust-portal)
...
#### <a name="your-organization-regularly-used-compliance-manger-in-the-service-trust-portal"></a>Ваша организация регулярно использовала диспетчер соответствия требованиям в портале доверия службы.
...
- [Знакомство с новым интерфейсом диспетчера соответствия требованиям](compliance-manager-setup.md#understand-the-compliance-manger-dashboard)
