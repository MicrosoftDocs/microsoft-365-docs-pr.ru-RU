...
Второй этап — настройка соединители Webex Teams на сайте Merge1. Сведения о настройке соединители Webex Teams см. в руководстве пользователя [Merge1 Third-Party Connectors.](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Webex%20Teams%20User%20Guide%20.pdf)
...
2. Перейдите **на вкладку** "Соединители", а затем выберите соединители **Webex Teams,** чтобы отобразить эту страницу. На этой странице содержатся свойства и сведения о соединители.
