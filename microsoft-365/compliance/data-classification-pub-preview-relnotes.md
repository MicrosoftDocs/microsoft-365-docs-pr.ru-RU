...
Клиенты с личной предварительной версией сталкивались с тем, что при миграции меток или удалении метки, которая уже была применена к содержимому, в обозревателе содержимого и обозревателе действий вместо имени метки отображался 32-битный идентификатор GUID. 
