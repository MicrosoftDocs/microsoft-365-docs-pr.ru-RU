...
**Если вы хотите, чтобы содержимое было удалено до окончательного удаления,** рассмотрите возможность использования [меток хранения ](labels.md) вместо политики хранения. При создании метки хранения можно настроить [проверку перед ликвидацией](disposition-reviews.md), чтобы просматривать контент в конце срока хранения.
