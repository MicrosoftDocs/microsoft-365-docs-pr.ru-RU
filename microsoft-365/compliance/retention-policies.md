...
Политика хранения применяется на уровне семейства веб-сайтов. Когда семейство веб-сайтов SharePoint или учетная запись OneDrive добавляется в политику хранения, для хранения документов используется архивная библиотека. Эта библиотека создается автоматически, если она еще не существует. Эту библиотеку можно просмотреть на странице **Содержимое сайта** на сайте верхнего уровня в семействе веб-сайтов. Большинство пользователей не могут просматривать архивную библиотеку, так как она видна только администраторам семейства веб-сайтов.
...
После назначения политики хранения учетной записи OneDrive или сайту SharePoint пути к содержимому будут зависеть от того, предусматривает ли политика хранения хранение и удаление, только хранение или только удаление.
