...
**Если вам требуется возможность просматривать контент перед его окончательным удалением,** рекомендуется использовать [метки хранения](labels.md) вместо политики хранения. При создании метки хранения можно настроить [проверку перед ликвидацией](disposition-reviews.md), чтобы просматривать контент в конце срока хранения.
