...
3. и поэтому поиск не находит там содержимого. Это означает, что обнаружение электронных данных не позволяет находить содержимое в корзине для его удержания. 
