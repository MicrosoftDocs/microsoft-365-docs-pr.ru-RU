...
Используйте соединитель Veritas в центре соответствия требованиям Microsoft 365 для импорта и архива данных с платформы Reuters FX для почтовых ящиков пользователей в организации Microsoft 365. Veritas предоставляет вам соединитель [Reuters FX,](https://globanet.com/reuters-fx/) который настроен для захвата элементов из стороннего источника данных (на регулярной основе), а затем импортировать эти элементы в Microsoft 365. Соединителя преобразует курсы валют и валют с учетной записи Reuters FX в формат сообщений электронной почты, а затем импортирует эти элементы в почтовый ящик пользователя в Microsoft 365.
...
3. Соединитель Reuters FX, который вы создаете в центре соответствия требованиям Microsoft 365, подключается к сайту Veritas Merge1 каждый день и передает содержимое в безопасное хранилище Azure в облаке Microsoft.
