...
## <a name="task-7-configure-sensitive-information-and-offensive-language-policies"></a>Задача 7: Настройка конфиденциальной информации и нежелательных языковых политик
...
## <a name="task-8-see-whats-happening-with-your-sensitive-items"></a>Задача 8: сведения о том, что происходит с конфиденциальными элементами
