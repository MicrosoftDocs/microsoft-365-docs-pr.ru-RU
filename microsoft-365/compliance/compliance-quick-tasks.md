...
[Политика хранения](retention-policies.md) позволяет заранее решить, сохранять ли контент, удалять содержимое или и то, и другое — сохранять и удалять содержимое в конце указанного периода хранения. Эти действия могут быть необходимы для обеспечения соответствия отраслевым нормам и внутренним политикам, а также для снижения риска в случае судебного разбирательства или нарушения безопасности.
...
Пошаговое руководство по созданию и публикации меток хранения приведено в разделе [Создание, публикация и автоматическое применение меток хранения](create-retention-labels.md). Сведения о лицензировании управления записями можно найти в [статье рекомендация лицензирования Microsoft 365 на соответствие требованиям безопасности &](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance#records-management).
