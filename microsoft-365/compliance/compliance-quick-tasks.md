...
Пошаговое руководство по использованию обозревателя действий представлено в статье Начало [работы с обозревателем действий](data-classification-activity-explorer.md).
