...
После создания политик защиты от потери данных (DLP) необходимо убедиться, что они работают должным образом и помогают обеспечить соответствие требованиям. С помощью отчетов DLP в центре безопасности &amp; и соответствия требованиям вы можете быстро просмотреть:
...
Эти отчеты можно найти &amp; в **панели мониторинга "** безопасность отчетов \> **Reports** \> " центра соответствия требованиям.
