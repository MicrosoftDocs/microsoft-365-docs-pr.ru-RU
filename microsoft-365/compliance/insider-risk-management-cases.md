...
### <a name="share-the-case"></a>Делитесь случаем

Совместное использование случая управления рисками изнутри позволяет следователям по рискам и аналитикам легко сотрудничать с другими заинтересованными сторонами в организации. Вы можете быстро поделиться ссылкой на случай управления рисками изнутри с внешними заинтересованными сторонами из области управления случаем. Чтобы получить доступ к делу по управлению рисками из ссылки, заинтересованные стороны должны быть включены в любую из групп ролей управления рисками.
...
- **ServiceNow.** После настройки соединителя Microsoft 365 ServiceNow для организации Microsoft 365 вы можете легко поделиться ссылкой на случай, открыть инцидент или запросить изменения в организации ServiceNow. Чтобы поделиться случаем с ServiceNow, выберите **Case Actions**  >  **Share**  >  **ServiceNow** из действия дела. Интеграция ServiceNow с инсайдерской поддержкой управления рисками включает в себя следующие сведения о случаях и действиях:
    - **Имя задачи.** Имя новой задачи ServiceNow.
    - **Описание задачи.** Описание новой задачи ServiceNow. Это редактирование поле описания автоматически включает ссылку на случай управления рисками изнутри.
    - **Тип задачи:** тип задачи для новой задачи ServiceNow, *запроса На* инцидент или *изменение.*
    - **Приоритет:** приоритет для новой задачи ServiceNow, планирование *,* *низкий,* *умеренный,* *высокий* или *критический*.
    - **Дата выполнения.** Запрашиваемая дата выполнения задачи ServiceNow.

![Совместное использование инсайдерской системы управления рисками с ServiceNow](../media/insider-risk-share-servicenow.png)

- **Электронная** почта. В сообщении электронной почты имеется ссылка на дело об управлении рисками изнутри. С помощью этого параметра можно выбрать любой локально настроенный клиент электронной почты. Чтобы поделиться ссылкой на случай с электронной почтой, выберите **Share** Email из панели инструментов  >   действий для дела.
- **Скопируйте** ссылку. Копирует ссылку на дело по управлению рисками изнутри в буфер обмена. Чтобы скопировать ссылку на случай в буфер обмена, выберите **ссылку Share** Copy из панели инструментов  >   действий.
