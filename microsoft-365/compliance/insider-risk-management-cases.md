...
Панель мониторинга insider risk management **Cases** позволяет просматривать дела и действовать над ими. Каждый виджет отчета на панели мониторинга отображает сведения за последние 30 дней.
...
В очереди дел перечислены все активные и закрытые дела для организации, а также текущее состояние следующих атрибутов дела:
...
В зависимости от количества и типа активных политик управления рисками внутри организации, просмотр большого количества дел может быть сложной задачей. Использование фильтров дел может помочь аналитикам и следователям сортировать дела по нескольким атрибутам. Для фильтрации оповещений на панели **мониторинга "Дела"** выберите **"Фильтр".** Можно фильтровать дела по одному или несколько атрибутов:
...
5. **Действия с делом:** варианты разрешения дела находятся на панели инструментов действия с делом. Вы можете разрешить дело, отправить пользователю уведомление по электронной почте или обослать дело для анализа данных или пользователей.
...
На **вкладке "Заметки** по делу" в этом случае аналитики рисков и следователи делятся комментариями, отзывами и аналитическими сведениями о своей работе по делу. Заметки являются постоянными дополнениями к делу и не могут быть изменены или удалены после с сохранения заметки. При создании дела из оповещения комментарии, внося в оповещение Confirm и **создание insider risk case,** автоматически добавляются в качестве заметки по делу.
...
Вкладка **"Авторы"** в этом случае — это вкладка, на которой аналитики рисков и следователи могут добавлять в дело других проверяющих. По умолчанию все пользователи,  для которых назначены  роли "Аналитики управления рисками для участников" и "Внутренние расследования по управлению рисками", перечислены как участники каждого активного и закрытого дела.

Для управления всеми делами управления рисками внутри организации необходимо использовать соответствующие средства контроля доступа для поддержания конфиденциальности и целостности расследования. Для поддержания контроля доступа к делам пользователям назначен один из двух типов доступа к случаям:

- **Постоянный** доступ: постоянный доступ автоматически предоставляется пользователям с ролями аналитиков управления рисками и участников внутренней оценки, когда дело создается из оповещения.   Постоянный доступ предоставляет полный контроль над делом на время его существования и дает возможность добавлять других участников дела.
- **Временный доступ:** временный доступ предоставляется пользователям только участниками, которые имеют постоянный доступ к делу. Обычно этот уровень доступа предоставляется пользователю, который должен добавить заметки к делу. Участники с временным доступом имеют все возможности управления случаями, кроме:
...
5. Выберите **"Отправить",** чтобы отправить  уведомление пользователю, или закройте диалоговое окно "Отмена", не отправляя уведомление пользователю. Все отправленные уведомления добавляются в очередь заметок о делах на панели мониторинга **"Заметки о** делах".
...
Чтобы дорасти дело до расследования для пользователя:
...
4. Просмотрите поля уведомлений и обновив их соответствующим образом. Значения, введенные здесь, будут переопределять значения в шаблоне.
5. Выберите **"Подтвердить",** чтобы создать  дело расследования для пользователя, или "Отмена", чтобы закрыть диалоговое окно, не создавая новое дело.
...
- Добавление напоминания календаря для последующей оценки случая, когда происходит внутренний риск
...
- **Электронная** почта: в сообщении электронной почты имеется ссылка на дело по управлению рисками внутри организации. С помощью этого параметра можно выбрать любой локально настроенный почтовый клиент. Чтобы поделиться ссылкой на дело с электронной почтой, выберите **"Поделиться**  >  **электронной почтой"** на панели инструментов действий с делом.
- **Ссылка**"Копировать": копирует ссылку на дело управления рисками внутри организации в буфер обмена. Чтобы скопировать ссылку на дело в буфер обмена, выберите ссылку **"Поделиться**  >  **копией"** на панели инструментов действий с делом.
...
1. В Центре [соответствия требованиям Microsoft 365](https://compliance.microsoft.com)перейдите в центр управления рисками для программы **insider и** выберите вкладку **"Дела".**
2. Выберите дело, а затем кнопку **"Разрешить дело"** на панели инструментов действий с делом.
