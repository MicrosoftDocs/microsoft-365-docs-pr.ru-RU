...
- **Постоянный** доступ: постоянный доступ автоматически предоставляется пользователям с ролями "Аналитики управления рисками для участников" и "Расследования по управлению рисками для участников внутренней оценки", когда дело создается из оповещения.   Постоянный доступ предоставляет полный контроль над делом на время его существования и дает возможность добавлять других участников дела.
- **Временный доступ:** временный доступ предоставляется пользователям только участниками, которые имеют постоянный доступ к делу. Обычно этот уровень доступа предоставляется пользователю, который должен добавлять заметки к делу. Участники с временным доступом имеют все возможности управления случаями, кроме:
...
5. В **диалоговом окте "Добавление** участника" выберите уровень доступа для этого участника. Можно выбрать пункт **"Постоянная"** или **"Временная".**
...
Используя рекомендуемые потоки Power Automate, специалисты по рискам и аналитики могут быстро принять меры, чтобы:

- Запрос сведений из отдела кадров или бизнеса о пользователе в случае внутри риска
