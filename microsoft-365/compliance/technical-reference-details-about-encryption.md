...
Эти наборы шифров поддерживали протоколы TLS 1.0 и 1.1 до даты их амортизации. Для GCC сред High и DoD дата амортизации была 15 января 2020 г., а для сред GCC и мира эта дата была 15 октября 2020 г.
