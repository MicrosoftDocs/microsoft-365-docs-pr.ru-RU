...
> [!IMPORTANT]
> Имейте в виду, что версии протокола TLS устарели, и эти устаревшие версии *не следует использовать* там, где доступны новые версии. Другими словами, в любом месте, где он указан, поддерживаются протоколы TLS 1,0, 1,1 и 1,2, выберите *самую последнюю* поддерживаемую версию (TLS 1,2). TLS в настоящее время не поддерживается. Если устаревшие службы не требуют TLS 1,0 или 1,1, их следует отключить. 
...
[Расширения шифрования TLS/SSL (центр ИТ-Windows)](https://technet.microsoft.com/library/cc766285%28v=ws.10%29.aspx)
 ...
 [Подготовка к протоколу TLS 1,2 в Office 365 и Office 365 GCC](https://docs.microsoft.com/office365/troubleshoot/security/prepare-tls-1.2-in-office-365)
