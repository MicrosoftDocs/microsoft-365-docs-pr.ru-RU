...
Office 365 перестал поддерживать TLS 1.0 и 1.1 31 октября 2018 г. Новые проблемы, найденные в клиентах, устройствах или службах, которые подключаются к Office 365 по TLS 1.0 и 1.1, не будут устранены. Официальное деprecation for GCC High and DoD environments started 15 January 2020. Отзыв TLS 1.0 и 1.1 для сред Worldwide и GCC начался 15 октября 2020 г.
...
| Набор шифров | Ключевой алгоритм и сила обмена ключами | Идеальное перенаровчение секретности | Шифр и сила | Алгоритм проверки подлинности |
|:-----|:-----|:-----|:-----|:-----|
