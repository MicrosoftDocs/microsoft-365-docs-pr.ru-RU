...
Office 365 перестал поддерживать TLS 1.0 и 1.1 31 октября 2018 г. Новые проблемы, найденные в клиентах, устройствах или службах, которые подключаются к Office 365 по TLS 1.0 и 1.1, не будут устранены. Официальное отзыв лицензии для сред GCC High и DoD началось 15 января 2020 г. Отзыв TLS 1.0 и 1.1 для сред Worldwide и GCC начался 15 октября 2020 г.
...
Протокол TLS использует *наборы* шифров , коллекции алгоритмов шифрования, для создания безопасных подключений. Office 365 поддерживает наборы шифров, перечисленные в следующей таблице. В таблице перечислены наборы шифров в порядке их силы, а самый мощный набор шифров указан первым.
...
| Набор шифров | Алгоритм и сила обмена ключами | Идеальное заглавная секретность | Шифр и сила | Алгоритм проверки подлинности |
|:-----|:-----|:-----|:-----|:-----|
...
| Протоколы | Имя набора шифров | Алгоритм обмена ключами/сила | Поддержка идеальной заглавной тайны | Алгоритм и сила проверки подлинности | Шифр и сила |
|:-----|:-----|:-----|:-----|:-----|:-----|
