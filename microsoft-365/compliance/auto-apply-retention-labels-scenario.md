...
- **Метка хранения**: настроить для классификации контента как [*записи*](records.md). (Документы, классифицированные как *записи* не могут быть изменены или удалены пользователями.)
