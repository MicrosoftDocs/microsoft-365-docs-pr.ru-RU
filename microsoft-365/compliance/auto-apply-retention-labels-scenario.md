...
На следующем снимке экрана показаны настройки при создании [метки хранения](retention.md#retention-labels) "Спецификация продукта" в Центре безопасности и соответствия требованиям. При создании метки хранения можно создать тип событий **Прекращение производства**. См. инструкции ниже.
