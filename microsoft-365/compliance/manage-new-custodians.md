...
- Контактные данные
  ...
  - **Отображаемого** имени — имя, отображаемого в адресной книге для хранителя. Обычно это сочетание имени, от первой и фамилии хранителя.
   ...
   - **Mail/SMTP** — основной SMTP-адрес для хранителя, например, brianj@contoso.onmicrosoft.com. Также указано имя пользователя-хранителя (UPN).
...
Чтобы активировать процесс переиндексации для обращения к частично индексным элементами:
