...
Один из способов проверить результаты поиска — проверить статистику результатов, чтобы убедиться, что они соответствуют вашим ожиданиям. После завершения поиска высокоуровневая статистика отображается во flyout сведений о поиске:
...
В представлении сводки можно увидеть результаты поиска, разбитые по типу расположения (например, Exchange). Для каждого типа расположения можно увидеть:
