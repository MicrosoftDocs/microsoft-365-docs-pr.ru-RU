...
3. На **вкладке Импорт** нажмите ![ кнопку Добавить ](../media/ITPro-EAC-AddIcon.gif) **значок Новое задание импорта**.
...
2. В левой области центра соответствия требованиям Microsoft 365 нажмите кнопку Управление информацией **> Import**.
