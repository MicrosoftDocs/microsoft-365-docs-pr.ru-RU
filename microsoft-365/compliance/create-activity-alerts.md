...
description: Добавление и управление оповещениями о действиях в Центре & безопасности, чтобы Корпорация Майкрософт 365 отправила вам уведомления по электронной почте при выполнении пользователями определенных действий.
