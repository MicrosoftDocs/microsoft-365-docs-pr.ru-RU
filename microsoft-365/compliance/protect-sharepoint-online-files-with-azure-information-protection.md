...
>[!Note]
>Текущее решение для файлов на строго конфиденциальном сайте группы SharePoint Online использует метки конфиденциальности Microsoft 365. Подробности представлены в [этой статье](protect-sharepoint-online-files-with-sensitivity-label.md).
>
