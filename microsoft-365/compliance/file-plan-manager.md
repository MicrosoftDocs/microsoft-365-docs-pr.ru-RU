...
Существуют два требования для доступа к диспетчеру плана хранения. Эти требования приводятся ниже.

- Подписка на Office 365 корпоративный E5.

- Пользователю назначена одна из следующих ролей в Центре безопасности и соответствия требованиям:
...
3. Заполните шаблон. Ниже представлены свойства и допустимые значения для каждого свойства в шаблоне плана хранения.<br/>
   ...
   |EventType|String|Это свойство указывает правило хранения, связанное с меткой. Можно использовать любое значение, уникальным образом идентифицирующее правило. Пример:</br>**имя**</br>**различающееся имя (DN)**</br>**GUID** </br>Чтобы просмотреть доступные правила хранения, можно использовать командлет [Get-RetentionComplianceRule](https://docs.microsoft.com/powershell/module/exchange/policy-and-compliance-retention/get-retentioncompliancerule?view=exchange-ps). Обратите внимание, что при экспорте меток из одной организации Office 365 нельзя использовать значения свойства EventType из этой организации в случае импорта меток в другую организацию Office 365. Это обусловлено уникальностью значений EventType для организации. |
   |||
