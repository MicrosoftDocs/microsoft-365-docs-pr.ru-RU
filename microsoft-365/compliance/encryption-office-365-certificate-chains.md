...
| **Срок действия не после** | 12 мая 23:59:00 2025 UTC |
...
| **Срок действия не после** | 16 апреля 07:09:14 2027 UTC |
| **Идентификатор ключа субъекта** | 65:f2:31:ad:2a:f7:f7:dd:52:96:0a:c7:02:c1:0e:ef:a6:d5:3b:11 |
| **Идентификатор ключа полномочия** | keyid:65:f2:31:ad:2a:f7:f7:dd:52:96:0a:c7:02:c1:0e:ef:a6:d5:3b:11 |
...
| **Срок действия не после** | 10 ноября 00:00:00 2031 UTC |
...
| **Срок действия не ранее** | Четверг, 1 августа 2013 г. 5:00 |
| **Срок действия не до** | Пятница, 15 января 2038 г., 4:00 |
...
### <a name="digicert-high-assurance-ev-root-ca"></a>**Корневой ЦС DigiCert High Assurance EV**
...
| **Срок действия не после** | 05 ноября 08:35:58 2029 UTC |
...
| **Срок действия не после** | 05 ноября 08:50:46 2029 UTC |
...
| **Pin (SHA-256)** | /zQvtsTIvTCkcG9zSJU58Z5uSMwF9GJUJUJU9mENvFQOk= |
...
| **Срок действия не после** | 30 сентября 14:01:15 2021 UTC |
...
### <a name="entrust-root-certification-authority---g2"></a>**Корневой сертификационный орган корневого корневого сертификата ( G2)**

| **Тема** | CN=Root Certification Authority ( Корневой ЦС по надзору за корневыми сертификатами) — G2<br>OU= &quot; (c) 2009 Доверенное, Inc. — только для авторизованного использования&quot;<br>OU=See www.entrust.net/legal-terms<br>O= &quot; Доверенный, Inc.&quot;<br>C=US |
| --- | --- |
| **Серийный номер** | 4A:53:8C:28 |
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 07 июля 17:25:54 2009 UTC |
| **Срок действия не после** | 07 декабря 17:55:54 2030 UTC |
...
| **Pin (SHA-256)** | du6FkDdMcVQ3u8prumAo6t3i3G27uMP2EAoR8R0at/U= |

### <a name="entrustnet-certification-authority-2048"></a>**Entrust.net сертификации (2048)**

| **Тема** | CN=Certification Authority .net (2048)<br>OU=(c) 1999 Entrust.net Limited<br>OU=www.entrust.net/CPS \_ 2048 incorp. по ref. (ограничить s liab.)<br>O=ИТ-компания.net |
| --- | --- |
| **Серийный номер** | 38:63:DE:F8 |
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha1RSA |
| **Срок действия не ранее** | 24 декабря 17:50:51 1999 UTC |
| **Срок действия не после** | 24 июля 14:15:12 2029 UTC |
...
### <a name="globalsign-root-ca---r1"></a>**Глобальный корневой ЦС — R1**
...
| **Срок действия не после** | 28 января 12:00:00 2028 UTC |
...
| **Длина открытого ключа** | RSA 2048 бит |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | Среда, 18 марта 2009 г., 03:00 |
| **Срок действия не до** | Воскресенье, 18 марта 2029 г., 03:00 |
| **Идентификатор ключа субъекта** | 8FF04B7FA82E4524AE4D50FA639A8BDEE2DD1BBC |
| **Идентификатор ключа полномочия** | KeyID:8f:f0:4b:7f:a8:2e:45:24:ae:4d:50:fa:63:9a:8b:de:e2:dd:1b:bc |
...
| **Тема** | CN=thawte Primary Root CA - G3<br>OU= &quot; (c) 2008 thawte, Inc. — только для авторизованного использования&quot;<br>OU=Certification Services Division<br>O= &quot; thawte, Inc.&quot;<br>C=US |
| --- | --- |
| **Серийный номер** | 60:01:97:B7:46:A7:EA:B4:B4:9A:D6:4B:2F:F7:90:FB |
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 02 апреля 00:00:00 2008 UTC |
| **Срок действия не после** | 01 декабря 23:59:59 2037 UTC |
...
| **Pin (SHA-256)** | GQbGEk27Q4V40A4GbVBUxsN/D6YCjAVUXgmU7drsvu= |

### <a name="verisign-class-3-public-primary-certification-authority---g5"></a>**Общедоступный основной сертификационный орган класса VeriSign 3 — G5**

| **Тема** | CN=VeriSign Class 3 Public Primary Certification Authority - G5<br>OU= &quot; (c) 2006 VeriSign, Inc. — только для авторизованного использования&quot;<br>OU=VeriSign Trust Network<br>O= &quot; VeriSign, Inc.&quot;<br>C=US |
| --- | --- |
| **Серийный номер** | 18:DA:D1:9E:26:7D:E8:BB:4A:21:58:CD:CC:6B:3B:4A |
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha1RSA |
| **Срок действия не ранее** | 08 ноября 00:00:00 2006 UTC |
| **Срок действия не после** | 16 июля 23:59:59 2036 UTC |
...
| --- | --- |
| **Издатель** | CN=ROOT <br>O=THEIC <br>C=CN |
| **Серийный номер** | 49:33:00:7C |
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 18 декабря 12:32:18 2014 UTC |
| **Срок действия не после** | 18 декабря 12:32:18 2024 UTC |
...
| **Альтернативное имя субъекта** | RFC822 Name=info@d-trust.net<br>URL=http://www.d-trust.net |
...
| **Идентификатор ключа полномочия** | keyid:fd:da:14:c4:9f:30:de:21:bd:1e:42:39:fc:ab:63:23:49:e0:f1:84 |
...
| **Идентификатор ключа полномочия** | keyid:d3:94:8a:4c:62:13:2a:19:2e:cc:af:72:8a:7d:36:d7:9a:1c:dc:67 |
...
### <a name="digicert-sha2-high-assurance-server-ca"></a>**ЦС digiCert SHA2 High Assurance Server**
...
| **Срок действия не после** | 22 октября 12:00:00 2028 UTC |
...
| **Thumbprint (SHA-256)** | 19400BE5B7A31FB733917700789D2F0A2471C0C0C9D506C0E504C06C16D7CB17C0 |
| **Pin (SHA-256)** | k2v657xBsOVe1PQRwOsHsw3bsGT2VzIqz5K+59sNQws= |
| **URL-адреса CRL** | http://crl4.digicert.com/DigiCertHighAssuranceEVRootCA.crl |
| **URL-адреса OCSP** | http://ocsp.digicert.com |

### <a name="digicert-sha2-secure-server-ca"></a>**ЦС Безопасного сервера DigiCert SHA2**
...
| **Срок действия не после** | 08 марта 12:00:00 2023 UTC |
...
### <a name="entrust-certification-authority---l1c"></a>**Сертификационный ЦС - L1C**

| **Тема** | CN=Certification Authority - L1C<br>OU= &quot; (c) 2009 Доверенный, Inc.&quot;<br>OU=www.entrust.net/rpa включается по ссылке<br>O= &quot; Доверенный, Inc.&quot;<br>C=US |
| --- | --- |
| **Издатель** | CN=Certification Authority .net (2048)<br>OU=(c) 1999 Entrust.net Limited<br>OU=www.entrust.net/CPS \_ 2048 incorp. по ref. (ограничивает liab.)<br>O=ИТ-компания.net |
| **Серийный номер** | 4C:0E:8C:39 |
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha1RSA |
| **Срок действия не ранее** | 11 ноября 15:40:40 2011 UTC |
| **Срок действия не после** | 12 ноября 02:51:17 2021 UTC |
| **Идентификатор ключа субъекта** | 1e:f1:ab:89:06:f8:49:0f:01:33:77:ee:14:7a:ee:19:7c:93:28:4d |
| **Идентификатор ключа полномочия** | keyid:55:e4:81:d1:11:80:be:d8:89:b9:08:a3:31:f9:a1:24:09:16:b9:70 |
...
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 05.19:13:56 2015 UTC |
| **Срок действия не после** | 05 декабря 19:43:56 2030 UTC |
| **Идентификатор ключа субъекта** | 82:a2:70:74:dd:bc:53:3f:cf:7b:d4:f7:cd:7f:a7:60:c6:0a:4c:bf |
| **Идентификатор ключа полномочия** | keyid:6a:72:26:7a:d0:1e:ef:7d:e7:3b:69:51:d4:6c:8d:9f:90:12:66:ab |
...
| **Pin (SHA-256)** | 980Ionqp3wkYtN9SZVgMucWQzJta1nfxNPwTem1X0uc= |
...
| **Срок действия не после** | 15 декабря 08:00:00 2021 UTC |
| **Идентификатор ключа субъекта** | da:40:77:43:65:1c:f8:fe:a7:e3:f4:64:82:3e:4d:43:13:22:31:02 |
| **Идентификатор ключа полномочия** | keyid:9b:e2:07:57:67:1c:1e:c0:6a:06:de:59:b4:9a:2d:df:dc:19:86:2e |
...
### <a name="globalsign-extended-validation-ca---sha256---g3"></a>**Глобальный расширенный ЦС проверки — SHA256 - G3**

| **Тема** | CN=GlobalSign Extended Validation CA - SHA256 - G3<br>O=GlobalSign nv-sa<br>C=BE |
| --- | --- |
...
| **Срок действия не после** | 21 сентября 00:00:00 2026 UTC |
...
### <a name="globalsign-organization-validation-ca---sha256---g2"></a>**Глобальный ЦС проверки организации — SHA256 - G2**
...
| **Длина открытого ключа** | RSA 2048 бит (e 65537) |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 02 августа 10:00:00 2011 UTC |
| **Срок действия не после** | 02 августа 10:00:00 2022 UTC |
...
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 20 февраля 10:00:00 2014 UTC |
| **Срок действия не после** | 20 февраля 10:00:00 2024 UTC |
| **Идентификатор ключа субъекта** | 96:de:61:f1:bd:1c:16:29:53:1c:c0:cc:7d:3b:83:00:40:e6:1a:7c |
| **Идентификатор ключа полномочия** | keyid:60:7b:66:1a:45:0d:97:ca:89:50:2f:7d:04:cd:34:a8:ff:fc:fd:4b |
...
### <a name="globalsign-organization-validation-ca---sha256---g3"></a>**Глобальный ЦС проверки организации — SHA256 - G3**

| **Тема** | CN=GlobalSign Organization Validation CA - SHA256 - G3<br>O=GlobalSign nv-sa<br>C=BE |
| --- | --- |
...
| **Длина открытого ключа** | RSA 2048 бит |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | Четверг, 3 сентября 2015 г. 17:00 |
| **Срок действия не до** | Среда, 3 сентября 2025 г. 17:00 |
...
| **Длина открытого ключа** | RSA 2048 бит |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | Вторник, 20 ноября 2018 г., 16:00 |
| **Срок действия не до** | Понедельник, 20 ноября 2028 г., 16:00 |
...
### <a name="lets-encrypt-authority-x3"></a>**Зашифруем authority X3**
...
| **Срок действия не после** | 17 марта 16:40:46 2021 UTC |
| **Идентификатор ключа субъекта** | a8:4a:6a:63:04:7d:dd:ba:e6:d1:39:b7:a6:45:65:ef:f3:a8:ec:a1 |
| **Идентификатор ключа полномочия** | keyid:c4:a7:b1:a4:7b:2c:71:fa:db:e1:4b:90:75:ff:c4:15:60:85:89:10 |
...
| **Тема** | CN=Microsoft Azure TLS Issuing CA 01<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Издатель** | CN=DigiCert Global Root G2, OU=www.digicert.com, O=DigiCert Inc, C=US |
...
| **Тема** | CN=Microsoft Azure TLS Issuing CA 02<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Издатель** | CN=DigiCert Global Root G2, OU=www.digicert.com, O=DigiCert Inc, C=US |
...
| **Тема** | CN=Microsoft Azure TLS Issuing CA 05<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Издатель** | CN=DigiCert Global Root G2, OU=www.digicert.com, O=DigiCert Inc, C=US |
...
| **Тема** | CN=Microsoft Azure TLS Issuing CA 06<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Издатель** | CN=DigiCert Global Root G2, OU=www.digicert.com, O=DigiCert Inc, C=US |
...
| **Тема** | CN=Microsoft IT TLS CA 1<br>OU=Microsoft IT<br>O=Microsoft Corporation<br>L=Redmond<br>S=Washington<br>C=US |
| --- | --- |
| **Издатель** | CN=CyberTrust Root<br>OU=CyberTrust<br>O=Товая<br>C=IE |
| **Серийный номер** | 08:B8:7A:50:1B:BE:9C:DA:2D:16:4D:3E:39:51:BF:55 |
| **Длина открытого ключа** | RSA 4096 битов (e 65537) |
| **Алгоритм подписи** | sha256RSA |
| **Срок действия не ранее** | 20 мая 12:51:28 2016 UTC |
| **Срок действия не после** | 20 мая 12:51:28 2024 UTC |
...
| **Тема** | CN=Microsoft IT TLS CA 2<br>OU=Microsoft IT<br>O=Microsoft Corporation<br>L=Redmond<br>S=Washington<br>C=US |
| --- | --- |
| **Издатель** | CN=CyberTrust Root<br>OU=CyberTrust<br>O=Товая<br>C=IE |
...
| **Срок действия не после** | 20 мая 12:51:57 2024 UTC |
...
| **Тема** | CN=Microsoft IT TLS CA 4<br>OU=Microsoft IT<br>O=Microsoft Corporation<br>L=Redmond<br>S=Washington<br>C=US |
| --- | --- |
| **Издатель** | CN=CyberTrust Root<br>OU=CyberTrust<br>O=Товая<br>C=IE |
...
| **Срок действия не после** | 20 мая 12:52:38 2024 UTC |
...
| **Тема** | CN=Microsoft IT TLS CA 5<br>OU=Microsoft IT<br>O=Microsoft Corporation<br>L=Redmond<br>S=Washington<br>C=US |
| --- | --- |
| **Издатель** | CN=CyberTrust Root<br>OU=CyberTrust<br>O=Товая<br>C=IE |
...
| **Срок действия не после** | 20 мая 12:53:03 2024 UTC |
...
| **Тема** | CN=Microsoft RSA TLS CA 01<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Издатель** | CN=CyberTrust Root, OU=CyberTrust, O=Root, C=IE |
...
| **Тема** | CN=Microsoft RSA TLS CA 02<br>O=Microsoft Corporation<br>C=US |
| --- | --- |
| **Издатель** | CN=CyberTrust Root, OU=CyberTrust, O=Root, C=IE |
...
| **Тема** | CN=Symantec Class 3 EV SSL CA - G3<br>OU=Symantec Trust Network<br>O=Symantec Corporation<br>C=US |
| --- | --- |
...
| **Срок действия не после** | 30 октября 23:59:59 2023 UTC |
| **Идентификатор ключа субъекта** | 01:59:ab:e7:dd:3a:0b:59:a6:64:63:d6:cf:20:07:57:d5:91:e7:6a |
| **Идентификатор ключа полномочия** | keyid:7f:d3:65:a7:c2:dd:ec:bb:f0:30:09:f3:43:39:fa:02:af:33:31:33 |
...
### <a name="thawte-sha256-ssl-ca"></a>**ca SSL shawte SHA256**

| **Тема** | CN=thawte SHA256 SSL CA<br>O= &quot; thawte, Inc.&quot;<br>C=US |
| --- | --- |
| **Издатель** | CN=thawte Primary Root CA - G3<br>OU= &quot; (c) 2008 thawte, Inc. — только для авторизованного использования&quot;<br>OU=Certification Services Division<br>O= &quot; thawte, Inc.&quot;<br>C=US |
...
| **Срок действия не после** | 22 мая 23:59:59 2023 UTC |
| **Идентификатор ключа субъекта** | 2b:9a:35:ae:01:18:38:30:e1:70:7a:05:e0:11:76:a3:ce:bd:90:14 |
| **Идентификатор ключа полномочия** | keyid:ad:6c:aa:94:60:9c:ed:e4:ff:fa:3e:0a:74:2b:63:03:f7:b6:59:bf |
...
| **Тема** | CN=Verizon Akamai SureServer CA G14-SHA2<br>OU=Cybertrust<br>O=Verizon Enterprise Solutions<br>L=Амстердам<br>C=NL |
| --- | --- |
| **Издатель** | CN=CyberTrust Root<br>OU=CyberTrust<br>O=Товая<br>C=IE |
...
| **Срок действия не после** | 02 апреля 14:35:52 2021 UTC |
...
В следующем списке содержатся устаревшие сертификаты, которые не включены выше и со временем будут объединены со списком выше.
