...
### <a name="entrust-root-certification-authority---g2"></a>**Корневой сертификационный орган корневого корневого сертификации Корневого сертификата ( G2)**

| **Тема** | CN=Root Certification Authority ( Корневой ЦС по надзору за корневыми сертификатами) — G2<br>OU= &quot; (c) 2009 Доверенное, Inc. — только для авторизованного использования&quot;<br>OU=See www.entrust.net/legal-terms<br>O= &quot; Доверен, Inc.&quot;<br>C=US |
| --- | --- |
...
| **Тема** | CN=Certification Authority - L1C<br>OU= &quot; (c) 2009 Доверенный, Inc.&quot;<br>OU=www.entrust.net/rpa включается по ссылке<br>O= &quot; Доверен, Inc.&quot;<br>C=US |
| --- | --- |
...
| **Pin (SHA-256)** | 8XFPrRr4VxmEIYKU35QtR3oGbduX1AlrBzaBUHgp7c= |
