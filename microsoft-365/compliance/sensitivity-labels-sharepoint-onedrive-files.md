...
- Power Query и настраиваемые надстройки с Excel в Интернете. Если эти файлы зашифрованы меткой конфиденциальности, SharePoint и OneDrive не могут обрабатывать файлы, чтобы пользователи не могли открыть их в Office в Интернете. Для этих файлов либо нанесите метку без шифрования, чтобы их можно было открыть в Office в Интернете, либо поручить пользователям открывать файлы в своих настольных приложениях.

- Если у вас возникли проблемы с открытием помеченных и зашифрованных файлов в Office в Интернете, попробуйте следующее:
