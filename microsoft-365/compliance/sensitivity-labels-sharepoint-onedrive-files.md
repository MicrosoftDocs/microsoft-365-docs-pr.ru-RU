...
> [!NOTE]
> Существует текущая проблема, из-за которую некоторые помеченные и зашифрованные файлы не открываются в Office в Интернете:
>
> В то время как мы исследуем проблему, связанную с определенными свойствами документов, вы не сможете открыть много файлов в Office в Интернете. Для этих файлов можно продолжать открывать и изменять их в настольных и мобильных Office приложениях. Или сделайте следующее:
>
> 1. Откройте файл в Office настольном приложении.
> 2. Удалите метку, применяемую для шифрования.
> 3. Сохраните файл в исходном расположении (SharePoint или OneDrive) и закроите настольное приложение.
> 4. Откройте файл в Office в Интернете и повторно откройте оригинальную метку, которая применяет шифрование.
> 
> Файлы, помеченные только в Office в Интернете, не затронуты.
