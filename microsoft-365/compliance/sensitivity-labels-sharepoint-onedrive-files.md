...
> [!NOTE]
> Существует текущая проблема, из-за которую помеченные и зашифрованные файлы не открываются в Office в Интернете:
>
...
> 
> Файлы, созданные и отредактированы только в Office в Интернете, не затронуты.
