...
> [!IMPORTANT]
> Если вы использовали мастер схемы точного соответствия данных и типов конфиденциальной информации для создания схемы и файлов шаблонов, вам ***необходимо** загрузить схему для этой процедуры.
