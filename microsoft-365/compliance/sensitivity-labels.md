...
> [!NOTE]
> Для клиентов правительства США метки конфиденциальности [теперь поддерживаются для сред GCC и GCC High](/officeupdates/current-channel#version-2101-january-26) и в настоящее время развертываются для сред Министерства обороны США.
>
