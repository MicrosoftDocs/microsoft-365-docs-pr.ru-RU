...
Ярлыки чувствительности из среды Microsoft Information Protection позволяют вам классифицировать и защищать данные вашей организации, при этом гарантируя, что производительность пользователей и их способность к сотрудничеству не пострадают.
