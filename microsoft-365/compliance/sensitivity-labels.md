...
- **Применить метку по умолчанию** ко всем новым документам и непомеченным сообщениям электронной почты, созданным пользователями и группами, которые включены в политику метки, и применить такую же или другую метку по умолчанию к контейнерам (если [включены метки конфиденциальности для Microsoft Teams, групп Microsoft 365 и сайтов SharePoint](sensitivity-labels-teams-groups-sites.md)). С помощью этого параметра клиент унифицированных меток Azure Information Protection также применяет метку по умолчанию к существующим документам без меток. Пользователи всегда могут изменить метку по умолчанию, если она не подходит для их документа или электронной почты.
