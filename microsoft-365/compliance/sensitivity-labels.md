...
Метки конфиденциальности поддерживаются только для клиентов в глобальном (общедоступном) облаке. Метки конфиденциальности не поддерживаются для клиентов в других облаках, например [национальных облаках](https://docs.microsoft.com/azure/active-directory/develop/authentication-national-cloud).
...
- **Сохраняемость.** После применения метки конфиденциальности к контенту метка сохраняется в метаданных этого электронного сообщения или документа. Это означает, что метка перемещается с контентом, включая параметры защиты, и становится основой для применения и внедрения политик.
...
В дополнение к электронной почте и документам метки конфиденциальности доступны в нескольких выпусках общедоступной предварительной версии. Дополнительные сведения о том, какие метки конфиденциальности можно использовать для файлов, групп, групп и сайтов, см. в следующих статьях:
...
К документу или электронной почте можно применить только одну метку конфиденциальности. Если вы требуете от своих пользователей предоставить обоснование для изменения метки на более низкий уровень классификации, порядок этого списка определяет более низкие классификации.
...
Подчиненные метки — это простой способ представления меток пользователю в логических группах. Подчиненные метки не наследуют параметры родительской метки. К содержимому можно применять подметки; родительские метки использовать нельзя.
...
Метки конфиденциальности отображаются в пользовательском интерфейсе приложений Office. Чтобы просмотреть текущую доступность для конкретных приложений и платформ, см. раздел **[Где эта функция доступна прямо сейчас?](https://support.office.com/article/2f96e7cd-d5a4-403b-8bd7-4cc636bae0f9)**
...
Сведения о метках конфиденциальности с приложениями Office в Интернете, см. в статье [Применение меток конфиденциальности к документам и электронной почте в Office – Интернет](https://support.office.com/article/2f96e7cd-d5a4-403b-8bd7-4cc636bae0f9)
...
В Office 365 автоматически отключает метки конфиденциальности, если у вас установлен клиент Azure Information Protection в Office для Windows.
Сведения о том, как устранить эту проблему, см. в статье [О клиенте встроенного добавления меток в Office](sensitivity-labels-office-apps.md#about-the-office-built-in-labeling-client)
