...
> [!NOTE]
> Метки конфиденциальности теперь поддерживаются в клиентах государственных организаций США (GCC и GCC-H). Дополнительные сведения см. в заметках о выпуске Приложений Microsoft 365 для предприятий [версии 2101 за 26 января](/officeupdates/current-channel#version-2101-january-26).
>
> Сведения о клиенте унифицированных меток Azure Information Protection и сканере см. в статье [Описание службы Azure Information Protection ценовой категории "Премиум" для государственных организаций](/enterprise-mobility-security/solutions/ems-aip-premium-govt-service-description).
...
Инструкции по использованию Cloud App Security с этими метками см. в статье [Интеграция Azure Information Protection](/cloud-app-security/azip-integration).
