...
Если вы не видите присвоенную пользователю или группе метку или параметр политики меток, проверьте порядок сортировки политик меток конфиденциальности. Чтобы изменить порядок политик меток, выберите политику меток конфиденциальности, нажмите многоточие справа и выберите **Вниз** или **Вверх**.
