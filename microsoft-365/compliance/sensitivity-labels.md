...
Количество меток конфиденциальности, которые можно создать и опубликовать, не ограничено за одним исключением: если метка обеспечивает применение шифрования, поддерживается не более 500 меток. Однако в целях снижения административной нагрузки и сложности для пользователей рекомендуется свести число меток к минимуму. Доказано снижение эффективности реальных развертываний, если пользователи применяют более пяти основных меток и более пяти подчиненных меток для каждой основной метки.
