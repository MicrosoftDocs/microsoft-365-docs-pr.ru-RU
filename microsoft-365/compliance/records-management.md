...
|Перемещение между контейнерами <sup>2</sup>|Разрешено |Разрешено, если никогда не будет разблокировано | Разрешено| **Заблокировано**|
...
>
> Кроме того, метки хранения, настроенные для нормативных записей, имеют следующие ограничения для администратора:
...
> - После того, как эти метки добавлены и сохранены в политике меток хранения, их невозможно удалить из расположений, можно только добавить расположения.
> 
