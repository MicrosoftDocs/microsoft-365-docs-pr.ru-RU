...
Управление безопасностью и соответствием требованиям — это партнерство. Вы несете ответственность за защиту данных, удостоверений и устройств, а Корпорация Майкрософт активно защищает службы Microsoft 365. Вы можете использовать Microsoft 365 и Корпоративная мобильность + Безопасность (EMS) вместе, чтобы помочь вам достичь соответствующего уровня защиты для вашей организации.
...
Защита доступа к данным и службам Microsoft 365 имеет решающее значение для защиты от кибератак и защиты от потери данных.
...
## <a name="step-5-leverage-the-microsoft-365-security-amp-compliance-center"></a>Шаг 5. Использование Центра соответствия требованиям безопасности Microsoft 365 &amp;

Центр соответствия требованиям безопасности предоставляет одно представление элементов управления, которые будут использовать для управления спектром безопасности Microsoft 365, включая управление угрозами, управление данными, поиск и &amp; расследование. 
...
Настройка параметров безопасности и соответствия требованиям в этих центрах администрирования и панели мониторинга для защиты среды Microsoft 365
