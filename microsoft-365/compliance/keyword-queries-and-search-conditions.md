...
| Оператор | Использование | Description |
|:-----|:-----|:-----|
...
| Оператор | Эквивалент запроса | Description |
|:-----|:-----|:-----|
