...
4. В **столбце Состояние** включаем политику для **команд чата и сообщений каналов.**
    ...
    > [!div class="mx-imgBorder"]
    > ![DLP для командных чатов и каналов](../media/dlp-teams-addteamschatschannels.png)
