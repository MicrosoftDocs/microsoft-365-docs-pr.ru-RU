...
## <a name="guidelines-for-setting-up-relevance-training"></a>Рекомендации по настройке обучения релевантности
 ...
 Откройте Advanced eDiscovery, в окне **Дела** выберите дело и щелкните **Перейти к делу**. Щелкните **Релевантность** \> **Настройка релевантности**. Воспользуйтесь этими рекомендациями по настройке релевантности. 
...
- **Вопросы для дел**.
  ...
  - Если слишком обобщить формулировку вопроса, Advanced eDiscovery может предоставить слишком много нерелевантных файлов. Если слишком сузить формулировку вопроса, процесс обучения релевантности может занять больше времени. 
