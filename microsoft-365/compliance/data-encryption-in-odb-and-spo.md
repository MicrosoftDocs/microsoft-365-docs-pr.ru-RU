...
Microsoft 365 является высокобезопасной средой, которая обеспечивает широкую защиту в нескольких слоях: физической безопасности центра обработки данных, сетевой безопасности, безопасности доступа, безопасности приложений и безопасности данных. Данная статья посвящена вопросам защиты данных, которые хранятся и передаются, благодаря их шифрованию для OneDrive для бизнеса и SharePoint Online.
...
Развертывание BitLocker выполняется для OneDrive для бизнеса и SharePoint Online в службе. Шифрование для каждого файла также OneDrive для бизнеса и SharePoint Online в Microsoft 365 и новых специализированных средах, построенных на многостоялая технологиях.
