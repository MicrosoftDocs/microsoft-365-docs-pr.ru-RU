...
---
# <a name="set-up-a-connector-to-archive-cisco-jabber-data-preview"></a>Настройка соединителя для архивации данных Cisco Jabber (Предварительная версия)
...
После нажатия кнопки **сохранить & готово**вы переходите к центру соответствия требованиям Microsoft 365 к странице **сопоставления пользователей** в мастере соединителей.
