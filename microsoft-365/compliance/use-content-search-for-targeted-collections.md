...
3. В поле **"Ключевые** слова" вклеить значение или значение, возвращенные сценарием `folderid:<folderid>` в  `documentlink:<path>/*` шаге 1.
    ...
    > [!IMPORTANT]
    > Для поиска documentlink необходимо использовать следовую  `asterisk '/*'` ссылку.  
