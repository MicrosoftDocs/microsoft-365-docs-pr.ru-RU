...
В этом документе Майкрософт представлены подробные указания по финансовым службам с подробным ответом на вопросы, возникающие в информационном информационном Апра, [аутсорсинге, включающем службы облачных вычислений](https://www.apra.gov.au/sites/default/files/information_paper_-_outsourcing_involving_cloud_computing_services.pdf). Инструкции Апра определяют три категории риска, в которых использование облака обычно падает — недостаток, повышенный и экстремальный риск, а также выделение ключевых проблем, которые должны рассматриваться как часть оценки риска.
...
Корпорация Майкрософт также решает все вопросы, касающиеся управления рисками Апра: стратегия, управление, процесс выбора решений, доступ к Апра и возможность работы, переход, оценка риска и безопасность, постоянная оценка, отказ в работе бизнеса и аудит Assurance. Наведите указатель на пункт Point, мы предоставляем советы и предлагаемые средства, которые помогут вам ответить на каждую ошибку при развертывании Azure.
...
Кроме того, если облачные службы считаются "повышенной или экстремальной угрозой", как описано в [информационном](https://www.apra.gov.au/sites/default/files/information_paper_-_outsourcing_involving_cloud_computing_services.pdf)информационном Апра, финансовое учреждение рекомендуется (но не обязательно) для работы с Апра, независимо от того, предоставлена ли служба в Австралии или за ее пределами.
...
- [Аутсорсинг, включающий облачные службы](https://www.apra.gov.au/sites/default/files/information_paper_-_outsourcing_involving_cloud_computing_services.pdf)
