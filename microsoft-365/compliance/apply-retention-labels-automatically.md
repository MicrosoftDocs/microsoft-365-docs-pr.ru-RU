...
Когда вы создаете автоматически присваиваемые метки хранения для конфиденциальной информации, вы видите тот же список шаблонов политик, что и при создании политики защиты от потери данных (DLP) . Каждый шаблон предварительно настроен на поиск определенных типов конфиденциальной информации. Например, шаблон, показанный здесь, ищет номера ITIN, SSN и паспорта США в категории **Конфиденциальность** и в **шаблоне Персональных данных (PII) конечного пользователя для США**:
...
После сохранения политики автоматического применения необходимо выполнить указанные ниже действия.

1. Нажмите вкладку **Политики меток** > **Публикация меток**

2. Когда будет предложено выбрать метку, выберите ту метку, которую вы создали с помощью запроса по ключевым словам, чтобы найти записи собраний в Teams.
