...
Для этой метки хранения вам необходимо также опубликовать ее в учетных записях OneDrive или на сайтах SharePoint соответствующих пользователей путем создания политики меток. В большинстве случаев записи собраний сохраняются в OneDrive, но записи собраний на каналах сохраняются в SharePoint.

После сохранения политики автоматического применения меток хранения необходимо выполнить указанные ниже действия.

1. Нажмите вкладку **Политики меток** > **Публикация меток**

2. Когда появится запрос на выбор метки, выберите ту же метку, которую вы выбрали для политики автоматического применения, определяющей записи собраний Teams.

3. Когда будет предложено выбрать расположение, выберите **Сайты SharePoint** и **Учетные записи OneDrive**. После этого можно оставить заданное по умолчанию значение **Все** или указать отдельные расположения, например включив или исключив определенные учетные записи OneDrive.

4. Завершите работу мастера и сохраните эту политику меток.
