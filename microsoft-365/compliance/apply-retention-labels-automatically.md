...
>
> - Применение стандартной метки хранения для SharePoint и Outlook, чтобы содержимое без меток помечалось автоматически
...
Чтобы изменить существующую политику автоматического применения меток, выберите ее для запуска мастера изменения политики хранения, позволяющего изменить выбранную метку хранения и [любые доступные параметры](#updating-retention-labels-and-their-policies) на шаге 2.
