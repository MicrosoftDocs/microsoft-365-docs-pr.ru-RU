...
2. Щелкните **Import** \> **PST-файлы импорта**для управления **сведениями** \> .
...
6. На странице " **Импорт PST-файлов** " нажмите кнопку](../media/165fb3ad-38a8-4dd9-9e76-296aefd96334.png) **Обновить** ![обновление. Состояние задания импорта отображается в столбце **состояние** . 
