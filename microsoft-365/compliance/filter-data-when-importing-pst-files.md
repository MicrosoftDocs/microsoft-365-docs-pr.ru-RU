...
2. Щелкните **** \> **PST-файлы импорта**для управления **сведениями** \> .
    
    Задания импорта для Организации перечислены на странице " **Импорт PST-файлов** ". Обратите внимание, что в столбце **состояние** **Завершено значение анализ** указывает, что задания импорта были проанализированы в Office 365 и готовы к импорту. 
