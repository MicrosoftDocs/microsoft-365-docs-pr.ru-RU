...
Корпорация Майкрософт использует [диспетчер распределенных](office-365-bitlocker-and-distributed-key-manager-for-encryption.md) ключей для шифрования секретов в центрах обработки данных Exchange Online. Например:
...
- Ключ клиента. Если вы используете шифрование [службы с ключом](customer-key-overview.md)клиента, вы будете использовать [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/key-vault-whatis) для защиты секретов.
...
[Контроль службы в Центре соответствия &amp; требованиям безопасности](https://go.microsoft.com/fwlink/?linkid=874645)
