...
2. Следуйте указаниям мастера. Если используется управление записями:
    ...
    - Для использования метки хранения, чтобы объявить [запись](records-management.md#records), включите параметр **Пометить элементы как записи**.
...
Чтобы изменить существующую политику меток хранения (тип политики **"Опубликовать**"), выберите ее и нажмите кнопку **Изменить**, чтобы запустить изменение политики хранения. С помощью этого мастера можно изменить описание политики и любые [доступные параметры](#updating-retention-labels-and-their-policies) из шага 2.
