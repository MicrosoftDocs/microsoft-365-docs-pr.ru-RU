...
- Начните использовать оценку GDPR в [диспетчере соответствия требованиям](compliance-manager.md) в рамках программы обеспечения конфиденциальности ККПА.
