...
Все экземпляры Dynamics 365 используют Microsoft SQL Server прозрачное шифрование данных (TDE) для выполнения шифрования данных в [режиме](/sql/relational-databases/security/encryption/transparent-data-encryption) реального времени при написании на диск (в покое). TDE шифрует SQL Server, База данных SQL Azure и Azure SQL хранилища данных. По умолчанию Корпорация Майкрософт сохраняет и управляет ключами шифрования баз данных для экземпляров Dynamics 365. (Ключи, используемые Dynamics 365 для financials, создаются платформа .NET Framework API защиты данных.)
