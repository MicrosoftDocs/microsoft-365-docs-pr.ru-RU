...
Онлайн-сервисы предлагают множество возможностей, позволяющих вам, как контроллеру, отвечать на запрос субъекта данных. Корпоративные онлайн-сервисы Microsoft и средства административного контроля помогают вам обрабатывать личные данные в ответ на запросы прав субъектов данных, позволяя вам обнаруживать, получать доступ, исправлять, ограничивать, удалять и экспортировать личные данные, которые находятся в данных, управляемых контроллером, хранящихся в облаке Microsoft. Онлайн-сервисы также предоставляют данные в машиночитаемой форме, если вам это нужно.
...
- Обработка в широком масштабе специальных категорий персональных данных - данных, раскрывающих расовое или этническое происхождение, политических убеждений и т. П. - или данных, касающихся уголовных приговоров и преступлений;  
...
Microsoft, как процессор, обязана помогать контролерам в обеспечении соответствия требованиям DPIA, изложенным в GDPR. Чтобы поддержать наших клиентов, соответствующие разделы DPIA от Microsoft являются абстрактными и будут предоставляться через этот раздел в будущих обновлениях с целью позволить контроллерам, полагающимся на службы Microsoft, использовать аннотации для создания своих собственных DPIA.
...
Да. GDPR требует, чтобы контроллеры (такие как организации, использующие корпоративные онлайн-сервисы Microsoft) использовали только процессоры (такие как Microsoft), которые предоставляют достаточные гарантии для удовлетворения ключевых требований GDPR. Microsoft предприняла упреждающий шаг, предоставив эти обязательства всем клиентам корпоративного лицензирования в рамках своих соглашений.
...
Условия Microsoft GDPR отражают обязательства, требуемые от процессоров в статье 28. Статья 28 требует, чтобы процессоры обязались:
...
- Помогать контролерам в их обязательствах отвечать на запросы субъектов данных о реализации своих прав на GDPR.
...
Вам нужно будет понять, каковы конкретные обязательства вашей организации перед GDPR и как вы их выполняете, хотя Microsoft здесь, чтобы помочь вам в вашем путешествии GDPR.
...
Персональные данные могут включать, но не ограничиваются ими, сетевые идентификаторы (например, IP-адреса), информацию о сотрудниках, базы данных о продажах, данные обслуживания клиентов, формы обратной связи с клиентами, данные о местоположении, биометрические данные, видеоматериалы CCTV, записи схем лояльности, состояние здоровья, и финансовая информация и многое другое. Он может даже включать информацию, которая не является личной - например, фотографию ландшафта без людей - где эта информация связана с номером счета или уникальным кодом с идентифицируемым лицом. И даже личные данные, которые были псевдонимами, могут быть личными данными, если псевдоним может быть связан с конкретным человеком. 
...
Персональные данные - это любая информация, касающаяся идентифицированного или идентифицируемого лица. Частный, публичный или рабочий характер роли конкретного человека не имеет значения. Личные данные могут включать:
...
Продукты и услуги Microsoft, такие как Azure, Dynamics 365, Enterprise Mobility + Security, Microsoft Office 365 и Windows 10, имеют сегодня доступные решения, которые помогут вам обнаруживать и оценивать угрозы и нарушения безопасности и выполнять обязательства уведомления о нарушениях GDPR.
