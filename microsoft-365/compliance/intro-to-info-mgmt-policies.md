...
ms.custom:
- seo-marvel-apr2020
description: Узнайте, как использовать политики управления сведениями для управления и отслеживания таких действий, как срок сохранения содержимого или действия, которые пользователи могут принять с этим содержимым.
