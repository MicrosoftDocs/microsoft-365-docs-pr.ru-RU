...
ms.custom:
- seo-marvel-apr2020
description: Узнайте, как использовать политики управления информацией для управления и отслеживания таких вещей, как длительное сохранение контента или действия, которые пользователи могут принимать с этим контентом.
