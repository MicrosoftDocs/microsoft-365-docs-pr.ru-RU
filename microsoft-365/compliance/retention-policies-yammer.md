...
> [!NOTE]
> Эта возможность находится на этапе предварительной версии и еще недоступна всем клиентам.
...
На сообщения Yammer не влияют политики хранения, настроенные для почтовых ящиков пользователей или групп. Хотя сообщения Yammer хранятся в Exchange, эти данные Yammer включаются только политикой хранения, настроенной для расположения **сообщений сообществ Yammer** и **сообщений пользователей Yammer**.
...
По умолчанию политика хранения для сообщений пользователей Yammer применяется ко всем пользователям в вашей организации, но она не применяется к внешним пользователям. Политику хранения можно применить к внешним пользователям, использовав **Выбрать пользователя** и уточнив их учетную запись. 
...
- Если нажать **Выбор пользователей** для расположения **Сообщения пользователей Yammer**, могут отображаться гости и пользователи, не входящие в почтовый ящик. Политики хранения не предназначены для этих пользователей, поэтому не выбирайте их.
