...
- При создании новой учетной записи пользователя и назначении пользователю лицензии Exchange Online почтовый ящик автоматически создается для пользователя. После создания почтового ящика ему автоматически назначена политика хранения по умолчанию с именем MrM Policy по умолчанию. В этой статье вы создайте новую политику хранения, а затем назначите ее почтовым ящикам пользователей, заменив политику MRM по умолчанию. В почтовом ящике может быть назначена только одна политика хранения.

- Дополнительные дополнительные новости о тегах хранения и политиках хранения в Exchange Online см. в дополнительных тегах хранения [и политиках хранения.](https://go.microsoft.com/fwlink/p/?LinkId=404424)
...
Чтобы создать новые теги хранения, вы будете использовать центр администрирования Exchange (EAC) в организации Exchange Online. Обязательно используйте классическую версию EAC.
...
2. На странице Новый тег, автоматически применяемый на всю страницу почтового ящика **(по умолчанию),** выполните следующие поля: 
    ...
    ![Параметры создания нового тега политики по умолчанию архива](../media/41c0a43c-9c72-44e0-8947-da0831896432.png)
...
2. На странице Новый тег, автоматически применяемый на всю страницу почтового ящика **(по умолчанию),** выполните следующие поля: 
    ...
    ![Параметры для создания нового тега политики политики удаления по умолчанию](../media/f1f0ff62-eec9-4824-8e7c-d93dcfb09a79.png)
...
2. На **теге New, который автоматически применяется к странице** папки по умолчанию, выполните следующие поля:
    ...
    ![Параметры создания нового тега политики хранения для папки "Удаленные элементы"](../media/6f3104bd-5edb-48ac-884d-5fe13d81dd1d.png)
...
После применения новой политики хранения к почтовым ящикам в шаге 4 в Exchange Online может занять до 7 дней, чтобы новые параметры хранения были применены к почтовым ящикам. Это вызвано тем, что процесс, называемый *помощником управляемых* папок, обрабатывает почтовые ящики по крайней мере один раз в 7 дней. Вместо ожидания запуска помощника управляемых папок вы можете заставить это сделать, заняв в Exchange Online PowerShell комдлет **Start-ManagedFolderAssistant.**
