...
На этом этапе мы создадим три пользовательских тега хранения, которые были описаны ранее.
...
2. На странице **"Новый тег", автоматически применяемом** к папке по умолчанию, заполните следующие поля:
   ...
   4. **Период хранения** Выберите, **когда элемент достигнет следующего возраста (в днях)** и введите срок хранения. В этом сценарии элементы удаляются через 1825 дней (5 лет).
...
После создания пользовательских тегов хранения необходимо создать новую политику хранения и добавить теги хранения. Вы добавим три пользовательских тега хранения, созданных на шаге 2, и встроенные теги, упомянутые в первом разделе. На шаге 4 вы назначите эту новую политику хранения почтовым ящикам пользователей.
...
4. В **тегах хранения щелкните** **значок "Добавить** ![ новый". ](../media/457cd93f-22c2-4571-9f83-1b129bcfb58e.gif)
...
5. На странице **"Массовое** назначение  политики хранения" в выпадаемом списке "Выберите политику хранения" выберите политику хранения, созданную на шаге 3; например, политика **архива и хранения в 1993 г.**
...
Вот и все! Вы настроили политику архивации и удаления для организации "Регина-муйла".
...
3. Запустите следующую команду, чтобы назначить новую политику хранения, созданную на шаге 3 (например, "Архив и политика хранения в Евлийском архиве и политике хранения"), плану почтового ящика по умолчанию. В этом примере предполагается, что план почтового ящика по умолчанию называется **ExchangeOnlineEnterprise.**
