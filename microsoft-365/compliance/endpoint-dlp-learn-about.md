...
### <a name="viewing-endpoint-dlp-data"></a>Просмотр данных защиты от потери данных в конечной точке
 ...
 Защита от потери данных в конечной точке зависит от типа MIME, поэтому действия будут записываться даже при изменении расширения файла. В общедоступной предварительной версии просматривается все:
