...
Несмотря на то, что анализ данных помогает выполнить процесс с помощью последующих этапов на разных этапах, он также позволяет переходить между вкладками и страницами, а также предоставлять варианты, которые могут относиться к конкретным ситуациям, проблемам или процессам рецензирования документов. 
