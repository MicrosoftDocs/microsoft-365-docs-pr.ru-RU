...
ms.locfileid: "51580622"
---
# <a name="employee-quick-setup"></a>Быстрая настройка для сотрудника

Вы впервые в Microsoft 365 для бизнеса? :::image type="icon" source="../media/video-call-icon.png" border="false":::[Просмотрите это видео,](https://support.microsoft.com/office/d6466f0d-5d13-464a-adcb-00906ae87029) чтобы узнать об этом. Затем выполните указанные ниже действия.
...
1. Введите электронную почту и пароль Microsoft 365, а затем **введите**.

## <a name="2-download-and-install-office-apps"></a>2. Загрузка и установка приложений Office
...
## <a name="6-get-outlook-on-your-phone"></a>6. Получить Outlook на телефоне
...
- На **телефоне Windows выберите** **Параметры**, Электронная почта **+ учетные** записи , **Добавить учетную** запись, а затем **Exchange**.