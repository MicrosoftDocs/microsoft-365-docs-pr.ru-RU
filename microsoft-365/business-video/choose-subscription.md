...
Выбор правильной подписки на Microsoft 365 — ключ к большей части использования службы. Здесь&#39;, как сравнить параметры и выбрать план,&#39;для вашей компании.
...
| **Защита от угроз** | Office 365 Advanced Threat Protection | Нет | Да | Нет |
 | Принудительных операций Windows Exploit Guard | Нет | Да | Нет |
...
Сравнение Microsoft 365 бизнес премиум с другими продуктами, в том [](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/licensing-microsoft-365-in-smb)числе другими планами Microsoft 365, см. в этой теме.