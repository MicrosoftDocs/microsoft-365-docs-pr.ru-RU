...
1. Просмотрите параметры и настройте их по мере необходимости. Например, вы можете настроить текст **электронной** почты и текст **подсказки политики.** Нажмите **Сохранить**.
