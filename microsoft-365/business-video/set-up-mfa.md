...
1. В **шаге 1** выберите **мобильное приложение** в выпадаемом списке телефона проверки подлинности. 
...
1. В Authenticator следуйте запросам, чтобы завершить мастер, а затем выберите знак плюса (+), чтобы добавить свою учетную запись.
