...
Теперь, когда защита на месте, вы не сможете открыть вредоносный файл из Outlook, OneDrive, SharePoint или Teams. Затронутые файлы будут иметь красные экраны рядом с ними. Если кто-то по пытается открыть заблокированный файл, он получит предупреждение.

После того как политика была на месте в течение некоторого времени, посетите страницу отчетов, чтобы узнать, что было сканировано.