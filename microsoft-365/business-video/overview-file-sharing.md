...
|![Безопасное совместное](../media/securely-share-file.png)<br/>[Поделиться файлом с кем-либо за пределами вашей компании](#share-a-file-with-someone-outside-of-your-company)|![Сотрудничество с клиентом](../media/share-and-collab-with-partner.png) <br/>[Совместное взаимодействие с клиентом или бизнес-партнером](#share-and-collaborate-with-a-client-or-business-partner) | ![Делиться в организации](../media/share-inside-your-org.png) <br/>[Совместное работы в компании](#share-inside-your-business) |
|--|--|--|

## <a name="share-a-file-with-someone-outside-of-your-company"></a>Поделиться файлом с кем-либо за пределами вашей компании

- Поделитесь файлом с кем-то за пределами вашей компании (например, клиентом или клиентом) по электронной почте, если он нужен только в одном из способов.
...
Если вы работаете с файлами, которые вы делитесь в своей компании, также имеется хорошая идея настроить команду в Microsoft Teams. Делитесь файлами там, и все в вашей компании могут легко найти и изменить их, и вы знаете, что все работаете на одной странице.
