...
Многофакторная проверка подлинности (MFA) или двухэтапная проверка подлинности требует, чтобы перед доступом к ресурсам была представлена вторая форма проверки подлинности, например код проверки подлинности.  
...
Расширенные функции управления устройствами Microsoft 365 бизнес премиум позволяет отслеживать и контролировать возможности пользователей с зарегистрированными устройствами. Эти функции включают условный доступ, управление мобильными устройствами (MDM), BitLocker и автоматические обновления.
