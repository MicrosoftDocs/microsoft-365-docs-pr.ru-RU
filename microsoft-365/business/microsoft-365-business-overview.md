...
- Выполнение расширенных анализов вложений электронной почты в песочнице для обнаружения новых вредоносных программ (безопасных вложений). 

- Включение политик защиты от фишинга, включающих модели машинного обучения и обнаружение подмикширования для защиты от расширенных атак (защита от фишинга в Защитнике для аналитики Office 365). 
