...
- Настройка расширенных политик, которые отключают доступ из ненадежных расположений или обходят многофакторную проверку подлинности из надежных мест, таких как Office Network (многофакторная проверка подлинности Azure, включая доверенные IP-адреса и условный доступ). 
