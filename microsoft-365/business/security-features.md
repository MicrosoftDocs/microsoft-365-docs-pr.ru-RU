...
- **[Защитник Майкрософт для Office 365](https://docs.microsoft.com/microsoft-365/security/office-365-security/office-365-atp)**
    ...
    Защитник Майкрософт для Office 365 помогает защитить бизнес от атак с помощью изощренных фишинговых атак и атак от атак через атаку, которые предназначены для нарушения безопасности сотрудников или сведений о клиентах. Поддерживаются перечисленные ниже возможности. 
