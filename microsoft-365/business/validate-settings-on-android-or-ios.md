...
3. Нажмите кнопку **Сброс ПИН-кода**. Вам будет предложено войти в систему, используя учетные данные пользователя Microsoft 365, а затем указать новый ПИН-код.
...
3. Нажмите кнопку **ОК**. Вам будет предложено войти в систему, используя учетные данные пользователя Microsoft 365, а затем указать новый ПИН-код.
...
3. У вас должен быть только один вариант  OneDrive для бизнеса. В противном случае нажмите кнопку **Добавить учетную запись** и выберите **OneDrive для бизнеса** в окне **Добавление учетной записи хранения** . При появлении соответствующего запроса укажите учетные данные пользователя Office 365 бизнес для входа. 
