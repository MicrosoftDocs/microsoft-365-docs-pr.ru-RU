...
Следуйте инструкциям в следующих разделах, чтобы проверить параметры защиты приложений на устройствах с Android или iOS.
...
Сначала убедитесь, что политика применяется к приложению, в котором вы собираетесь проверить ее.
  
1. В Центре администрирования Microsoft 365 бизнес [премиум](https://portal.office.com)перейдите **в** политику изменения \> **политик.**
    
2. Выберите **политику приложений для Android** для параметров, созданных при установке, или другую политику, которую вы создали, и убедитесь, что она применена к Outlook, например. 
...
1. На устройстве пользователя с Android откройте Outlook и во sign in с помощью учетных данных Microsoft 365 бизнес премиум пользователя.
    
2. Вам также будет предложено ввести ПИН-код или использовать отпечаток пальца.
...
В  области "Изменение политики" выберите "Изменить рядом с управлением доступом к документам **Office",**"Управление доступом пользователей к файлам **Office** на мобильных устройствах" и убедитесь, что для сброса **ПИН-кода** после количества неудачных попыток установлено определенное число.  По умолчанию это значение 5. 
  
1. На устройстве пользователя с Android откройте Outlook и во sign in с помощью учетных данных Microsoft 365 бизнес премиум пользователя.
    
2. Введите неправильный ПИН-код указанное в политике количество раз. Вы увидите запрос с состоянием ограничения **попыток ПИН-кода** для сброса ПИН-кода. 
    
    ![After too many incorrect PIN attempts, you need to reset your PIN.](../media/fca6fcb4-bb5c-477f-af5e-5dc937e8b835.png)
  
3. Нажмите кнопку **Сброс ПИН-кода**. Вам будет предложено войти с помощью учетных данных Microsoft 365 бизнес премиум пользователя, а затем потребуется установить новый ПИН-код.
...
1. На устройстве пользователя с Android откройте Outlook и войдите с учетными данными Microsoft 365 бизнес премиум пользователя и введите ПИН-код при запросе.
...
2. Откройте сообщение электронной почты с вложением и коснитесь значка со стрелкой вниз рядом со сведениями о вложении.
    ...
    Вы увидите, что не **удается сохранить** устройство в нижней части экрана. 
...
В  области "Изменение политики" выберите "Правка рядом с управлением доступом к документам **Office",**"Управление доступом пользователей к файлам **Office** на мобильных устройствах" и убедитесь, что после простоя приложений **Office** пользователям требуется несколько минут.  По умолчанию это значение составляет 30 минут. 
...
3. Снова доступ к Outlook на устройстве с Android.
...
2. Выберите политику приложений для **iOS** для параметров, созданных при установке, или другую политику, которую вы создали, и убедитесь, что она применена, например, для Outlook. 
...
1. На устройстве пользователя с iOS откройте Outlook и во sign in с помощью учетных данных Microsoft 365 бизнес премиум пользователя.
...
3. Нажмите кнопку **ОК**. Вам будет предложено войти с помощью учетных данных Microsoft 365 бизнес премиум пользователя, а затем потребуется установить новый ПИН-код.
...
1. На устройстве пользователя с iOS откройте Outlook и войдите с учетными данными Microsoft 365 бизнес премиум пользователя и введите ПИН-код при запросе.
...
3. У вас должен быть только один вариант  OneDrive для бизнеса. Если нет, **коснитесь "Добавить учетную** запись" и выберите **OneDrive** для бизнеса на экране **"Добавление учетной** записи хранения". Предопишите пользователю Microsoft 365 бизнес премиум, чтобы он вошел в учетную запись при запросе. 
...
3. Снова доступ к Outlook на устройстве с iOS.
