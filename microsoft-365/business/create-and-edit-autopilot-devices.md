...
1. В центре администрирования Microsoft 365 **устройства** \> **autoPilot**.
...
1. На странице **Подготовка Windows** выберите вкладку **Devices** и выберите контрольный ящик рядом с одним или более устройствами. 
