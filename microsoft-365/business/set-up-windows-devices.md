...
6. Убедитесь, что на странице **ваша организация** указана правильная информация, и нажмите кнопку **присоединиться** .
   ...
   На странице **Готово!** страница, чоссе **выполнена** .
...
Чтобы проверить состояние синхронизации, на странице " **Рабочий или учебный доступ** " в разделе **Параметры** нажмите кнопку **подключено к** _ \<organization name\> _ области, чтобы отобразить **сведения о** кнопках и **Отключить** ее. Выберите **сведения** , чтобы получить состояние синхронизации. 
  
На странице **состояние синхронизации** нажмите кнопку **синхронизировать** , чтобы получить последние политики управления мобильными устройствами на компьютер.
...
## <a name="verify-the-pc-is-upgraded-to-windows-10-business"></a>Проверка того, что компьютер обновлен до Windows 10 Корпоративная

Убедитесь, что ваши устройства с Windows 10, подключенные к Azure AD, обновлены до Windows 10 бизнес в рамках вашей подписки на Microsoft 365 Business Premium.
