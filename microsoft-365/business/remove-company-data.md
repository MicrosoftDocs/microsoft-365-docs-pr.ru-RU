...
2. В левом nav выберите **Управление** \> **устройствами.**  
  
3. На странице **Управление** выберите или ищите пользователя, который должен удалить данные, и выберите имя. 
    
4. На следующей области выберите устройство или устройства из списка **Устройств.** На открываемой области устройства можно сбросить устройство в заводские параметры или удалить данные компании в зависимости от типа устройства. 
    
    ![На области удаления данных компании выберите устройство, с которого необходимо удалить данные.](../media/resetorremove.png)
  
5. На области подтверждения выберите **Подтвердить** \> **закрыть**.
