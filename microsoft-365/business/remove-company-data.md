...
2. В центре администрирования на карточке **Действия устройств** выберите команду **Удаление данных компании**.
    
    ![On the Devices card, choose Remove company data](media/b6fcf74b-0d7d-4e1a-894f-40f9d4a215b8.png)
  
3. На панели **Удаление данных компании** выберите (или найдите с помощью функции поиска) пользователя, данные которого нужно удалить. 
