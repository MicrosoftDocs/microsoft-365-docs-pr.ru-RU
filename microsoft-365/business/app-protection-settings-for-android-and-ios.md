...
6. Next decide **Who will get these settings?** Если вы не хотите использовать группу безопасности " **все пользователи** ", нажмите кнопку **изменить**, выберите группы безопасности, которые получают эти параметры \> **Select**.
