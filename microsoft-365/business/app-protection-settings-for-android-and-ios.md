...
1. Войдите в [центр администрирования Microsoft 365 Business](https://go.microsoft.com/fwlink/p/?linkid=837890) с учетными данными глобального администратора. 
    
2. В центре администрирования выберите **политики** \> **устройств** \> **Добавить политику**.
