...
Вы можете использовать профили АвтоПилота для управления Windows установлен на устройствах пользователей. Эти профили содержат описанные ниже параметры.
  
 **Автоматически задаваемы функции по умолчанию AutoPilot:**
  
|**Параметр**|**Описание**|
|:-----|:-----|
|Пропустить регистрацию кортаны, OneDrive и OEM  <br/> |Пропускает установку потребительских приложений, таких как Кортана и личные OneDrive. Пользователь устройства может установить их позже, если пользователь является локальным администратором на устройстве. Оригинальная регистрация производителя пропускается, так как устройство будет управляться Microsoft 365 бизнес премиум.  <br/> |
|Интерфейс входа с фирменной символикой компании  <br/> |Если в вашей компании есть страница Добавить брендинг [Microsoft 365,](../admin/setup/customize-sign-in-page.md)пользователь устройства получит этот опыт при входе.  <br/> |
|Автоматическая регистрация в службе управления мобильными устройствами с использованием настроенных учетных записей AAD  <br/> |Идентификатор пользователя будет управляться Azure Active Directory, и пользователи будут Windows и Microsoft 365 с Microsoft 365 бизнес премиум учетными данными.  <br/> |
