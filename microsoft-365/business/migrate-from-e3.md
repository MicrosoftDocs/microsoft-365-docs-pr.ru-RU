...
| Менеджер по клиентам Outlook, MileIQ    | ![Включено с Microsoft 365 Бизнес Премиум](../media/check-mark.png)    | | 
| **Защита от угроз**        | | | 
...
|Azure Information Protection Plan 1, bitlocker enforcement|![Включено с Microsoft 365 Бизнес Премиум](../media/check-mark.png)||
