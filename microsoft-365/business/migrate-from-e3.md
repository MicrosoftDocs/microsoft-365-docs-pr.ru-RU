...
<sup>1</sup> в Microsoft 365 бизнес версия приложений Office не включает активацию корпоративных лицензий с помощью групповой политики, телеметрии приложений, элементов управления обновления, сравнения и запроса электронной таблицы, а также бизнес-аналитики.

## <a name="migration"></a>Миграция

Чтобы перенести подписку, ознакомьтесь [со статьей переходить к другому плану вручную](https://docs.microsoft.com/office365/admin/misc/switch-plans-manually) для получения инструкций, если вы хотите переместить всего нескольких пользователей в Microsoft 365 бизнес, вы можете [обновить его автоматически](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/upgrade-to-different-plan)или с партнером для переноса E3 подписки и лицензии на Microsoft 365 Business Subscription.
...
Если вы обновили всех пользователей в Организации до Microsoft 365 Business, вы увидите мастер настройки на домашней странице, а также можете воспользоваться инструкциями по [настройке Microsoft 365 для бизнеса в мастере установки](set-up.md) , чтобы защитить файлы и мобильные устройства.
