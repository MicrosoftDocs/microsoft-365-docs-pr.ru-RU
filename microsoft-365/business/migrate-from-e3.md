...
Microsoft 365 бизнес премиум имеет все необходимое для вашего малого бизнеса, сочетая лучшие в своем классе приложения с облачной производительностью с простым управлением устройствами и безопасностью. Если у вас в настоящее время Office 365 подписка на E3, но не более 300 сотрудников, рассмотрите возможность Microsoft 365 бизнес премиум дополнительных функций безопасности.
...
### <a name="office-365-e3-subscription-configuration-and-data"></a>Office 365 Конфигурация и данные подписки на E3
...
> [!NOTE]
> Если вы Office 365 политики и устройства MDM, эти устройства будут перечислены на странице **Устройства** в центре администрирования Microsoft 365 администратора. Все политики, которые вы создали, будут показываться в списке классических политик на портале [Intune.](https://portal.azure.com/#blade/Microsoft_Intune_DeviceSettings/ExtensionLandingBlade/overview)
