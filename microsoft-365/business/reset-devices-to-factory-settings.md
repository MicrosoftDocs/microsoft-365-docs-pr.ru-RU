...
2. В центре администрирования на карточке **Действия устройств** выберите команду **Сброс до заводских настроек**.
    
    ![On the Device actions card, choose Factory reset](media/7caddd12-207e-4c99-b61c-0495fc5f55e3.png)
  
3. На панели **Сброс до заводских настроек** установите флажок рядом с устройством, с которого хотите удалить данные, и нажмите кнопку **Выбрать**.
