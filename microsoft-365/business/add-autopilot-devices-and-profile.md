...
3. На странице **"Отправка CSV-файла** со списком устройств" перейдите к расположению, где вы подготовили файл. CSV-файл, а затем **откройте** \> **следующий файл.** Файл должен иметь три загона:
