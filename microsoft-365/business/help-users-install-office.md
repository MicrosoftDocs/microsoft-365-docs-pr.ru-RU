...
1. Перейдите в центр администрирования <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">https://admin.microsoft.com</a> и войдите в систему с учетными данными глобального администратора. 

2. В левой панели навигации перейдите к разделу **Настройка** , а затем на странице **Настройка** перейдите к разделу **приложения и обновления**.
    > [!NOTE]
    > Если все пользователи установили приложения Office, вы можете видеть эту карточку.
  
3. В **справке пользователи устанавливают свои карточки приложений Office** , нажмите кнопку **Просмотреть** , а затем **приступите к работе**.
