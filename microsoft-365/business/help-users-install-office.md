...
2. Перейдите к разделу **Настройка** в левой области навигации, а затем на странице **Настройка** перейдите к разделу **приложения и обновления**.
    > [!NOTE]
    > Эта карточка может не отображаться, если все пользователи установили приложения Office.
  
3. В **справке пользователи устанавливают свои карточки приложений Office** , нажмите кнопку **Просмотреть**, а затем приступайте к **работе**.
