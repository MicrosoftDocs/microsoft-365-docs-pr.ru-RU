...
| Самостоятельный сброс паролей для гибридных учетных записей Azure Active Directory (Azure AD), служба Azure Multi-Factor Authentication (MFA), условный доступ, обратная запись пароля для локальных удостоверений|    ![Входит в состав Microsoft 365 Business](./media/check-mark.png) | ![Входит в состав Microsoft 365 E3](./media/check-mark.png) | 
...
| Единый вход для приложений Azure AD Office 365 (SSO): 10 приложений на пользователя (приложения коллекции, такие как Salesforce) * | ![Входит в состав Microsoft 365 Business](./media/check-mark.png) | ![Входит в состав Microsoft 365 E3](./media/check-mark.png) | 
...
| Microsoft Intune, Windows для автопилота|  ![Входит в состав Microsoft 365 Business](./media/check-mark.png) | ![Входит в состав Microsoft 365 E3](./media/check-mark.png) | 
|Доступ к виртуальному рабочему столу (вда)   |  |    ![Входит в состав Microsoft 365 E3](./media/check-mark.png) | 
|Виртуальный рабочий стол Windows (ВВД)  | ![Входит в состав Microsoft 365 Business](./media/check-mark.png) |     ![Входит в состав Microsoft 365 E3](./media/check-mark.png) | 
|Активация на общем компьютере (SCA)   | ![Входит в состав Microsoft 365 Business](./media/check-mark.png) |     ![Входит в состав Microsoft 365 E3](./media/check-mark.png) | 
...
Для миграции свяжитесь с вашим партнером, чтобы перенести Microsoft 365 бизнес-подписку и лицензии на подходящую подписку Microsoft 365 E3 с лицензиями.
