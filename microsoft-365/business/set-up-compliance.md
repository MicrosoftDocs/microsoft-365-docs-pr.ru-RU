...
В разделе [Создание политики защиты от потери данных в шаблоне](https://docs.microsoft.com/microsoft-365/compliance/create-a-dlp-policy-from-a-template) приведен пример того, как настроить политику защиты от потери персональных данных. 
...
Чтобы настроить метки конфиденциальности, просмотрите видео [Создание меток о конфиденциальности и управление ими](https://support.microsoft.com/office/2fb96b54-7dd2-4f0c-ac8d-170790d4b8b9) .
