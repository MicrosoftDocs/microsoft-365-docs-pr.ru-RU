...
||**Базовая линия (Общедоступная)**|**Базовая линия (Частная )**|**Конфиденциально**|**Строго конфиденциальный**|
|:-----|:-----|:-----|:-----|:-----|
...
|Тип ссылки для общего доступа по умолчанию|**Только люди в вашей организации**|**Только люди в вашей организации**|**Определенные пользователи**|**Пользователи с существующим доступом**|
