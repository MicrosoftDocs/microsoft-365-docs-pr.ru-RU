...
---
# <a name="step-2-optimal-networking-for-your-microsoft-365-for-enterprise-tenants"></a>Этап 2. Оптимальная сеть для Microsoft 365 для корпоративных клиентов
...
- Использование сетевых Аналитика для разработки периметра сети для расположения офисов.
...
## <a name="using-network-insights-preview"></a>Использование сетевых Аналитика (предварительный просмотр)
...
> [!IMPORTANT]
> Сведения о сети, рекомендации по производительности и оценки в центре Microsoft 365 Admin в настоящее время находятся в состоянии предварительного просмотра. Он доступен только для Microsoft 365, которые были зарегистрированы в программе предварительного просмотра функций.

Дополнительные сведения см. [в Microsoft 365 Network Аналитика.](../enterprise/office-365-network-mac-perf-insights.md)
...
- Использование сетевых Аналитика
