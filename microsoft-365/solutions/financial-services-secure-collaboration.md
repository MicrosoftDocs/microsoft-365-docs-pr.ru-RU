...
Будучи партнером Microsoft, Protiviti внесла свой вклад и предоставила материал обратной связи для этой статьи.

## <a name="empower-organizational-and-employee-productivity-by-using-microsoft-365-and-teams"></a>Повышение производительности труда сотрудников и организаций с помощью Microsoft 365 и команд
...
Teams обеспечивают центр сотрудничества для организации. Это помогает объединить людей для продуктивной работы над общими инициативами и проектами. Teams позволяют членам команды вести беседы в формате 1:1 и многопартийные чаты, совместно работать над соавторами документов, а также хранить и обмениваться файлами. Teams также облегчают онлайн-встречи благодаря интегрированной корпоративной голосовой и видео Teams также можно настраивать с помощью приложений Microsoft, таких как Microsoft Planner, Microsoft Dynamics 365, PowerApps, PowerBI и сторонних бизнес-приложений. Teams предназначены для использования как внутренними членами команды, так и разрешенными внешними пользователями, которые могут присоединяться к каналам команды, участвовать в беседах в чате, получать доступ к сохраненным файлам и использовать другие приложения.

Каждая команда Microsoft поддерживается группой Office 365. Эта группа считается службой членства для многочисленных служб Office 365, включая Teams. Группы Office 365 используются для безопасного разграничения между «владельцами» и «участниками» и для контроля доступа к различным возможностям в Teams. В сочетании с соответствующими средствами управления и регулярно проводимыми проверками доступа, Teams позволяют только членам и владельцам использовать авторизованные каналы и возможности.
...
Другой распространенный сценарий - использование Teams в качестве «виртуальной комнаты данных» для безопасной совместной работы, хранения и управления документами. Члены команды и синдикаты в инвестиционных банках, компаниях по управлению активами или частных акционерных компаниях могут безопасно сотрудничать в сделке или инвестициях. Межфункциональные группы часто участвуют в планировании и выполнении таких сделок, и возможность безопасного обмена данными и ведения бесед является ключевым требованием. Надежный обмен соответствующими документами с внешними инвесторами также является ключевым требованием. Teams предоставляют безопасное и полностью проверяемое место для централизованного хранения, защиты и обмена инвестиционными данными.
...
### <a name="teams-improve-collaboration-and-reduce-compliance-risk"></a>Teams: улучшить сотрудничество и снизить риск соответствия

Microsoft 365 предоставляет другим групповым возможностям политики за счет использования групп Office 365 в качестве базовой службы членства. Эти политики могут помочь улучшить сотрудничество и удовлетворить требования соответствия.

**Политики именования групп в Office 365** гарантируют, что группы Office 365 и, следовательно, группы будут именоваться в соответствии с корпоративной политикой. Имена могут быть проблематичными, если они не подходят. Например, сотрудники могут не знать, с какими командами работать или обмениваться информацией, если имена не применяются соответствующим образом. Политики именования групп (включая поддержку политик на основе префиксов / суффиксов и пользовательских заблокированных слов) могут обеспечивать соблюдение правил гигиены и предотвращать использование определенных слов, таких как зарезервированные слова или неправильная терминология.
  
**Политики истечения срока действия групп Office 365** гарантируют, что группы и группы Office 365 не будут храниться в течение более длительных периодов времени, чем организация хочет или нуждается. Эта возможность помогает предотвратить две ключевые проблемы управления информацией:
...
Администраторы могут указать срок действия для групп Office 365, например 90, 180 или 365 дней. Если служба, поддерживаемая группой Office 365, неактивна в течение срока действия, владельцы группы получают уведомление. Если никаких действий не предпринимается, группа Office 365 и все связанные с ней службы, включая Teams, удаляются.
  
Чрезмерное хранение данных, хранящихся в Teams и других групповых услугах, может представлять риск для организаций, оказывающих финансовые услуги. Политики истечения срока действия групп Office 365 - это рекомендуемый способ предотвратить сохранение ненужных данных. В сочетании со встроенными метками хранения и политиками Microsoft 365 помогает организациям сохранять только те данные, которые необходимы для соблюдения корпоративных политик и обязательств по соблюдению нормативных требований.
...
Выводы и наблюдения FINRA в отношении цифровых коммуникаций напрямую связаны со способностью организации соблюдать правило [SEC Rule 17a-4](https://www.law.cornell.edu/cfr/text/17/240.17a-4) для сохранения всех сообщений, связанных с бизнесом, правила [3110](https://www.finra.org/rules-guidance/rulebooks/finra-rules/3110)и [3120](https://www.finra.org/rules-guidance/rulebooks/finra-rules/3120)FINRA для контроля и анализа сообщений, а также правило [4510](https://www.finra.org/rules-guidance/rulebooks/finra-rules/4510)для ведения учета. Комиссия по торговле товарными фьючерсами (FTC) обнародует аналогичные требования в соответствии с 17 CFR 131. Эти правила подробно обсуждаются далее в этой статье.
...
*  [Windows Hello](https://docs.microsoft.com/windows/security/identity-protection/hello-for-business/hello-overview): для работы на ПК мы рекомендуем использовать Windows Hello. Для автоматического входа используется биометрическая информация (например, лицо или отпечаток пальца).  
* [Ключи безопасности FIDO2](https://docs.microsoft.com/windows/security/identity-protection/hello-for-business/microsoft-compatible-security-key) теперь доступны у нескольких партнеров Microsoft: Yubico, Feitian Technologies и HID Global в виде USB, NFC-совместимого значка или биометрического ключа.
...
### <a name="communication-compliance"></a>Соответствие коммуникациям
