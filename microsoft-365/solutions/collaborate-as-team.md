...
3. На панели **Общие сведения**, нажмите**Внешние удостоверения**.
4. В области **удостоверения Организации** щелкните **Параметры внешние параметры совместной работы**.
...
2. В центре администрирования SharePoint в области навигации слева разверните узел **политики** и выберите **общий доступ**.
