...
description: Используйте эти иллюстрации, например схему архитектуры Teams, чтобы понять основы архитектуры для реализации решений по производительности Microsoft 365.
ms.author: samanro
author: samanro
manager: bcarter
ms.audience: ITPro
...
ms.locfileid: "52029095"
---
# <a name="microsoft-365-productivity-illustrations"></a>Иллюстрации повышения производительности в Microsoft 365

Серия корпоративных решений Microsoft 365 предоставляет рекомендации по реализации возможностей Microsoft 365, особенно в тех случаях, когда возможности пересекаются с технологиями, включая схемы архитектуры Teams.
...
На этой иллюстрации содержатся сведения для ИТ-архитекторов о Microsoft 365 Groups. Чтобы узнать о настройке и администрировании групп и групп Microsoft 365 для совместной работы в организации, см. в этой ссылке Настройка безопасного взаимодействия с [Microsoft 365](/microsoft-365/solutions/setup-secure-collaboration-with-teams) и управление совместной [деятельностью?](/microsoft-365/solutions/collaboration-governance-overview).
...
Корпорация Майкрософт предоставляет средства для переноса локального сетевого файла и сайтов SharePoint Server в Microsoft 365 с акцентом на защиту и обеспечение безопасности контента во время миграции. В этом наборе иллюстраций показано, какие методы можно использовать для перемещения контента в SharePoint, Teams и OneDrive, а также способы перемещения данных в процессе. 

| Элемент | Описание |
|:-----|:-----|
|[![Плакат модели: миграция в Microsoft 365](../media/solutions-architecture-center/msft-migration-thumb.png)](https://download.microsoft.com/download/0/5/b/05b7fb7c-1557-4ebb-9036-c5fc3a4cd94c/Migration-posters-mm-spmt.pdf) <br/> [Скачивание в формате PDF](https://download.microsoft.com/download/0/5/b/05b7fb7c-1557-4ebb-9036-c5fc3a4cd94c/Migration-posters-mm-spmt.pdf) \| [Скачать в качестве visio](https://download.microsoft.com/download/0/5/b/05b7fb7c-1557-4ebb-9036-c5fc3a4cd94c/Migration-posters-mm-spmt.vsdx)   <br/> Обновлено в марте 2021 г. |Содержимое: <ul><li>  Миграция совместной файловой папки</li><li>Миграция SharePoint Server </li> </ul><br> Дополнительные сведения см. в [материалах Migrate your content to Microsoft 365.](/sharepointmigration/migrate-to-sharepoint-online)|
...
Безопасность и защита информации для организаций с несколькими регионами с одним клиентом Microsoft 365
...
## <a name="microsoft-defender-for-endpoint-deployment-strategy"></a>Стратегия развертывания Microsoft Defender для конечной точки
...
Рекомендуемые возможности для защиты удостоверений и устройств с доступом к Microsoft 365, другим службам SaaS и локальному приложению, опубликованным с помощью прокси-сервера Azure AD Application.
...
## <a name="advanced-ediscovery-architecture-in-microsoft-365"></a>Архитектура расширенных электронных данных в Microsoft 365

Расширенный рабочий процесс и поток данных, в том числе в среде Microsoft 365 Multi-Geo. 

| Элемент | Описание |
|:-----|:-----|
|[![Плакат модели: архитектура расширенных электронных данных в Microsoft 365](../media/solutions-architecture-center/ediscovery-poster-thumb.png)](../media/solutions-architecture-center/m365-advanced-ediscovery-architecture.png) <br/> [Представление как изображение](../media/solutions-architecture-center/m365-advanced-ediscovery-architecture.png) \| [Скачивание в формате PDF](https://download.microsoft.com/download/d/1/c/d1ce536d-9bcf-4d31-b75b-fcf0dc560665/m365-advanced-ediscovery-architecture.pdf) \| [Скачать в качестве visio](https://download.microsoft.com/download/d/1/c/d1ce536d-9bcf-4d31-b75b-fcf0dc560665/m365-advanced-ediscovery-architecture.vsdx)   <br/> Обновленный октябрь 2020 г.|Содержимое: <ul><li>  Конечный рабочий процесс в одной среде</li><li>Конечный рабочий процесс в среде Microsoft 365 Multi-Geo </li><li>Конечный поток данных, поддерживающих рабочий процесс EDRM</li> |
...
Дополнительные сведения см. в статье для этого плаката: [Empower remote workers with Microsoft 365](empower-people-to-work-remotely.md).

## <a name="microsoft-teams-with-security-isolation"></a>Microsoft Teams с изолированностью безопасности

С помощью Microsoft 365 можно настроить частную команду в Microsoft Teams и использовать параметры безопасности сайта SharePoint и уникальную метку конфиденциальности для шифрования файлов, чтобы только члены группы могли расшифровать их.
