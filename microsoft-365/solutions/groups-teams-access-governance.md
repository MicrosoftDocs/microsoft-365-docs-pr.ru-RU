...
|Условный доступ|||
||Многофакторная проверка подлинности|[Многофакторная проверка подлинности Azure](https://docs.microsoft.com/azure/active-directory/authentication/concept-mfa-howitworks)|
...
- [Многофакторная проверка подлинности Azure](https://docs.microsoft.com/azure/active-directory/authentication/concept-mfa-howitworks)
