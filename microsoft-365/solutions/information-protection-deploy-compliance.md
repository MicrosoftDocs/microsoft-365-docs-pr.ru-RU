...
После выполнения спецификаций оценки и проверки соответствия требованиям в диспетчере соответствия требованиям вы можете перейти к средству [оценки соответствия требованиям](../compliance/working-with-compliance-score.md) и проанализировать баллы и срез, а также костей данных, включая область управления.
