...
| Управление внутренними рисками |  Выявление и анализ вредоносных и непреднамеренных действий в организации и принятие мер соответствующих мер. В Microsoft 365 такие действия можно определить даже в том случае, если сотрудник использует устройство, не входящее в число управляемых. | Microsoft 365 E5 или Microsoft 365 E3 с дополнениями для контроля соответствия требованиям или управления внутренними рисками |
||||
