...
12. В колонке **Клиентские приложения** установите переключатель **Да** для параметра **Настроить**, а затем выберите параметр **Мобильные приложения и настольные клиенты**.</br>
