...
## <a name="allow-or-block-guest-access-based-on-their-domain"></a>Разрешение или блокировка гостевого доступа на основе домена
...
По умолчанию гости не видны в глобальном списке адресов Exchange. С помощью указанных ниже действий можно сделать гостевых гостей видимыми в глобальном списке адресов.
