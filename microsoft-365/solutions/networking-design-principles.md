...
Десятки тысяч организаций, включая почти все fortune 500, каждый день используют Office 365 для своих критически важных функций миссии. Они делают это безопасно, и они делают это через Интернет.

Независимо от того, какие цели безопасности у вас есть в игре, существуют способы их выполнения, которые не требуют vpn-подключений, прокси-серверов, TLS перерыв и проверку, или централизованный интернет-отступ, чтобы получить трафик пользователей от сети и на нашу как можно быстрее, что обеспечивает лучшую производительность, будь то ваша сеть штаб-квартиры компании, удаленный офис или этот пользователь, работающий дома. Наше руководство основано на построении служб Office 365 и обеспечении безопасного и исполняемой работы пользователей.

## <a name="further-reading"></a>Дальнейшее чтение

[Принципы подключения к сети Office 365](../enterprise/microsoft-365-network-connectivity-principles.md)
...
[Подключение Office 365 для удаленных пользователей с помощью раздельного туннеля VPN](../enterprise/microsoft-365-vpn-split-tunnel.md)