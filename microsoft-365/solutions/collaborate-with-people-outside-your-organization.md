...
- **Включите общий доступ** : Настройте общие элементы управления в Azure Active Directory, Teams, Office 365 Groups и SharePoint, чтобы обеспечить необходимый уровень общего доступа для Организации.
