...
По умолчанию в Microsoft 365 общий доступ к людям за пределами вашей организации включен для SharePoint и OneDrive, но отключен для Teams. Многие сценарии внешнего общего доступа SharePoint и OneDrive работают без дополнительной настройки. Чтобы подтвердить параметры сценария, который вы используете, или включить новый сценарий, выберите один из следующих параметров:
...
- [Сотрудничество на сайте.](collaborate-in-site.md) Узнайте, как настроить Microsoft 365, чтобы обеспечить общий доступ к сайтам SharePoint с гостями.
