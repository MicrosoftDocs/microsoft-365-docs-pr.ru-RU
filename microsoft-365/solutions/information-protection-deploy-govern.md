...
- Необходимо использовать техническую схему хранения и удаления персональных данных, хранимой в Microsoft 365.
...
Поскольку правила конфиденциальности данных не являются очень конкретными для хранения и удаления данных, необходимо учитывать другие факторы, которые могут диктовать рекомендации по управлению информацией для персональных данных, хранимой в подписке Microsoft 365. Вот несколько примеров:
...
Для начала см. в руб. [Управление](../compliance/manage-information-governance.md) управлением информацией и хранением данных, удалением и уничтожением [в Microsoft 365.](/office365/Enterprise/office-365-data-retention-deletion-and-destruction-overview)
...
Используйте [политики хранения и метки](../compliance/retention.md) хранения для хранения или удаления контента в Microsoft 365, который содержит или, как ожидается, содержит персональные данные.
