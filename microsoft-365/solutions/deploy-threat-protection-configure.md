...
keywords: безопасность, настройка, конфигурация, Microsoft 365 E5, расширенные средства защиты от угроз
ms.author: deniseb
author: denisebmsft
manager: dansimp
ms.audience: ITPro
...
Microsoft 365 Defender объединяет оповещения, инциденты, автоматическое расследование и ответы, а также расширенный поиск по рабочим нагрузкам (Microsoft Defender for Identity, Microsoft Defender for Office 365, Microsoft Defender for Endpoint и Microsoft Cloud App Security) в единое стекло. Новые функции постоянно добавляются в Microsoft 365 Defender; рассмотрите возможность получения функций предварительного просмотра.
...
Центр безопасности Microsoft 365 предназначен для администраторов безопасности и групп операций безопасности. В центре безопасности Microsoft 365 можно:
