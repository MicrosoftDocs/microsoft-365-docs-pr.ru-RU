...
Вы можете настроить истечение срока действия ссылки типа *Любой пользователь* для определенного хранилища OneDrive с помощью командлета [Set-SPOSite](https://docs.microsoft.com/powershell/module/sharepoint-online/set-sposite).
...
3. Выберите **Custom** и нажмите **Далее** .
4. Введите имя политики и нажмите кнопку **Далее** .
5. На странице **Расположения для применения политики** отключите все параметры, кроме параметров **Сайты SharePoint** и **Учетные записи OneDrive** , а затем щелкните **Далее** .
6. На странице **Определение параметров политики** нажмите **Далее** .
7. На странице **Настройка расширенных правил DLP** щелкните **Создать правило** и введите имя для правила.
8. В разделе **Условия** нажмите **Добавить условие** и выберите **Содержит** .
