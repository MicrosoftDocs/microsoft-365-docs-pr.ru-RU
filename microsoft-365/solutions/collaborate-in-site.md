...
Чтобы задать параметры внешней совместной работы:
...
3. Выберите **Внешние удостоверения** и щелкните элемент **внешние параметры совместной работы**.
4. В области **Параметры гостевого приглашения** убедитесь, что **Администраторы и пользователи в роли гостя могут приглашать** , а **Участники** — значение **Да**.
