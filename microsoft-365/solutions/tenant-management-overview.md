...
Правильная конфигурация клиентов Microsoft 365 обеспечивает этот фундамент, в результате чего ваши сотрудники сосредоточатся на завершении своей работы, а ИТ-отдел сосредоточится на решениях, которые обеспечивают дополнительную бизнес-ценность. 
...
4. Миграция Windows устройств, Office клиентов и Office серверов и данных
...
## <a name="a-microsoft-365-tenant-defined"></a>Определенный Microsoft 365 клиент

Клиент Microsoft 365 является выделенным экземпляром служб Microsoft 365 и данных организации, хранимой в определенном расположении по умолчанию, например в Европе или Северной Америке. Это расположение указывается при создании клиента для организации. Каждый Microsoft 365 является отдельным, уникальным и отделен от всех других Microsoft 365 клиентов. Вы создаете Microsoft 365 клиента при покупке одного или более продуктов в Корпорации Майкрософт, таких как Microsoft 365 E3 или E5, а также набор лицензий для каждого из них.
...
*Управление клиентом* — это планирование, развертывание и текущая работа Microsoft 365 клиентов. 

## <a name="attributes-of-a-well-designed-and-operating-tenant"></a>Атрибуты хорошо разработанного и операционного клиента

Помимо правильного имени и расположения клиента существуют дополнительные элементы для планирования, развертывания и управления для обеспечения эффективности, безопасности и производительности приложений облачной производительности, таких как Microsoft Teams и &mdash; &mdash; Exchange Online.
...
- Вы синхронизировали учетные записи, группы и другие объекты.
  - Учетные записи клиента Azure AD Exchange Online почтовыми ящиками с правильными доменами DNS для адресов электронной почты.
...
- Локальное Office серверы и их данные были перенесены в облачные приложения или используются в гибридной конфигурации.
...
В этой иллюстрации Microsoft 365 клиента:

- Продукты и лицензии для Microsoft 365 E3 и E5.
- Microsoft 365 приложений производительности.
...
|:-------|:-----|:-------|
| Несколько клиентов | Каждый Microsoft 365 является отдельным, уникальным и отделен от всех других Microsoft 365 клиентов. С несколькими арендаторами существуют ограничения и дополнительные соображения при управлении ими и предоставлении услуг пользователям. | Microsoft 365 E3 или E5 | 
...
| Возможность или функция | Описание | Лицензирование |
|:-------|:-----|:-------|
| Network Insights | Метрики производительности сети, собранные Microsoft 365 клиента, чтобы помочь вам разработать периметры сети для расположения офисов. | Microsoft 365 E3 или E5 | 
| Автоматизация обновлений конечной точки | Автоматизация конфигурации и текущих обновлений для Microsoft 365 конечных точек в клиентских файлах PAC, сетевых устройствах и службах. | Microsoft 365 E3 или E5 | 
||||
...
| Возможность или функция | Описание | Лицензирование |
|:-------|:-----|:-------|
| Переход на Windows 10 | Перенос устройств с Windows 7 или Windows 8.1 на Windows 10 Корпоративная. | Windows 10 Корпоративная лицензий, включенных в Microsoft 365 E3 или E5 | 
| Миграция в Приложения Microsoft 365 для предприятий | Миграция Office клиентских приложений, таких как Word и PowerPoint, в версии, установленные из облака, которые обновляются с новыми функциями. | Microsoft 365 E3 или E5 | 
| Перенос локального сервера и данных в Microsoft 365 | Миграция Exchange почтовых ящиков, SharePoint сайтов и Skype для бизнеса Online в Microsoft 365 облачные службы. | Microsoft 365 E3 или E5 | 
||||
...
| Basic Mobility + Security | Защита и управление мобильными устройствами пользователей, таких как iPhone, iPad, Android и Windows с помощью встроенной службы.  | Microsoft 365 E3 или E5 | 
||||

## <a name="next-steps"></a>Дальнейшие действия

Используйте эти действия, чтобы настроить и управлять Microsoft 365 клиентов.
...
4. [Перенос локального Office серверов и данных](tenant-management-migration.md)
5. [Развертывание управления устройствами и приложениями](tenant-management-device-management.md)

[![Действия по развертыванию и управлению клиентом Microsoft 365 клиента](../media/tenant-management-overview/tenant-management-step-grid.png)](tenant-management-tenants.md)

Каждый шаг описывает параметры развертывания, суммирует результаты и текущие задачи по обслуживанию.

Чтобы понять, как вымышленная, но представительная многонациональная организация развернула элементы Microsoft 365 клиента, см. в примере [Contoso.](../enterprise/contoso-case-study.md)
