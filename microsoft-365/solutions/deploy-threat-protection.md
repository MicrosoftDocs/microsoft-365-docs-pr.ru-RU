...
Решения для обеспечения безопасности Майкрософт встроены в наши продукты и службы. Возможности автоматизации и машинного обучения уменьшают нагрузку на группы безопасности, чтобы убедиться, что нужные элементы будут устранены. А сила решений microsoft security построена на триллионах сигналов, которые мы обработать каждый день в нашем [интеллектуальном графике безопасности.](https://cloud-platform-assets.azurewebsites.net/intelligent-security-graph) Решения для безопасности Microsoft [365 включают Microsoft 365 Defender](../security/mtp/microsoft-threat-protection.md), решение, которое объединяет сигналы по электронной почте, данным, устройствам и удостоверениям, чтобы нарисовать картину расширенных угроз в отношении вашей организации.
