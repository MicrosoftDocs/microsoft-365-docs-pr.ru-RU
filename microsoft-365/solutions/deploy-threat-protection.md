...
keywords: решение, установка, расширенные средства защиты от угроз, atp, security, Microsoft 365 E5, средства защиты, защитник, m365
ms.author: deniseb
author: denisebmsft
manager: dansimp
ms.audience: ITPro
...
Это решение описывает мощные возможности защиты от угроз в Microsoft 365 E5 и объясняет, почему защита от угроз важна. Ознакомьтесь с этой статьей, чтобы получить обзор защиты от угроз в Microsoft 365 E5 и подходы к настройке и конфигурации для вашей организации.
...
Продолжайте [настраивать возможности защиты от угроз в Microsoft 365.](deploy-threat-protection-configure.md)
