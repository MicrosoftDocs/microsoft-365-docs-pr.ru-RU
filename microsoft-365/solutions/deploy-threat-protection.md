...
1. [Настройка многофакторной проверки подлинности и политик условного доступа](#step-1-set-up-multi-factor-authentication-and-conditional-access-policies)
2. [Настройка Advanced Threat Protection в Azure](#step-2-configure-azure-advanced-threat-protection)
3. [Включение Защиты от угроз (Майкрософт)](#step-3-turn-on-microsoft-threat-protection)
4. [Настройка Office 365 Advanced Threat protection](#step-4-configure-office-365-advanced-threat-protection)
5. [Настройка Advanced Threat Protection в защитнике Майкрософт](#step-5-configure-microsoft-defender-advanced-threat-protection)
6. [Настройка Microsoft Cloud App Security](#step-6-configure-microsoft-cloud-app-security)
7. [Отслеживание состояния и выполнение действий](#step-7-monitor-status-and-take-actions)
8. [Обучение пользователей](#step-8-train-users)
