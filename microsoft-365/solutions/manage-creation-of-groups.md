...
Если вашему бизнесу требуется ограничить, кто может создавать группы, вы можете сделать это, следуя процедурам в этой статье. Когда вы ограничиваете, кто может создать группу, это влияет на все службы, которые полагаются на группы для доступа, в том числе:
...
Можно ограничить создание Группы Microsoft 365 членами определенной группы Или группы безопасности Microsoft 365. Для настройки этого используется Windows PowerShell. В этой статье вы можете пройти необходимые действия.
