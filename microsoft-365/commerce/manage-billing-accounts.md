---
title: Общие сведения об учетных записях выставления счетов
f1.keywords:
- NOCSH
ms.author: cmcatee
author: cmcatee-MSFT
...
ms.locfileid: "53394403"
---
# <a name="understand-billing-accounts"></a>Общие сведения об учетных записях выставления счетов
...
В Центр администрирования Microsoft 365 поддерживается следующий тип учетных записей:
...
Вы можете предоставить другим доступ к учетной записи счетов в Центр администрирования Microsoft 365 с помощью ролей и разрешений. Доступ к учетной записи вы выставления счетов может предоставить только владелец учетной записи. Одну из следующих ролей можно назначить пользователям:
...
> [!Note]
> Роли счетов для биллинга применяются только к учетным записям, и не применяются к другим Центр администрирования Microsoft 365 сценариям.
