...
- Владелец учетной **записи выставления счетов** &mdash; Может назначать разрешения, редактировать учетные записи, подписывать соглашения и просматривать учетные записи.
- Корреспондент учетной **записи для выставления счетов** &mdash; Можно изменять учетные записи, подписывать и просматривать учетные записи.
- **Средство чтения** &mdash; счетов выставления счетов Может просматривать учетные записи.
