...
4. Чтобы экспортировать [](#view-who-has-licenses-for-a-self-service-purchase-subscription) список пользователей, на которые следует ссылаться на следующий шаг, выполните действия, которые необходимо предпринять в списке пользователей, у которых есть лицензии на самообслуживаемую подписку.
5. Назначьте лицензии всем, у кого есть лицензия в другой подписке. Полный список действий см. [в подразьте назначение лицензий пользователям.](../../admin/manage/assign-licenses-to-users.md)
6. Свяжитесь с человеком, который приобрел подписку на самостоятельное приобретение, и попросите [его отменить ее.](manage-self-service-purchases-users.md#cancel-a-subscription)
...
### <a name="cancel-a-self-service-purchase-subscription"></a>Отмена подписки на самообслуживаемую покупку

Если вы решите отменить подписку на самообслуживаемую покупку, пользователи с лицензиями потеряют доступ к продукту. Пользователь, который изначально приобрел подписку на самостоятельное приобретение, получает сообщение об отмене подписки.
