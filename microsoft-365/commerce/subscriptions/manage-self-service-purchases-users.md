...
> [!NOTE]
> Необходимо включить новый интерфейс центра администрирования.
...
4. В области **назначить лицензии пользователям** Начните вводить имя, а затем выберите его из результатов, чтобы добавить его в список. Вы можете добавить до 20 пользователей за раз.
