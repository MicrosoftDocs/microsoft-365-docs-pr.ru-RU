...
> [!IMPORTANT]
> Если вы изменяете план с меньшим количеством служб, связанных с данными, чем текущий план (понижение уровня), необходимо вручную выполнить резервное копирование всех данных, которые необходимо сохранить. Дополнительные сведения см. в статье [резервное копирование данных перед переключением O365 для бизнес-планов](back-up-data-before-switching-plans.md).
...
Убедитесь в том, что покупаете подписку для той же организации, в которой сейчас находятся пользователи. Например, проверьте адреса электронной почты пользователей Office 365, которых хотите переместить. Если их адреса электронной почты \@входят в Contoso.com, необходимо приобрести новую подписку на contoso.com.
...
3. **Убедитесь, что у вас достаточно лицензий для каждого пользователя** . Каждому пользователю необходима лицензия, соответствующая своей подписке. Так, если вы хотите переместить десять пользователей в Office 365 корпоративный E5, у вас должно быть десять доступных лицензий.
