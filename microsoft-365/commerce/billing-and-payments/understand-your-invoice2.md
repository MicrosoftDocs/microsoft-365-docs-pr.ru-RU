...
### <a name="use-the-new-admin-center-to-change-your-purchase-order-number"></a>Использование нового центра администрирования для изменения номера заказа на покупку
...
### <a name="use-the-old-admin-center-to-change-your-purchase-order-number"></a>Использование старого центра администрирования для изменения номера заказа на покупку
...
2. Выберите подписку, которую нужно изменить, и в разделе **метод оплаты** выберите **Обновить сведения об оплате**.

3. В области **Обновить сведения об оплате** выберите **нет**.

4. В нижней части области **Обновление сведений об оплате** введите номер заказа на покупку, нажмите кнопку **послать**, а затем **Закрыть**.
