...
> [!NOTE]
> Если вы перейдете на автоматическую оплату с помощью кредитной карты, не забудьте сначала погасить текущую задолженность. Проверьте варианты оплаты и инструкции в своей выписке по счету. Дополнительную информацию можно узнать [в статье сведения](understand-your-invoice2.md)о счете.
