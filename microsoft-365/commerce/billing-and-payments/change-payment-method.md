...
2. <span data-ttu-id="cf884-143">Если вы находитесь в **табличном** представлении, выберите **карточки**.</span><span class="sxs-lookup"><span data-stu-id="cf884-143">If you're in **Table** view, select **Cards**.</span></span>
