...
| "В данный момент не удается обработать ваш запрос. Повторите попытку через несколько минут". | Если последующие попытки привели к одному и том же сообщению об ошибке в течение более 15 минут, обратитесь [в службу поддержки.](../admin/contact-support-for-business-products.md) |
...
[Поиск и ввод ключа продукта](enter-your-product-key.md) (статья)
