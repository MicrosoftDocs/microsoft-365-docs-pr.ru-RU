...
При покупке подписки на Microsoft 365 для бизнеса вы можете оформить набор приложений и служб, которые вы платите ежемесячно или ежегодно. Приложения и службы, которые вы получаете в рамках подписки, зависят от того, какой продукт вы приобрели, например приложения Microsoft 365 для бизнеса или Microsoft 365 бизнес стандарт. Что входит в каждый продукт, можно узнать на странице [Microsoft 365](https://products.office.com/compare-all-microsoft-office-products?&activetab=tab:primaryr1) для малого и среднего бизнеса.
