...
2. На **вкладке Продукты** найдите активную подписку. Щелкните три точки (другие действия) и выберите **Отменить подписку**.
...
[Понимание счета или](./billing-and-payments/understand-your-invoice2.md) счета Microsoft 365 для бизнеса (статья)\
[Отмена подписки](./subscriptions/cancel-your-subscription.md) (статья)
