...
## <a name="buy-another-subscription"></a>Приобретение дополнительной подписки
...
2. На странице **Подписка** выберите **Добавить подписки**.
    ...
    ![Баннер, показывающий, что подписка для этой организации уже приобретена.](../admin/media/9e18d31a-24a5-4c64-a71c-fafd4a4feb28.png)
  
3. Наведите указатель мыши на подписку, которую вы хотите приобрести, и нажмите кнопку **купить**.

    ![Ссылка "приобрести" на странице "Покупка служб" центра администрирования Microsoft 365.](../admin/media/f344c0a8-c58f-461d-b8e9-cddbb18f8ee8.png)
