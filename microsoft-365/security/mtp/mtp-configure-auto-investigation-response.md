...
Затем, после всех действий, просмотр и управление действиями [в центре действий.](mtp-autoir-actions.md)
...
|Требования к сети |- [Microsoft Defender for Identity включен](/azure-advanced-threat-protection/what-is-atp)<br/>- [Microsoft Cloud App Security](/cloud-app-security/what-is-cloud-app-security) configured<br/>- [Microsoft Defender для интеграции удостоверений](/cloud-app-security/mdi-integration) |
|Требования к компьютеру Windows: |-Windows 10 версии 1709 или более поздней (см. статью [Сведения о выпуске Windows 10](/windows/release-information/)) <br/>- Настроены следующие службы защиты от угроз:<br/>- [Microsoft Defender для конечной точки](/windows/security/threat-protection/microsoft-defender-atp/configure-endpoints)<br/>- [Антивирус Microsoft Defender](/windows/security/threat-protection/windows-defender-antivirus/configure-windows-defender-antivirus-features) |
|Защита контента электронной почты и файлов Office |[Microsoft Defender для Office 365](../office-365-security/office-365-atp.md#configure-atp-policies) настроен |
|Разрешения | Чтобы настроить возможности автоматического расследования и реагирования, необходимо, чтобы роль глобального администратора или администратора безопасности была назначена в Azure Active Directory () или в центре администрирования [https://portal.azure.com](https://portal.azure.com) Microsoft 365 ( [https://admin.microsoft.com](https://admin.microsoft.com) ).<p>Чтобы получить разрешения, необходимые для работы с автоматизированными возможностями расследования и реагирования, такими как проверка, одобрение или отклонение ожидающих действий, см. в документе [Required permissions for Action Center tasks.](mtp-action-center.md#required-permissions-for-action-center-tasks) |
...
3. Просмотрите политики группы устройств. В частности, посмотрите на **столбец уровня исправлений.** Рекомендуется автоматически **использовать угрозы полного устранения.**  Возможно, потребуется создать или изменить группы устройств, чтобы получить необходимый уровень автоматизации. Чтобы получить помощь в этой задаче, см. в следующих статьях:
   ...
   - [Создание и управление группами устройств](/windows/security/threat-protection/microsoft-defender-atp/machine-groups)
...
2. Убедитесь, что все следующие политики настроены. Чтобы получить помощь и рекомендации, см. в [справке "Защита от угроз".](../office-365-security/protect-against-threats.md)
   ...
   - [Безопасные вложения (Office 365)](../office-365-security/protect-against-threats.md#atp-safe-attachments-policies)
   - [Безопасные ссылки (Office 365)](../office-365-security/protect-against-threats.md#atp-safe-links-policies)
...
3. [Убедитесь, что Microsoft Defender для Office 365 для SharePoint, OneDrive и Microsoft Teams](../office-365-security/protect-against-threats.md#part-5---turn-on-atp-for-sharepoint-onedrive-and-microsoft-teams-workloads) включена.
...
2. В области навигации посмотрите **на** **происшествия,** центр действий и охоту, как показано на предыдущем изображении.
   ...
   - Если вы не *видите* **инциденты,** центр действий или охоту, то Microsoft 365 Defender может не быть включена.  В этом случае переехав [в Центр действий.](mtp-action-center.md)
3. В области навигации выберите **Параметры**  >  **Microsoft 365 Defender**. Подтверди, что microsoft 365 Defender включен. 

> [!TIP]
> Нужна помощь? [Включив Microsoft 365 Defender.](./mtp-enable.md)

## <a name="next-steps"></a>Дальнейшие действия

- [Действия по исправлению в Microsoft 365 Defender](mtp-remediation-actions.md)
