...
Переключитесь на точку аналитики SOC аналитика, теперь можно приступить к анализу атаки на портале защиты от угроз Майкрософт. 

1.  Откройте очередь инцидентов [Microsoft Threat protection Portal](https://security.microsoft.com/incidents) с любого устройства.
...
После устранения инцидента все связанные с ним предупреждения будут закрыты в Microsoft Threat Protection и на соответствующих порталах.
