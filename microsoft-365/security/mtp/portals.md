...
|---|---|---| 
| Центр безопасности Microsoft 365 | Мониторинг и реагирование на угрозы и усиление защиты в удостоверениях, электронной почте, данных, конечных точках и приложениях с [Помощью Microsoft 365 Defender](microsoft-threat-protection.md) | [security.microsoft.com](https://security.microsoft.com/) |
