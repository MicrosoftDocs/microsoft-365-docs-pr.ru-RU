...
#### <a name="logging-into-servicenow-as-the-integration-user"></a>Вход в ServiceNow в качестве пользователя интеграции
...
Если установка и настройка выполнены, но на домашней странице не видны карточки ServiceNow, которые не могут быть предоставлены в ServiceNow из Microsoft Secure Score, проверьте состояние страницы подготовки по адресу https://security.microsoft.com/ticketProvisioning. Нажмите кнопку **сохранить** и вернитесь на домашнюю страницу. Отображаются карточки.
