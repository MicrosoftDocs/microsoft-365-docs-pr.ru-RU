...
* **Инициировать сеанс живого ответа** — загружает удаленную оболочку на устройство для углубленного [расследования безопасности.](/windows/security/threat-protection/microsoft-defender-atp/live-response)
...
* [Исследование сущностями на устройствах с помощью живого ответа](/windows/security/threat-protection/microsoft-defender-atp/live-response)
