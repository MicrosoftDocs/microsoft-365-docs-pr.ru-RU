...
---
# <a name="devicefilecertificateinfobeta"></a>девицефилецертификатеинфобета
...
| `SignatureType` | string | Указывает, были ли сведения о подписи прочитаны как внедренные | содержимое самого файла или чтение из внешнего файла каталога |
