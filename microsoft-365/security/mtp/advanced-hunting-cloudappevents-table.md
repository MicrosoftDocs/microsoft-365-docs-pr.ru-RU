...
- [<span data-ttu-id="3a947-167">Использование общих запросов</span><span class="sxs-lookup"><span data-stu-id="3a947-167">Use shared queries</span></span>](advanced-hunting-shared-queries.md)
