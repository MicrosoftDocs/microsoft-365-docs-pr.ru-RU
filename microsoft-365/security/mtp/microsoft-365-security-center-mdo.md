...
В разделе [Начало работы](../office-365-security/office-365-atp.md#getting-started) статьи [Microsoft Defender для Office 365](../office-365-security/office-365-atp.md) предварительно логические блоки конфигурации выглядят следующим образом:
...
- [Правила настраиваемого обнаружения](/windows/security/threat-protection/microsoft-defender-atp/custom-detection-rules)
