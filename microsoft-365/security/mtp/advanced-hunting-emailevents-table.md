...
`EmailEvents`Таблица в [расширенной](advanced-hunting-overview.md) схеме Поиск содержит сведения о событиях, связанных с обработкой сообщений электронной почты в защитнике майкрософт для Office 365. Используйте этот справочник для создания запросов, возвращающих данные из этой таблицы.
...
| `PhishDetectionMethod` | string | Метод, используемый для обнаружения сообщения электронной почты как фишинга: репутация вредоносного URL-адреса, URL-адрес безопасных ссылок детонации, фильтр "Расширенный фишинг", "общий фильтр фишинга", "несанкционированный": внутренний домен, защита от использования доменов, олицетворение пользователя, олицетворение |
