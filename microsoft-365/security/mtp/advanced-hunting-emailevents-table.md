...
| `OrgLevelPolicy` | string | Политика организации, которая инициирует действие, предпринятые с сообщением электронной почты |
...
| `Connectors` | string | Настраиваемые инструкции, определяемые организационным потоком почты и маршрутией электронной почты |
