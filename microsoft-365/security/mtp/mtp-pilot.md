...
| [Имитация атаки](mtp-pilot-simulate.md) <br>~2 дня| Чтобы смоделировать атаку, вы получите руководство по:<br><br>- Проверка требований тестовой среды <br>- Запуск имитации <br>- Исследовать инцидент <br>- устранить инцидент. 
