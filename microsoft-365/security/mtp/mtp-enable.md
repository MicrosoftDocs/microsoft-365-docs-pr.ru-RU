...
![Изображение страницы приветствия Microsoft Threat Protection, показанной в том случае, если защита от угроз Майкрософт не включена на ](../../media/mtp-welcome.png)
 *странице приветствия Microsoft Threat Protection в центре безопасности Microsoft 365*
...
**Новые возможности:** Начиная с 12 мая, 2020 клиенты постепенно перестанут получать изменения этого интерфейса. При новом интерфейсе служба автоматически выбирает оптимальное расположение центра обработки данных для собранных данных на основе существующих служб безопасности Microsoft 365. Выбранное расположение центра обработки данных отображается на экране.
...
![Изображение области навигации центра безопасности Microsoft 365 с помощью функций защиты от угроз Майкрософт ](../../media/mtp-on.png)
