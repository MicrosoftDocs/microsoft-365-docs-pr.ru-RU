...
<br>![Изображение страница of_Azure Advanced Threat Protection, на которой следует нажать кнопку Далее, чтобы перейти к следующей странице](../../media/mtp-eval-48.png) <br>
...
11. В разделе Параметры [Azure Azure ATP](https://go.microsoft.com/fwlink/?linkid=2040449) выберите пункт **Защитник Windows ATP**, а затем включите выключатель. Нажмите кнопку **Сохранить**. 
...
|![Этап имитации атаки](../../media/mtp/run-sim.png) <br>[Этап имитации атаки](mtp-pilot-simulate.md) | Запустите моделирование атак для пилотной среды пилотной системы защиты от угроз Майкрософт.
|:-------|:-----|
