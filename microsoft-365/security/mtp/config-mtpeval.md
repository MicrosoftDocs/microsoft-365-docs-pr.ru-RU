...
![Image of_Microsoft защита от угроз для пользователей, Advanced Threat Protection в Azure, для конечных точек Microsoft Defender Advanced Threat Protection, для облачных приложений, Microsoft Cloud App Security и данных, Office 365 Advanced Threat protection  ](../../media/mtp-eval-31.png)
...
4. В разделе Параметры облачного обнаружения выберите **Интеграция с защитником Майкрософт**, а затем включите интеграцию. Щелкните **Сохранить**.
   ...
   ![Image of_the страницу защитника Microsoft Defender, где установлен флажок Блокировать несанкционированные приложения под интеграцией Microsoft Defender ATP. Нажмите кнопку Сохранить.](../../media/mtp-eval-56.png)
...
![Снимок экрана с вариантом of_Microsoft защиты от угроз на странице параметров центра безопасности Microsoft 365 ](../../media/mtp-eval-72b.png) <br>

Более подробная информация приведена в статье [Включение защиты от угроз Майкрософт](mtp-enable.md). 

Поздравляем! Вы только что создали пробную лабораторию и пилотную среду Microsoft Threat protection! Теперь вы можете ознакомиться с пользовательским интерфейсом защиты от угроз Майкрософт! Ознакомьтесь со следующими сведениями в интерактивном руководстве по защите от угроз Майкрософт и Узнайте, как использовать каждую панель мониторинга для повседневных задач безопасности.
