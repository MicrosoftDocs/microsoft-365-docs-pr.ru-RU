...
ms.reviewer: ''
description: Ознакомьтесь с последними оценками и анализом системы защиты от угроз Майкрософт, которая всегда обеспечивает высокие показатели в независимых тестах (AV-TEST, Threat сравнения с AV, SE, МИТРЕ ATT&а). Просмотрите последние результаты анализа и анализа.
