...
>[!IMPORTANT]
>Классификация, группа устройств, состояние расследования и фильтры платформы ОС в настоящее время доступны только в общедоступной предварительной версии.
