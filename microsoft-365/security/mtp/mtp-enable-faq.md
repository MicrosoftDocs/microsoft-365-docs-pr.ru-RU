...
---
# <a name="frequently-asked-questions-when-turning-on-microsoft-365-defender"></a>Вопросы и ответы о включаемом Защитнике Microsoft 365
...
Нет, Microsoft 365 Defender консолидирует данные из служб безопасности Microsoft 365, которые вы уже развернули. После включив его, инциденты, автоматизация и поиск начнет работать в области развернутых продуктов. Если ни один из этих продуктов не развернут должным образом, Microsoft 365 Defender не будет отображать какие-либо данные и не сможет принять никаких действий.
