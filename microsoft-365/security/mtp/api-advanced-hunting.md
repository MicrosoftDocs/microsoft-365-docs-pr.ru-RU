...
3. Вы можете делать до 10 вызовов в минуту на клиента.
4. У вас есть 10 минут времени работы в час на клиента.
5. Общее время работы клиента составляет четыре часа.
...
-|-|-
Приложение | AdvancedАting.Read.All | Выполнение расширенных запросов
