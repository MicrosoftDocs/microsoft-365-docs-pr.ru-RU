...
- **Роли Глобального Azure Active Directory (Azure AD)**
- **Пользовательский доступ к роли**

Учетные записи, на которые назначены следующие **роли Global Azure AD,** могут получать доступ к функциям и данным Защитника Microsoft 365:
...
>! [ПРИМЕЧАНИЕ] Эта статья применяется только к управлению глобальными ролями Azure AD. Дополнительные сведения об использовании настраиваемого управления доступом на основе ролей см. в пользовательских ролях для управления доступом на основе [ролей.](custom-roles.md)
