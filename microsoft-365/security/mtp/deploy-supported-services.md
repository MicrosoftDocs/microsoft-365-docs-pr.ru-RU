...
- Инциденты идентифицированы и соотносятся на основе оповещений и сигналов событий от всех доступных датчиков и специальных возможностей анализа
- Книги автоматического исследования и исправлений (AIR) применяются к различным типам сужаемого объекта, включая устройства, почтовые ящики и учетные записи пользователей
