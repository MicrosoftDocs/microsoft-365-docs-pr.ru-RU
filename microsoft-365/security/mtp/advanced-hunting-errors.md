...
|--|--|--|--|
| Ошибки синтаксиса | Запрос содержит неуязвимые имена, включая ссылки на несущестотные операторы, столбцы, функции или таблицы. | Убедитесь, [что ссылки на операторы и](https://docs.microsoft.com/azure/data-explorer/kusto/query/) функции Kusto верны. Проверьте [схему на правильность](advanced-hunting-schema-tables.md) столбцов, функций и таблиц для расширенных охоты. Заключив переменные строки в кавычках, чтобы они распознались. При написании запросов используйте предложения автозаполнеия из IntelliSense. | `A recognition error occurred.` |
