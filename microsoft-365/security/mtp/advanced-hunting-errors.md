...
При использовании расширенного поиска отображаются ошибки, уведомляющие о синтаксических ошибках и о [предопределенных квотах и параметрах использования](advanced-hunting-limits.md). В таблице ниже приведены советы по устранению ошибок и их устранению.
