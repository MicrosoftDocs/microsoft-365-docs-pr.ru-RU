...
[Расширенный](advanced-hunting-overview.md) Поиск в защитнике Microsoft 365 позволяет профилактическое слежение за угрозами в:
- Устройства, управляемые защитником Майкрософт для конечной точки
- Сообщения электронной почты, обработанные Microsoft 365
- Действия облачных приложений, события проверки подлинности и действия контроллера домена, отслеживаемые Microsoft Cloud App Security и защитник Майкрософт для удостоверения
