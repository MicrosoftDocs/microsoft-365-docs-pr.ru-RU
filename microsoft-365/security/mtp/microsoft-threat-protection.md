...
В этом интерактивном руководстве вы узнаете, как защитить свою организацию с помощью Microsoft 365 Defender. Вы увидите, как Защитник Microsoft 365 помогает обнаруживать угрозы безопасности, исследовать атаки на вашу организацию и предотвращать вредоносные действия автоматически.
...
- Единая информационная система для разных продуктов **—** централизованное представление всех сведений об обнаружении, влиянии активов, автоматизированных действий и связанных свидетельствах в одной очереди и одной области в [security.microsoft.com.](https://security.microsoft.com) 
- **Очередь** объединенных инцидентов . Чтобы помочь специалистам по безопасности сосредоточиться на том, что является критически важным, обеспечивая полную область атаки, активы и автоматизированные действия по исправлению группируются и своевременно выдаются. 
- **Автоматическое реагирование на** угрозы — сведения о критических угрозах совместно в режиме реального времени между продуктами Microsoft 365 Defender помогают остановить последовательность атаки. Например, если в конечной точке, защищенной Microsoft Defender для конечной точки, обнаружен вредоносный файл, Защитник Office 365 будет проверять и удалять его из всех сообщений электронной почты. Файл будет заблокирован всем набором безопасности Microsoft 365.
