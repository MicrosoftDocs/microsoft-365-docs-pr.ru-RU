...
|Рекомендация  |E3  |E5  |
|---------|---------|---------|
|**Настройка многофакторной проверки подлинности и использование рекомендуемых политик условного доступа, в том числе политик риска входа**. Корпорация Майкрософт рекомендует и проверила набор политик, которые совместно работают для защиты всех облачных приложений, в том числе Office 365 и Microsoft 365 Services. Просмотр [конфигураций доступа для удостоверений и устройств](./office-365-security/microsoft-365-policies-configurations.md). | |![Зеленая галочка](../media/green-check-mark.png)|
...
Добавив дополнительные меры защиты к привилегированным учетным записям и защищая их от известных атак, вы перемещаете внимание на защиту от неизвестных угроз. Чем определено и расширено адверсариес использовать инновационные и новые неизвестные методы для атак организаций. Благодаря обширной телеметрии данных корпорации Майкрософт, собранных на основе миллиардов устройств, приложений и служб, мы можем выполнять защитник для Office 365 в Windows, Office 365 и Azure для предотвращения атак с нулевым сроком действия, использования сред Санд и проверки допустимости перед предоставлением доступа к содержимому. 


|Рекомендация  |E3  |E5  |
|---------|---------|---------|
|**Настройка защитника Майкрософт для Office 365** :<br>* Безопасные вложения<br>* Безопасные ссылки<br>* ATP для SharePoint, OneDrive и Microsoft Teams<br>* Защита от фишинга в защитнике для Office 365|         |![Зеленая галочка](../media/green-check-mark.png) |
|**Настройка защитника Майкрософт для возможностей конечной точки** :<br>* Антивирусная программа "Защитник Windows" <br>* Защита от эксплойтов <br> * Снижение уязвимой зоны <br> * Изоляция на основе оборудования <br>* Контролируемый доступ к папкам     |         |![Зеленая галочка](../media/green-check-mark.png) |
...
|**Разверните [защитник Майкрософт для удостоверения](https://docs.microsoft.com/azure-advanced-threat-protection/what-is-atp)** , чтобы отслеживать и защитить от угроз, предназначенных для локальной среды Active Directory.   |         |![Зеленая галочка](../media/green-check-mark.png) |
|Используйте **защитник Azure** _ для мониторинга угроз между гибридными и облачными рабочими нагрузками. Azure Defender_ включает свободный уровень возможностей и стандартный уровень возможностей, которые оплачиваются на основе рабочих часов или транзакций.|         |         |
...
- **Еженедельно изучите самые популярные вредоносные и фишинговые пользователи** : используйте защитник Майкрософт для Office 365 Threat Explorer, чтобы просмотреть Топ пользователей, которым назначены вредоносные программы и фишинга, и узнать, почему эти пользователи подвержены воздействию этой уязвимости.
