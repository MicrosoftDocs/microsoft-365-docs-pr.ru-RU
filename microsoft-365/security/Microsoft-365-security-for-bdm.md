...
|Рекомендация  |E3 |E5  |
|---------|---------|---------|
|Применение многофакторной проверки подлинности (MFA) для всех учетных записей администраторов.|![Зеленая галочка](../images/green-check-mark.png)|![Зеленая галочка](../images/green-check-mark.png)| 
|Реализуйте управление привилегированными удостоверениями Azure Active Directory (Azure AD), чтобы применить привилегированный доступ к ресурсам Azure AD и Azure. Вы также можете узнать, у кого есть доступ, и проверить привилегированный доступ.|         | ![Зеленая галочка](../images/green-check-mark.png)|
|Реализуйте управление привилегированным доступом в Office 365 для управления детализированным доступом к задачам привилегированного администрирования в Office 365. |         | ![Зеленая галочка](../images/green-check-mark.png)|
|Настройка и использование привилегированных рабочих станций доступа (PAW) для управления службами. Не используйте одни рабочие станции для просмотра Интернета и проверки электронной почты, не связанной с учетной записью администратора.|  ![Зеленая галочка](../images/green-check-mark.png)|![Зеленая галочка](../images/green-check-mark.png) | 

Эти возможности показаны на следующей схеме.
![Рекомендуемые возможности для защиты привилегированных учетных записей](../images/m365-security-bdm-illustrations-privileged-accounts.png)
...
- Удаление лицензий из учетных записей администраторов. Если нет определенного пользовательского случая для назначения лицензий определенным учетным записям администраторов, удалите лицензии из этих учетных записей. 
...
- Отключите протоколы POP3, IMAP и SMTP. Большинство современных организаций больше не используют устаревшие протоколы. Вы можете безопасно отключить эти и разрешить только исключения, если это необходимо. 
...
|Рекомендация  |E3  |E5  |
|---------|---------|---------|
|**Настройка Office 365 Advanced Threat protection (ATP)**:<br>• Безопасные вложения ATP<br>• Безопасные ссылки ATP<br>• ATP для SharePoint, OneDrive и Microsoft Teams<br>• Защита от фишинга ATP|         |![Зеленая галочка](../images/green-check-mark.png) |
|**Настройка функций Advanced Threat Protection в защитнике Майкрософт**:<br>• Антивирусная программа "Защитник Windows" <br>• Защита от эксплойтов <br> • Сокращение уязвимой зоны <br> • Изоляция на основе оборудования <br>• Контролируемый доступ к папкам     |         |![Зеленая галочка](../images/green-check-mark.png) |
|**Используйте Microsoft Cloud App Security** для обнаружения приложений SaaS и начните использовать анализ поведения и обнаружение аномалий. |         |![Зеленая галочка](../images/green-check-mark.png) |

Эти возможности показаны на следующей схеме.
![Рекомендуемые возможности для защиты от неизвестных угроз](../images/m365-security-bdm-illustrations-unknown-threats.png)
...
|Рекомендация |E3 |E5 |
|---------|---------|---------|
|Убедитесь, что **журнал аудита Office 365** включен.|![Зеленая галочка](../images/green-check-mark.png)|![Зеленая галочка](../images/green-check-mark.png)|
|Проанализируйте контрольный **рейтинг еженедельно** — надежный показатель — это центральное расположение для доступа к состоянию безопасности клиента Office 365 и выполнения действий на основе рекомендаций по обеспечению безопасности. Эту проверку рекомендуется выполнять еженедельно.|![Зеленая галочка](../images/green-check-mark.png)|![Зеленая галочка](../images/green-check-mark.png)|
...
|**Разверните [Azure ATP](https://docs.microsoft.com/en-us/azure-advanced-threat-protection/what-is-atp) ** для мониторинга и защиты от угроз, предназначенных для локальной среды Active Directory.   |         |![Зеленая галочка](../images/green-check-mark.png) |
...
Эти возможности показаны на следующей схеме.
![Рекомендуемые возможности для непрерывного мониторинга и аудита](../images/m365-security-bdm-illustrations-monitoring-auditing.png)
