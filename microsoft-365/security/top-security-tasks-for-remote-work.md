...
- [Microsoft 365 для кампаний](https://docs.microsoft.com/microsoft-365/campaigns/) (включает рекомендуемую конфигурацию безопасности для Microsoft 365 бизнес)
...
|5 |[Включить Microsoft 365 Defender](#5-turn-on-microsoft-365-defender)|||![Включена](../media/d238e041-6854-4a78-9141-049224df0795.png)|
...
Обзор, включая сводку планов, см. в [defender for Office 365.](office-365-security/office-365-atp.md)
...
- Создайте новое правило условного доступа для обязательного обязательного многофаксального доступа для гостей и внешних пользователей.
- Обновите правило условного доступа MFA с учетом рисков, чтобы исключить гостей и внешних пользователей.

Используйте рекомендации [](./office-365-security/identity-access-policies-guest-access.md) по обновлению общих политик, чтобы разрешить и защитить гостевой и внешний доступ, чтобы понять, как гостевой доступ работает с Azure AD, а также обновить затронутые политики.
...
> [!NOTE]
> Если вы уже зарегистрировали компьютеры в управлении устройствами, чтобы обеспечить соответствие требованиям компьютеров, вам также потребуется исключить гостевых учетных записей из правила условного доступа, которое обеспечивает соответствие устройств требованиям.
...
Управлять устройством может только одна организация, поэтому не забудьте исключить гостевых учетных записей из правила условного доступа в Azure AD. Если вы не исключите гостевых и внешних пользователей из политик, которые требуют соответствия устройств требованиям, эти политики заблокируют этих пользователей. Дополнительные сведения см. в обновлении общих политик для поддержки и защиты гостевого и [внешнего доступа.](./office-365-security/identity-access-policies-guest-access.md)
...
- [Альтернативные способы для специалистов по безопасности и ИТ для достижения современных средств контроля безопасности в современных уникальных сценариях удаленной работы](https://www.microsoft.com/security/blog/2020/03/26/alternative-security-professionals-it-achieve-modern-security-controls-todays-unique-remote-work-scenarios/)
