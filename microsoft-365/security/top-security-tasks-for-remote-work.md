...
- [10 основных способов защиты планов Office 365 и Microsoft 365 для бизнеса](../admin/security-and-compliance/secure-your-business-data.md). 
...
|2     | [Защита от угроз в Office 365](#2-protect-against-threats-in-office-365) |![Включена](../media/d238e041-6854-4a78-9141-049224df0795.png) |  ![Включена](../media/d238e041-6854-4a78-9141-049224df0795.png)       | ![Включена](../media/d238e041-6854-4a78-9141-049224df0795.png)       | 
...
|План  |Рекомендация  |
|---------|---------|
|Планы Office 365 (без Azure AD P1 или P2)     |[Включение параметров безопасности по умолчанию в Azure AD](https://docs.microsoft.com/azure/active-directory/fundamentals/concept-fundamentals-security-defaults). Параметры безопасности по умолчанию в Azure AD включают MFA для пользователей и администраторов.   |
...
## <a name="2-protect-against-threats-in-office-365"></a>2: защита от угроз в Office 365

Все планы Office 365 включают различные функции защиты от угроз. Увеличить уровень защиты для этих функций занимает всего несколько минут.
...
- [Определение политик соответствия требованиям устройств](../enterprise/identity-access-policies.md#define-device-compliance-policies)
- [Обязательные совместимые компьютеры](../enterprise/identity-access-policies.md#require-compliant-pcs-but-not-compliant-phones-and-tablets) (правило условного доступа)
...
Сетевые элементы, такие как концентраторы VPN, центральное оборудование для сетевого выхода (например, прокси-серверы и устройства защиты от потери данных), Центральная пропускная способность в Интернете, цепи обратной связи, возможность преобразования сетевых адресов и т. д., неожиданно направляются в течение огромных напряжений из-за нагрузки весь бизнес, использующий их. Конечный результат низкой производительности и продуктивности связан с неудовлетворительным пользовательским интерфейсом для пользователей, которые адаптируются к работе из дома.
