...
![Выполните эти основные задачи, чтобы обеспечить поддержку работы из дома.](../media/security/security-support-remote-work.png)
...
- [Microsoft 365 для кампаний](https://docs.microsoft.com/microsoft-365/campaigns/) (в том числе рекомендуемая конфигурация безопасности для Microsoft 365 бизнес)
...
## <a name="3-configure-microsoft-defender-for-office-365"></a>3: Настройка защитника Майкрософт для Office 365

Защитник Майкрософт для Office 365, входящий в состав Microsoft 365 и Office 365, защищает организацию от вредоносных угроз, таких как сообщения электронной почты, ссылки (URL-адреса) и средства для совместной работы. Для настройки этого может потребоваться несколько часов.
...
Общие сведения о планах, в том числе о планах, приведены в разделе [Defender for Office 365](office-365-security/office-365-atp.md).
...
Вам потребуется работать с администратором Exchange Online и администратором SharePoint Online, чтобы настроить защитник для Office 365 для этих рабочих нагрузок:
...
- Ознакомьтесь с [тремя этапами защитника Майкрософт для развертывания удостоверений](https://docs.microsoft.com/azure-advanced-threat-protection/what-is-atp#whats-next)

## <a name="5-turn-on-microsoft-365-defender"></a>5: включение защитника Microsoft 365

Теперь, когда у вас есть защитник Майкрософт для Office 365 и защитник Майкрософт для настроенного удостоверения, вы можете просматривать объединенные сигналы из этих возможностей на одной панели мониторинга. [Защитник microsoft 365](https://docs.microsoft.com/microsoft-365/security/mtp/microsoft-threat-protection) позволяет объединить оповещения, происшествия, автоматическое исследование и отклики, а также расширенный поиск рабочих нагрузок (защитник Майкрософт для удостоверения, защитник для Office 365, защитник Майкрософт для конечной точки и Microsoft Cloud App Security) в одну область на [Security.Microsoft.com](https://security.microsoft.com).

![Иллюстрация панели мониторинга MTP](../media/top-ten-security-remote-work-mtp-dashboard.png)

После настройки одного или нескольких защитника для служб Office 365 включите MTP. Новые функции постоянно добавляются в MTP; Рассмотрите возможность принимать функции предварительного просмотра.

- [Дополнительные сведения о MTP](https://docs.microsoft.com/microsoft-365/security/mtp/microsoft-threat-protection)
- [Включение MTP](https://docs.microsoft.com/microsoft-365/security/mtp/mtp-enable)
- [Необязательное для предварительной версии функции](https://docs.microsoft.com/microsoft-365/security/mtp/preview)
...
- Вы создаете политику защиты приложений (APP), которая определяет, какие приложения на устройстве управляются и какие варианты поведения разрешены (например, запрещает копирование данных из управляемого приложения в неуправляемое приложение). Вы создаете одну политику для каждой платформы (iOS, Android).
...
> [!NOTE]
> Если вы уже зарегистрировали компьютеры в управлении устройствами, чтобы потребовать соответствия требованиям компьютеров, вам также потребуется исключить гостевые учетные записи из правила условного доступа, которое применяет соответствие требованиям к устройствам.
...
- [Определение политик соответствия требованиям устройств](./office-365-security/identity-access-policies.md#define-device-compliance-policies) — Рекомендуемые параметры для Windows 10 включают защиту от вирусов. Если у вас есть Microsoft 365 е, используйте защитник Майкрософт для конечной точки для мониторинга работоспособности устройств сотрудников. Убедитесь, что политики соответствия требованиям для других операционных систем включают антивирусную защиту и программное обеспечение для защиты от других точек.
