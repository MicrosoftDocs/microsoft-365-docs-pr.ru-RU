...
> |                  | LogOnUsers                | sourceUserId        | contoso\liz-bean;   contoso\jay-hardee                                             | Домен и пользователь интерактивного пользователя логотипа/s во время события. Примечание. Для устройств Windows 10 версии 1607 сведения о домене недоступны. |
