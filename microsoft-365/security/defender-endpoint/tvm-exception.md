...
---
# <a name="create-and-view-exceptions-for-security-recommendations---threat-and-vulnerability-management"></a>Создание и просмотр исключений для рекомендаций по безопасности — контроль угроз и уязвимостей
...
Если группа устройств фильтруется на любой из контроль угроз и уязвимостей, в качестве параметров будут отображаться только группы отфильтрованных устройств.

Это кнопка фильтрации группой устройств на любой из контроль угроз и уязвимостей страниц: 
...
На странице Рекомендации безопасности выберите **настраивайте** столбцы и проверьте поля для устройств Exposed **(после** исключений) и **Impact (после исключений).**
