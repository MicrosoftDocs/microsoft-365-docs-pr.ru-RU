...
6. Нажмите кнопку **Сохранить**. **Добавление строки** закрывается. В **настраиваемом**, нажмите **кнопку Далее**. В **тегах 3 Scope** теги области необязательны. Выполните одно из следующих действий.
