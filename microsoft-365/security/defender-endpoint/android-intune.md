...
> Вы можете подключиться к Google Play из Intune, чтобы развернуть приложение Defender for Endpoint в режимах администратора устройств Enterprise entrollment.
...
9. Defender for Endpoint поддерживает политики конфигурации приложений для управляемых устройств с помощью Intune. Эту возможность можно использовать для автоматического использования применимых разрешений на Android(ы), поэтому конечный пользователь не должен принимать эти разрешения(ы).
    ...
    1. На странице **Создание политики конфигурации приложений** введите следующие сведения:
        ...
        - Нажмите **кнопку Выберите приложение,** **выберите ATP в Защитнике Microsoft,** выберите **ОК,** а затем **далее**.
...
10. Выберите **ATP в Защитнике Microsoft** в списке Назначения \> **свойств** \>  \> **Изменить**.
...
1.  На **устройствах** выберите **профили** конфигурации Создание платформы профилей Android Enterprise Выберите ограничения устройства в соответствии с одним из следующих, в зависимости от типа  >    >    >   регистрации устройства.  
