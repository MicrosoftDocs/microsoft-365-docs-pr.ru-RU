...
1. **4.18.2104 или** более позднее : Добавление serialNumberId, VID_PID, поддержка GPO на основе filepath
...
1. Описание. Список свойств устройств, которые необходимо использовать для покрытия в группе.
Список свойств устройств, которые необходимо использовать для покрытия в группе.
