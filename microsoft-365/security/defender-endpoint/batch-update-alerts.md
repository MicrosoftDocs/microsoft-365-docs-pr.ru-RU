...
## <a name="http-request"></a><span data-ttu-id="9830b-132">HTTP-запрос</span><span class="sxs-lookup"><span data-stu-id="9830b-132">HTTP request</span></span>
```http
