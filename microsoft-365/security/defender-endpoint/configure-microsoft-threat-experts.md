...
---
# <a name="configure-and-manage-microsoft-threat-experts-capabilities"></a>Настройка и управление возможностями экспертов по угрозам Майкрософт
...
> [!NOTE]
> Обсудите требования к требованиям с поставщиком технических служб Майкрософт и командой учетных записей перед тем, как обратиться к экспертам microsoft Threat Experts - Targeted Attack Notification managed threat hunting service.
...
Если вы уже клиент Defender для конечных точек, вы можете подать заявку через Центр безопасности Защитника Майкрософт. 

1. Из области навигации перейдите в Параметры > общие > расширенные функции > **Microsoft Threat Experts - Targeted Attack Notifications**.
...
Это доступно в качестве службы подписки. Если вы уже клиент Defender для конечных точек, вы можете связаться со своим представителем Майкрософт, чтобы подписаться на экспертов Microsoft Threat Experts - Experts on Demand. 
...
2. В верхнем правом меню нажмите кнопку **?** . Затем выберите **Обратитесь к эксперту по угрозам**. 
    ...
    На следующем экране показано, когда вы находитесь на полной подписке Microsoft Threat Experts - Experts on-Demand.
...
## <a name="sample-investigation-topics-that-you-can-consult-with-microsoft-threat-experts---experts-on-demand"></a>Примеры тем исследования, которые можно проконсультироваться с экспертами Microsoft Threat Experts - Experts on Demand 
...
- Я получил это целевое уведомление об атаке от экспертов Microsoft Threat. У нас нет собственной группы реагирования на инциденты. Что мы можем сделать сейчас и как сдержать инцидент?
- Я получил целевое уведомление об атаке от экспертов microsoft Threat. Какие данные вы можете предоставить нам, чтобы мы могли передать нашей группе реагирования на инциденты?

  >[!NOTE]
  >Microsoft Threat Experts — это служба управляемой охоты на кибербезопасность, а не служба реагирования на инциденты. Тем не менее, эксперты могут без проблем перенаупрестить расследование в службы группы обнаружения и реагирования Microsoft Cybersecurity Solutions Group (CSG) при необходимости. Вы также можете взаимодействовать со своей командой реагирования на инциденты для устранения проблем, которые требуют реагирования на инциденты. 
...
Ответы экспертов по угрозам Майкрософт различаются в зависимости от вашего запроса. Они напишите вам отчет о  ходе консультации эксперта по угрозе в течение двух дней, чтобы сообщить о состоянии расследования из следующих категорий: 
