...
- [Защитник для конечной точки для Mac](microsoft-defender-endpoint-mac.md)
...
7. Выберите **Открыть** и выбрать файл вмеяния.
...
9. Выберите **вкладку Область.**

    ![Изображение вкладки области](images/jamfpro-scope-tab.png)

10. Выберите целевые компьютеры.
