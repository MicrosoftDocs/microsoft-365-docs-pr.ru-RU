...
Новый API Microsoft 365 Defender потоковой передачи включает события электронной почты и оповещения в дополнение к событиям на устройстве.
Дополнительные сведения см. [в Microsoft 365 Defender API потоковой передачи.](../defender/streaming-api.md)
