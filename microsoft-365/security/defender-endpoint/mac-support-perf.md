...
1. Далее введите следующие команды:
      ...
      > 
1. Настройка Microsoft Defender для конечной точки для Mac с исключениями для процессов или расположения дисков, которые способствуют повышению производительности и повторной защите в режиме реального времени.
