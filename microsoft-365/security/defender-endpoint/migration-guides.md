...
## <a name="migration-guides"></a>Руководство по миграции

Если вы рассматриваете возможность перехода от решения защиты от угроз, не от Microsoft, к Microsoft Defender для конечной точки с антивирусной программой Microsoft Defender, ознакомьтесь с нашими рекомендациями по миграции. Выберите сценарий, который лучше всего представляет, где вы находитесь в процессе развертывания, и см. инструкции.
...
## <a name="got-feedback"></a>Есть отзывы?

Дайте нам знать, что вы думаете! Отправка отзывов в нижней части страницы. Мы будем учитывать ваши отзывы, продолжая улучшать и добавлять в наши рекомендации по миграции.

## <a name="see-also"></a>См. также

- [Microsoft Defender для конечной точки](https://docs.microsoft.com/windows/security/threat-protection)
- [Microsoft Defender для Office 365](https://docs.microsoft.com/microsoft-365/security/defender-365-security/office-365-atp)
