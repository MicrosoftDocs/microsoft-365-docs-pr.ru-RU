...
Когда puA обнаруживается на конечной точке, Defender for Endpoint на Linux ведет запись инфекции в истории угроз. Историю можно визуализировать на портале Центра безопасности Защитника Майкрософт или с помощью средства `mdatp` командной строки. Имя угрозы будет содержать слово "Application".
