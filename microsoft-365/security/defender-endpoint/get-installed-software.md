...
Извлекает коллекцию установленного программного обеспечения, связанного с данным ID устройства.
...
В случае успеха этот метод возвращает 200 ОК с установленной информацией о программном обеспечении в теле.
