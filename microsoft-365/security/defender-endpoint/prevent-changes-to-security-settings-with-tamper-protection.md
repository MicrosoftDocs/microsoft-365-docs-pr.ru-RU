...
- Редактирование или удаление параметров безопасности с помощью групповой политики
...
- При использовании Центр безопасности в Microsoft Defender для управления защитой от взлома не нужно использовать метод Intune или присоединение клиента.
...
3. В списке результатов найми `IsTamperProtected` или `RealTimeProtectionEnabled` . (Значение true *означает,* что включена защита от взлома.)
...
2. В центре [администрирования Microsoft Endpoint Manager](https://go.microsoft.com/fwlink/?linkid=2109431)перейти к **антивирусу безопасности Endpoint,** а затем  >  выбрать + **Создать политику**. 
