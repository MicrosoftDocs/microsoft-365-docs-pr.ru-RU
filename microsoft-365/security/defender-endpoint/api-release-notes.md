...
- Добавлен новый метод API оценки экспорта — оценка уязвимостей программного обеспечения _Delta Export (ответ JSON)_ Методы оценки экспорта и [свойства каждого устройства.](get-assessment-methods-properties.md)
