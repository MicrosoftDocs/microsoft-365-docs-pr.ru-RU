...
[Методы и свойства экспортной оценки на устройство](get-assessmnt-1methods-properties.md) | Запуск вызовов API, таких как оценка безопасной конфигурации экспорта, оценка инвентаризации программного обеспечения и оценка уязвимостей \- по экспорту программного обеспечения.
