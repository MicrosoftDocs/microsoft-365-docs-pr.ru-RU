...
> [!NOTE]
> Иногда Центр безопасности в Microsoft Defender называется порталом Defender для конечных точек, и к нему можно получить доступ по [https://aka.ms/MDATPportal](https://aka.ms/MDATPportal) ссылке . 
