...
## <a name="1-export-secure-configuration-assessment-json-response"></a>1. Оценка безопасной конфигурации экспорта (ответ JSON)
