...
Команды, которые можно использовать в консоли, придерживаются аналогичных принципов [Windows команд.](https://docs.microsoft.com/windows-server/administration/windows-commands/windows-commands#BKMK_c)
