...
- Загрузите сценарий PowerShell или исполняемый в библиотеку и запустите его на устройстве с уровня клиента.
...
Устройства должны запускать одну из следующих версий Windows
  ...
  - **Windows 10**
    - [Версия 1909 или](https://docs.microsoft.com/windows/whats-new/whats-new-windows-10-version-1909) более поздней версии  
    - [Версия 1903 с](https://docs.microsoft.com/windows/whats-new/whats-new-windows-10-version-1903) [KB4515384](https://support.microsoft.com/en-us/help/4515384/windows-10-update-kb4515384)
    - [Версия 1809 (RS 5)](https://docs.microsoft.com/windows/whats-new/whats-new-windows-10-version-1809) с [KB4537818](https://support.microsoft.com/help/4537818/windows-10-update-kb4537818)
    - [Версия 1803 (RS 4)](https://docs.microsoft.com/windows/whats-new/whats-new-windows-10-version-1803) с [KB4537795](https://support.microsoft.com/help/4537795/windows-10-update-kb4537795)
    - [Версия 1709 (RS 3)](https://docs.microsoft.com/windows/whats-new/whats-new-windows-10-version-1709) с [KB4537816](https://support.microsoft.com/help/4537816/windows-10-update-kb4537816)
...
1. Во входе в Центр безопасности Защитника Майкрософт.
...
|`download <file_path> &` | Скачивает файл в фоновом режиме. |
драйверы |  Отображает все драйверы, установленные на устройстве. |
|`fg <command ID>` | Возвращает загрузку файла на первый план. |
...
| `getfile` | Получает файл с устройства. <br> ПРИМЕЧАНИЕ. Эта команда имеет предпосылок команду. Вы можете использовать команду `-auto` совместно с `getfile` автоматическим запуском необходимой команды. |
...
Команды, которые можно использовать в консоли, следуют аналогичным принципам, как [и команды Windows.](https://docs.microsoft.com/windows-server/administration/windows-commands/windows-commands#BKMK_c)
...
|Команда  |Действие  |
|---------|---------|
|`Download "C:\windows\some_file.exe" &`     |Начинается загрузка файла с *some_file.exe* в фоновом режиме.         |
...
1. Нажмите **кнопку Отправка файла в библиотеку**. 
...
### <a name="automatically-run-prerequisite-commands"></a>Автоматически запускать команды обязательных условий

Некоторые команды имеют необходимые команды для запуска. Если вы не запустите предпосылок, вы получите ошибку. Например, запуск команды `download` без `fileinfo` возвращает ошибку.

Автоматический флаг можно использовать для автоматического запуска необходимых команд, например:
...
- Сеансы живого ответа ограничиваются 10 сеансами живого ответа одновременно.
- Масштабное выполнение команд не поддерживается.
- Неактивное время действия сеанса неактивного времени отклика — 5 минут. 
- Пользователь может одновременно инициировать только один сеанс.
