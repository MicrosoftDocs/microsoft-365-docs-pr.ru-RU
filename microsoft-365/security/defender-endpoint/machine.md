...
:---|:---|:---
[Машины списка](get-machines.md) | [коллекция](machine.md) машин | Список [сущностями](machine.md) машин в организации.
...
[Обнаружение уязвимостей](get-discovered-vulnerabilities.md) | [коллекция уязвимостей](vulnerability.md) | Извлекает коллекцию обнаруженных уязвимостей, связанных с данным iD машины.
...
[Добавление или удаление тегов машин](add-or-remove-machine-tags.md) | [машина](machine.md) | Добавление или удаление тега в определенную машину.
[Поиск машин по IP](find-machines-by-ip.md) | [коллекция](machine.md) машин | Поиск машин с IP-адресом.
[Поиск машин по тегу](find-machines-by-tag.md) | [коллекция](machine.md) машин | Поиск машин по [тегу](machine-tags.md).
[Отсутствие КБ](get-missing-kbs-machine.md) | Коллекция KB | Получить список отсутствующих КБ, связанных с машинным ИД
[Настройка значения устройства](set-device-value.md)| [коллекция](machine.md) машин | Установите [значение устройства.](tvm-assign-device-value.md)

## <a name="properties"></a>Свойства

Свойство |   Тип   |   Описание
:---|:---|:---
id | Строка | [удостоверение](machine.md) компьютера.
...
osPlatform | Строка | Платформа операционной системы.
osProcessor | Строка | Процессор операционной системы.
version | String | Версия операционной системы.
osBuild | Nullable long | Номер сборки операционной системы.
lastIpAddress | Строка | Последний IP-адрес локального NIC на [компьютере.](machine.md)
lastExternalIpAddress | Строка | Последний IP-адрес, [с помощью которого](machine.md) машина имеет доступ к Интернету.
...
rbacGroupName | Строка | Имя группы машин.
...
machineTags | Коллекция String | Набор [тегов](machine.md) машин.
