...
- **Параметры антивируса Microsoft Defender**
  - Версия разведки безопасности
  - Защита с облачным доставкой  
  - Защита потенциально нежелательного приложения (PUA)
  - Защита в режиме реального времени
 
Сведения о смягчении последствий в [](next-gen-threat-and-vuln-mgt.md)этом разделе включают данные управления угрозами и уязвимостями, которые также предоставляют подробные сведения о сработок из различных ссылок в отчете.
