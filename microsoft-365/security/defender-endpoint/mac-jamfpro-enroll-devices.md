...
---
# <a name="enroll-microsoft-defender-for-endpoint-for-macos-devices-into-jamf-pro"></a>Регистрация Microsoft Defender для конечной точки для macOS-устройств в Jamf Pro 
