...
Извлекает определенную [машину](machine.md) по ее ID устройства или имени компьютера.


## <a name="limitations"></a>Ограничения
1. Устройства можно получить в последний раз в соответствии с настроенной политикой хранения.
...
При успешном и устройстве существует — 200 ОК с [машинным](machine.md) объектом в теле.
