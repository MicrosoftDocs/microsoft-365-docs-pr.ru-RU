...
---
# <a name="get-machineaction-api"></a>Получите API machineAction
...
Извлекает [определенное действие машины](machineaction.md) по его ID.
...
В случае успешной работы этот метод возвращает код ответа 200 Ok с [объектом Machine Action.](machineaction.md) Если объект действия машины с указанным id не найден - 404 Не найден.
