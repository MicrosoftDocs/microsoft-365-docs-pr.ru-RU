...
> [!WARNING]
> Это потенциально может позволить небезопасным файлам запускать и заражать устройства. Исключение файлов или папок может значительно снизить защиту, предоставляемую правилами сокращения направлений атак. Файлы, заблокированные правилом, будут разрешены к запуску, и отчет или событие не будут записываться.
