...
Для настройки этих параметров можно использовать поставщики услуг групповой политики, PowerShell и Службы управления мобильными устройствами (MDM).
...
|:----|:----|
| Блокировка злоупотреблений с использованием уязвимых подписанных драйверов | `56a863a9-875e-4185-98a7-b882c64b5ce5` |
