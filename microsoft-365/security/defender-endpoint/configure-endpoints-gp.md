...
Для каждого устройства можно указать, можно ли собирать образцы с устройства, когда через Центр безопасности Microsoft Defender будет сделан запрос на отправку файла для глубокого анализа.
...
1.  На устройстве управления GP скопируйте следующие файлы из пакета конфигурации:
    ...
    - _Скопируйте AtpConfiguration.admx в_ _C: Windows \\ \\ PolicyDefinitions_
...
5.  Щелкните **компоненты Windows** **и Защитник Windows ATP**.
...
После настройки сценария бортовой настройки продолжайте редактирование той же групповой политики, чтобы добавить конфигурации защиты конечной точки. Выполните изменения групповой политики в системе под управлением Windows 10 или Server 2019, чтобы убедиться, что у вас есть все необходимые антивирусные возможности Microsoft Defender. Может потребоваться закрыть и открыть объект групповой политики для регистрации параметров конфигурации ATP Defender.

Все политики находятся под `Computer Configuration\Policies\Administrative Templates` .

**Расположение политики:** \Windows Components\Защитник Windows ATP
...
**Расположение политики:**  \Windows Components\Защитник Windows антивирус
...
**Расположение политики:** \компоненты Windows\Защитник Windows антивирус\MAPS
...
**Расположение политики:** \Компоненты Windows\Защитник Windows Антивирус\Защита в режиме реального времени

Политика | Параметр 
:---|:---
Отключение защиты в режиме реального времени|Отключено
Включив мониторинг поведения|Включен
Сканирование всех загруженных файлов и вложений|Включен
Мониторинг активности файлов и программ на компьютере|Включен

<br/>

**Расположение политики:**  \Windows Components\Защитник Windows антивирус\Scan
...
Политика | Параметр 
:---|:---
Проверьте последнюю информацию о безопасности вирусов и шпионских программ перед запуском запланированного сканирования |Включен


<br/>

**Расположение политики:** \Windows Components\Защитник Windows антивирус\Защитник Windows Exploit Guard\Attack Surface Reduction
...
1. Перейдите в [Центр безопасности Защитника Майкрософт.](https://securitycenter.windows.com/)
