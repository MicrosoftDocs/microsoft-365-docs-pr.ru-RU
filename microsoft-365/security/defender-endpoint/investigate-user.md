...
- Сведения о учетной записи пользователя, оповещений Microsoft Defender для удостоверений и в журнале на устройствах, роли, типе логотипа и другие сведения
...
В  области сведений пользователя слева содержится информация о пользователе, например связанных открытых инцидентах, активных оповещений, имя SAM, SID, Microsoft Defender для удостоверений оповещений, количество устройств, на которые пользователь вошел, когда пользователь был первым и последним видел, роли и типы логотипов. В зависимости от функций интеграции, которые вы включили, вы увидите другие сведения. Например, если вы включаете Skype для бизнес-интеграции, вы сможете связаться с пользователем с портала. Раздел оповещений **ATP** Azure содержит ссылку на страницу Защитник Майкрософт для удостоверений, если включена функция Microsoft Defender для удостоверений, и есть оповещения, связанные с пользователем. На странице Защитник Майкрософт для удостоверений будут предоставляться дополнительные сведения о оповещениях.
