...
:---|:---|:---
![Изображение логотипа Accenture](images/accenture-logo.png)|[Управление обнаружением & Accenture (MDR)](https://go.microsoft.com/fwlink/?linkid=2164353) | Управление, обслуживание и расширение глобальных операций по кибербезопасности с помощью расширенных возможностей обнаружения, активного обнаружения и реагирования на расширенные кибератаки в ИТ-среде и локальной среде, расположенной в облаке и локальной среде.
![Изображение логотипа Aujas](images/aujas-logo.png) | [Aujas управляемый MDE Service](https://go.microsoft.com/fwlink/?linkid=2162429) | Кибербезопасность Aujas предоставляет 24*7 управляемых служб безопасности во всем корпоративном спектре, используя Microsoft Defender для конечных точек через свои центры киберзащиты.
![Изображение логотипа BDO Digital](images/bdo-logo.png)| [BDO Digital](https://go.microsoft.com/fwlink/?linkid=2090394) | В управляемой защите BDO Digital используются средства наилучшей практики, AI и эксперты по безопасности на дому для защиты удостоверений 24/7/365
...
![Изображение логотипа CyberProof](images/cyberproof-logo.png) |[Киберустойчивое управляемое обнаружение & ответа (MDR)](https://go.microsoft.com/fwlink/?linkid=2163964) | Службы обнаружения и реагирования управляемых угроз 24x7 полностью интегрированы с Azure Sentinel и Defender for Endpoint.
![Изображение логотипа Dell Technologies Advanced Threat Protection](images/dell-logo.png)| [Расширенные средства защиты от угроз Dell Technologies](https://go.microsoft.com/fwlink/?linkid=2091004) | Professional службы мониторинга вредоносного поведения и аномалий с возможностью 24/7
...
![Изображение логотипа expel](images/expel-logo.png)| [Expel Managed detection and response for Microsoft Defender Endpoint](https://go.microsoft.com/fwlink/?linkid=2162430) | Expel помогает вашей безопасности не отстать, обнаруживая риски безопасности в конечной точке Microsoft Defender.
![Изображение логотипа Mandiant](images/mandiant-logo.png) | [Mandiant Managed Defense (MDR) для Microsoft Defender для конечной точки](https://go.microsoft.com/fwlink/?linkid=2164352) | Укрепите защитника для конечной точки с помощью 24/7 фронтовой MDR-аналитики и знаний из Mandiant.
![Изображение логотипа NTT Security](images/ntt-logo.png)| [Безопасность NTT](https://go.microsoft.com/fwlink/?linkid=2095320) | Служба EDR NTT обеспечивает 24/7 мониторинга & в конечной точке и сети
...
![Изображение логотипа Trustwave Threat Detection & службы реагирования](images/trustwave-logo.png)| [Trustwave Threat Detection & службы реагирования](https://go.microsoft.com/fwlink/?linkid=2127542) | Службы обнаружения угроз и реагирования для Azure с помощью интеграции с Sentinel и Defender для конечной точки
