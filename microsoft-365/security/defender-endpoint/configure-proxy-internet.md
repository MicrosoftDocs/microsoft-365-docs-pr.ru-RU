...
>
> - Windows 10 версии 1809 или Windows Server 2019 —https://support.microsoft.com/kb/5001384
...
1. Скачайте [MDATP клиентского анализатора](https://aka.ms/mdatpanalyzer) на компьютер, на котором работает датчик Defender для конечной точки.
