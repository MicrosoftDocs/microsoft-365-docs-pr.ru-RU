...
К счастью, можно предпринять шаги для устранения и уменьшения подобных проблем. Если в вашей Центр безопасности в Microsoft Defender вы видите [ложные](../defender/microsoft-365-security-center-mde.md)срабатыва- нии, операции безопасности могут предпринять действия по их устранению, используя следующий процесс:
...
Оповещений можно классифицировать как ложные срабатыва или истинные положительные сигналы в Центр безопасности в Microsoft Defender. Классификация оповещений помогает обучить Microsoft Defender для конечной точки, чтобы со временем вы могли видеть больше истинных оповещений и меньше ложных оповещений.
...
Если у вас есть предупреждения, которые являются ложными срабатывательными или являются истинными срабатывательными, но для неважных событий, вы можете подавить эти оповещения в Центр безопасности в Microsoft Defender. Подавление оповещений помогает снизить уровень шума в панели мониторинга операций безопасности. 
...
> [!TIP]
> Нужна помощь с антивирусными исключениями? См. в рубке Настройка и проверка исключений [для антивирусная программа в Microsoft Defender проверки.](/windows/security/threat-protection/microsoft-defender-antivirus/configure-exclusions-microsoft-defender-antivirus)
...
Настраиваемые сетевые индикаторы включается в Центр безопасности в Microsoft Defender (см. [расширенные функции)](/microsoft-365/security/defender-endpoint/advanced-features)   
