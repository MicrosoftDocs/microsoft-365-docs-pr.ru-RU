...
---
# <a name="get-file-statistics-api"></a>Получить API статистики файлов
...
Извлекает статистику для данного файла.
...
Если успешно и файл существует — 200 ОК со статистическими данными в теле. Если файл не существует - 404 Не найден.
