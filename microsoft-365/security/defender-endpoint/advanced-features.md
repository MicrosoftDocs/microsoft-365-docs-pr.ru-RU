...
## <a name="azure-advanced-threat-protection-integration"></a>Интеграция с расширенными средствами защиты от угроз Azure
...
Включение этого параметра позволяет переадлить сигналы в Azure Information Protection. Это дает владельцам и администраторам данных видимость защищенных данных на бортовых устройствах и оценках рисков устройств.
