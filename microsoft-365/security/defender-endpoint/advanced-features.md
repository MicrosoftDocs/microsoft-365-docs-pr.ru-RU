...
1. В области навигации выберите **Параметры**  >  **Конечные** точки Общие расширенные функции  >    >    >  **Разрешить или заблокировать файл.**
...
При включив эту функцию, вы сможете включить данные из Microsoft Defender Office 365 в Microsoft 365 Defender для проведения комплексного расследования безопасности в Office 365 почтовых ящиках и Windows устройствах.
