...
- [Управление устройствами для macOS](mac-device-control-overview.md) теперь в общем доступе
- Устранена проблема, из-за которой быстрое сканирование не удалось начать из меню состояния на macOS 11 (Big Sur)
