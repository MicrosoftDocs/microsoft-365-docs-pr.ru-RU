...
Добавление или управление тегами для создания логической групповой принадлежности. Теги устройств поддерживают правильное сопоставление сети, позволяя вам присоединять различные теги для захвата контекста и включения динамического создания списков в рамках инцидента.
...
>Дополнительные сведения см. [в веб-сайте configure-advanced-scan-types-microsoft-defender-antivirus](/windows/security/threat-protection/microsoft-defender-antivirus/configure-advanced-scan-types-microsoft-defender-antivirus).
...
> - Это действие должно соответствовать форматам политики целостности кода Защитник Windows application Control и требованиям к подписанию. Дополнительные сведения см. в виде форматов политики целостности кода [и подписи.](/windows/device-security/device-guard/requirements-and-deployment-planning-guidelines-for-device-guard#code-integrity-policy-formats-and-signing)
...
- [Неточность отчета](/microsoft-365/security/defender-endpoint/tvm-security-recommendation#report-inaccuracy)
