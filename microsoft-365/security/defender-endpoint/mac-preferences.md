...
| **Комментарии** | В следующих разделах описано содержимое словаря. |
...
| **Комментарии** | Доступно в Microsoft Defender для конечной точки версии 100.67.60 или выше. |
...
| **Комментарии** | Доступно в Microsoft Defender для конечной точки версии 100.83.73 или выше. |
...
| **Комментарии** | Применимо только если *$type* *исключенPath* |
...
| **Комментарии** | Применимо только если *$type* *исключеноFileExtension* |
...
| **Комментарии** | Применимо только *если $type* *исключеноFileName* |
...
| **Комментарии** | Доступно в Microsoft Defender для конечной точки версии 101.07.23 или выше. |
...
| **Комментарии** | Доступно в Microsoft Defender для конечной точки версии 101.19.61 или выше. |

### <a name="endpoint-detection-and-response-preferences"></a>Параметры обнаружения конечных точек и ответов

Управление предпочтениями компонента обнаружения конечной точки и ответа (EDR) Microsoft Defender для конечной точки на macOS.
