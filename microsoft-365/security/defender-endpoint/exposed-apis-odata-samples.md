...
Если вы не знакомы с запросами OData, см.: [запросы OData V4](https://www.odata.org/documentation/)
...
Получите 100 устройств с "HealthStatus", не равные "Active":
...
Получите все устройства, которые последний раз видели после 2018-10-20:
...
Получите все антивирусные проверки, созданные пользователем Analyst@examples.onmicrosoft.com с помощью Microsoft Defender для конечной точки:
...
Получите количество открытых оповещений для определенного устройства:
...
Получите все устройства с "computerDnsName", начиная с "mymachine":
