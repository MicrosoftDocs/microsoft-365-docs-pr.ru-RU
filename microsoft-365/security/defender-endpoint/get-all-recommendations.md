...
---
# <a name="list-all-recommendations"></a>Список всех рекомендаций
...
Извлекает список всех рекомендаций по безопасности, влияющих на организацию.
...
В случае успеха этот метод возвращает 200 ОК со списком рекомендаций по безопасности в теле.
