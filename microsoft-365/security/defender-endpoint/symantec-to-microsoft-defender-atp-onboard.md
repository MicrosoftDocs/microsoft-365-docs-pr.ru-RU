...
5. [Удалить Symantec](#uninstall-symantec).

6. [Убедитесь, что Microsoft Defender для конечной точки работает правильно.](#make-sure-microsoft-defender-for-endpoint-is-working-correctly)
...
|macOS:<p>11.3.1 (Big Sur)<p>10.15 (Каталина)<p>10.14 (Mojave)     |Скачайте и используйте приложение DIY по [https://aka.ms/mdatpmacosdiy](https://aka.ms/mdatpmacosdiy) ссылке . <p>Дополнительные сведения см. [в сайте Microsoft Defender для конечной точки на macOS.](microsoft-defender-endpoint-mac.md)        |
...
|PowerShell | 1. На Windows откройте Windows PowerShell в качестве администратора. <p>2. Запустите `Get-MpComputerStatus` cmdlet. <p>3. В списке результатов найди **amRunningMode: Пассивный режим** или **AMRunningMode: пассивный режим SxS.** |
...
2. Удалите пароль для Symantec:<br/>
   ...
   1. На Windows устройствах откройте редактор реестра в качестве администратора.
...
3. Удалите Symantec с устройств. Если вам нужна помощь в этом, см. в документации Broadcom. Вот несколько ресурсов Broadcom: 
   ...
   - [Удалить Symantec Endpoint Protection](https://knowledge.broadcom.com/external/article/156148/uninstall-symantec-endpoint-protection.html)

   - Windows устройства: вручную удалить Endpoint Protection [14](https://knowledge.broadcom.com/external/article?articleId=170040) клиентов на Windows
   ...
   - Устройства Linux: [часто задающие вопросы для Endpoint Protection на Linux](https://knowledge.broadcom.com/external/article?articleId=162054)

## <a name="make-sure-microsoft-defender-for-endpoint-is-working-correctly"></a>Убедитесь, что Microsoft Defender для конечной точки работает правильно

Теперь, когда у вас есть uninstalled Symantec, следующим шагом будет убедиться, что Defender для конечной точки работает правильно. Посетите веб-сайт демонстрационных сценариев Microsoft Defender for Endpoint [https://demo.wd.microsoft.com](https://demo.wd.microsoft.com) (). Попробуйте один или несколько демонстрационных сценариев на этой странице, включая по крайней мере следующие:
- Облачная защита
