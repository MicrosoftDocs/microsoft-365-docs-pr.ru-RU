...
![Например, уведомление о том, что подключение заблокировано: ИТ-администратор заставил Windows Security заблокировать это сетевое подключение. Свяжитесь со своей службой поддержки ИТ.](/microsoft-365/security/defender-endpoint/images/np-notif)
...
|-|-|-|
|5007 | Защитник Windows (операционная) | Событие при смене параметров |
