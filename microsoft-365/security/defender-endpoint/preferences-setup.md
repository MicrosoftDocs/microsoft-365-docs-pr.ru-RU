...
Статья | Описание
:---|:---
Общие параметры | Измените общие параметры, которые ранее определялись как часть процесса работы с бортовой установкой.
Разрешения | Управление доступом к порталу с помощью RBAC, а также групп устройств.
Интерфейсы API | Включение интеграции intel и SIEM угроз.
Правила | Настройка правил подавления и параметров автоматизации.
Управление устройствами | На борту и вне устройствах.
Сетевые оценки | Выберите устройства, которые будут регулярно проверяться и добавляться в инвентарь устройств.
