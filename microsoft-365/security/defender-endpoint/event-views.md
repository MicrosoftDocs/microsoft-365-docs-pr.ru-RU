...
Подробные отчеты о событиях и блоках в Безопасность Windows, если у вас есть подписка на E5, и используйте [Microsoft Defender для конечной точки.](microsoft-defender-endpoint.md)
...
1. Введите **просмотра событий** в меню Пуск и откройте Windows **просмотра событий**.
...
5. Нажмите **OK**. Укажите имя фильтра.
