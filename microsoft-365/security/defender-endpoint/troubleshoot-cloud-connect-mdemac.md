...
Проверка того, что подключение не заблокировано: в браузере, например Microsoft Edge для Mac или Safari, https://x.cp.wd.microsoft.com/api/report откройте и https://cdn.x.cp.wd.microsoft.com/ping .
