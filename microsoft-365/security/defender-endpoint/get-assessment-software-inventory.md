...
## <a name="1-export-software-inventory-assessment-json-response"></a>1. Оценка инвентаризации программного обеспечения экспорта (ответ JSON)
