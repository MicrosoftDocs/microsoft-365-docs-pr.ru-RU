...
3. Чтобы установить надстройку без участия пользователя, откройте командную подсказку и используйте следующий синтаксис:
   ...
   - `BccEmailAddress` указывает дополнительных получателей копии всех отправленных пользователями копий. Значение по умолчанию пусто (дополнительных получателей в ск. нет).
