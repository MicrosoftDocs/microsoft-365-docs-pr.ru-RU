...
|[Включение надстройки Report Message](enable-the-report-message-add-in.md)|Работает с Outlook, Outlook для Mac и Outlook в Интернете (прежнее название — Outlook Web App) и является рекомендуемой надстройкой. <p> В зависимости от вашей подписки, сообщения, которые пользователи сообщили с помощью надстройки, доступны на [портале](admin-submission.md)учетных данных администратора, [автоматическом расследовании и откликах (AIR)](air-view-investigation-results.md), [отчету о сообщениях пользователей](view-email-security-reports.md#user-reported-messages-report)и [обозревателе угроз](threat-explorer-views.md#email--submissions). <p> Можно настроить копирование или перенаправление сообщений, отправленных в указанный почтовый ящик. Для получения дополнительных сведений обратитесь к разделу [политики отправки пользователей](user-submission.md).|
...
|[Отправка нежелательных и фишинговых сообщений электронной почты в Outlook в Интернете](report-junk-email-and-phishing-scams-in-outlook-on-the-web-eop.md)|Использование встроенных возможностей Outlook в Интернете для организаций с почтовыми ящиками Exchange Online (недоступно в автономном EOP). <p> Сообщения, которые пользователи сообщают, доступны на [портале отправки администратором](admin-submission.md). <p> Можно настроить копирование или перенаправление сообщений, отправленных в указанный почтовый ящик. Для получения дополнительных сведений обратитесь к разделу [политики отправки пользователей](user-submission.md).|
|[Отправка нежелательных и фишинговых сообщений электронной почты в Outlook для iOS и Android](report-junk-email-and-phishing-scams-in-outlook-for-iOS-and-Android.md)|Использование встроенных возможностей Outlook для iOS и Android для организаций с почтовыми ящиками Exchange Online (недоступно в автономном EOP). <p> Сообщения, которые пользователи сообщают, доступны на [портале отправки администратором](admin-submission.md). <p> Можно настроить копирование или перенаправление сообщений, отправленных в указанный почтовый ящик. Для получения дополнительных сведений обратитесь к разделу [политики отправки пользователей](user-submission.md).|
