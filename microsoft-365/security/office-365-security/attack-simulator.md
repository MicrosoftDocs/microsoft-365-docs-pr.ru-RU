...
- Чтобы открыть Центр безопасности и соответствия требованиям, перейдите по ссылке <https://protection.office.com/>. Симулятор атак доступен в \> **симуляторе атак**с **управлением угрозами** .
