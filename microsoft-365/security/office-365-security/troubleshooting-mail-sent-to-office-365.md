...
Технологии фильтрации EOP предназначены для обеспечения защиты от нежелательной почты для Microsoft 365, а также других продуктов Майкрософт, таких как Exchange Server. Кроме того, вы также можете использовать SPF, DKIM и DMARC; технологии проверки подлинности электронной почты, которые помогают устранить проблему подмены и фишинга, проверяя, авторизован ли домен, отправляющий электронную почту. Влияние на фильтрацию EOP зависит от ряда факторов, связанных с отправкой IP-адреса, домена, проверки подлинности, точности списков, нормами жалоб, содержимым и т. д. Из них один из основных факторов, влияющих на репутацию репутации отправителя и возможность доставки электронной почты, — это частота жалоб для нежелательной почты.
...
Для получения дополнительных сведений о полученной ошибке обратитесь к списку кодов ошибок в [отчетах о недоставке электронной почты в Exchange Online](https://docs.microsoft.com/exchange/mail-flow-best-practices/non-delivery-reports-in-exchange-online/non-delivery-reports-in-exchange-online).
 ...
 Например, если вы получили следующий отчет о недоставке, он указывает, что IP-адрес отправителя заблокирован корпорацией Майкрософт:

 `550 5.7.606-649 Access denied, banned sending IP [x.x.x.x]; To request removal from this list please visit https://sender.office.com/ and follow the directions.`

Чтобы запросить удаление из этого списка, можно [удалить себя из списка заблокированных отправителей с помощью портала удаления списков](use-the-delist-portal-to-remove-yourself-from-the-office-365-blocked-senders-lis.md).

## <a name="my-email-landed-in-the-recipients-junk-email-folder"></a>Моя электронная почта, отправленная в папку "Нежелательная почта" получателя
...
Если вы часто проводите массовые кампании по электронной почте для пользователей Microsoft 365 и хотите обеспечить безопасность и своевременное получение сообщений, следуйте советам, приведенным в этом разделе.

### <a name="ensure-that-the-from-name-reflects-who-is-sending-the-message"></a>Убедитесь, что имя пользователя соответствует отправителю сообщения.
