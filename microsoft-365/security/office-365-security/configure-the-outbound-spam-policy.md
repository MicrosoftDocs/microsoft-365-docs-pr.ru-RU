...
В Exchange Online PowerShell или отдельном Exchange Online Protection PowerShell различия между политиками фильтрации исходящей нежелательной почты и фильтром исходящей нежелательной почты очевидны. Управление политиками фильтрации нежелательной почты осуществляется с помощью командлетов ** \*– хостедаутбаундспамфилтерполици** и управление правилами фильтрации нежелательной почты с помощью командлетов ** \*– хостедаутбаундспамфилтерруле** .
