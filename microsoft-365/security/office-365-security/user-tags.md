...
Теги пользователя — это идентификаторы для определенных групп пользователей в [защитнике для Office 365](office-365-atp.md). Существует два типа тегов пользователя:
