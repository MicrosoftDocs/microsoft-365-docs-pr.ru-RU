...
> [!NOTE]
> Если вы используете единый центр Microsoft 365 безопасности, вы можете установить теги здесь: https://security.microsoft.com/securitysettings/userTags .
...
> [!NOTE]
> Нельзя удалить встроенный тег учетной **записи Priority.**
