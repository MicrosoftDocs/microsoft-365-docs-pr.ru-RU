...
5. На портале Azure создайте новую политику условного доступа с помощью следующих параметров:

   **Назначения** \> **Пользователи и группы**: выберите соответствующих пользователей и группы, которые требуется включить и исключить.

   **Назначения** \> **Облачные приложения или действия** \> **Облачные приложения** \> **Включить** \> **Выбор приложений**: выберите **Office 365 Exchange Online**

   **Элементы управления доступом** \> **Сеанс**: выберите **использовать принудительные ограничения приложения**
