...
||[Блокирование клиентов, не поддерживающих современную проверку подлинности](identity-access-policies.md#block-clients-that-dont-support-modern-authentication)|Включить Exchange Online в назначение облачных приложений|
...
|**Строго контролируемый**|[*Всегда требуется* многофаксная](identity-access-policies.md#require-mfa-based-on-sign-in-risk)|Включить Exchange Online в назначение облачных приложений|
|
