...
1. На портале Microsoft 365 Defender () выберите обозреватель & совместной работы (или обнаружения в <https://security.microsoft.com>  \>  **режиме реального времени).** (В этом примере используется Explorer.) Если вы на портале сходящихся Microsoft 365 Defender https://security.microsoft.com/) (прокрутите до **обозревателя &**  >  **электронной почты.**
...
2. В меню **Просмотр** выберите вредоносные программы в **статье** **Email**.
...
1. На портале Microsoft 365 Defender () выберите обозреватель & совместной работы (или обнаружения в <https://security.microsoft.com>  \>  **режиме реального времени).** (В этом примере используется Explorer.)
