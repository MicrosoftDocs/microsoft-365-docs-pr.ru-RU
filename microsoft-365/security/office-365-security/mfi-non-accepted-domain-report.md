...
В отчете о не [](mail-flow-insights-v2.md) принятых доменах [](https://protection.office.com) в панели мониторинга потока почты в Центре соответствия требованиям & безопасности отображаются сведения о сообщениях из локальной организации электронной почты, где домен отправитель не настроен как принятый домен в вашей Microsoft 365 организации. 
