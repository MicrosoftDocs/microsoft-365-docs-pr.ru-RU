...
1. На портале Microsoft 365 Defender **перейдите** к политикам & правил Политики угрозы Клиент \>  \> **разрешить и блокировать списки**.
...
1. На портале Microsoft 365 Defender **перейдите** к политикам и & политики угрозы \>  \> **Клиент разрешить или заблокировать списки**.
...
1. На портале Microsoft 365 Defender перейдите к **клиенту политики** управления угрозами \>  \> **Разрешить и заблокировать списки**.
