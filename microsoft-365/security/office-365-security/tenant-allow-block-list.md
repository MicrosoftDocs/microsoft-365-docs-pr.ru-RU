...
---
# <a name="managing-allows-and-blocks-in-the-tenant-allowblock-list"></a>Управление разрешением и блоками в списке "Разрешить или заблокировать клиента"
...
## <a name="use-the-security--compliance-center-to-create-url-entries-in-the-tenant-allowblock-list"></a>Использование Центра безопасности & соответствия требованиям для создания URL-адресов в списке "Разрешить или заблокировать клиента"
...
2. На странице **"Список заблокированных** и разрешаний клиентов" убедитесь, что вкладка **"URL-адреса"** выбрана, и нажмите кнопку **"Добавить".**

3. В **окне "Добавление новых** URL-адресов" настройте следующие параметры:

   - **Добавление URL-адресов с поддиаными** знаками: введите один URL-адрес в строку до 20.
...
Чтобы очистить существующие фильтры, щелкните **"Фильтр",** а затем щелкните  **"Очистить фильтры".**
...
Чтобы добавить записи в список "Клиенты: разрешить или заблокировать", используйте следующий синтаксис:
...
В этом примере из списка допустимого или заблокированного клиента удаляется указанная запись URL-адреса.
...
- Имена хостов разрешены, если истинны все следующие утверждения:
  ...
  - Слева от периода находится хотя бы один символ.
