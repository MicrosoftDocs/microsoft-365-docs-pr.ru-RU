...
Рабочие нагрузки, такие как SharePoint, OneDrive и Teams, созданы для совместной работы. Использование защитника для Office 365 помогает блокировать и обнаруживать файлы, которые определены как вредоносные на сайтах групп и в библиотеках документов. Подробнее о том, как это работает, можно прочитать [здесь](atp-for-spo-odb-and-teams.md).
