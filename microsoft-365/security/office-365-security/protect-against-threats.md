...
3. В вылете сведений о политике, которые появляются, сделайте следующие действия:
   - **Основной порог электронной почты & разделе свойства** нежелательной почты: Нажмите кнопку Изменить порог и **свойства нежелательной почты**. В **выявяемом** пороге нежелательной  почты и свойствах установите пороговое значение bulk email до 5 (Strict) или 6 (Standard). Выполнив необходимые действия, нажмите кнопку **Сохранить**.
