...
4. Возвращаясь к вылету сведений о политике, нажмите **кнопку Закрыть**.
...
2. На странице **Политики по борьбе со спамом** выберите политику с именем **политики** входящие сообщения о нежелательной почте из списка, нажав на имя.

3. В разделе Сведения о политике, которые появляются, щелкните **Изменить** порог нежелательной почты и свойства в разделе Bulk **email threshold & свойств нежелательной** почты.

4. В **выявяемом** пороге нежелательной  почты и свойствах установите пороговое значение bulk email до 5 (Strict) или 6 (Standard). По завершению нажмите кнопку **Сохранить**

5. Возвращаясь к вылету сведений  о политике, перейдите в раздел Разрешенные и заблокированные отправители и домены и просмотрите или отредактировать разрешенные отправители и разрешенные домены.

6. Когда закончите, нажмите кнопку **Закрыть**.
