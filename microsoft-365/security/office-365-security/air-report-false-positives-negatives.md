...
|---|---|---|
|Сообщение электронной почты было отправлено в папку нежелательной почты пользователя|<ul><li>Перемещение сообщения в папку удаленных элементов пользователя</li><li>Перемещение сообщения в почтовый ящик пользователя</li><li>Удаление сообщения</li></ul>|[Поиск и расследование вредоносной электронной почты, доставленной в Office 365](investigate-malicious-email-that-was-delivered.md)|
|Сообщение электронной почты или файл были на карантине|<ul><li>Освобождение электронной почты или файла</li><li> Удаление электронной почты или файла</li></ul>|[Управление карантинными сообщениями в качестве администратора](manage-quarantined-messages-and-files.md)|
|
...
1. Перейдите на портал Microsoft 365 Defender ( <https://security.microsoft.com> ).
