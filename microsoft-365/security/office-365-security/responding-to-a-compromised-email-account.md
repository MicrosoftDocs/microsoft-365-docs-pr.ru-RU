...
Если пользователь сообщает о любом из указанных признаков, необходимо провести дальнейшее расследование. [Microsoft 365 Defender](https://security.microsoft.com) и портал Azure предлагают инструменты для расследования активности учетной записи пользователя, которая, как вы подозреваете, может быть скомпрометирована.

- **Единые журналы аудита на портале Microsoft 365 Defender**. Просмотрите все действия в подозреваемой учетной записи, отфильтруйте результаты по диапазону дат: с момента сразу перед подозрительным действием до текущей даты. Не фильтруйте действия во время поиска.
...
1. Откройте Центр администрирования Microsoft 365 на странице <https://admin.microsoft.com> и перейдите к разделу **Пользователи** \> **Активные пользователи**.
...
4. Откройте Центр администрирования Exchange на странице <https://admin.exchange.microsoft.com> и перейдите к разделу **Получатели** \> **Почтовые ящики**.

5. Найдите и выберите пользователя. В открывшемся диалоговом окне выполните указанные ниже действия.
   - В разделе **Почтовые приложения** заблокируйте все доступные настройки, переместив переключатель вправо ![Отключить](../../media/scc-toggle-on.png):
     - **Outlook в Интернете**
...
1. Откройте Центр администрирования Microsoft 365 на странице <https://admin.microsoft.com> с помощью учетной записи глобального администратора и выполните следующие действия.
...
2. Откройте портал Microsoft 365 Defender на странице <https://security.microsoft.com> и выполните следующие действия.
   1. Перейдите в раздел **Разрешения и роли** \> **Почта и роли совместной работы** \> **Роли**.
   2. На странице **Разрешения** выберите все группы ролей в списке и найдите учетную запись пользователя в разделе **Участники** появившейся области сведений. Если группа ролей содержит учетную запись пользователя, выполните следующие действия.
      1. В разделе **Участники** выберите **Изменить**.
      2. В появившейся области **Изменение свойства "Выбор участников"** нажмите **Изменить**.
      3. В появившейся области **Выбор участников** нажмите **Удалить**.
      4. В появившейся области выберите учетную запись пользователя и нажмите **Удалить**.

         После завершения нажмите **Готово**, **Сохранить** и **Закрыть**.

3. Откройте Центр администрирования Exchange на странице <https://admin.exchange.microsoft.com> и выполните следующие действия.
   1. Выберите **Роли** \> **Роли администраторов**.
   2. На странице **Роли администраторов** вручную выберите все группы ролей. В области сведений выберите вкладку **Назначено**, чтобы проверить учетные записи пользователей. Если группа ролей содержит учетную запись пользователя, выполните следующие действия.
      1. Выберите учетную запись пользователя.
      2. Нажмите ![значок "Удалить"](../../media/m365-cc-sc-delete-icon.png).
