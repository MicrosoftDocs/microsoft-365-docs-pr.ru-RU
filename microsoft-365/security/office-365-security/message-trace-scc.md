...
> [!NOTE]
> Для выполнения трассировки сообщений администратор должен быть членом группы "Управление организацией", "Управление соответствием требованиям" или "группы ролей службы поддержки".
