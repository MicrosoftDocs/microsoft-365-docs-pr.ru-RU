...
В ходе последних обновлений мы также добавили события расследования от автоматического реагирования на инциденты Office 365 ATP 2 в API управления. Помимо включения данных об основных сведениях расследования, таких как ID, Name и Status, он также содержит сведения высокого уровня о действиях и сущностях расследования.   
...
|64|аиринвестигатион|Автоматизированные события реагирования на инциденты, включающие подробные сведения о расследовании и релевантные артефакты из Office 365 Advanced Threat Protection Plan 2.|
...
[Автоматизированное реагирование на инциденты (AIR) в Office 365](automated-investigation-response-office.md)
