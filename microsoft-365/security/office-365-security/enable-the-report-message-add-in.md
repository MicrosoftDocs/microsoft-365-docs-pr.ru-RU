...
7. На **странице "Настройка надстройки"** настройте следующие параметры:
   ...
   - **Метод развертывания:** выберите одно из следующих значений:
     ...
     - **Доступно:** пользователи могут установить надстройки на **сайте Home** Get, управляемые \>  \> **администратором.**
...
3. В **отобра просмотреть** и изменить параметры в соответствующем для вашей организации октете "Изменение сообщения отчета". По завершении нажмите кнопку **Сохранить**.
