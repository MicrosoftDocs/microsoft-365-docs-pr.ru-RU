...
1. Перейдите на [страницу "службы &](https://admin.microsoft.com/AdminPortal/Home#/Settings/ServicesAndAddIns) надстроек" центра администрирования Microsoft 365.
