...
Кроме того, если в организации используется [защитник Microsoft для Office 365 (план 1](office-365-atp.md) ) или [2](office-365-ti.md), то надстройка с сообщениями отчета предоставляет группе безопасности Организации полезную информацию, которую можно использовать для просмотра и обновления политик безопасности.
