...
3. В **отобра просмотреть** и изменить параметры в соответствующем для вашей организации октете "Изменение сообщения отчета". Когда закончите, нажмите кнопку **Сохранить**.
