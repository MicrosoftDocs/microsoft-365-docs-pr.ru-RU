...
С помощью Microsoft Defender для Office 365 команда безопасности вашей организации может настраивать защиту, определяя политики в Microsoft 365 Defender (выберите <https://security.microsoft.com> \> **Сообщения электронной почты и совместная работа** \> **Политики и правила**).
...
В Microsoft Defender для Office 365 входит расширенная [панель мониторинга для отчетов](view-reports-for-mdo.md), позволяющая отслеживать производительность Defender для Office 365. Она доступна в разделе **Отчеты** \> **Панель мониторинга** на портале Microsoft 365 Defender.
...
Чтобы получить доступ к возможностям Microsoft Defender для Office 365 в Microsoft 365 Defender, вам нужна соответствующая роль. В следующей таблице приведено несколько примеров.

|Роль или группа ролей|Дополнительные ресурсы|
|---|---|
|глобальный администратор (назначается в Azure Active Directory или в Microsoft 365 Defender)|[О ролях администратора Microsoft 365](../../admin/add-users/about-admin-roles.md)|
|Администратор безопасности (назначается в Azure Active Directory или в Microsoft 365 Defender)|[Разрешения роли администратора в Azure Active Directory](/azure/active-directory/users-groups-roles/directory-assign-admin-roles) <p> [Разрешения в Microsoft 365 Defender](permissions-in-the-security-and-compliance-center.md)|
...
|Search and Purge (назначается только в Microsoft 365 Defender)|[Разрешения в Microsoft 365 Defender](permissions-in-the-security-and-compliance-center.md)|

Дополнительные сведения см. в статье [Разрешения в Microsoft 365 Defender](permissions-in-the-security-and-compliance-center.md).
