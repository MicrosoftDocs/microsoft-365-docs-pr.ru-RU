...
*Ознакомьтесь с обновленной версией советов и процедур для работы с этими списками в качестве администратора* , [чтобы предотвратить пометку сообщений электронной почты как спама в Office 365](prevent-email-from-being-marked-as-spam.md).
