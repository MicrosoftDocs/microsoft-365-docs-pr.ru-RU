...
- В политике задано **наименьшее** значение приоритета, которое вы не можете изменить (политика всегда применяется последней). Все создаваемые настраиваемые политики всегда имеют более высокий приоритет.
