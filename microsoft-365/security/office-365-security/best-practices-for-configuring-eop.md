...
### <a name="miscellaneousnon-policy-settings"></a>Прочие параметры и параметры, не относякие к политике
...
|Отправка SMTP с проверкой подлинности|Отключено|Отключено|Отправка SMTP клиента с проверкой подлинности (также известная как отправка SMTP клиента или ПРОВЕРКА ПОДЛИННОСТИ SMTP) требуется для отправки электронной почты клиентами POP3 и IMAP4.|
