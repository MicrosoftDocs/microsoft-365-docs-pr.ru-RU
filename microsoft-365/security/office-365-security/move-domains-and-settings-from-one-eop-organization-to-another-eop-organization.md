...
- Защита от нежелательной почты
  ...
  - Политики фильтрации исходящие нежелательных сообщений
...
6. Добавьте проверочные записи типа TXT в записи DNS. Это позволит вам быстрее проверить домены в организации-источнике после их удаления из целевой организации. Дополнительные сведения о настройке DNS см. в записях создания DNS у любого поставщика услуг размещения [DNS для Microsoft 365.](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider)
...
Дополнительные сведения о настройке DNS см. в записях создания DNS у любого поставщика услуг размещения [DNS для Microsoft 365.](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider)
...
Если вы решили установить недопустимый адрес для записей MX, чтобы отправители в очереди сообщения во время перехода, необходимо вернуть им правильное значение, указанное в Центре [администрирования.](https://admin.microsoft.com) Дополнительные сведения о настройке DNS см. в записях создания DNS у любого поставщика услуг размещения [DNS для Microsoft 365.](https://docs.microsoft.com/microsoft-365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider)
