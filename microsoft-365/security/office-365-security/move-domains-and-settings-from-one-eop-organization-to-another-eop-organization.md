...
2. Щелкните **Домены**.
   ...
   Если вы не видите домены, нажмите кнопку **настроить навигацию**, выберите пункт **Настройка**, а затем нажмите кнопку **сохранить**.
...
1. Войдите в центр администрирования по адресу <https://portal.office.com> .
