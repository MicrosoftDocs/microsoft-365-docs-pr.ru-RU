...
- Список **"Блокировать следующие URL-адреса".** Дополнительные сведения см. в [списке "Блокировка следующих URL-адресов" для безопасных ссылок](atp-safe-links.md#block-the-following-urls-list-for-safe-links)
...
2. В **окне "Политика безопасных ссылок"** для организации перейдите в поле **"Блокировать следующие URL-адреса".**
...
Подробные сведения о синтаксис записи см. в синтаксис записи для [списка "Блокировать следующие URL-адреса".](atp-safe-links.md#entry-syntax-for-the-block-the-following-urls-list)
...
2. В политике **безопасных ссылок** для организации настройте следующие параметры в параметрах, которые применяются к содержимому, кроме раздела **"Электронная** почта":

   - **Приложения Office 365:** убедитесь, что для поддерживаемых приложений Office 365 вкл. ![ ](../../media/scc-toggle-on.png)

   - **Не отслеживайте,** когда пользователи нажимают кнопку "Безопасные ссылки": переключение влево для отслеживания щелчков, связанных с заблокированными URL-адресами, в поддерживаемых приложениях Office 365: выключение. ![ ](../../media/scc-toggle-off.png)
