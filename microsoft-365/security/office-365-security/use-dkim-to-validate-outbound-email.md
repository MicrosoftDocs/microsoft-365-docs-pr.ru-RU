...
DKIM —  один из троицы методов проверки подлинности (SPF, DKIM и DMARC), помогающих предотвратить отправку спуфинговых сообщений, которые выглядят так, как будто они приходят из вашего домена.
