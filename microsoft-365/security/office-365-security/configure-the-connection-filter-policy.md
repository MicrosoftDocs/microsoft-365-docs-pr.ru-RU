...
3. В появившемся всплывающем меню **по умолчанию** настройте любой из следующих параметров:
   ...
   - **Список разрешенных IP-адресов**: нажмите кнопку **изменить**. В появившемся всплывающем меню **белого списка IP-** адресов введите IPv4-адрес в поле **адрес или диапазон адресов** , используя следующий синтаксис:
     ...
     Чтобы добавить IP-адрес или диапазон адресов, нажмите кнопку **Добавить** ![значок](../../media/ITPro-EAC-AddIcon.png). Чтобы удалить запись, выберите запись в поле **разрешенный IP-адрес** , а **Remove** ![затем нажмите](../../media/scc-remove-icon.png)кнопку Удалить удаление. Выполнив необходимые действия, нажмите кнопку **Сохранить**.
   ...
   - **Список заблокированных IP-адресов**: нажмите кнопку **изменить**. В появившемся всплывающем меню **списка заблокированных IP-** адресов введите один IP-адрес, диапазон IP-адресов или IP-адрес CIDR в поле **адрес или диапазон адресов** , как описано в параметрах **белого списка IP-** адресов.
     ...
     Чтобы добавить IP-адрес или диапазон адресов, нажмите кнопку **Добавить** ![значок](../../media/ITPro-EAC-AddIcon.png). Чтобы удалить запись, выберите запись в разделе **заблокированный IP-адрес** , а **Remove** ![затем нажмите](../../media/scc-remove-icon.png)кнопку Удалить удаление. Выполнив необходимые действия, нажмите кнопку **Сохранить**.
