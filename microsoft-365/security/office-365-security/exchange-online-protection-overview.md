...
- [Настройте EOP, день 1, для администраторов office 365 ATP](https://docs.microsoft.com/microsoft-365/security/office-365-security/protect-against-threats?view=o365-worldwide): Настройка средств защиты и обнаружения EOP в ядре Office 365 Advanced Threat protection.
