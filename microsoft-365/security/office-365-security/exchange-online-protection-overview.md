...
- [Настройте EOP, день 1, для администраторов Майкрософт для office 365](https://docs.microsoft.com/microsoft-365/security/office-365-security/protect-against-threats?view=o365-worldwide): Настройка средств защиты и обнаружения EOP в ядре Microsoft Defender для Office 365.
