...
- Создайте и используйте отдельные учетные записи, которые назначены роли администратора [Microsoft 365](../../admin/add-users/about-admin-roles.md) *только для администрирования.* Администраторы должны иметь собственную учетную запись пользователя для регулярного использования, не связанного с администрированием, и использовать учетную запись администратора, только если это необходимо для выполнения задачи, связанной с их ролью или должностью.
