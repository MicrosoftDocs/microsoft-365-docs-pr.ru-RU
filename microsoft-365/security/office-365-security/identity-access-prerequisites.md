...
|[Настройка записи пароля в локальной AD](/azure/active-directory/active-directory-passwords-getting-started). Возвращение пароля позволяет Azure AD требовать, чтобы пользователи меняли собственные пароли при обнаружении компрометации учетной записи с высоким уровнем риска. Эту функцию можно включить с помощью Azure AD Подключение  одним из двух способов: включить запись пароля на необязательный экран функций мастера установки Azure AD Подключение или включить его через Windows PowerShell.|Только облако|Microsoft 365 E3 или E5|
...
|[Включить Azure Active Directory identity Protection](/azure/active-directory/identity-protection/overview-identity-protection). Azure AD Identity Protection позволяет обнаруживать потенциальные уязвимости, влияющие на удостоверения организации, и настраивать автоматизированную политику восстановления с низким, средним и высоким уровнем риска и риска для пользователей.||Microsoft 365 E5 или Microsoft 365 E3 с надстройки безопасности E5|
|**Включить современную проверку** подлинности [для Exchange Online](/Exchange/clients-and-mobile-in-exchange-online/enable-or-disable-modern-authentication-in-exchange-online) и [для Skype для бизнеса Online](https://social.technet.microsoft.com/wiki/contents/articles/34339.skype-for-business-online-enable-your-tenant-for-modern-authentication.aspx). Современная проверка подлинности является обязательным условием использования MFA. Современная проверка подлинности включена по умолчанию для Office 2016 и 2019 годов, SharePoint и OneDrive для бизнеса.||Microsoft 365 E3 или E5|
|
...
|Платформа|Word/Excel/PowerPoint|OneNote|OneDrive App|SharePoint App|[Клиент синхронизации OneDrive](/onedrive/enable-conditional-access)|
|---|---|---|---|---|---|
...
- [Microsoft 365 Поддержка клиентских приложений — условный доступ](../../enterprise/microsoft-365-client-support-conditional-access.md)
- [Microsoft 365 Поддержка клиентских приложений — многофакторная проверка подлинности](../../enterprise/microsoft-365-client-support-multi-factor-authentication.md)
...
Для выпусков Microsoft 365 или Office 365, которые не поддерживают условный доступ, можно включить по умолчанию безопасность, чтобы требовать MFA для всех учетных записей. [](/azure/active-directory/fundamentals/concept-fundamentals-security-defaults)

Вот некоторые дополнительные рекомендации:

- Используйте [службу Azure AD управление привилегированными пользователями,](/azure/active-directory/privileged-identity-management/pim-getting-started) чтобы уменьшить число постоянных административных учетных записей.
...
- Создание и использование отдельных учетных записей, которые Microsoft 365 [роли](../../admin/add-users/about-admin-roles.md) администратора *только для администрирования.* Администраторы должны иметь свою учетную запись пользователя для регулярного неуправления и использовать только административную учетную запись, если это необходимо для выполнения задачи, связанной с их ролью или функцией работы.
