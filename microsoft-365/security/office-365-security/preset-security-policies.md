...
- Откройте Центр безопасности и соответствия требованиям на сайте <https://protection.office.com/>. Чтобы перейти непосредственно на страницу **предустановленных политик безопасности,** используйте <https://protection.office.com/presetSecurityPolicies> .
...
Действия, необходимые для  изменения назначения  стандартной или строгой политики безопасности защиты, такие же, как при первоначальном назначении предварительно заранее заранее заранее заранее заранее заранее заранее принятых политик [безопасности пользователям.](#use-the-security--compliance-center-to-assign-preset-security-policies-to-users)

Чтобы отключить  стандартную  или строгую защиту с сохранением существующих условий и исключений, сдвиньте этот переключение на **"Отключено".** Чтобы включить политики, переключить его на **"Включено".**
