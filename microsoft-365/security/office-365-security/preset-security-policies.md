...
- Политики Microsoft Defender для **Office 365:** это организации с подписками на надстройки Microsoft 365 E5 или Defender для Office 365:
  ...
  - [Политики безопасных ссылок](set-up-atp-safe-links-policies.md) с именем **Standard Preset Security Policy** и Strict **Preset Security Policy**.

  - [Политики безопасных вложений](set-up-atp-safe-attachments-policies.md) с именем **Standard Preset Security Policy** и Strict **Preset Security Policy**.
...
Вы не можете изменить параметры политики в профилях защиты. Значения **стандартных** **и** строгих параметров политики описаны в рекомендуемых параметрах безопасности EOP и Microsoft Defender для Office [365.](recommended-settings-for-eop-and-office365-atp.md)
