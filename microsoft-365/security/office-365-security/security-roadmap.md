...
|Управление идентификацией и доступом|<ul><li>[Включить защиту удостоверений Azure Active Directory.](/azure/active-directory/active-directory-identityprotection-enable)</li><li>В федерадных средах удостоверений применяйте безопасность учетных записей (длина пароля, возраст, сложность и т.д.).</li></ul>|
