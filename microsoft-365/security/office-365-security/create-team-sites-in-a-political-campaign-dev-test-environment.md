...
1. При необходимости войдите в Центр администрирования Microsoft 365 (<https://admin.microsoft.com>) с использованием учетных данных учетной записи глобального администратора пробной подписки. Справочные сведения см. в статье [Вход в Microsoft 365](https://support.microsoft.com/office/e9eb7d51-5430-4929-91ab-6157c5a050b4).

2. На **домашней странице** нажмите **Показать все**. В появившемся разделе **Центры администрирования** нажмите **Соответствие требованиям**.

3. С **домашней страницы** Центра соответствия требованиям Microsoft 365 перейдите в раздел **Решения** \> **Защита информации**. Чтобы сразу перейти на страницу **Защита информации**, используйте ссылку <https://compliance.microsoft.com//informationprotection>.

4. На странице **Защита информации** убедитесь, что выбран тег **Метка** и нажмите ![Значок "Создать метку"](../../media/m365-cc-sc-create-icon.png) **Создать метку**.

5. Откроется мастер **Новая метка конфиденциальности**. На шаге **Имя и описание** введите следующие значения:
   - **Имя**: Тип **Внутренний**.
   - **Отображаемое имя**
...
6. В области **Параметры метки** нажмите кнопку **Далее**.

7. В области **Проверьте параметры** нажмите **Создать эту метку**, а затем — кнопку **Закрыть**.

8. Повторите действия 5–8 для следующих меток:
...
15. В области **Назовите политику** введите **Кампания** в поле **Название**, а затем нажмите кнопку **Далее**.
...
1. Войдите в центр администрирования, используя учетную запись с ролью администратора компании или администратора безопасности. Справочные сведения см. в статье [Вход в Office 365](https://support.microsoft.com/office/e9eb7d51-5430-4929-91ab-6157c5a050b4).
...
19. Выберите элемент **Добавить или удалить метки**. На панели **Политики: добавление и удаление меток** нажмите **СтратегияКампании**, а затем — **ОК**.
