...
ms.locfileid: "43636050"
---
# <a name="anti-spam-protection-in-microsoft-365"></a>Защита от нежелательной почты в Microsoft 365

> [!NOTE]
> Эта статья предназначена для администраторов Microsoft 365. В разделе [Обзор фильтра нежелательной почты](https://support.Microsoft.com/article/5ae3ea8e-cf41-4fa0-b02a-3b96e21de089) , а также [сведения о нежелательной почте и фишинге](https://support.Microsoft.com/article/86c1d76f-4d5a-4967-9647-35665dc17c31).

Если вы являетесь клиентом Microsoft 365 с почтовыми ящиками в Exchange Online или отдельном клиенте Exchange Online Protection (EOP) без почтовых ящиков Exchange Online, сообщения электронной почты автоматически защищаются от спама (Нежелательная почта) по EOP.
