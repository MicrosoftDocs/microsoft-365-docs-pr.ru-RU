...
2. В открывшемся окне **Новая роль группы** настройте следующие параметры:
    ...
    - **Роли**: щелкните **Добавить** ![ значок Добавить ](../../media/ITPro-EAC-AddIcon.png) или **Удалить** ![ итпро-ЕАК-ремовеикон. gif, ](../../media/ITPro-EAC-RemoveIcon.gif) чтобы выбрать или изменить роли, назначенные группе ролей.

    - **Члены**: щелкните **Добавить** ![ значок Добавить ](../../media/ITPro-EAC-AddIcon.png) или **Удалить** ![ итпро-ЕАК-ремовеикон. gif ](../../media/ITPro-EAC-RemoveIcon.gif) , чтобы изменить членство в группе ролей.
...
2. На открывшейся странице "Свойства группы ролей" в разделе **мемеберс** выполните одно из следующих действий:
