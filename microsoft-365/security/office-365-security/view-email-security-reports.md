...
Чтобы просмотреть отчет на портале Защитник Microsoft  365, перейдите в отчеты электронной почты & совместной & отчеты о \>  \> **совместной работе.** На **скомпрометированную пользователей,** нажмите **просмотреть сведения**. Чтобы перейти непосредственно к отчету, откройте <https://security.microsoft.com/reports/CompromisedUsers> .

После нажатия кнопки **Просмотр** сведений можно отфильтровать диаграмму и таблицу сведений, щелкнув **фильтр** и выбрав одно или несколько следующих значений в вылете:
...
Когда вы закончите фильтрацию, нажмите кнопку **Применить** или **Отменить**.

![Представление отчета в отчете о скомпрометированных пользователях](../../media/compromised-users-report-activity-view.png)

В таблице ниже графика приведены следующие сведения:
...
Чтобы просмотреть отчет на портале Защитник Microsoft  365, перейдите в отчеты электронной почты & совместной & отчеты о \>  \> **совместной работе.** В **правиле транспорта Exchange** нажмите **кнопку Просмотр сведений**. Чтобы перейти непосредственно к отчету, откройте <https://security.microsoft.com/reports/ETRRuleReport> .

![Виджет правила транспорта Exchange на странице отчетов & электронной почты](../../media/transport-rule-report-widget.png)

После щелчка **"Просмотр сведений"** доступны следующие диаграммы и данные:

- **Просмотр данных по правилам транспорта Exchange** \> **Разбивка диаграмм по направлению.**  На этой  диаграмме показано количество входящие и исходящие сообщения, на которые повлияли правила потока почты.

- **Просмотр данных по правилам транспорта Exchange** \> **Разбивка диаграммы** по строгости. На этой диаграмме показано количество сообщений с высокой степенью тяжести, средней серьезности и **низкой** серьезности. Вы установите уровень серьезности в качестве действия в правиле **(Аудит** этого правила с уровнем серьезности или _SetAuditSeverity)._ Дополнительные сведения см. в сообщении о действиях правила [потока почты в Exchange Online.](/Exchange/security-and-compliance/mail-flow-rules/mail-flow-rule-actions)

- **Просмотр данных по правилам транспорта DLP Exchange** \> **Разбивка диаграммы** по направлению  . На  этой диаграмме показано количество входящие и исходящие сообщения, которые были затронуты правилами предотвращения потери данных (DLP) потока почты.

- **Просмотр данных по правилам транспорта DLP Exchange** \> **Разбивка диаграммы** по строгости. В этом представлении показано  количество сообщений высокой степени **тяжести,** средней степени тяжести и низкой степени тяжести, которые были затронуты правилами потока почты DLP.

Для **просмотра данных по выборам правил** транспорта Exchange в таблице сведений ниже показано следующее:
...
Для **просмотра данных по выборам** правил транспорта DLP Exchange в таблице сведений ниже показано следующее:
...
Чтобы просмотреть отчет на портале Защитник Microsoft  365, перейдите в отчеты электронной почты & совместной & отчеты о \>  \> **совместной работе.** В **сводке состояния mailflow** щелкните **Сведения о просмотре.** Чтобы перейти непосредственно к отчету, откройте <https://security.microsoft.com/reports/mailflowStatusReport> .
...
После нажатия **кнопки Просмотр** сведений можно отфильтровать диаграмму и таблицу сведений, щелкнув **фильтр** и выбрав:

- **Дата:** **дата начала и** дата **окончания**
...
> [!NOTE]
> Отчет **об обнаружении нежелательной** почты пройдет 30 июня 2021 г. Такая же информация доступна в отчете о состоянии [защиты от угроз.](#threat-protection-status-report)
...
Чтобы просмотреть отчет на портале Microsoft 365 Defender,  перейдите в отчеты электронной почты & совместной & отчеты о \>  \> **совместной работе.** При **обнаружении Spoof** нажмите **кнопку Просмотр сведений**. Чтобы перейти непосредственно к отчету, откройте <https://security.microsoft.com/reports/SpoofMailReportV2> .
...
После нажатия **кнопки Просмотр** сведений можно отфильтровать диаграмму и таблицу сведений, щелкнув **Фильтр** и выбрав одно или несколько следующих значений:
...
Чтобы просмотреть отчет на портале Microsoft 365 Defender,  перейдите в отчеты электронной почты & совместной & отчеты о \>  \> **совместной работе.** В **статусе защиты от угроз** нажмите **кнопку Просмотр сведений**. Чтобы перейти непосредственно к отчету, откройте один из следующих URL-адресов:
...
По умолчанию после нажатия сведений **Просмотреть** на диаграмме показаны данные за последние 7 дней. При **нажатии фильтра** можно выбрать диапазон дат в 90 дней (пробная подписка может быть ограничена 30 днями). Таблица сведений позволяет фильтровать в течение 30 дней.
...
Чтобы просмотреть отчет на портале Microsoft 365 Defender,  перейдите в отчеты электронной почты & совместной & отчеты о \>  \> **совместной работе.** В **верхней части вредоносных** программ **щелкните Просмотр сведений**. Чтобы перейти непосредственно к отчету, откройте <https://security.microsoft.com/reports/TopMalware> .
...
После нажатия **сведений Просмотра** на странице отчетов отображается более крупная версия диаграммы пирога. В таблице сведений ниже диаграммы показаны следующие сведения:
