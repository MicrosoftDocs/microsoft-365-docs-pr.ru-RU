...
- **Разделите на: технология обнаружения** и **Просмотр данных по: \> Фишинг электронной почты**: отображаются следующие сведения:
  ...
  - **Созданная для ATP репутация URL-адреса**<sup>1</sup>: репутация вредоносного URL-адреса, созданного из ATP детонатионс в других клиентах ATP.
