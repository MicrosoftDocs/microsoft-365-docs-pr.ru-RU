...
Отчеты защиты от потери данных доступны в Центре соответствия требованиям Microsoft 365. Перейдите в раздел **Отчеты** \> **Данные организации**, чтобы найти отчеты **Соответствия политике защиты от потери данных**, **Инциденты защиты от потери данных**, и **Ложные срабатывания и переопределения защиты от потери данных**.
...
Портал Microsoft 365 Defender и Центр соответствия требованиям Microsoft 365 поддерживают два способа мониторинга журнала аудита и создания отчетов:

- Настройка политик оповещений, просмотр оповещений и отслеживание тенденций: используйте политику оповещений и инструменты панели мониторинга оповещений на портале Microsoft 365 Defender или в Центре соответствия требованиям Microsoft 365.
...
- [Политики оповещений в Microsoft 365](../../compliance/alert-policies.md)
