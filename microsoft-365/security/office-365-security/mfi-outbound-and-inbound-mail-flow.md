...
Однако вы можете [](https://docs.microsoft.com/exchange/mail-flow-best-practices/use-connectors-to-configure-mail-flow/use-connectors-to-configure-mail-flow) использовать соединители для обеспечения наилучшей доступной защиты TLS для сообщений, которые отправляются между вашими почтовыми серверами и Microsoft 365. Поток почты между Microsoft 365 и вашими почтовыми серверами или серверами, принадлежащими вашим партнерам, часто является более важным и конфиденциальным, чем обычные сообщения, поэтому к этим сообщениям необходимо применить дополнительную безопасность и безопасность.
