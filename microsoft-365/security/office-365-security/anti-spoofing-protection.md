...
ms.locfileid: "43636038"
---
# <a name="anti-spoofing-protection"></a>Защита от спуфинга

Если вы являетесь пользователем Microsoft 365 с почтовыми ящиками в Exchange Online или пользователем отдельного предложения Exchange Online Protection (EOP) без почтовых ящиков Exchange Online, EOP включает функции, помогающие защитить вашу организацию от поддельных отправителей.
...
Организация Office 365 ATP может использовать Threat Explorer в Центре безопасности и соответствия требованиям для просмотра информации о попытках фишинга. Дополнительные сведения см. в статье [Исследование угроз Microsoft 365 и реагирование на них](office-365-ti.md).
