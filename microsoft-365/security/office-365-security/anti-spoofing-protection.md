...
- **Политики защиты от фишинга**. В EOP политики защиты от фишинга содержат следующие параметры защиты от спуфинга:
