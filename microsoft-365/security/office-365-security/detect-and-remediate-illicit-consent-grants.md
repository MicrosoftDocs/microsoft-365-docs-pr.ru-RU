...
1. Откройте портал **Microsoft 365 Defender,** <https://security.microsoft.com> а затем выберите **аудит.**

2. На **открываемой** странице Аудит убедитесь, что выбрана вкладка **Поиск,** а затем настройте следующие параметры:
