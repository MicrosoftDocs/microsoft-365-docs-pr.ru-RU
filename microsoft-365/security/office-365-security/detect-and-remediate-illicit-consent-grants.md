...
## <a name="what-is-the-illicit-consent-grant-attack-in-office-365"></a>Что такое атака незаконного предоставления согласия в Office 365?
...
- Вы можете отопросить разрешение приложения на портале Azure Active Directory по:
  ...
  - Перейдите к пострадавшему пользователю в **лезвии Azure Active Directory пользователя.**
