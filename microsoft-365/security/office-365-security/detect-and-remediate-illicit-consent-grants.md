...
1. Откройте **Центр безопасности & соответствия требованиям** в клиенте.
...
4. Отфильтруйте результаты для получения согласия для приложения и добавьте OAuth2PermissionGrant.
