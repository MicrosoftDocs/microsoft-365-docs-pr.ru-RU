...
Чтобы включить, отключить и настроить на стороне клиента параметры фильтра нежелательной почты, доступные в Outlook, используйте групповую политику. Дополнительные сведения см. в [статье Административные шаблоны файлов (ADMX/ADML) и центр развертывания Office для приложений Microsoft 365 для предприятий, office 2019 и office 2016](https://www.microsoft.com/download/details.aspx?id=49030).
