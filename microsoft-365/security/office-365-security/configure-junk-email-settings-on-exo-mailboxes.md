...
> [!NOTE]
>
> - Если пользователь еще не открыл свой почтовый ящик, при выполнении предыдущей команды может возникнуть ошибка. Чтобы отключить эту ошибку для массовых операций, добавьте `-ErrorAction SilentlyContinue` команду **Set – MailboxJunkEmailConfiguration** .
>
...
|Параметр на Set-MailboxJunkEmailConfiguration|Параметры Outlook в Интернете|
|---|---|
...
> [!NOTE]
>
> - Если пользователь еще не открыл свой почтовый ящик, при выполнении предыдущих команд может возникнуть ошибка. Чтобы отключить эту ошибку для массовых операций, добавьте `-ErrorAction SilentlyContinue` команду **Set – MailboxJunkEmailConfiguration** .
>
