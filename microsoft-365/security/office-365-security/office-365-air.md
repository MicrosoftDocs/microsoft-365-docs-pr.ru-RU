...
|:---|:---|:---|
|Обнаружен потенциально вредоносный URL-адрес|**Высокий**|Это оповещение создается при следующем: <ul><li>Пользователь, защищенный [безопасными ссылками](atp-safe-links.md) в организации, щелкает вредоносную ссылку</li><li>Изменения вердикта для URL-адресов определены Microsoft Defender для Office 365</li><li>Пользователи переопределяют страницы предупреждения о безопасных ссылках (в зависимости от политики [безопасных ссылок организации).](set-up-atp-safe-links-policies.md)</li></ul> <p> Дополнительные сведения о событиях, которые вызывают это оповещение, см. в дополнительных сведениях [о политиках "Настройка безопасных ссылок".](set-up-atp-safe-links-policies.md)|
...
|---|---|
|Настройка функций AIR|Одна из следующих ролей: <ul><li>Глобальный администратор</li><li>Администратор безопасности</li></ul> <p> Эти роли могут быть назначены в [Azure Active Directory](https://docs.microsoft.com/azure/active-directory/users-groups-roles/directory-assign-admin-roles) или в Центре [& безопасности.](permissions-in-the-security-and-compliance-center.md)|
|Запуск автоматического расследования <p> --- или --- <p> Утверждение или отклонение рекомендуемых действий|Одна из следующих ролей, назначенная в [Azure Active Directory](https://docs.microsoft.com/azure/active-directory/users-groups-roles/directory-assign-admin-roles) или в Центре [& безопасности:](permissions-in-the-security-and-compliance-center.md) <ul><li>Глобальный администратор</li><li>Администратор безопасности</li><li>Оператор безопасности</li><li>Читатель сведений о безопасности <br> --- и --- </li><li>Поиск и очистка (эта роль назначена только в центре [& безопасности.](permissions-in-the-security-and-compliance-center.md) Возможно, вам придется создать там новую группу ролей и добавить роль Поиска и очистки в эту новую группу ролей.</li></ul>|

## <a name="required-licenses"></a>Необходимые лицензии

[Лицензии Microsoft Defender для Office 365 Plan 2](office-365-atp.md#microsoft-defender-for-office-365-plan-1-and-plan-2) должны быть назначены на:
...
Новый и улучшенный центр безопасности объединяет возможности AIR в [Microsoft Defender для Office 365](office-365-atp.md) и в Microsoft Defender для [конечной точки.](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/automated-investigations) С помощью этих обновлений и улучшений группа операций безопасности сможет просматривать сведения об автоматизированных расследованиях и действиях по исправлению в электронной почте, контенте совместной работы, учетных записях пользователей и устройствах в одном месте.
...
|**Центр действий**|Обновленный центр **действий** () объединяет ожидающих и завершенных действий <https://security.microsoft.com/action-center> по электронной почте, устройствам и удостоверениям. Дополнительные дополнительные действия см. в центре действий. Подробнее см. в центре [действий.)](../mtp/mtp-action-center.md)|
|**Страница Инциденты**|Теперь **страница Incidents** сопоставляет несколько расследований, чтобы обеспечить более консолидированное представление о расследованиях. ([Дополнительные новости об инцидентах.)](../mtp/incidents-overview.md)|
|
