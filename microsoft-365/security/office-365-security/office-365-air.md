...
- Изменения, которые скоро будут внесены на Microsoft 365 Defender
...
> [!TIP]
> Дополнительные новости о политиках оповещения или изменения параметров по умолчанию см. в Microsoft 365 [центре соответствия](../../compliance/alert-policies.md)требованиям.
...
## <a name="changes-are-coming-soon-in-your-microsoft-365-defender-portal"></a>Изменения скоро в вашем Microsoft 365 Defender
...
>
> - Office 365 Центр & безопасности ( <https://protection.office.com> )
