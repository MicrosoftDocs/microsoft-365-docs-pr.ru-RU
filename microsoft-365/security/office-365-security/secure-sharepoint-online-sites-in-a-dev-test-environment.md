...
Эта статья содержит пошаговые инструкции по созданию среды разработки и тестирования, включающей конфиденциальные и строго конфиденциальные сайты SharePoint для решения [Защита сайтов и файлов SharePoint Online](secure-sharepoint-online-sites-and-files.md).
...
В этой среде разработки и тестирования можно экспериментировать и настраивать параметры согласно вашим потребностям, прежде чем развертывать эти типы сайтов группы в рабочей среде.
...
Если вы хотите протестировать конфиденциальные и строго конфиденциальные сайты группы в эмулированной корпоративной среде, см. инструкции в статье [Синхронизация хэшей паролей](https://docs.microsoft.com/microsoft-365/enterprise/password-hash-sync-m365-ent-test-environment).

>[!Note]
>Для тестирования конфиденциальных и строго конфиденциальных сайтов группы не требуется эмулированная корпоративная тестовая среда, включающая эмулированную интрасеть, подключенную к Интернету, и функцию синхронизации каталогов для леса доменных служб Active Directory (AD DS). Здесь эта возможность показана как дополнительная, чтобы вы могли тестировать конфиденциальные и строго конфиденциальные сайты группы и экспериментировать с ними в среде, которая представляет обычную организацию.
>
...
## <a name="phase-4-create-your-team-sites"></a>Этап 4. Создание сайтов группы

На этом этапе можно создать и настроить конфиденциальные и строго конфиденциальные сайты группы для вашего примера организации.

### <a name="sensitive-team-site-for-marketing-campaigns"></a>Конфиденциальный сайт группы для маркетинговых кампаний

Сначала создайте сайт группы конфиденциального уровня для участников маркетинговой группы, чтобы они могли совместно работать над текущими маркетинговыми кампаниями.

1. [Создать новый закрытый сайт группы](https://support.office.com/article/create-a-team-site-in-sharepoint-ef10c1e7-15f3-42a3-98aa-b5972711777d) с именем **Маркетинговые кампании**.
2.  На панели инструментов сайта группы SharePoint щелкните значок параметров и выберите вариант **Разрешения для сайта**.
3.  В области **Разрешения для сайта** в разделе **Параметры общего доступа** щелкните **Изменить параметры общего доступа**.
4.  В разделе **Разрешения на предоставление общего доступа** выберите **Только владельцы сайта могут делиться файлами, папками и сайтом** и щелкните **Сохранить**.

Теперь настройте папку документов сайта группы SharePoint «Маркетинговые кампании» для использования метки хранения «Конфиденциально».
...
Затем настройте политику защиты от потери данных (DLP), которая предупреждает пользователей, когда они предоставляют общий доступ к документу с меткой «Конфиденциально» ( в их число входят документы на сайте «Маркетинговые кампании») за пределами организации.
...
Сначала создайте сайт группы строго конфиденциального уровня для участников группы «Старшие руководители», чтобы обеспечить возможность совместной работы над стратегией компании.

1. [Создать новый закрытый сайт группы](https://support.office.com/article/create-a-team-site-in-sharepoint-ef10c1e7-15f3-42a3-98aa-b5972711777d) с именем **Стратегия компании**.
2.  На панели инструментов сайта группы SharePoint щелкните значок параметров и выберите вариант **Разрешения для сайта**.
3.  В области **Разрешения для сайта** в разделе **Параметры общего доступа** щелкните **Изменить параметры общего доступа**.
4.  В разделе **Разрешения на предоставление общего доступа** установите флажок **Только владельцы сайта могут делиться файлами, папками и сайтом**.
5.  Отключите параметр **Разрешить запросы на доступ** и нажмите кнопку **Сохранить**.

Затем настройте папку документов на сайте группы SharePoint «Стратегия компании» на использование метки «Строго конфиденциально».
...
Затем настройте политику защиты от потери данных (DLP), которая блокирует пользователей, когда они предоставляют общий доступ к документу с меткой «Строго конфиденциально» (в число таких сайтов входит сайт «Стратегия компании») за пределами организации.
...
Файлам в разделе документов сайта группы SharePoint «Стратегия компании» назначена метка хранения «Строго конфиденциально», и на них распространяется действие настроенной политики DLP. Файлам также может быть назначена метка конфиденциальности «Стратегия компании».    

Ниже приведена итоговая конфигурация для сайтов группы «Маркетинговые кампании» и «Стратегия компании».
