...
1. [Создать новый закрытый сайт группы](https://support.office.com/article/ef10c1e7-15f3-42a3-98aa-b5972711777d) с именем **Маркетинговые кампании**.
...
1. [Создать новый закрытый сайт группы](https://support.office.com/article/ef10c1e7-15f3-42a3-98aa-b5972711777d) с именем **Стратегия компании**.
2. На панели инструментов сайта группы SharePoint щелкните значок параметров и выберите вариант **Разрешения для сайта**.
