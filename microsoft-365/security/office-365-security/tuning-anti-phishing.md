...
- [Безопасные ссылки в Microsoft Defender для Office 365](set-up-safe-links-policies.md)

- [Безопасные вложения в Microsoft Defender для Office 365](set-up-safe-attachments-policies.md)
