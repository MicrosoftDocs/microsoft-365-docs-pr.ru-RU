...
- Вы можете повторить этот шаг для олицетворения (домена или пользователя). Отчет об олицетворении находится в разделе  \>  \> **Insights** панели управления угрозами.
