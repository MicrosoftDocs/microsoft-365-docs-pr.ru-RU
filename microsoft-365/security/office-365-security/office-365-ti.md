...
Используйте панель мониторинга угроз (это также [](security-dashboard.md)называется панелью мониторинга безопасности), чтобы быстро узнать, какие угрозы были устранены, а также наглядно довести до лиц, принимающих решения, как Microsoft 365 службы безопасности вашего бизнеса.
...
Используйте Симулятор атак, чтобы настроить и запустить реалистичные кибератаки в вашей организации и идентифицировать уязвимых людей до того, как реальная кибератака повлияет на ваш бизнес. Дополнительные дополнительные информации см. в [Office 365.](attack-simulator.md)
...
Microsoft Defender для Office 365 использует управление доступом на основе ролей. Разрешения назначены через определенные роли в Azure Active Directory, центре администрирования Microsoft 365 или Центре & безопасности.

> [!TIP]
> Хотя некоторые роли, например администратор безопасности, могут быть назначены в Центре & безопасности, следует использовать центр администрирования Microsoft 365 или Azure Active Directory. Сведения о ролях, группах ролей и разрешениях см. в следующих ресурсах:
>
