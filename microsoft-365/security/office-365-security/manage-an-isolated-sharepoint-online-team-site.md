...
1. Войдите в учетную запись, которая является членом группы доступа "Администраторы" для сайта. Чтобы получить справку, Узнайте, [где войти в Microsoft 365](https://support.office.com/article/e9eb7d51-5430-4929-91ab-6157c5a050b4).
