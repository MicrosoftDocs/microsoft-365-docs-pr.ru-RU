...
|Электронная почта|Вредоносный URL-адрес<br/>(" [Безопасные ссылки" в Office 365 ATP](atp-safe-links.md)были обнаружены вредоносным URL-адресом.|Обратимое удаление электронной почты и кластера <br/><br/>Сообщение электронной почты, содержащее вредоносный URL-адрес, считается вредоносным.|
