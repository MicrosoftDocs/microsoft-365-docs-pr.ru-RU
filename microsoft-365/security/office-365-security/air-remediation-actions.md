...
|Электронный адрес|Вредоносный URL-адрес<br/>( [Безопасные ссылки в защитнике Майкрософт для Office 365](atp-safe-links.md)были обнаружены в качестве вредоносного URL-адреса.|Обратимое удаление электронной почты и кластера <br/><br/>Сообщение электронной почты, содержащее вредоносный URL-адрес, считается вредоносным.|
