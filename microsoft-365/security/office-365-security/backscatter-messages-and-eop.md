...
В Microsoft 365 организациях с почтовыми ящиками в Exchange Online или автономных организациях Exchange Online Protection (EOP) без Exchange Online почтовых ящиков EOP делает все возможное для выявления и бесшумного сброса сообщений из сомнительных источников без создания NDR. Но, в зависимости от простого объема электронной почты, течет через службу, всегда есть возможность того, что EOP будет непреднамеренно отправлять backscatter.
...
> [!TIP]
> Веб Backscatter.org веб-сайт () рекомендует использовать свою службу для проверки входящих сообщений электронной почты в режиме Сейф режиме Reject (крупные службы электронной почты почти всегда отправляют некоторые <http://www.backscatterer.org/?target=usage> backscatter).
