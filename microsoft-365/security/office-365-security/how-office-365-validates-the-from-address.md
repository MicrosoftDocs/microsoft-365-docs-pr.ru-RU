...
Чтобы обойти требования к адресу для входящие сообщения электронной почты, можно использовать список IP-адресов (фильтрация подключений) или правила потока почты (также известные как правила транспорта), как описано в ["Создание](create-safe-sender-lists-in-office-365.md)списков безопасного отправитель в Microsoft 365 .
...
Дополнительные сведения о том, как можно укрепить организацию от фишинга, нежелательной почты, нарушений данных и других угроз, см. в [топ-10](../../admin/security-and-compliance/secure-your-business-data.md)способов защиты Microsoft 365 бизнес-планов.