...
## <a name="tune-threat-management-policies-in-the-microsoft-365-defender-portal"></a>Настройка политик управления угрозами на портале Microsoft 365 Defender

Портал Microsoft 365 Defender содержит возможности, защищающие среду. Он также включает отчеты и панели мониторинга, которые можно использовать для мониторинга и принятия мер. В некоторых областях есть конфигурации политик по умолчанию. В некоторых областях не содержатся политики или правила по умолчанию. Посетите эти политики под управлением угрозами, чтобы настроить параметры управления угрозами для более безопасной среды.
