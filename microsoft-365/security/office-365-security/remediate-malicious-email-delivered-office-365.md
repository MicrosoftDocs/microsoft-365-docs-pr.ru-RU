...
> [!NOTE]
> Чтобы устранять вредоносные сообщения электронной почты, группам безопасности требуется назначенная им роль поиска и очистки.  Назначение ролей делается с помощью разрешений в Центре [& безопасности.](permissions-in-the-security-and-compliance-center.md)
