...
Сведения о том, как параметры строгой политики отличаются от параметров политики по умолчанию и стандартных, см. в разделе Рекомендуемые параметры [для EOP](recommended-settings-for-eop-and-office365.md)и Microsoft Defender для Office 365 безопасности.
...
|Безопасность Microsoft 365|[Модуль обучения: защита организации с помощью встроенной и интеллектуальной безопасности из Microsoft 365](/learn/modules/security-with-microsoft-365)|Этот модуль позволяет описать, Microsoft 365 функции безопасности работают вместе, и сформулировать преимущества этих функций безопасности.|
