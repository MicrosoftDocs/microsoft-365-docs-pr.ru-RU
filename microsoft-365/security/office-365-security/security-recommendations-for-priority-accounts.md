...
|Задача|Все корпоративные планы Office 365|Microsoft 365 E3|Microsoft 365 E5|
|---|:---:|:---:|:---:|
...
Сведения о том, чем параметры строгой политики отличаются от параметров политики по умолчанию и стандартных, см. в разделе Рекомендуемые параметры безопасности EOP и [Microsoft Defender для Office 365.](recommended-settings-for-eop-and-office365-atp.md)
