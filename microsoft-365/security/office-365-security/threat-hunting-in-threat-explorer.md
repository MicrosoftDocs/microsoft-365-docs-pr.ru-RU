...
Чтобы открыть средство Explorer, перейдите & центр управления угрозами центра обеспечения соответствия требованиям (или обнаружение в  >    >   **режиме реального времени).** По умолчанию вы прибудете на страницу **Вредоносные** программы, но для ознакомления с вашими вариантами используйте падение **View.** Если вы охотитесь за фишингом или копаете в кампанию угроз, выберите эти представления.

> [!div class="mx-imgBorder"]
> ![Просмотр drop down в Обозревателе угроз](../../media/threat-explorer-view-drop-down.png)
...
> [!div class="mx-imgBorder"]
> ![Кнопка отправитель в Обозревателе угроз](../../media/threat-explorer-sender-button.png)
...
> [!div class="mx-imgBorder"]
> ![Расширенный фильтр в обозревателе угроз](../../media/threat-explorer-advanced-filter.png)
...
> [!div class="mx-imgBorder"]
> ![Доступные параметры в столбцах](../../media/threat-explorer-column-options-details.png)
...
Наконец, в URL-адрес включен iD оповещений, например: `https://protection.office.com/viewalerts?id=372c9b5b-a6c3-5847-fa00-08d8abb04ef1`
