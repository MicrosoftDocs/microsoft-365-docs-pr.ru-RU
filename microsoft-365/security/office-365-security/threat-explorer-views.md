...
[Обозреватель](threat-explorer.md) угроз (и отчет о обнаружениях в режиме реального времени) — это мощное средство, близкое к режиму реального времени, чтобы помочь командам по операциям безопасности исследовать угрозы на портале Microsoft 365 Defender и реагировать на них. Explorer (и отчет об обнаружении в режиме реального времени) отображает сведения о подозрительных вредоносных программах и фишинге в электронной почте и файлах в Office 365, а также других угрозах и рисках для вашей организации.

- Если у вас [есть Microsoft Defender для Office 365](defender-for-office-365.md) плана 2, у вас есть Explorer.
- Если у вас есть Microsoft Defender для Office 365 плана 1, у вас есть обнаружения в режиме реального времени.
...
|---|---|---|
|Microsoft Defender для Office 365 P1|Обнаружение в режиме реального времени|7 |
|Microsoft Defender для Office 365 P1 платный|Обнаружение в режиме реального времени|30|
|Microsoft Defender для Office 365 P1 платного тестирования Defender для Office 365 P2|Обозреватель угроз|7 |
|Microsoft Defender для Office 365 P2|Обозреватель угроз|7 |
|Microsoft Defender для Office 365 P2 платный|Обозреватель угроз|30|
|
...
Чтобы просмотреть этот отчет, в Explorer (или обнаружения в режиме реального времени) выберите **Просмотр** \> **вредоносных программ** \> **содержимого**. В этом представлении показаны файлы, которые были идентифицированы microsoft Defender как вредоносные для Office 365 в [SharePoint Online, OneDrive для бизнеса и Microsoft Teams](mdo-for-spo-odb-and-teams.md).

Просмотр сведений по семейство вредоносных программ, технологии обнаружения (как было обнаружено вредоносное ПО) и рабочая нагрузка (OneDrive, SharePoint или Teams).
...
В этом представлении мы сейчас рассматриваем данные для файлов, которые были взорваны Сейф [вложения.](safe-attachments.md) Ниже диаграммы приведены сведения о конкретных сообщениях электронной почты, которые были обнаружены Сейф вложениями.
