...
- Если у вас [есть Microsoft Defender для Office 365](office-365-atp.md) Plan 2, у вас есть Explorer.
...
В этом представлении мы сейчас рассматриваем данные для файлов, которые были взорваны с помощью [безопасных вложений.](atp-safe-attachments.md) Ниже диаграммы приведены сведения о конкретных сообщениях электронной почты, которые были обнаружены вложениями, обнаруженными в безопасных вложениях.
