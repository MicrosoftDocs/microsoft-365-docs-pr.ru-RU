---
title: Политики отправки пользователей
f1.keywords:
- NOCSH
ms.author: chrisda
author: chrisda
...
ms.locfileid: "48350285"
---
# <a name="user-submissions-policies"></a>Политики отправки пользователей
...
- Пропустите фильтрацию нежелательной почты, создав правило для передачи почты Exchange, чтобы задать уровень вероятности нежелательной почты. В разделе Использование центра администрирования Exchange [Создайте правило для почтового процесса, которое задает для сообщения НЕжелательной почты,](https://docs.microsoft.com/microsoft-365/security/office-365-security/use-mail-flow-rules-to-set-the-spam-confidence-level-scl-in-messages?view=o365-worldwide#use-the-eac-to-create-a-mail-flow-rule-that-sets-the-scl-of-a-message) чтобы установить значение вероятности нежелательной почты равным **– 1**.

- Отключите сканирование вложений для вредоносных программ. Использование [настройки (или редактирования) политики безопасных вложений ATP](https://docs.microsoft.com/microsoft-365/security/office-365-security/set-up-atp-safe-attachments-policies?view=o365-worldwide#step-2-set-up-or-edit-an-atp-safe-attachments-policy) для создания политики безопасных вложений с отключенным **вложенным параметром не будет проверяться наличие вредоносных программ** .

- Отключение сканирования URL-адресов в сообщениях. Используйте инструкции [Add (или Edit) для безопасных ссылок ATP, которые применяются ко всем или определенным получателям электронной почты,](https://docs.microsoft.com/microsoft-365/security/office-365-security/set-up-atp-safe-links-policies?view=o365-worldwide#step-3-add-or-edit-atp-safe-links-policies-that-apply-to-all-or-specific-email-recipients) чтобы создать политику безопасных ссылок, выбрав **действие для неизвестных потенциально вредоносных URL-адресов в сообщениях** со значением **выкл**.

- Создайте политику защиты от вредоносных программ, чтобы отключить автоматическое удаление вредоносных программ с нулевым временем. В разделе [Использование центра безопасности & соответствия требованиям можно создать политики защиты от вредоносных программ](https://docs.microsoft.com/microsoft-365/security/office-365-security/configure-your-spam-filter-policies?view=o365-worldwide#use-the-security--compliance-center-to-create-anti-spam-policies) , чтобы установить **Автоматический Автоматический импорт вредоносных программ** в **состояние "Выкл**.".

- Создайте политику фильтрации нежелательной почты, чтобы отключить автоматическое удаление ZAP для нежелательной почты и фишингового ZAP. В статье [Использование центра безопасности & соответствия требованиям для создания политик защиты от нежелательной почты](https://docs.microsoft.com/microsoft-365/security/office-365-security/configure-your-spam-filter-policies?view=o365-worldwide#use-the-security--compliance-center-to-create-anti-spam-policies) и **снятия флажков** для сообщений ZAP и фишингового ZAP.

- Отключите правило нежелательной почты. Используйте [Настройка параметров нежелательной почты в почтовых ящиках Exchange Online](https://docs.microsoft.com/microsoft-365/security/office-365-security/configure-junk-email-settings-on-exo-mailboxes?view=o365-worldwide) , чтобы отключить правило нежелательной почты. После отключения EOP не сможет перемещать сообщения в папку "Нежелательная почта" на основе фильтрации нежелательной почты вредоносности действие **переместить сообщение в папку нежелательной почты** или в коллекцию списков надежных отправителей почтового ящика.
