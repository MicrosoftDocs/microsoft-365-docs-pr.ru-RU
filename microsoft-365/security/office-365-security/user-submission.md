...
- Отключите сканирование вложений для вредоносных программ в пользовательском почтовом ящике. Используйте [Настройка политик безопасных вложений в Office 365 ATP](set-up-atp-safe-attachments-policies.md) для создания политики безопасных вложений с параметром **отключено** для **безопасных вложений неизвестный ответ на вредоносные программы**.

- Отключение проверки URL-адресов для сообщений в настраиваемом почтовом ящике. Используйте [Настройка политик безопасных ссылок в Office 365 ATP](set-up-atp-safe-links-policies.md) для создания политики безопасных ссылок с параметром " **отключено** " для параметра **"выбрать действие для неизвестных потенциально вредоносных URL-адресов в сообщениях**".
