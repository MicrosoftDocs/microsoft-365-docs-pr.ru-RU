...
Фишинг ZAP включен по умолчанию в политике нежелательной почты. Фишинг ZAP можно отключить с помощью параметра *фишзапенаблед* командлета [Set-HostedContentFilterPolicy](https://go.microsoft.com/fwlink/p/?LinkId=722758), командлета EOP.
...
В политике нежелательной почты по умолчанию включена Нежелательная почта. Отключить нежелательную почту можно с помощью параметра *спамзапенаблед* командлета [Set-HostedContentFilterPolicy](https://go.microsoft.com/fwlink/p/?LinkId=722758) в Exchange Online PowerShell или PowerShell Exchange Online Protection.
...
Чтобы отключить функцию ZAP и сообщение о нежелательной почте для клиента O365 или группы пользователей, используйте параметры *фишзапенаблед* и *Спамзапенаблед* командлета [Set-HostedContentFilterPolicy](https://go.microsoft.com/fwlink/p/?LinkId=722758), EOP.
