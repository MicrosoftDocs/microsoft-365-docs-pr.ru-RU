...
### <a name="does-zap-change-the-email-header"></a>Изменяют ли ZAP заголовок сообщения?

Макрокоманда ZAP не вносит изменения в заголовок сообщения электронной почты.

### <a name="how-does-zap-affect-mailboxes-on-hold"></a>Влияние ZAP на удержание почтовых ящиков?

ZAP не удаляет сообщения из почтовых ящиков на удержании, поэтому в сообщениях не перемещаются действия, выполняемые в карантине. Сообщения по-прежнему будут перемещены в папку нежелательной почты, если она указана в политике. 

[Щелкните здесь, чтобы получить дополнительные сведения о удержании почтовых ящиков.](https://docs.microsoft.com/exchange/policy-and-compliance/holds/holds?view=exchserver-2019)
