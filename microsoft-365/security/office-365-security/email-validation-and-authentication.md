...
### <a name="configure-permitted-senders-of-unauthenticated-email"></a>Настройка разрешенных отправителей непроверенной электронной почты

Вы также можете использовать [аналитику спуфинга](learn-about-spoof-intelligence.md) и [список разрешенных и заблокированных клиентов](tenant-allow-block-list.md), чтобы предоставить отправителям разрешение на передачу непроверенных сообщений в вашей организации.
...
Дополнительные сведения о рекомендациях поставщиков услуг см. в статье [M3AAWG: Рекомендации по обмену мобильными сообщениями для поставщиков услуг](https://www.m3aawg.org/sites/default/files/m3aawg-mobile-messaging-best-practices-service-providers-2015-08_0.pdf).

Подробнее о том, как Office 365 использует SPF и поддерживает проверку подлинности DKIM:

- [Дополнительные сведенья об SPF](how-office-365-uses-spf-to-prevent-spoofing.md)

- [Дополнительные сведения о DKIM](support-for-validation-of-dkim-signed-messages.md)
