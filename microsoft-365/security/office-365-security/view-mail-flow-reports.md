...
> [!NOTE]
> Большинство отчетов, описанных в этом разделе, доступны в центре администрирования Exchange (EAC). Дополнительные сведения см. в сообщении о потоке [почты в новом центре администрирования Exchange.](/exchange/monitoring/mail-flow-reports/mail-flow-reports) Отчет [о правилах транспорта Exchange](view-email-security-reports.md#exchange-transport-rule-report) доступен на портале Защитник Microsoft 365.
...
- **Сверлить** \> **Malware (anti-malware)**: This selection takes you to the [Malware detections report.](view-email-security-reports.md#malware-detections-report)
