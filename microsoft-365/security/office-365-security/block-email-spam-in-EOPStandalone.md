...
Вам часто приходит спам в виде массовых рассылок, например информационных бюллетеней или рекламы? Вы можете настроить фильтр нежелательной почты в Office 365 при помощи[использования правил потока обработки почты для настройки фильтрации массовых рассылок](use-transport-rules-to-configure-bulk-email-filtering.md) или включив параметр **Массовые рассылки** в [Расширенных параметрах фильтрации (AFC) нежелательной почты в Office 365](advanced-spam-filtering-asf-options.md). В Центре администрирования Exchange сначала выберите **Защита** \> **Фильтр содержимого**, а затем дважды щелкните ту политику фильтра, которую вы хотите скорректировать. Нажмите **Действия со спамом и массовыми рассылками**, чтобы настроить параметры, как показано ниже.
