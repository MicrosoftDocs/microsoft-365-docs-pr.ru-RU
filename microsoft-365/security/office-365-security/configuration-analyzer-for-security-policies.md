...
Значения **стандартных** **и** строгих политик, которые используются в качестве базовых значений, описаны в рекомендуемых параметрах безопасности EOP и Microsoft Defender для Office [365.](recommended-settings-for-eop-and-office365-atp.md)
