...
- **Anti-phishing**
- **Anti-malware**
- **AtP Сейф вложения** (если ваша подписка включает Microsoft Defender для Office 365)
- **ATP Сейф ссылки** (если в вашей подписке включен Microsoft Defender для Office 365)
