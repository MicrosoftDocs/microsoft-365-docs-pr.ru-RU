...
И помните, что вы всегда можете предоставить нам отзывы о том  или ином Microsoft 365 безопасности, нажав кнопку Обратная связь в нижнем правом углу Центра & [безопасности.](https://support.microsoft.com/office/a5f2fd18-b029-4257-b5a8-ae83e7768c85)
...
- Следите за тем, как новые трекеры будут показываться в Microsoft 365 среде. Когда это доступно, вы найдете трекеры [здесь](https://protection.office.com/). Перейдите **к отслеживанию угроз управления** \> **угрозами.**
