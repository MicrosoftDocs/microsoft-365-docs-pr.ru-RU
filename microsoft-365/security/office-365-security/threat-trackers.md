...
Чтобы просмотреть и использовать отслеживания угроз в организации, перейдите на портал Microsoft 365 Defender () и выберите отслеживание угрозы & электронной <https://security.microsoft.com>  \> **почты.**

> [!NOTE]
> Чтобы использовать отслеживание угроз, необходимо быть глобальным администратором, администратором безопасности или считывателями безопасности. См. [разрешения на портале Microsoft 365 Defender.](permissions-in-the-security-and-compliance-center.md)
...
![Microsoft 365 Портал Defender](../../media/microsoft-365-defender-portal.png)
...
![Защитник Microsoft для Office 365 на портале Microsoft 365 Defender](../../media/policies.png)
...
- Убедитесь, что ваша группа безопасности имеет правильные роли и разрешения. Вы должны быть глобальным администратором или иметь роль администратора безопасности или поиска и очистки на портале Microsoft 365 Defender. См. [разрешения на портале Microsoft 365 Defender.](permissions-in-the-security-and-compliance-center.md)
