...
Отчет обновляется, чтобы показать данные о сообщениях электронной почты, которые люди в организации сообщали как попытку фишинга. Эти сведения можно использовать для проведения дополнительного анализа и, при необходимости, настройки политик защиты от фишинга в [Microsoft Defender](configure-atp-anti-phishing-policies.md)для Office 365 .
...
- [Автоматическое расследование и ответ в Microsoft 365 Defender](../defender/m365d-autoir.md)
