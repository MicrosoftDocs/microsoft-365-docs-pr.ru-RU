...
Теги пользователя — это идентификаторы для определенных групп пользователей в защитнике Майкрософт для Office 365. Дополнительные сведения о тегах, лицензировании и настройке тегов можно узнать здесь: [User tagss in Office 365 ATP](user-tags.md).

В обозревателе угроз вы увидите информацию по тегам пользователя в следующих статьях:
