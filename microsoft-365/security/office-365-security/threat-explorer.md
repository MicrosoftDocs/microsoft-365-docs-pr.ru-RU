...
- [Просмотр фишинговых URL-адресов и щелчок данных решения](#view-phishing-url-and-click-verdict-data)
...
В настоящее время место доставки находится в сетке электронной почты и во flyout электронной почты. Поле **расположения доставки** получает переименование **_Исходное расположение_ доставки *_. Кроме того, мы представляем другое поле, _Latest*_delivery location_**.
...
>
> - Если сообщение  доставлено, расположение  доставки может быть "доставлено", а "неизвестно", но правило папки "Входящие" переместило сообщение в папку по умолчанию (например, черновик или архив), а не в папку "Входящие" или "Нежела гостевая почта".
>
...
- *Локальное или внешнее* решение: почтовый ящик не существует в облаке, но находится локально.
...
**Проводник** \> **Просмотр фишинга** \> **Щелчки** \> **Верхние URL-адреса** или URL-адреса при нажатии кнопки "Top **Clicks"** (Нажатие верхнего URL-адреса) выбирают любую запись, чтобы \> открыть этот флажок.
...
## <a name="view-phishing-url-and-click-verdict-data"></a>Просмотр фишинговых URL-адресов и щелчок данных решения
...
3. Щелкните **"Отправитель",** а затем выберите **"URL-адреса"** \> **"Щелкните решение".**

4. Выберите один или несколько  параметров, например "Заблокировано" и  "Переопределено блокировкой", а затем нажав кнопку "Обновить" в той же строке, что и параметры для применения этого фильтра. (Не обновляйте окно браузера.)
...
## <a name="more-ways-to-use-explorer-and-real-time-detections"></a>Другие способы использования обнаружения в проводнике и в режиме реального времени
