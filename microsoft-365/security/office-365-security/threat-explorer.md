...
Подробнее о том, как изучать вредоносные сообщения [, можно узнать в статье Поиск и проверка вредоносных сообщений электронной почты, которые были доставлены в Office 365](https://docs.microsoft.com/office365/securitycompliance/investigate-malicious-email-that-was-delivered).
...
**Проводник > Просмотр фишинговых >ных щелчков > верхние URL-адреса или наиболее популярные щелчки URL > щелкните любую запись для открытия всплывающего меню URL-адреса**
...
Вы можете перейти к тому же расположению в режиме реального времени, как показано ниже.

**В проводнике > обнаружение в режиме реального времени > просматривать URL-адреса > фишинга > верхние URL-адреса или самые популярные щелчки > щелкните любую запись, чтобы открыть всплывающее окно URL-адреса > перейдите на вкладку нажатия.**
