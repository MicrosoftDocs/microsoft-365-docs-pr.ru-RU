...
- [Просмотр заголовщика электронной почты и загрузка тела сообщения](#preview-email-header-and-download-email-body)
...
### <a name="preview-email-header-and-download-email-body"></a>Просмотр заголовщика электронной почты и загрузка тела сообщения
...
**Место доставки** показывает результаты политик и обнаружений, которые запускают после доставки. Он связан с действием **_доставки._** Возможные значения:
