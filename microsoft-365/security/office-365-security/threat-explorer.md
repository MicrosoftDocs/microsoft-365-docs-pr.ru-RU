...
Кроме того, вы можете **экспортировать отчеты** в Microsoft Excel, чтобы просматривать их идентификаторы, а затем вредоносности их нажатия, сделав задачу понимания того, где поступил трафик. Вот как это работает. Начиная с управления угрозами на панели быстрого запуска Office 365, щелкните эту цепочку.

**Проводник > Просмотр фишинговых >ных щелчков > Топ URL-адресов**
