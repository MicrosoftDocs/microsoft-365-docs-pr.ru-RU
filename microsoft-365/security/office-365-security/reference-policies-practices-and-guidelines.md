...
Электронная почта, отправляемая Microsoft 365 пользователям, должна соответствовать всем политикам Корпорации Майкрософт, регламентам передачи электронной почты и использованию Microsoft 365.
...
Электронная почта, отправленная Microsoft 365 пользователям, должна соблюдать все применимые законы и правила, регулирующие сообщения электронной почты в применимой юрисдикции.
...
Отправленная в Microsoft 365 электронная почта должна соответствовать применимым рекомендациям, указанным в ниже документах (некоторые ссылки доступны только на английском языке).
...
Кроме того, серверы электронной почты, подключенные к Microsoft 365, должны придерживаться следующих требований:
...
## <a name="microsoft-365-limits"></a>Microsoft 365 ограничения

Отправители должны соблюдать Microsoft 365 ограничения, перечисленные [в Exchange Online Protection ограничения.](/office365/servicedescriptions/exchange-online-protection-service-description/exchange-online-protection-limits)
