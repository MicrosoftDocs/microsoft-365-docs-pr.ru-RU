...
|**Результаты почтового трафика для EOP и ATP** (только для PowerShell). Выходные данные этого командлета содержат сведения о домене, дате, типе события, направлении, действии и количестве сообщений.|[Get — Маилтраффикатпрепорт](https://docs.microsoft.com/powershell/module/exchange/get-mailtrafficatpreport)|
