...
В отчете " **Расширенные типы файлов для защиты от угроз** " отображаются типы файлов, обнаруженных в качестве вредоносных, с помощью [безопасных вложений](atp-safe-attachments.md).
