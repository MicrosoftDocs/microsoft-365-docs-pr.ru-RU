...
В этом разделе даны вопросы и ответы о защите от вредоносных программ в организациях Microsoft 365 с почтовыми ящиками в Exchange Online или автономных организациях Exchange Online Protection (EOP) без почтовых ящиков Exchange Online.
...
Да. Хотя мы рекомендуем указать запись MX корпорации Майкрософт, мы понимаем, что существуют законные бизнес-причины для того, чтобы сначала перенаказать вашу электронную почту в другое место, кроме Майкрософт.
...
- **Исходящий:** настройте маршрутику через smart host из Microsoft 365 к сторонней сторонней службе назначения.
