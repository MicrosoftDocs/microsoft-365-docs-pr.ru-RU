...
Клиенты Exchange Online: [мониторинг, составление отчетов и трассировка сообщений в Exchange Online](https://technet.microsoft.com/library/87bdeeae-bd80-4a3b-95c5-62fbaf97c2e8.aspx)
  
Клиенты Exchange Online Protection: [отчеты и трассировка сообщений в Exchange Online Protection](reporting-and-message-trace-in-exchange-online-protection.md)
...
[Справка о фишинге, подложных лотереях и других видах мошенничества](https://go.microsoft.com/fwlink/p/?LinkId=325606)
  
[Мошенничество в Интернете и по электронной почте: как защитить себя](https://go.microsoft.com/fwlink/p/?LinkID=325607)
...
4. **Убедитесь, что в DNS настроены соответствующие записи SPF.**
    ...
    [Вопросы и ответы о доменах](/office365/admin/setup/domains-faq)
