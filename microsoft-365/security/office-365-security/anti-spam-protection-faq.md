...
О. Да, прочтите эту статью, [чтобы защитить конфиденциальность в Интернете](https://support.microsoft.com/help/4091455) .
...
11. **Форматируйте исходящие уведомления о доставке.**
    ...
    При создании сообщений уведомлений о доставке отправителям следует следовать формату недоставки, описанному в [RFC 3464](https://www.ietf.org/rfc/rfc3464.txt).
