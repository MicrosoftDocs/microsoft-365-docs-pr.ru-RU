...
- **[Администратор Exchange в](/azure/active-directory/users-groups-roles/directory-assign-admin-roles#exchange-administrator)** Azure Active Directory.

- **Администратор почтового потока** в центре & безопасности. Если учетная запись также не входит в группы ролей администратора организации или администратора Exchange, рассмотрите следующие проблемы:
  ...
  - Пользователь не будет иметь доступ к центру администрирования Microsoft 365.
