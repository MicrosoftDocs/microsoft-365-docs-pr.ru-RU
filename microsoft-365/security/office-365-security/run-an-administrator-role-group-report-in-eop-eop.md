...
1. В EAC перейдите  в "Аудит соответствия требованиям" и выберите "Запуск отчета о группе ролей \>  **администраторов".**
