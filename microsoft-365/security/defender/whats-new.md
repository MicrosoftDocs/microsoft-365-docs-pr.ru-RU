...
- [Новая страница оповещения на Microsoft 365 Defender портале](https://techcommunity.microsoft.com/t5/microsoft-365-defender/easily-find-anomalies-in-incidents-and-alerts/ba-p/2339243) <br> Предоставляет расширенные сведения для контекста в качестве атаки. Вы можете увидеть, какие другие срабатывные оповещения вызвали текущее оповещение, а также все затронутые объекты и действия, связанные с атакой, включая файлы, пользователей и почтовые ящики. Дополнительные [сведения см. в дополнительных](/microsoft-365/security/defender/investigate-alerts) сведениях.
- [График тренда для инцидентов и оповещений на Microsoft 365 Defender портале](https://techcommunity.microsoft.com/t5/microsoft-365-defender/new-alert-page-for-microsoft-365-defender-incident-detections/ba-p/2350425) <br> Определите, есть ли несколько оповещений по одному инциденту или ваша организация находится под атакой с несколькими различными инцидентами. Дополнительные [сведения см. в](/microsoft-365/security/defender/incident-queue) дополнительных сведениях о приоритетах инцидентов.
