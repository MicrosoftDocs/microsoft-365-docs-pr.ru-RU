...
> [!NOTE]
> Пользователи Defender для Office 365 теперь могут *управлять ключами и поворачивать ключи* DomainKeys Identified Mail (DKIM) через Центр безопасности Microsoft 365: https://security.microsoft.com/threatpolicy, или перейдите к **Политика и правила > Политики угроз > DKIM**.
...
В разделе [Начало работы](/microsoft-365/security/defender-365-security/defender-for-office-365.md#getting-started) статьи [Microsoft Defender для Office 365](/microsoft-365/security/defender-365-security/defender-for-office-365) предварительно логические блоки конфигурации выглядят следующим образом:
...
Вместе со [ссылкой](../defender-365-security/protect-against-threats.md), по которой можно сразу приняться за дело и перейти к настройке в день 1.
...
Быстрый переход к языку запросов Kusto для охоты на проблемы является преимуществом совмещения этих двух центров безопасности. Группы безопасности могут отслеживать промахи при автоматической очистке, выбирая следующие действия [здесь](https://security.microsoft.com/advanced-hunting), в **Охота** > **Расширенная охота**.
...
- [Создание имитации фишинговых атак](../defender-365-security/attack-simulation-training.md) и [создание полезных данных для обучения сотрудников](../defender-365-security/attack-simulation-training-payloads.md)
