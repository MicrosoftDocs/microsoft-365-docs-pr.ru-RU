...
С Microsoft 365 Defender, когда запускается автоматическое расследование, сведения об этом расследовании доступны как во время, так и после автоматизированного процесса расследования. [](m365d-autoir.md) Если у вас есть [необходимые разрешения](m365d-action-center.md#required-permissions-for-action-center-tasks), вы можете просмотреть эти подробности в представлении со сведениями об исследовании. Это представление предоставляет вам состояние в курсе и возможность утверждать любые ожидающих действий. 
...
- Любой инцидент или опыт центра действий на Microsoft 365 Defender портале ( [https://security.microsoft.com](https://security.microsoft.com) )
...
| **Alerts** | Содержит список оповещений, связанных с исследованием. Оповещения могут исходить из функций защиты от угроз на устройстве пользователя, в Office приложениях, Microsoft Cloud App Security и других Microsoft 365 Defender функций.|
