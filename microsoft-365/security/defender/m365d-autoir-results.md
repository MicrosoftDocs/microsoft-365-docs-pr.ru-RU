...
- Любые инциденты или опыт центра действий в центре безопасности Microsoft 365 ( [https://security.microsoft.com](https://security.microsoft.com) )
...
| **Alerts**    | Содержит список оповещений, связанных с исследованием. Оповещения могут исходить из функций защиты от угроз на устройстве пользователя, в приложениях Office, Microsoft Cloud App Security и других функций Защитника Microsoft 365.|
