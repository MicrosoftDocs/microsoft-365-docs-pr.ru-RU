...
Учетные записи, задав следующие роли **глобальной Azure Active Directory (AD),** могут получать доступ к Microsoft 365 и данным Defender:
...
> ! [ПРИМЕЧАНИЕ] Эта статья применяется только к управлению глобальными Azure Active Directory ролей. Дополнительные сведения об использовании настраиваемого управления доступом на основе ролей см. в пользовательских ролях для управления доступом на основе [ролей.](custom-roles.md)
...
Во время предварительного просмотра Microsoft 365 Defender не применяет элементы управления доступом на основе Cloud App Security параметров. Доступ к Microsoft 365 Defender не зависит от этих параметров.
