...
Программа-вымогательство быстро превратилась из простых вредоносных программ, затрагивающих отдельных пользователей компьютеров, в корпоративную угрозу, которая серьезно влияет на отрасли и государственные учреждения. Несмотря на то, что [Microsoft 365 Defender](microsoft-365-defender.md) предоставляет множество возможностей, которые выявляют и блокируют действия вымогателей и связанные с ними действия по вторжению, выполнение профилактических проверок на наличие признаков компромисса может помочь защитить сеть.
...
С [помощью расширенных поисков](advanced-hunting-overview.md) в Microsoft 365 Defender можно создавать запросы, которые будут находить отдельные артефакты, связанные с активностью вымогателей. Вы также можете выполнить более сложные запросы, которые могут искать признаки активности и взвешивать эти знаки, чтобы найти устройства, которые требуют немедленного внимания.
...
| Активность вымогателей | Общие средства | Intent |
|--|--|--|
