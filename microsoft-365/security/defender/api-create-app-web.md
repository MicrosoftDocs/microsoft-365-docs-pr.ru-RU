...
---
# <a name="create-an-app-to-access-microsoft-365-defender-without-a-user"></a>Создание приложения для доступа Microsoft 365 Defender без пользователя
...
1. Установите TENANT_ID для клиента Azure, который хочет использовать приложение для доступа к Microsoft 365 Defender.
