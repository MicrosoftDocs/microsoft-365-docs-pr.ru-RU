...
![Изображение области навигации центра безопасности Microsoft 365 с Microsoft 365 Defender имеет центр безопасности Microsoft 365 с управлением инцидентами и другими возможностями ](../../media/overview-incident.png)
...
Чтобы получить ответы на наиболее часто задаваемые вопросы о включив Microsoft 365 Defender, ознакомьтесь с часто задаваемой [проблемой.](m365d-enable-faq.md)
