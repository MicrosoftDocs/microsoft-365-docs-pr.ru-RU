...
2. Для каждого инцидента с высоким приоритетом приступить к [расследованию:](investigate-incidents.md)
   ...
   - Восстановление. Восстановление ресурсов клиента до состояния, в который они были до инцидента.

3. После устранения инцидента у вас будет время:
   ...
   - Определите, необходимы ли изменения в вашей позе безопасности, и примите меры для их реализации.
