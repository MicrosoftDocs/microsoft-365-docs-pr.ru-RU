...
После составления и хранения списка полезных представлений фильтра в качестве URL-адресов можно быстро обработать [](manage-incidents.md) и приоритизировать инциденты в очереди и управлять ими для последующего назначения и анализа.
