...
8. Убедитесь, что не **отслеживайте,** когда пользователи щелкают параметр безопасных ссылок, а остальные параметры выбраны. Подробные [сведения см. в параметрах](/microsoft-365/security/office-365-security/recommended-settings-for-eop-and-office365) Безопасные ссылки. Щелкните **Сохранить**. 
