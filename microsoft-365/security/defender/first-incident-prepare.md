...
- Реализация [нулевой структуры доверия](/security/zero-trust/)
...
Чтобы проверить ход исправления программного [](../defender-endpoint/next-gen-threat-and-vuln-mgt.md) обеспечения, посетите страницу Управления угрозами и уязвимостью в Защитнике для конечной точки, к которой можно получить доступ Microsoft 365 Defender с помощью вкладки **More resources.**
