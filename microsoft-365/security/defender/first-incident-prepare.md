...
Автоматизация является важной частью реализации и поддержания среды нулевого доверия, а также сокращения количества оповещений, которые потенциально могут привести к событиям реагирования на инциденты. Компоненты Microsoft 365 Defender можно автоматизировать, такие как действия по исправлению (известные как расследования инцидента в центре безопасности Microsoft 365), действия уведомлений и даже создание билетов поддержки, например в [ServiceNow](https://microsoft.service-now.com/sp/).

## <a name="step-2-determine-your-organizations-security-posture"></a>Шаг 2. Определение позиции безопасности организации
...
## <a name="step-3-assess-your-organizations-vulnerability-exposure"></a>Шаг 3. Оценка уязвимости организации
