...
Microsoft 365 Defender предоставляет большую часть своих данных и действий с помощью набора программных API. Эти API помогают автоматизировать рабочий процесс и в полной мере использовать Microsoft 365 defender.
...
После выполнения этих действий вы будете готовы получить доступ к API Microsoft 365 Defender с помощью определенного контекста.
...
Дополнительные сведения см. в приложении **[Create to access Microsoft 365 API Defender от имени пользователя.](api-create-app-user-context.md)**
...
Дополнительные сведения см. в **[приложении Create with partner access to Microsoft 365 API Defender.](api-partner-access.md)**
