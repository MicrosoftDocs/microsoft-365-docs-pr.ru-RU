...
- [Автоматические расследования могут](m365d-autoir.md) привести к действиям по исправлению, которые принимаются автоматически или ожидают вашего утверждения.
...
2. На **вкладке История** выберите файл с типом действия карантиного файла. 
