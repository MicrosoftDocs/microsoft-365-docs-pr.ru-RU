...
[Расширенный поиск](advanced-hunting-overview.md) в Microsoft 365 Defender позволяет активно охотиться на угрозы по всему:
- Устройства, управляемые Microsoft Defender для конечной точки
- Электронные сообщения, обработанные Microsoft 365
- Действия облачного приложения, события проверки подлинности и действия контроллера домена, отслеживаемые Microsoft Cloud App Security и Microsoft Defender for Identity
