...
**Начало работы**. Когда вы будете готовы к регистрации: в этом разделе указаны действия по фактическому присоединению к службе, получению и настройке устройств, подготовке конечных пользователей и развертыванию приложений.
...
- [Получение справки для конечных пользователей](../working-with-managed-desktop/end-user-support.md)
