...
[Конфиденциальность и персональные данные](service-description/privacy-personal-data.md) | Обновленная статья
...
[Получение справки для пользователей](working-with-managed-desktop/end-user-support.md) | Обновленная статья
[Справочник по настраиваемым настройкам — компьютеры, управляемые Майкрософт](working-with-managed-desktop/config-setting-ref.md) | Обновленная статья
...
[Предварительные условия для компьютеров, управляемых Майкрософт](get-ready/prerequisites.md) | Обновленная статья
[Операции безопасности на компьютерах, управляемых Майкрософт](service-description/security-operations.md) | Новая статья
[Доступ к порталу администрирования](get-started/access-admin-portal.md) | Обновленная статья
...
Новая или измененная статья | Описание
--- | ---
[Требования к классическим приложениям, управляемым Майкрософт](service-description/mmd-app-requirements.md) | Обновленная статья
[Соответствие требованиям](intro/compliance.md) | Обновленная статья
...
[Получение справки для пользователей](working-with-managed-desktop/end-user-support.md) | Обновленная статья
[Этапы регистрации устройств для партнеров](get-started/register-devices-partner.md) | Обновленная статья
[Управляемые Майкрософт настольные устройства](service-description/device-list.md) | Обновленная статья
[Самостоятельная регистрация новых устройств](get-started/register-devices-self.md) | Обновленная статья
...
[Поддерживаемые Майкрософт регионы и языки, поддерживаемые microsoft Managed Desktop](service-description/regions-languages.md) | Обновленная статья
...
Новая или измененная статья | Описание
--- | ---
[Безопасность на компьютерах, управляемых Майкрософт](service-description/security.md)| Обновленная статья
[Работа с аналитикой](working-with-managed-desktop/insights.md) | Обновленная статья
[Аналитика центра безопасности Windows](working-with-managed-desktop/security-update-insights.md) | Новая статья
[Как обновления обрабатываются на компьютерах, управляемых Майкрософт](service-description/updates.md) | Обновленная статья
[Службы настольных устройств, управляемых Майкрософт](service-description/device-services.md) | Обновленная статья
...
[Поддержка администраторов в отношении компьютеров, управляемых Майкрософт](working-with-managed-desktop/admin-support.md) | Обновленная статья
[Управляемые Майкрософт настольные устройства](service-description/device-list.md) | Обновленная статья
[Архивные устройства с управляемым рабочим столом (Майкрософт)](service-description/archived-device-list.md) | Обновленная статья
...
[Управляемые Майкрософт настольные устройства](service-description/device-list.md) | Обновленная статья
[Главная страница "Управляемые Майкрософт компьютеры"](https://docs.microsoft.com/microsoft-365/managed-desktop/) | Обновленная статья
[Что собой представляют компьютеры, управляемые Майкрософт?](https://docs.microsoft.com/microsoft-365/managed-desktop/intro/index) | Обновленная статья
[Подготовка пользователей к работе с устройствами](get-started/get-started-devices.md) | Обновленная статья
...
[Поддерживаемые Майкрософт регионы и языки, поддерживаемые microsoft Managed Desktop](service-description/regions-languages.md) | Обновленная статья
[Управляемые Майкрософт настольные устройства](service-description/device-list.md) | Обновленная статья
[Архивные устройства с управляемым рабочим столом (Майкрософт)](service-description/archived-device-list.md) | Новая статья
...
Новая или измененная статья | Описание
--- | ---
[Установка портала компании Intune на компьютерах, управляемых Майкрософт](get-started/company-portal.md) | Новая статья
...
[Регистрация устройств на компьютерах, управляемых Майкрософт](get-started/register-devices-self.md) | Новая статья
[Регистрация устройств на компьютерах, управляемых Майкрософт, для партнеров](get-started/register-devices-partner.md) | Новая статья
...
Новая или измененная статья | Описание
--- | ---
[Программные устройства](service-description/device-list.md) | Обновлена поддержка определенных устройств Dell и HP.
...
[Управление приложениями для компьютеров, управляемых Майкрософт](working-with-managed-desktop/manage-apps.md) | Обновлены сведения о том, как обновить или откатить предыдущую версию бизнес-приложений. 

## <a name="december-2018"></a>Декабрь 2018 г.
Новая или измененная статья | Описание
--- | ---
[Операции и мониторинг для компьютеров, управляемых Майкрософт](service-description/operations-and-monitoring.md) | Добавлена таблица с балансом ответственности и обновлены другие таблицы.
[Поддержка администраторов в отношении компьютеров, управляемых Майкрософт](working-with-managed-desktop/admin-support.md) | Обновлены типы поддержки, пояснения серьезности и дополнительные сведения.

## <a name="november-2018"></a>Ноябрь 2018 г.

Новая или измененная статья | Описание
--- | ---
[Поддержка компьютеров, управляемых Майкрософт](service-description/support.md)<br />поддержка [компьютеров, управляемых Майкрософт, и](working-with-managed-desktop/end-user-support.md) пользователей | Обновлено, чтобы включить Австралию.

## <a name="october-30-2018"></a>30 октября 2018 г.
Контент реорганизованы: добавлен раздел для описания [службы управляемых компьютеров Майкрософт.](service-description/index.md) 
