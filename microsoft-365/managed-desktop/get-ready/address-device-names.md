...
---
# <a name="address-device-name-dependency"></a>Зависимость от имени адресов устройств

Microsoft Managed Desktop применяет стандартизированный формат имен при регистрации устройств и автоматически переименовывать устройства, если имя будет изменено позже. Дополнительные сведения см. в [сайте Device names.](../service-description/device-names.md)
