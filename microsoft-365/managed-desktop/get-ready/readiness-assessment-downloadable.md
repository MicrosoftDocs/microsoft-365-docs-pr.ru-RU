...
1. Скопируйте скачаный ZIP-файл на каждое устройство, которое нужно проверить.
...
Устройства могут получить несколько основных конечных [точек](network.md) для работы с компьютерами, управляемыми Майкрософт.
...
Результат **консультации** означает, что вы используете некоторые профили Wi-Fi, которые требуют сертификатов и профилей для правильной работы. Дополнительные сведения см. в справке по развертыванию сертификатов и профилю [Wi-Fi/VPN.](certs-wifi-lan.md#deploy-certificates-and-wi-fivpn-profile)
