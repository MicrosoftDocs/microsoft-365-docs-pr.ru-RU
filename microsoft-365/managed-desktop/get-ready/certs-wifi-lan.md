...
5. Отправьте запрос в службу поддержки под названием "развертывание сертификата" или "развертывание профилей Wi-Fi" на компьютер с управляемыми ИТ-операциями Майкрософт с помощью портала администрирования на рабочем столе Майкрософт, чтобы просмотреть и развернуть профиль конфигурации на "современные рабочие устройства — тестирование ". Системные операции, управляемые Майкрософт для настольных систем, помогут вам узнать, когда запрос будет выполнен через запрос поддержки на портале администрирования. 
