...
Чтобы получить полное руководство по настройке приложений для работы с Azure Active Directory, обратитесь к приложению Understand considerations for [applications and resources](/azure/active-directory/devices/azureadjoin-plan#understand-considerations-for-applications-and-resources) in the Azure content set. Сводка:
...
6. [Подготовка локального доступа к ресурсам для microsoft Managed Desktop](authentication.md) (Эта статья)
