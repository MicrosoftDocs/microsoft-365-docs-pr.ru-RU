...
1. Перейдите к [диспетчеру конечных точек Майкрософт](https://endpoint.microsoft.com/) и выберите пункт "Устранение неполадок и поддержка" и найдите раздел "запросы к службам" в разделе Microsoft Managed дескоп.  
2. Отправьте запрос в службу поддержки, озаглавленный "развертывание сопоставленных дисков", и предоставьте все необходимые сведения о файловом ресурсе.  
...
4. Необходимо протестировать и проверить, работает ли конфигурация, развернутая управляемыми ИТ-операциями Майкрософт. Ответьте на вкладку обсуждение в разделе сведения о том же запросе поддержки, чтобы уведомить управляемые корпорацией Майкрософт рабочие ИТ по завершении тестирования.  
