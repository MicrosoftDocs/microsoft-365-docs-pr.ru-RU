...
---
# <a name="security-technologies-in-microsoft-managed-desktop"></a>Технологии безопасности на настольных компьютерах, управляемых Майкрософт

<!--Security, also Onboarding doc: data handling/store, privileged account access -->

Для обеспечения безопасности управляемых устройств и данных на рабочем столе Майкрософт используется несколько технологий Майкрософт. Кроме того, в центре управления рабочими столами Майкрософт используются различные [процессы](security-operations.md) в сочетании с этими технологиями.
...
Для получения сведений о способах хранения, использования и безопасности, используемых корпорацией Майкрософт для настольных ПК, ознакомьтесь с нашим техническим документом по адресу [https://aka.ms/mmd-data](https://aka.ms/mmd-data) .
...
Мониторинг |    Защитник Майкрософт для конечной точки используется для мониторинга угроз безопасности на всех настольных устройствах, управляемых корпорацией Майкрософт. Защитник для конечной точки позволяет корпоративным клиентам обнаруживать, изучать и отвечать на дополнительные угрозы в корпоративной сети. Дополнительные сведения см. в разделе [защитник Майкрософт для конечной точки.](https://docs.microsoft.com/windows/threat-protection/windows-defender-atp/windows-defender-advanced-threat-protection) 
