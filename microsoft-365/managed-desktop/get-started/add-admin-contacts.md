...
Служба технической поддержки ИТ | в тех случаях, когда наши сотрудники службы поддержки переносятся на билеты пользователей за пределами областей поддержки для управляемых компьютеров Майкрософт 
