...
|Администратор поддержки службы     | Администраторы с этой ролью будут иметь **разрешения на чтение и запись компонентов, не связанных с безопасностью** , на портале администрирования настольных компьютеров Майкрософт.         |
