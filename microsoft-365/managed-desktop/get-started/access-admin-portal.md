...
### <a name="assigning-built-in-roles-to-administrators"></a>Назначение встроенных ролей администраторам

Для управления встроенными ролями существует группа безопасности для каждой настраиваемой роли с именем "Современные рабочие роли _—_ имя роли" (например, "Современные рабочие роли — диспетчер безопасности"). Чтобы назначить пользователей одной из этих групп безопасности, выполните следующие действия.
