...
Имя группы Azure AD | Назначение пользователей   
 --- | ---
Современный рабочее место — Office – проект — установка | Пользователям требуется только проект
Современный рабочее место — Office — Visio — установка | Пользователи, которым требуется только Visio
Современный рабочее место — Office — проект и Visio — установка | Пользователям требуется как проект, так и Visio
