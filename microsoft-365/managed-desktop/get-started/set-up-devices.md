...
Мы рекомендуем работать с одним из наших утвержденных партнеров по устройствам. Для получения дополнительной помощи по настройке связи с устройством вы можете обратиться к контактной записи Майкрософт. Однако по сути процесс выглядит так:
...
1. Просмотрите список утвержденных [в настоящее](../service-description/device-list.md) время устройств, чтобы определить, какие из ваших устройств утверждены для использования с управляемыми Майкрософт компьютерами. Если вы повторно будете использовать существующее устройство, вам придется его перезапракть.
