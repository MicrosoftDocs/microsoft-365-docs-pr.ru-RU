...
5. После сохранения файла необходимо отфильтровать результаты только на тех устройствах, которые планируется зарегистрировать с помощью управляемого рабочего стола Майкрософт, и загрузить данные на компьютер, управляемый Майкрософт. Откройте диспетчер конечных точек Майкрософт и перейдите в меню **устройства** выберите раздел Рабочий стол с управляемым Майкрософт и выберите пункт **устройства**. Выберите **+ Регистрация устройств** , которая открывает оперативную подпрограмму для регистрации новых устройств.
