...
компьютеры, управляемые Майкрософт определяет каждое устройство уникальным образом, ссылаясь на его аппаратный хаш. У вас есть три варианта получения этой информации:
...
### <a name="autopilot-group-tag"></a>Тег группы Автопилот

При использовании портала Администрирования для регистрации устройств мы автоматически назначаем **тег группы Microsoft365Managed_Autopilot** автопилота.
Служба ежедневно отслеживает все компьютеры, управляемые Майкрософт устройства и назначает тег группы любому, у кого он еще не имеется.
