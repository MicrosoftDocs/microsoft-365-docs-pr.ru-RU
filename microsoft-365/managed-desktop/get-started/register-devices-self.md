...
3. Выберите **"Регистрация устройств".** Система добавит устройства в список устройств на устройствах, помеченных как ожидающих **регистрации.** Регистрация обычно занимает менее 10 минут, и при  успешном запуске устройство будет показываться как готовое для пользователя. Это означает, что оно готово к использованию.
...
| Неактивный | Устройство было доставлено пользователю и зарегистрировано в клиенте. Однако они не использовали устройство в последнее время (за последние 7 дней).  | 
