---
title: Настройка SharePoint в качестве источника учебного контента для Microsoft Viva Обучение (Предварительная версия)
ms.author: chucked
...
description: Узнайте, как настроить SharePoint как источник обучающего контента для Microsoft Viva Обучение (Preview).
ms.openlocfilehash: 96dc12f8c69281f420b339198222f9f918ebc5b4
ms.sourcegitcommit: 4886457c0d4248407bddec56425dba50bb60d9c4
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/03/2021
ms.locfileid: "53289947"
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="791e1-103">Настройка SharePoint в качестве источника учебного контента для Microsoft Viva Обучение (Предварительная версия)</span><span class="sxs-lookup"><span data-stu-id="791e1-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="791e1-104">Эта функция еще не доступна в предварительном просмотре продукта.</span><span class="sxs-lookup"><span data-stu-id="791e1-104">This feature is not yet available in product preview.</span></span>
