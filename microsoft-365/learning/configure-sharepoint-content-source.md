...
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a>Настройка SharePoint в качестве источника учебного контента для Microsoft Viva Обучение (Предварительная версия)
