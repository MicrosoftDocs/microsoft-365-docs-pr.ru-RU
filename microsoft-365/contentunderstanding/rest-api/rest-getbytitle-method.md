...
Получает или обновляет сведения о модели осмысления документации SharePoint Syntex с помощью названия модели (см. [пример](rest-getbytitle-method.md#examples)).
...
### <a name="get-information-about-the-contoso-contract-model"></a>Получение сведений о модели контрактов Contoso

В этом примере для модели осмысления документации контрактов Syntex используется имя `Contoso Contract`.
...
### <a name="get-and-delete-the-contoso-contract-model-by-name"></a>Получение и удаление модели контрактов Contoso по имени

В этом примере для модели осмысления документации контрактов Contoso используется имя `Contoso Contract`.
