...
> [!NOTE]
> Если вы создаете новое средство извлечение, выберите **Новый тип столбца** и **Одна строка текста**, при этом максимальная длина составляет 255 символов. Все введенные символы, превышающие эту длину, будут усечены. 
