...
Перейдите в [центр администрирования Power Platform](https://admin.powerplatform.microsoft.com/resources/capacity) , чтобы проверить свои кредиты и использование.
