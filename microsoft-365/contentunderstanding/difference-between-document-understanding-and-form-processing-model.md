...
| Интеграция функций соответствия требованиям, если включена защита информации (Майкрософт) | Поддержка опубликованных меток хранения.<br>Поддержка меток конфиденциальности появится в ближайшее время. | Поддержка опубликованных меток хранения.<br>Установка опубликованных меток хранения. |
