...
Microsoft SharePoint Syntex — это служба Microsoft 365, которая помогает организациям:
...
|См. примеры сценариев с идеями о том, как можно использовать SharePoint Syntex в организации |[Сценарии и варианты использования для Microsoft SharePoint Syntex](./adoption-scenarios.md)| 
