...
> [!NOTE]
> Вместо того, чтобы вручную создавать объяснение для списка фраз, воспользуйтесь [библиотекой объяснений](explanation-types-overview.md#use-explanation-templates) с шаблонами популярных списков фраз, например *дата*, *номер телефона*, *номер кредитной карты* и т. д.
...
1. Следующие символы в любом количестве: 
   ...
   в. точка, символ подчеркивания, знак процента или тире.
...
В следующей таблице приведены варианты встроенных символов, которые в настоящее время недоступны для использования в шаблонах регулярных выражений.
