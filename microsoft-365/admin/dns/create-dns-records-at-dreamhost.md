...
5. Выберите **"Изменить этот домен для использования пользовательских записей MX"!**
...
7. Если вы удалили какие-либо записи, выберите "Обновить пользовательские **записи MX"!**
