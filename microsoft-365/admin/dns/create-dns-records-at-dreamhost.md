...
---
# <a name="create-dns-records-at-dreamhost-for-microsoft"></a>Создание записей DNS для Майкрософт на сайте Dreamhost
...
После добавления этих записей на сайте DreamHost ваш домен будет настроен для работы со службами Майкрософт.
...
2. На странице **"Информационная** панель" выберите **"Домены"** и **"Управление доменами".**
    
    ![Dreamhost-BP-Configure-1-2](../../media/ab05c16a-79f6-491f-ad07-9a2e6674671d.png)
  
3. На странице **"Управление доменами"** в **разделе** "Домен" выберите **DNS** для домена, который нужно изменить. 
...
5. Выберите **"Добавить запись" сейчас!**
...
2. На странице **"Информационная** панель" выберите **"Почта",** а затем **"Настраиваемая MX".**
    
    ![Dreamhost-BP-Configure-2-1](../../media/58478679-4018-49cc-9d83-371dc5fa4a22.png)
  
3. В разделе **"Управление доставкой** почты"  в **столбце** "Действия" выберите "Изменить" для домена, который нужно изменить. 
...
7. Если вы удалили какие-либо записи, выберите "Обновить пользовательские **записи MX" сейчас!**
...
6. Используя два предыдущих шага и значения из остальных пяти строк таблицы, добавьте каждую из остальных пяти записей CNAME.
