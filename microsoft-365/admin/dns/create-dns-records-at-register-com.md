...
---
# <a name="create-dns-records-at-registercom-for-microsoft"></a>Создание записей DNS в Register.com microsoft
...
После добавления этих записей в Register.com домен будет настроен для работы с службами Майкрософт.
...
4. Найдите строку, содержаную имя домена, который необходимо изменить; а затем в этой строке выберите **Управление**.
    
5. Прокрутите вниз в раздел **Расширенные технические параметры,** а затем выберите **Изменить TXT Records (SPF).**
...
8. На следующей странице выберите **Продолжить еще** раз, чтобы подтвердить изменения. 
...
5. Прокрутите в **раздел Расширенные технические параметры,** а затем выберите **Изменить записи обменник почты**.
...
6. В поля для новой записи введите (или скопируйте и вставьте) значения из таблицы ниже.
    ...
    |:-----|:-----|:-----|
    |@  <br/> |High (Высокий)  <br/> Дополнительные сведения о приоритете см. в статье [Что такое приоритет записей MX?](../setup/domains-faq.yml). <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/>  <br/>**Примечание.**  Получите свой \<*domain-key*\> из учетной записи Майкрософт. <br> [Как его найти?](../get-help-with-domains/information-for-dns-records.md)          |
...
9. На следующей странице выберите **Продолжить снова,** чтобы подтвердить и сохранить изменения. 
...
5. Прокрутите в **раздел Расширенные технические параметры,** а затем выберите **Изменить записи псевдонимов домена.**
    
    ![Выберите Изменение записей псевдонимов домена](../../media/9fbc31ed-d67c-4828-8bd4-b51068f1e0ca.png)
  
6. Выберите **Дополнительные псевдонимы домена**.
...
8. При добавлении всех необходимых записей CNAME выберите **Продолжить**.
...
5. Прокрутите раздел **Расширенные технические параметры,** а затем выберите **Изменить TXT Records (SPF).**
...
8. На следующей странице выберите **Продолжить снова,** чтобы подтвердить и сохранить изменения. 
...
5. Прокрутите в **раздел Расширенные технические параметры,** а затем выберите **Изменить записи SRV**.
...
9. При добавлении обеих записей SRV выберите **Продолжить**.
    
    ![Выберите Продолжить](../../media/008b255a-42d3-442d-83ea-3ffcb7c8fc5d.png)
  
10. На следующей странице выберите **Продолжить снова,** чтобы подтвердить и сохранить изменения. 
