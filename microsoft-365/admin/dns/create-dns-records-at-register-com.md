...
---
# <a name="create-dns-records-at-registercom-for-microsoft"></a>Создание записей DNS для Register.com Майкрософт
...
После добавления этих записей Register.com домен будет настроен для работы со службами Майкрософт.
...
4. Найдите строку с именем домена, который необходимо изменить; а затем в этой строке выберите **"Управление".**
    
5. Прокрутите вниз до раздела **"Дополнительные** технические параметры" и выберите "Изменить **записи TXT (SPF)".**
...
8. На следующей странице снова выберите **"Продолжить",** чтобы подтвердить изменения. 
...
5. Прокрутите страницу до раздела **"Дополнительные** технические параметры" и выберите "Изменить записи **почтового обменник".**
...
6. В поля для новой записи введите (или скопируйте и вставьте) значения из таблицы ниже.
    ...
    |:-----|:-----|:-----|
    |@  <br/> |High (Высокий)  <br/> Дополнительные сведения о приоритете см. в статье [Что такое приоритет записей MX?](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq). <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/>  <br/>**Примечание.**  Получите свой \<*domain-key*\> из учетной записи Майкрософт. <br> [Как его найти?](../get-help-with-domains/information-for-dns-records.md)          |
...
9. На следующей странице снова выберите **"Продолжить",** чтобы подтвердить и сохранить изменения. 
...
5. Прокрутите страницу до раздела **"Дополнительные** технические параметры" и выберите "Изменить записи **псевдонимов домена".**
    
    ![Select Edit Domain Aliases Records](../../media/9fbc31ed-d67c-4828-8bd4-b51068f1e0ca.png)
  
6. Выберите **"Добавить дополнительные псевдонимы домена".**
...
8. После того как вы добавили все необходимые записи CNAME, выберите **"Продолжить".**
...
5. Прокрутите страницу до раздела **"Дополнительные** технические параметры" и выберите "Изменить **записи TXT (SPF)".**
...
8. На следующей странице снова выберите **"Продолжить",** чтобы подтвердить и сохранить изменения. 
...
5. Прокрутите **страницу до** раздела "Дополнительные технические параметры" и выберите **"Изменить записи SRV".**
...
9. После того как вы добавили обе записи SRV, выберите **"Продолжить".**
    
    ![Выберите "Продолжить"](../../media/008b255a-42d3-442d-83ea-3ffcb7c8fc5d.png)
  
10. На следующей странице снова выберите **"Продолжить",** чтобы подтвердить и сохранить изменения. 
