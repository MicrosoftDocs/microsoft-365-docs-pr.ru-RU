...
6. <span data-ttu-id="8b9a3-136">Нажмите **Создать**.</span><span class="sxs-lookup"><span data-stu-id="8b9a3-136">Select **Create**.</span></span>
