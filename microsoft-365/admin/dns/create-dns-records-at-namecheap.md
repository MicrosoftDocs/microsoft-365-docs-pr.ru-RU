...
---
# <a name="create-dns-records-at-namecheap-for-office-365"></a>Создание записей DNS для Office 365 на сайте Namecheap
...
После того как вы добавите эти записи на сайте Namecheap, ваш домен будет настроен для работы со службами Office 365.
...
7. В поля для новой записи введите (или скопируйте и вставьте) значения из таблицы ниже.
    ...
    (Поле **Priority** (Приоритет)  это поле без названия справа от поля **Value** (Значение). Выберите значение **TTL** из раскрывающегося списка. 
    
    |**Type (Тип)**|**Host (Узел)**|**Value (Значение)**|**Priority (Приоритет)**|**TTL (Срок жизни)**|
    |:-----|:-----|:-----|:-----|:-----|
    |MX Record (Запись MX)  <br/> |@  <br/> |\<*Domain — Key*\>. mail.Protection.Outlook.com.  <br/> **This value MUST end with a period (.)** <br/> **Примечание:** Получите * \<ключ\> домена* из учетной записи Office 365.  [Как его найти?](../get-help-with-domains/information-for-dns-records.md)          |нуль  <br/> Дополнительные сведения о приоритете см. в статье [Приоритет записей MX](https://support.office.com/article/2784cc4d-95be-443d-b5f7-bb5dd867ba83.aspx).    <br/> |30 мин  <br/> |
...
9. Если есть какие-либо другие записи MX, удалите каждую из них, выполнив двухшаговую процедуру.
    ...
    Сначала выберите значок " **Удалить** " (корзина может) для записи, которую необходимо удалить. 
    
    ![Namecheap-BP-Configure-2-4](../media/7a7a751f-29c2-495f-8f55-98ca37ce555a.png)
  
    Во вторых, нажмите кнопку **Да** , чтобы подтвердить удаление. 
