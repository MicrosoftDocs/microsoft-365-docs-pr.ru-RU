...
---
# <a name="create-dns-records-at-namecheap-for-microsoft"></a>Создание записей DNS в Namecheap для Microsoft
...
После добавления этих записей в Namecheap домен будет настроен на работу с службами Майкрософт.
...
2. На странице **"Посадка"** в **учетной записи** выберите **список доменов** из отпадаемого списка. 
    
    ![Namecheap-BP-Configure-1-2](../../media/3f457d64-4589-422c-ae34-fc24b0e819eb.png)
  
3. На странице **Список домена** найдите имя домена, который необходимо изменить, а затем выберите **Управление**.
    
    ![Namecheap-BP-Configure-1-3](../../media/fb2020d8-707c-4148-835e-304ac6244d66.png)
  
4. Выберите **расширенный DNS.**
    
    ![Namecheap-BP-Configure-1-4](../../media/05a4f0b9-1d27-448e-9954-2b23304c5f65.png)
  
5. В разделе **HOST RECORDS** выберите **ADD NEW RECORD**.
...
6. В раскрывающемся списке **Type** (Тип) выберите **TXT Record** (Запись TXT).
    ...
    > [!NOTE]
    > При **выборе ADD** NEW RECORD автоматически появляется сброс **type.** 
...
8. Выберите **контроль save Changes** (check mark). 
...
7. В поля для новой записи введите (или скопируйте и вставьте) значения из таблицы ниже.
    ...
    (Поле **Priority** (Приоритет)  это поле без названия справа от поля **Value** (Значение). Выберите **значение TTL** из выпадаемого списка.) 
    
    |**Type (Тип)**|**Host (Узел)**|**Value** (Значение)|**Priority** (Приоритет)|**TTL** (Срок жизни)|
    |:-----|:-----|:-----|:-----|:-----|
    |MX Record (Запись MX)  <br/> |@  <br/> |\<*domain-key*\>.mail.protection.outlook.com.  <br/> **Это значение ДОЛЖНО оканчиваться точкой (.).** <br/> **Примечание:** Получите вашу  *\<domain-key\>*  учетную запись Майкрософт.  [Как его найти?](../get-help-with-domains/information-for-dns-records.md)          |0  <br/> Дополнительные сведения о приоритете см. в статье [Что такое приоритет записей MX?](../setup/domains-faq.yml). <br/> |30 мин  <br/> |
...
9. Если есть какие-либо другие записи MX, удалите каждую из них, выполнив двухшаговую процедуру.
    ...
    Сначала выберите значок **Delete** (корзина) для записи, которую необходимо удалить. 
    
    ![Namecheap-BP-Configure-2-4](../../media/7a7a751f-29c2-495f-8f55-98ca37ce555a.png)
  
    Во-вторых, **выберите Да,** чтобы подтвердить удаление. 
...
9. Используя предыдущие четыре шага и значения из остальных пяти строк в таблице, добавьте все остальные пять записей CNAME.
