...
Перед использованием домена с Microsoft 365 необходимо убедиться в том, что вы являетесь его владельцем. Вы можете войти в свою учетную запись в вашем регистраторе доменных имен и создать запись DNS в Microsoft 365, если вы владеете доменом.
...
|TXT  <br/> |(Leave this field empty.)  <br/> |MS=ms *XXXXXXXX* <br/> **Примечание**: это пример. Используйте указанную здесь **конечную точку или значение адреса** , приведенное в таблице в Microsoft 365. [Как его найти?](../get-help-with-domains/information-for-dns-records.md) <br/> |
...
Когда Microsoft 365 находит правильную запись TXT, домен проверяется.
