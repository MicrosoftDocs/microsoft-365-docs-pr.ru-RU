...
6. Скопируйте из таблицы значение "Назначение" или "Указывает на адрес". Оно потребуется вам на следующем этапе. Рекомендуется скопировать и в pasting это значение, чтобы все интервалы оставались правильными.
