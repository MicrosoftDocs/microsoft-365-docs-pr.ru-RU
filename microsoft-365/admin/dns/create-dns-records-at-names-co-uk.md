...
---
# <a name="create-dns-records-at-namescouk-for-microsoft"></a>Создание записей DNS для Names.co.uk Майкрософт
...
После добавления этих записей Names.co.uk домен будет настроен для работы со службами Майкрософт.
...
3. На странице **"Зоны DNS**  на учетной записи" в столбце "Имя домена" выберите имя домена, который вы хотите обновить. 
