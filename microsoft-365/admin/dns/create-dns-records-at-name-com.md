...
После добавления этих записей name.com домен будет настроен для работы со службами Майкрософт.
...
2. В **области "Мои домены"** выберите имя домена, который нужно изменить.
...
4. В поля для новой записи введите (или скопируйте и вставьте) значения из таблицы ниже.
    ...
    |:-----|:-----|:-----|:-----|:-----|
    |MX  <br/> |(Оставьте это поле пустым.)  <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/> **Примечание.** Получите свою  *\<domain-key\>*  учетную запись Майкрософт.           [Как найти это значение?](../get-help-with-domains/information-for-dns-records.md)          |Используйте значение по умолчанию (300).  <br/> |0  <br/> Дополнительные сведения о приоритете см. в статье [Что такое приоритет записей MX?](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq). <br/> |
...
6. Если в списке указаны другие записи MX, удалите их. Для этого выполните указанные ниже действия.
    ...
    Для каждой другой записи MX выберите **"Удалить"** в **столбце "Действия".** 
    
    ![Name-BP-Configure-2-3](../../media/16734a98-31c4-4023-a2a5-10b7c95bc58e.png)
  
    Чтобы подтвердить каждое удаление, снова выберите **"Удалить"** в **столбце "Действия".** 
...
6. Добавьте вторую запись CNAME.
    ...
    Используйте значения из второй строки таблицы выше, а затем выберите **"Добавить** запись", чтобы добавить вторую запись. 
...
3. В **столбце "Сведения"** выберите **DNS Records+ (Записи DNS+**). 
