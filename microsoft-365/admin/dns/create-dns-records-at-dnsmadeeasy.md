...
---
# <a name="create-dns-records-at-dnsmadeeasy-for-microsoft"></a>Создание записей DNS для Майкрософт на сайте DNSMadeEasy
...
После добавления этих записей на сайте DNSMadeEasy ваш домен будет настроен для работы со службами Майкрософт.
...
2. На странице **"Консоль** управления" в области **"Недавно** обновленные домены" выберите домен, который требуется обновить. 
    
3. На странице **управляемой DNS** в области **TXT Records** (Записи TXT) выберите **+** () control ( **Add new).**
...
2. На странице **"Консоль** управления" в области **"Недавно** обновленные домены" выберите домен, который требуется обновить. 
    ...
    На странице **"Консоль** управления" в области "Недавно обновленные домены" выберите домен, который требуется обновить.  
    
    ![DNSMadeEasy-BP-Configure-1-2](../../media/8d8f403e-d7cd-429e-913b-dacb1f4644a2.png)
  
3. На странице **"Управляемая DNS"** в области **"Записи MX"** выберите в области **"+" (Добавить** **новый).**
...
7. Если выбраны все записи, выберите **"Удалить".**
    
    ![DNSMadeEasy-BP-Configure-2-4-2](../../media/e9064c07-1ce7-4387-b47a-90d4193da374.png)
  
8. В **диалоговом окне "Удаление записей MX"** выберите  "Удалить", чтобы подтвердить изменения. 
...
3. На странице **управляемой DNS** в области **cnAME Records** (Записи CNAME) выберите **(+)** control ( **Add new).**
...
6. Добавьте все остальные четыре записи CNAME.
    ...
    В разделе **"CnAME Records"** (Записи CNAME) выберите **(+)** control ( **Add new),** создайте  запись, используя значения из следующей строки таблицы, а затем снова выберите "Отправить", чтобы завершить запись. 
...
3. На странице **"Управляемая DNS"** в области **"TXT Records"** (Записи TXT) выберите **(+)** **(Добавить новый).**
...
3. На странице **"Управляемая DNS"** в области **записей SRV** выберите контроль **(+)** ( **Добавить новый).**
...
6. Добавьте вторую запись SRV.
    ...
    В разделе **SRV Records (SRV Records)** выберите **(+)** control ( **Add new),** создайте запись,  используя значения из следующей строки таблицы, а затем снова выберите "Отправить", чтобы завершить запись. 
