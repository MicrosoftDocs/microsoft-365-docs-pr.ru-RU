...
---
# <a name="create-dns-records-at-network-solutions-for-microsoft"></a>Создание записей DNS для Майкрософт на сайте Network Solutions
...
После добавления этих записей на сайте Network Solutions ваш домен будет настроен для работы со службами Майкрософт.
...
5. Прокрутите вниз до раздела "Почтовые серверы **(записи MX")** и выберите "Изменить **записи MX".**
...
6. В поля для новой записи введите (или скопируйте и вставьте) значения из таблицы ниже.
    ...
    |:-----|:-----|:-----|
    |10   <br/> Дополнительные сведения о приоритете см. в статье [Приоритет записей MX](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq).    <br/> |3600  <br/> | *\<domain-key\>*  .mail.protection.outlook.com.  <br/> **Это значение ДОЛЖНО оканчиваться точкой (.).** <br/> **Примечание.** Получите свою  *\<domain-key\>*  учетную запись Майкрософт. [Как его найти?](../get-help-with-domains/information-for-dns-records.md)          |
...
10. Когда все они будут выбраны, выберите **"Продолжить".**
...
5. Прокрутите вниз до раздела "Псевдонимы **хостов "CNAME Records" (Записи CNAME)** и выберите "Изменить **записи CNAME".**
...
7. После того как вы добавили все необходимые записи CNAME, выберите **"Продолжить".**
...
5. Прокрутите **вниз до раздела "Служба (записи SRV")** и выберите "Изменить **записи SRV".**
...
6. В поля для двух новых записей введите (или скопируйте и вставьте) значения из таблицы ниже.
    ...
    |_sipfederationtls  <br/> |_tcp  <br/> |3600  <br/> |100  <br/> |1   <br/> |5061  <br/> |sipfed.online.lync.com.  <br/> **Это значение ДОЛЖНО оканчиваться точкой (.).** <br/> |
