...
1. Чтобы приступить к работе, перейдите на страницу ваших доменов в Azure, используя [эту ссылку](https://portal.azure.com ). You'll be prompted to log in first.
...
4. Добавьте первую из четырех записей CNAME.
    ...
    |**Имя**|**Тип**|**TTL (Срок жизни)**|**Единица срока жизни**|**Alias**|
    |:-----|:-----|:-----|:-----|:-----|
