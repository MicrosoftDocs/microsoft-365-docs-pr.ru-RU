...
7. Если есть другие записи MX, удалите их, выбрав для каждой записи в столбце **"Удалить".** 
...
7. Добавьте вторую запись SRV.
    ...
    В разделе **"Добавление записи DNS"** создайте запись, используя значения из второй  строки таблицы, и снова выберите "Создать запись", чтобы завершить запись. 
