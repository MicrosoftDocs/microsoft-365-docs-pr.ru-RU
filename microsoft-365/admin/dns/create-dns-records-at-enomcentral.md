...
---
# <a name="create-dns-records-at-enomcentral-for-microsoft"></a>Создание записей DNS в eNomCentral для Microsoft
...
После добавления этих записей в eNomCentral домен будет настроен для работы с службами Майкрософт.
...
2. В **моих доменах** выберите имя домена, которое необходимо изменить.
...
4. В поля для новой записи введите (или скопируйте и вставьте) значения из таблицы ниже.
   ...
   Выберите значение **Тип записи** из отсевного списка.
...
5. In the boxes for the new record, type or copy and paste the values from the following table.
   ...
   |---|---|---|
   |@| *\<domain-key\>*  .mail.protection.outlook.com.  <br/> **Это значение ДОЛЖНО оканчиваться точкой (.).** <br/> **Примечание:** Получите вашу  *\<domain-key\>*  учетную запись Майкрософт. [Где это находится?](../get-help-with-domains/information-for-dns-records.md)|10   <br/> Дополнительные сведения о приоритете см. в статье [Приоритет записей MX](../setup/domains-faq.yml).   |
