...
---
# <a name="create-dns-records-at-enomcentral-for-microsoft"></a>Создание записей DNS для Майкрософт на сайте eNomCentral
...
После добавления этих записей на сайте eNomCentral ваш домен будет настроен для работы со службами Майкрософт.
...
2. В **моих доменах** выберите имя домена, который нужно изменить.
...
4. В поля для новой записи введите (или скопируйте и вставьте) значения из таблицы ниже.
   ...
   В **выпадаемом списке** выберите значение Record Type (Тип записи).
...
5. В поля для двух новых записей введите (или скопируйте и вставьте) значения из таблицы ниже.
   ...
   |Служба|Протокол|Priority|Насыщенность|Порт|Target (Hostname)|
   |---|---|---|---|---|---|
   |_sip|_tls|100|1 |443|sipdir.online.lync.com.  <br/> **Это значение ДОЛЖНО оканчиваться точкой (.).**|
   |_sipfederationtls|_tcp|100|1 |5061|sipfed.online.lync.com.  <br/> **Это значение ДОЛЖНО оканчиваться точкой (.).**|
