...
Если web.com ваш поставщик услуг размещения DNS, выполните действия в этой статье, чтобы подтвердить владение доменом и настроить записи DNS для электронной почты, Skype для бизнеса Online и других служб.
...
При регистрации в web.com домен добавляется с помощью web.com **установки.** 
...
2. Создайте две записи серверов доменных имен, используя значения из приведенной ниже таблицы, либо измените существующие записи серверов доменных имен, чтобы они соответствовали следующим значениям:
    ...
    |Второстепенный сервер доменных имен  <br/> |Используйте значение для доменного имени, предоставленного web.com.  <br/> |
