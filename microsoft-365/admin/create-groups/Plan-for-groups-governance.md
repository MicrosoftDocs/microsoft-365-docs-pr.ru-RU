...
Группы Office 365 позволяют пользователям и снизить риск их затенения, предоставляя в течение одного этапа многие средства, необходимые для сотрудничества. Группы Office 365 позволяют выбрать набор людей, с которыми требуется совместная работа, и легко настроить набор ресурсов для совместного использования. Назначение разрешений для ресурсов вручную — это то, что при добавлении членов в группу автоматически предоставляются необходимые разрешения всем ресурсам, предоставляемым группой.

## <a name="technical-architecture"></a>Техническая архитектура

Существует три основных модальности для обмена данными, поддерживаемые группами Office 365. Группы могут создаваться в этих интерфейсах и использоваться в наборе Office 365:
- [Outlook](https://support.office.com/article/learn-about-office-365-groups-b565caa1-5c40-40ef-9915-60fdb2d97fa2): совместная работа через электронную почту с общей групповой папкой "Входящие" и "Календарь"
- [Microsoft Teams](https://support.office.com/article/learn-about-office-365-groups-b565caa1-5c40-40ef-9915-60fdb2d97fa2): Рабочая область для сохраняемого чата, в которой вы можете иметь неформальные, интерактивное время, беседы по различным темам, организованные по определенным вложенным группам.
- [Yammer](https://support.office.com/article/learn-about-office-365-groups-b565caa1-5c40-40ef-9915-60fdb2d97fa2): Корпоративный социальное интерфейс для совместной работы

> [!NOTE]
> Создание новой группы с помощью других приложений для совместной работы, таких как SharePoint, планировщика или потока, приведет к созданию группы с модальностью взаимодействия Outlook с возможностью подключения к Microsoft Teams.

В зависимости от того, где создана группа, определенные ресурсы автоматически подготавливаются, например:
- [Папка "Входящие"](https://support.office.com/article/have-a-group-conversation-in-outlook-a0482e24-a769-4e39-a5ba-a7c56e828b22) — для обмена сообщениями между участниками. В этом почтовом ящике есть адрес электронной почты, который можно настроить на прием сообщений от пользователей вне группы и даже за преходясь в Организации, подобно обычному списку рассылки.
...
- [Библиотека документов SharePoint](https://support.office.com/article/share-group-files-749bc73b-90c9-4760-9b6f-9aa1cf01b403) — центральное место для хранения и совместного использования файлов в группе.
...
> [!NOTE]
> Если новая группа Office 365 создана с помощью Yammer или Teams, эта группа не отображается в Outlook или адресной книге, так как основной обмен данными между этими пользователями происходит в соответствующих клиентах.

> [!IMPORTANT]
> При создании новой группы Yammer группа Office 365 не создает почтовый ящик группы или ресурс календаря. Таким образом, Группа Yammer не может быть подключена к Microsoft Teams. Просмотр [Yammer и групп](https://docs.microsoft.com/yammer/manage-yammer-groups/yammer-and-office-365-groups)
...
- Teams: Рабочая область на основе чата (высокая скорость совместной работы) — внутренний цикл
  ...
  - Live Chat, аудио-и видеоконференции, записанные собрания.
...
### <a name="control-who-can-create-office-365-groups"></a>Контроль пользователей, которые могут создавать группы Office 365
Группы могут создаваться конечными пользователями из нескольких конечных точек, в том числе Outlook, SharePoint, Microsoft Teams и других сред.
...
>- Оцените, какие группы сценариев могут управлять с помощью динамического членства и разрешить самостоятельную поддержку для REST.

Существует три основных модели подготовки в группах: "Открытие", "IT" или "управляется". В следующей таблице описываются преимущества каждой модели.
...
### <a name="group-soft-delete-and-restore"></a>Обратимое удаление и восстановление группы
...
|         |         |         |
|---------|---------|---------|
|![изображение DESC](../../media/decision_point.png)|Точки принятия решений|<ul><li>Необходимо ли указывать для команд определенную дату окончания срока действия в рамках организации?</li><li>Как определить стратегию работы с потерянными группами?</li></ul>|
...
### <a name="group-guest-access"></a>Гостевой доступ к группе
...
- [Гостевой доступ в группах Office 365 — Справка для администраторов](https://support.office.com/article/Guest-access-to-Office-365-groups-Admin-Help-7c713d74-a144-4eab-92e7-d50df526ff96)
...
- [Авторизация гостевого доступа в Microsoft Teams](https://docs.microsoft.com/microsoftteams/teams-dependencies)

### <a name="group-policies--information-protection"></a>Групповые политики & защита информации
...
|         |         |         |
|---------|---------|---------|
|![изображение DESC](../../media/decision_point.png)|Точки принятия решений|<ul><li>Существуют ли в Организации особые требования к использованию, которые необходимо сообщить всем пользователям?</li><li>Требуются ли в Организации классификации всего контента?</li><li>Требуется ли для организации хранение контента в течение определенного периода времени?</li><li>Требуются ли для вашей организации определенные политики хранения данных с AP плиед по группам?</li><li>Предполагается, что ваша организация должна иметь возможность архивировать неактивные группы для сохранения контента?</li><li>Нужно, чтобы создатели групп могли назначать категории, зависящие от Организации, в Teams?</li></ul>|
|![изображение DESC](../../media/next_steps.png)|Дальнейшие действия|<ul><li>Документирование рекомендаций по использованию в Организации для групп</li><li>Задокументируйте требования Организации к классификации.</li><li>Определение политик, которые должны быть применены на основе классификации, например чувствительность, хранение, гостевой доступ</li><li>Определите метки конфиденциальности для Организации и параметры защиты, которые необходимо связать.</li><li>Определите политику меток, чтобы управлять тем, какие пользователи и группы видят эти метки.</li><li>Настройте [Предварительный просмотр метки конфиденциальности групп](https://docs.microsoft.com/microsoft-365/compliance/sensitivity-labels-teams-groups-sites) и начните классифицировать группы в Организации.</li><li>Запланируйте реализацию этих требований в рамках развертывания групп.</li></ul>|
...
### <a name="upgrade-traditional-collaboration-tools"></a>Обновление традиционных средств для совместной работы
...
|         |         |         |
|---------|---------|---------|
|![изображение DESC](../../media/decision_point.png)|Точки принятия решений|<ul><li>У вашей организации есть списки рассылки, которые [не подходят](https://docs.microsoft.com/office365/admin/manage/upgrade-distribution-lists#how-do-i-check-which-dls-are-eligible-for-upgrade) для обновления?<li>Как определить, к какому типу относится список рассылки, который лучше всего перенесен?</li></ul>|
...
- [Причины обновления списка рассылки до групп в Outlook](https://aka.ms/whyupgradedls)
- Обновление с одним щелчком с помощью центра администрирования Exchange или с помощью [сценариев PowerShell](https://support.office.com/article/Migrate-distribution-lists-to-Office-365-Groups-Admin-help-787d7a75-e201-46f3-a242-f698162ff09f?ui=en-US&rs=en-US&ad=US)
...
### <a name="groups-reporting"></a>Отчеты по группам
...
| **Возможность**      | **Details**                                    | **Обязательная лицензия Azure AD Premium** | **Решение** |
| ------------------- | ---------------------------------------------- | ------------------------------------- | ------------ |
