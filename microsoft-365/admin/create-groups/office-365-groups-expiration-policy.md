...
Как отмечалось выше, срок действия по умолчанию отключен. Администратору необходимо включить политику истечения срока действия и настроить свойства, чтобы они вступили в силу. Чтобы включить его, перейдите **Azure Active Directory (AAD)** к  >  **Groups**  >  **сроку действия**групп Azure Active Directory (AAD). Здесь можно задать время жизни группы по умолчанию и указать время, в течение которого вы хотите, чтобы первый и второй уведомления об истечении срока действия переходили на владельца группы.
...
## <a name="how-expiration-and-renewal-work"></a>Как истечет срок действия и обновление

Политика истечения срока действия работает следующим образом: 

- По месяцу до истечения срока действия, система проверяет, есть ли действия группы с момента создания группы или с начала текущего цикла обновления.

- Если будет обнаружено предыдущее действие, Дата истечения срока действия заменяется числом дней, указанным в политике срока действия.

- Если предыдущее действие не обнаружено, система продолжит отслеживать действия до даты окончания срока действия. Если действие обнаружено, система переместит дату истечения срока на указанную величину в это время.

за 30 дней до истечения срока действия группы Владельцы группы (или адреса электронной почты, указанные для групп, которым не назначен владелец), получат сообщение электронной почты, что позволит им легко продлить группу. Если они не возобновляют его, они получат еще одно продление срока действия до истечения срока действия через 15 дней. Если они по-прежнему не возобновлены, в течение дня до истечения срока их действия будет получено еще одно уведомление. (После того как группа будет обновлена, дальнейшие напоминания по электронной почте не будут отправляться в течение 30 дней до новой даты.)

Владельцы групп будут уведомлены по электронной почте. Если группа была создана с помощью планировщика, SharePoint или любого другого приложения, уведомления об истечении срока действия всегда поступают через электронную почту. Если группа была создана с помощью Teams, владелец группы получит уведомление об обновлении в разделе действие. Не рекомендуется включать срок действия для группы, если владелец группы не имеет действительный адрес электронной почты.
...
## <a name="how-expiry-works-with-retention-policies"></a>Как работает политика хранения с истекшим сроком действия
