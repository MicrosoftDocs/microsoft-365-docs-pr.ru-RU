...
|Количество групп, участником которых может быть пользователь|7 000|
...
По умолчанию максимальное число групп Microsoft 365, которые может иметь организация, равно 500 000. Чтобы перейти к превышению лимита по умолчанию, необходимо обратиться в службу поддержки Майкрософт. Для получения дополнительных сведений об ограничении групп Microsoft 365, ознакомьтесь со статьей [microsoft 365 Groups — Справка для администраторов](https://support.microsoft.com/office/b565caa1-5c40-40ef-9915-60fdb2d97fa2).
