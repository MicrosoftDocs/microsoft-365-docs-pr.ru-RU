...
Несмотря на то, что пользователи могут создать группу Office 365 из Outlook или других приложений, как администратор, вам может потребоваться создать или удалить группы, добавить или удалить участников и настроить их работу. Это можно сделать с помощью центра администрирования Microsoft 365. 
...
1. В [центре администрирования](https://go.microsoft.com/fwlink/p/?linkid=848041)перейдите на страницу **группы** **группы** > . 

::: moniker-end

::: moniker range="o365-21vianet"

1. В [центре администрирования](https://go.microsoft.com/fwlink/p/?linkid=850627)перейдите на страницу **группы** **группы** > . 
...
1. В центре администрирования обновите страницу, чтобы появилась новая группа **, выберите** \> группы группы, а затем выберите имя <a href="https://go.microsoft.com/fwlink/p/?linkid=2052855" target="_blank">группы, в</a>которую вы хотите добавить участников.
