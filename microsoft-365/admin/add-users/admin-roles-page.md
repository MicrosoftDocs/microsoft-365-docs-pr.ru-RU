...
> [!TIP]
> Нужны подробные описания ролей? Ознакомьтесь [с разрешениями на роль администратора в Azure Active Directory](/azure/active-directory/users-groups-roles/directory-assign-admin-roles#available-roles) и [о ролях администратора.](/office365/admin/add-users/about-admin-roles)
...
Назначение роли администратора службы пользователям, которым необходимо создавать запросы на службы для служб Azure, Microsoft 365 и Office 365. [Подробнее](/office365/admin/add-users/about-admin-roles#roles-available-in-the-microsoft-365-admin-center)
