...
## <a name="watch-add-an-adminbrbr"></a>Просмотрите: Добавьте администратора.<br><br>
...
Разрешения роли администратора можно проверить двумя различными способами:

- Вы можете перейти к сведениям о пользователе и просмотреть его в разделе **роли** на странице **учетная запись** .
- Можно также перейти к **роли** и выбрать роль Admin и выбрать назначенных администраторов, чтобы узнать, какие пользователи назначены.
