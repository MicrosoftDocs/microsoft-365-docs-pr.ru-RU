...
1. В центре администрирования перейдите к **ролям ролей,** чтобы просмотреть все роли администратора, доступные >  для вашей организации.
...
2. На странице **Активные пользователи** выберите пользователя, роль администратора которого необходимо изменить. В области вылетов рядом с **Ролями** выберите **"Управление ролями".**
