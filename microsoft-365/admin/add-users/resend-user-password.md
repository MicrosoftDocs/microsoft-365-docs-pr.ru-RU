...
---
# <a name="resend-a-users-password---admin-help"></a>Повторная отправка справки для администратора пользователя

В этой статье объясняется, как повторно отправить уведомление электронной почты новому пользователю в Office 365. Для этого необходимо переустановить пароль пользователя.
