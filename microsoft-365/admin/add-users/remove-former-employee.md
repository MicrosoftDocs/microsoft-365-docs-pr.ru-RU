...
Если вы используете Azure Active Directory, см. в этой ленте подстановка [Remove-MsolUser](https://go.microsoft.com/fwlink/?linkid=842230) PowerShell.
