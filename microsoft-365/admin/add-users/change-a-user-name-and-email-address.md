---
title: Изменение имени пользователя и адреса электронной почты в Office 365
f1.keywords:
- NOCSH
ms.author: cmcatee
author: cmcatee-MSFT
...
description: 'Узнайте, как глобальный администратор может изменить адрес электронной почты в Office 365 и отображаемое имя. '
ms.openlocfilehash: 16dab0f0ac65bccea0e2273e396315a32dd33439
ms.sourcegitcommit: ca2b58ef8f5be24f09e73620b74a1ffcf2d4c290
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 02/24/2020
ms.locfileid: "42245753"
---
# <a name="change-a-user-name-and-email-address-in-office-365"></a>Изменение имени пользователя и адреса электронной почты в Office 365

Изменить адрес электронной почты и отображаемое имя пользователя в Office 365 может потребоваться, например, если этот пользователь сменил фамилию при вступлении в брак.
...
Эти действия могут выполнять только [глобальные администраторы Office 365](about-admin-roles.md). 
...
3. Выберите параметр **Сделать основным** для адреса электронной почты, который необходимо установить основным адресом электронной почты для этого пользователя. 
    ...
    **Внимание!** Этот параметр не отображается, если вы приобрели Office 365 у GoDaddy или другой партнерской службы, предоставляющей консоль управления. В этом случае войдите в консоль управления GoDaddy или другого партнера и задайте основной псевдоним там. 
    
    Кроме того, этот параметр отображается только для глобальных администраторов Office 365. Если вы не видите его, это означает, что у вас нет разрешения на изменение имени пользователя и его основного адреса электронной почты.
...
5. Сообщите пользователю следующие данные:
  ...
  - Новое имя пользователя: оно потребуется ему для входа в Office 365.
...
При отображении сообщения об ошибке "**Не удалось изменить пользователя. Проверьте сведения о пользователе и повторите попытку**." Это означает, что вы не являетесь глобальным администратором Office 365 и у вас нет разрешений на изменение имени пользователя. Найдите глобального администратора и попросите его внести это изменение.
...
Некоторые люди будут продолжать отправлять на него письма, поэтому его удаление может повлечь за собой проблемы с доставкой. Office 365 будет автоматически перенаправлять сообщения на новый адрес. Кроме того, не следует продолжать использовать старые SMTP-адреса и указывать их для новых учетных записей. Это тоже может стать причиной недоставки сообщений или их отправки не по адресу.
