...
3. В первом поле введите первую часть нового адреса электронной почты. Если вы добавили в Microsoft 365 собственный домен, выберите домен для нового псевдонима электронной почты в раскрывающемся списке. 
...
3. В первом поле введите первую часть нового адреса электронной почты. Если вы добавили в Microsoft 365 собственный домен, вы можете выбрать домен для нового псевдонима электронной почты в раскрывающемся списке.
