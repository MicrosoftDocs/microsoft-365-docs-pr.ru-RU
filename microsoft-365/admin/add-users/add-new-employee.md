 ...
 **Нет приложений Office в вашем плане?** Выполните следующие действия, но пропустите разделы для установки приложений. Вместо этого [используйте версии Office](https://support.microsoft.com/office/91a4ec74-67fe-4a84-a268-f6bdf3da1804) online. 
...
|[Шаг 2. Предодайте сотруднику свой ИД пользователя и пароль](#step-2-give-the-employee-their-user-id-and-password) <br/> |При создании учетной записи вы получите ИД и пароль, которые можно передать сотруднику, чтобы он входил в нее.  <br/> |
