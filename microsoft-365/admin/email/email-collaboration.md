...
В этой таблице поясняются различные доступные варианты совместной работы.
  


|**Метод совместной работы**|**Описание**|
|:-----|:-----|
|Группы в Outlook  <br/> |Общая рабочей области, которая работает во всех приложениях в Microsoft 365. Включает общий почтовый ящик, календарь и сайт OneDrive для бизнеса для хранения файлов. Пользователи могут создавать, находить группы и присоединяться к ним в Outlook прямо из электронной почты или календаря. Новые и существующие пользователи с подпиской на Exchange Online или Microsoft 365 могут использовать группы в Outlook.  <br/> |
...
В следующей таблице представлены краткие обзоры различных типов групп и поясняется, когда и как их использовать с различными функциями совместной работы.
  

||**Группы в Outlook**|**Списки рассылки**|**Общие почтовые ящики**|**Общедоступные папки**|
|:-----|:-----|:-----|:-----|:-----|
|**Пользователи** <br/> |Пользователи, которым нужна рабочая область для совместной работы для групповых сообщений, файлов и календаря, интегрированная со службами, которые они уже используют (Outlook Web App, OneDrive для бизнеса)  <br/> |Потребность отправлять электронную почту группе получателей с общими интересами или характеристиками.  <br/> |Общие почтовые ящики — отличный способ обработки вопросов электронной почты клиентов, так как несколько человек в вашей организации могут отвечать на запросы и отвечать на них. На вопросы клиентов вы получите более быстрые ответы, а связанные сообщения электронной почты хранятся в одном почтовом ящике.  <br/><br/> Представители, работающие от имени виртуального идентификатора, например support@contoso.com. Представитель может отвечать на сообщения электронной почты от имени идентификатора общего почтового ящика.  <br/> |Обладая необходимыми разрешениями, все пользователи в организации могут получить доступ к общим папкам и выполнять поиск в них. Они подходят для архивации электронной почты или обмена документами.  <br/> |
