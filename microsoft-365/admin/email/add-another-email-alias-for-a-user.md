...
3. Нажмите кнопку **+ Добавить псевдоним** и введите новый псевдоним для пользователя.   
    ...
    > [!TIP]
    > Псевдоним электронной почты должен заканчиваться доменом из раскрывающегося списка. Чтобы добавить в список другое доменное имя, ознакомьтесь со статьей [Добавление домена в Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/setup/add-domain). 
  
     
5. Когда все будет готово, нажмите кнопку **сохранить изменения**.
    
6. Подождите 24 часа, пока новые псевдонимы не заполняются в Microsoft 365.
...
4. В текстовом поле в разделе **псевдоним**введите первую часть нового псевдонима электронной почты. Если вы добавили свой домен в Microsoft 365, вы можете выбрать домен для нового псевдонима электронной почты с помощью раскрывающегося списка. Затем нажмите **Добавить**.
