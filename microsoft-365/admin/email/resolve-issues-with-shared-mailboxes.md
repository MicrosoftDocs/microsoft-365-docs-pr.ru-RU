...
Это сообщение появляется, когда в Microsoft 365 возникает проблема задержки репликации. Она должна пройти примерно через час, когда сведения о новом общем почтовом ящике (или добавленных пользователях) реплицированы во всех наших центрах обработки данных. Подождите час, а затем попробуйте еще раз отправить сообщение.
