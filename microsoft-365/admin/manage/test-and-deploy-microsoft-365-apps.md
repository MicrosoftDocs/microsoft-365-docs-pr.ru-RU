...
ms.locfileid: "51488293"
---
# <a name="test-and-deploy-microsoft-365-apps-by-partners-in-the-integrated-apps-portal"></a>Тестирование и развертывание приложений Microsoft 365 партнерами на портале интегрированных приложений

Центр администрирования Microsoft 365 предоставляет гибкость для развертывания приложений одного магазина, настраиваемой бизнес-линии приложений и партнерских приложений Microsoft 365 в одном расположении. К расположению можно получить доступ в центре администрирования Майкрософт > параметров > интегрированных приложений. Возможность поиска, тестирования и полного развертывания приобретенных и лицензированных приложений партнерами Майкрософт на портале интегрированных приложений обеспечивает удобство и преимущества, необходимые вашей организации для регулярного обновления бизнес-служб и эффективной работы.

Дополнительные сведения о приобретении и лицензировании приложений Microsoft 365 у партнеров для вашей организации см. в руб. Управление и развертывание приложений Microsoft 365 в центре администрирования [Microsoft 365.](https://techcommunity.microsoft.com/t5/microsoft-365-blog/manage-and-deploy-microsoft-365-apps-from-the-microsoft-365/ba-p/1194324)
...
Портал интегрированных приложений доступен только глобальным администраторам и доступен только для клиентов WorldWide. Эта функция недоступна в суверенных и государственных облаках.

На портале интегрированных приложений отображается список приложений, включаний в себя отдельные приложения и приложения Microsoft 365 от партнеров, развернутых в вашей организации. В списке перечислены только веб-приложения, spFx-приложения, надстройки Office и приложения Teams. В веб-приложениях можно увидеть 2 вида приложений.
...
Вы можете управлять тестированием и развертыванием приобретенных и лицензированных приложений Microsoft 365 от партнеров.
...
3. На странице **опубликованных приложений Microsoft 365 Apps** выберите приложение, которое необходимо развернуть, выбрав **Get it now.** В основном отображаются приложения Word, PowerPoint, Excel, Надстройки Outlook, приложения Teams и SharePoint (построенные на технологии SharePoint Framework). Примите разрешения и выберите **Продолжить**.
...
6. Выберите **Добавить пользователей,** выберите **Это тестового развертывания,** а затем выбрать **всю** организацию или **конкретные пользователи / группы** или Просто **меня**.
    ...
    Конкретные пользователи/группы могут быть группой Microsoft 365, группой безопасности или распределенной группой. Вы также можете выбрать **развертывание Test,** если вы хотите подождать, чтобы развернуть приложение во всей организации.
...
8. Выберите **Далее,** чтобы просмотреть развертывание и выбрать **готовое развертывание.** Развертывание можно просмотреть со вкладки **Обзор,** выбрав **просмотр этого развертывания.** В центре администрирования Microsoft 365 вы можете увидеть состояние каждого развернутого приложения и дату развертывания приложения.
...
- Предложение SaaS связано с надстройки, но не интегрируется с Microsoft Graph и не предоставляется AAD-ID приложения.
- Предложение SaaS связано с надстройкими, но AAD App ID, предоставленный для интеграции Microsoft Graph, является общим для нескольких предложений SaaS.

## <a name="upload-custom-line-of-business-apps-for-testing-and-full-deployment"></a>Загрузка настраиваемой линейки бизнес-приложений для тестирования и полного развертывания

1. В центре администрирования в левом nav выберите **Параметры,** а затем **интегрированные приложения.**

2. Выберите **Загрузите настраиваемые приложения.** Поддерживается только настраиваемая линейка приложений для Word, PowerPoint, Excel и Outlook.

3. Загрузите файл манифеста с устройства или добавьте ссылку URL-адреса. Некоторые приложения требуют добавления пользователей, прежде чем выбрать Развертывание.
...
- Регистрируется администратор exchange admininstrator.
...
Интегрированные приложения позволяют развертывать приложения Web Apps, Teams, Excel, PowerPoint, Word, Outlook и spFx. Для надстройок интегрированные приложения поддерживают развертывание в почтовых ящиках Exchange, а не в почтовых ящиках Exchange.
