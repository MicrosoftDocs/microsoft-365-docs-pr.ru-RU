...
- При удалении лицензии у пользователя данные, связанные с этой учетной записью, хранятся в течение 30 дней. По истечении 30-дневного льготного периода данные удаляются и не могут быть восстановлены. Файлы, сохраненные в OneDrive или SharePoint Online, не удаляются. Дополнительные сведения см. в статье [Хранение и удаление OneDrive](https://docs.microsoft.com/onedrive/retention-and-deletion)
