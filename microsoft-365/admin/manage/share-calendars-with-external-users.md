...
Часто приходится планировать встречи с людьми вне организации. Чтобы упростить процесс поиска взаимоприемлемого времени собрания, Office 365 позволяет сделать календари доступными "внешним пользователям"  тем, кому нужно видеть сведения о доступности, но у кого при этом нет учетных записей пользователей для среды Office 365.
...
3. На открывшейся странице **календаря** укажите, хотите ли вы предоставить пользователям доступ к своим календарям пользователям за прев Организации, у которой есть Office 365 или Exchange.
