...
1. В центре администрирования откройте страницу " **Параметры**  >  **служб &** надстроек".
     ...
     > [!NOTE]
    > Центр администрирования обновлен до развертывания интегрированных приложений. Если вы не видите эти действия, перейдите к разделу централизованное развертывание, перейдя к разделу " **Параметры**  >  **интегрированных приложений** ". В верхней части страницы **интегрированные приложения** **выберите надстройки.**
...
> [!NOTE]
> Запрет доступа пользователей к магазину Office также сделает их [неопубликованными надстройками Office для тестирования](https://docs.microsoft.com/office/dev/add-ins/testing/create-a-network-shared-folder-catalog-for-task-pane-and-content-add-ins).
