...
> [!NOTE] 
> Предотвращение доступа пользователей в офисный магазин также не позволит им выгружать надстройки Office для тестирования [из сетевой сети.](/office/dev/add-ins/testing/create-a-network-shared-folder-catalog-for-task-pane-and-content-add-ins)
