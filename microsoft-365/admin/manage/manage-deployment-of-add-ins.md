...
1. В центре администрирования откройте страницу "параметры надстроек **Settings** \> **"** . Если страница **надстройки** не отображается, **перейдите на** \> страницу надстройки **встроенных приложений для приложений** \> **Add-ins** .
...
4. Если вы выбрали вариант добавления надстройки из магазина Office, сделайте выбор в надстройке. </br>
    ...
    > [!NOTE] 
    > С помощью параметра магазин Office обновления и расширения автоматически развертываются для пользователей.
