...
Office надстройки помогут вам персонализировать документы и упростить доступ к информации в Интернете (см. в руб. Начало использования [Office надстройки).](https://support.microsoft.com/office/82e665c4-6700-4b56-a3f3-ef5441996862) В качестве администратора можно развернуть Office для пользователей в организации с помощью функции централизованного развертывания в Центр администрирования Microsoft 365. Централизованное развертывание — это рекомендуемый и наиболее насыщенный функцией способ для большинства администраторов развернуть надстройки для пользователей и групп в организации.
