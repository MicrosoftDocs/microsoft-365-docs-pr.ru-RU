...
|Столбец|Описание|
|---|---|
|Галочка|При выборе контрольного знака в строке заголовка столбца будут выбраны все отображаемые в настоящее время сообщения. Выбор контрольного знака рядом с одним или более сообщениями позволяет принимать меры по этим сообщениям.|
