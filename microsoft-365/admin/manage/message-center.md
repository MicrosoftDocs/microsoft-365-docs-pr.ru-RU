...
Центр сообщений представляет представление всех активных сообщений в формате таблицы. По умолчанию оно отображает последнее сообщение в верхней части списка. Вы можете выбрать **Службу,** чтобы видеть сообщения для различных служб, таких как Microsoft 365 Apps, SharePoint Online и т.д.   В **теге** Вы можете выбрать **влияние администратора,** конфиденциальность данных, обновление функций, основные **обновления,** новые функции, выход на пенсию или сообщения о **влиянии** пользователя.     В **состоянии Сообщения** можно выбрать **избранное,** **непрочитанные** или **обновленные** сообщения.
...
[Управление функциями Office в what's New](../manage/show-hide-new-features.md) (статья)
