...
После того как вы включите внешний общий доступ на уровне организации, вы можете настроить параметры общего доступа, чтобы отключить внешний общий доступ для определенных сайтов. Сведения см. в разделе ["Включите или выключите внешний общий доступ для сайта".](/sharepoint/change-external-sharing-site)
