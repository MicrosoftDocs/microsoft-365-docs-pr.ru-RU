...
> [!NOTE]
> Далее применяется только к **Office 365, выполняемым 21Vianet.
 ...
 **Если Office 365 управляет** записями DNS вашего домена, Office 365 устанавливает для вас эту запись CNAME. 
...
Если вы планируете развертывание Office 365 и хотите узнать больше обо всех записях DNS, которые вам может потребоваться добавить или обновить, ознакомьтесь с ними в справке: записи системы внешних доменных имен [для Office 365](../../enterprise/external-domain-name-system-records.md).
