...
|7.  <br/> |Вы можете отфильтровать диаграммы, выбрав элемент в легенде. Например, на диаграмме **"Файлы"** выберите **"Файлы"** или **"Активные файлы".** На **диаграмме "Сайты"** можно выбрать **"Всего сайтов"** или **"Активные сайты".** На **диаграмме "Хранилище"** можно выбрать **выделенное** хранилище или **потребляемую память.** При выборе другого значения данные в таблице-сетке не меняются.  <br/> |
