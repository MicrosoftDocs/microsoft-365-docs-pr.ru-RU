...
|Другие действия|Пользователь считается активным, но имеет нулевое значение для сообщений чата, 1:1 вызовов, сообщений канала, общих собраний и упорядоченных значений метрики. Примеры действий — когда пользователь открывает сообщение с сообщением канала, но не отвечает и не получает сообщение о том, что оно прочитано, но не ответило на него. |
|||