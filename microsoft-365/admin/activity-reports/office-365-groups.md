...
2. В разделе Параметры выберите пункт **Просмотреть больше** в разделе **Активные пользователи — Microsoft 365 Services**.
3. В раскрывающемся списке **выберите отчет** выберите **Office 365** \> **действие группы**Office 365.
