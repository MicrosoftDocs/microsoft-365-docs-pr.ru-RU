...
> [!NOTE]
> Для просмотра отчетов необходимо быть глобальным администратором Microsoft 365 или Exchange, SharePoint, Skype для бизнеса или читателя отчетов. 
