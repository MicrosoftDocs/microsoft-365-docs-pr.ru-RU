...
|4.  <br/> |Представление " **действия** " позволяет оценить тенденции числа активных пользователей. Пользователь считается активным, если он выполнял действие с файлом (сохранение, синхронизацию, изменение или предоставление общего доступа) или посетит страницу в течение определенного периода времени.<br/> NOTE: действие может выполняться несколько раз для одного опроса, но будет считаться только одним активным опросом. Например, вы можете создать опрос Pro и продолжить изменение одного и того же опроса несколько раз в указанный период времени, он будет считаться только одним опросом. <br>|
