...
|3.  <br/> |Для обеспечения качества данных мы выполняем ежедневные проверки данных за предыдущие пять дней и заполняются все обнаруженные промежутки. Вы можете заметить различия в исторических данных во время процесса.  <br/> |
...
|6.  <br/> | На диаграмме **активности** ось Y представляет собой количество указанных действий.  <br/>  На диаграмме **файлы** ось Y — это количество пользователей, участвующих в обсуждениях Teams, частных чата, звонках и собраниях.  <br/>  Ось X на диаграмме — это выбранный диапазон дат для конкретного отчета.  <br/> |
...
|9.  <br/> |Выберите **столбцы** , чтобы добавить столбцы в отчет или удалить их из него.  <br/> ![Teams user activity report - choose columns](../../media/eb5fbcee-e371-4d36-a0c6-fa54732311ec.png)|
