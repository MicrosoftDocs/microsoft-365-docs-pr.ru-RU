...
2. Выберите пользователя, а затем над списком пользователей выберите три точки (больше действий), а затем выберите **Удалить пользователя**.
...
Да, удаление пользователя освободит Microsoft 365, назначенную этому пользователю. Вы сможете назначить ее другому пользователю. [Прочитать статью.](../../commerce/licenses/buy-licenses.md)
