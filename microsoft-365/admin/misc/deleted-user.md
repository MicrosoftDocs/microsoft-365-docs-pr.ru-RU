...
2. Выберите пользователя, а затем над списком пользователей выберите "Дополнительные **параметры"** (**...**) и выберите **"Удалить пользователя".**
  
3. В области подтверждения удаления выберите **"Удалить пользователя".** <br/>[Прочитайте статью полностью.](../add-users/delete-a-user.md)
...
2. Выберите пользователя, а затем над списком пользователей выберите "Удалить  > **пользователя".**
...
Чтобы восстановить пользователей,  вы можете искать удаленных  на домашней странице и выбирать удаленных пользователей в результатах, а также переходить на страницу "Удаленные пользователи" в левой области навигации и выбирать пользователя, который нужно восстановить.  [Прочитать статью](../add-users/delete-a-user.md).
...
Да, удаление пользователя освободит лицензию Microsoft 365, назначенную этому пользователю. Вы сможете назначить ее другому пользователю. [Прочитать статью.](../../commerce/licenses/remove-licenses-from-subscription.md)
