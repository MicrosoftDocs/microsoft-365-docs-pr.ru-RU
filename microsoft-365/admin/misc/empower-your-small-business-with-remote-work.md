...
По мере того, как предприятия адаптируются к увеличению необходимости удаленной работы людей и виртуального подключения к своим клиентам, этот сайт обновляется с помощью последних сведений, советов, ресурсов и рекомендаций по удаленной работе для предприятий с помощью Microsoft 365.
...
Центр технической документации для Microsoft 365 Business обновляется с помощью новых безопасных методов удаленной работы.

Дополнительные сведения см. [в материале Microsoft 365 Business resources.](https://docs.microsoft.com/microsoft-365/business)
