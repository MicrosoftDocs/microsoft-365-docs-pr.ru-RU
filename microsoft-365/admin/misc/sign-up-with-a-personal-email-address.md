...
## <a name="when-you-skip-adding-a-custom-domain"></a>При пропуске добавления пользовательского домена

  
Если вы подписываетесь на Office 365 с помощью личного адреса электронной почты и не можете добавить [в него настраиваемый домен](../get-help-with-domains/what-is-a-domain.md) , вы ограничиваете доступ к определенным функциям. 
  
Если вы добавите личный домен, вы получите доступ ко всем функциям Premium ниже:
