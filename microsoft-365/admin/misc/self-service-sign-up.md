...
description: Узнайте о самообслуживаниях Microsoft 365 и самостоятельных программах самообслуживания, таких как Microsoft Power Apps, Microsoft Flow и Dynamics 365 для Finance.
...
Самостоятельная регистрация позволяет пользователям в вашей организации зарегистрироваться в веб-службах Майкрософт. Мы вызываем этот процесс регистрации "Самостоятельная регистрация", так как пользователи могут подписаться на использование служб, оплаченных подпиской, или использовать бесплатные службы, не запрашивая от них действий.
...
1. У студентов и преподавателей есть адреса электронной почты учебного заведения, которые указывают, что они связаны с ним. Например, адрес электронной почты jakob@uw.edu может указывать на учащийся в университете штата Вашингтон.
...
| Программа <br/> | Описание <br/> | Дополнительные сведения <br/> | Веб-сайт для самостоятельной регистрации в службе <br/> |
|:-----|:-----|:-----|:-----|
|Office 365 a1 * * * * <br/> |Любой студент или преподаватель может использовать учебный адрес электронной почты для регистрации бесплатной Office 365 и получения приложений Office для Интернета, 1 ТБ облачного хранилища OneDrive и SharePoint Online для сайтов, групп и сайтов проектов.  <br/> |[Office 365 для образования: технические вопросы и ответы](https://go.microsoft.com/fwlink/p/?LinkId=536625) <br/> |[Office 365 для образования](https://go.microsoft.com/fwlink/p/?linkid=140841) <br/> |
