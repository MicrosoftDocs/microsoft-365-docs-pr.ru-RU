...
2. Студенты и преподаватели заходят на [наш веб-сайт](https://go.microsoft.com/fwlink/p/?LinkId=536628)и используют свой адрес электронной почты для регистрации служб, которые предлагает ваша организация, например Office 365 профессиональный плюс. Они также могут зарегистрироваться для использования бесплатных служб.
    
3. Мы проверим их адреса электронной почты, после чего они смогут сразу же приступить к использованию Office 365, Power BI и других служб.
    
4. Как администратор бизнеса вы увидите, кто зарегистрировался для подписки, просмотрев страницу " **подписки** " в центре администрирования. Таким образом, вы можете увидеть, когда в клиенте есть новые или неопознанные лицензии для служб. 
...
|**Office 365 a1 плюс** <br/> |Студенты и преподаватели, соответствующие условиям, могут зарегистрироваться в Office 365 A1 Plus, который включает в себя все перечисленные выше компоненты, а также Office 365 профессиональный плюс. Office 365 профессиональный плюс содержит инструменты для эффективной работы (в том числе Word, PowerPoint, Excel, Outlook, OneNote, Publisher, Access и Skype для бизнеса), которые можно установить на компьютере или ноутбуке.  <br/> |[Office 365 для образования: технические вопросы и ответы](https://go.microsoft.com/fwlink/p/?LinkId=536625) <br/> |[Office 365 для образования](https://go.microsoft.com/fwlink/p/?linkid=140841) <br/> |
|**Power BI** <br/> |Power BI позволяет пользователям визуализировать данные, делиться об обнаружении и совместно работать с интуитивно понятными новыми способами. <br/> Если ваша организация уже подписывается на Office 365, вы можете дополнительно ознакомиться с лицензиями на пробную версию "Power BI Pro для отдельных пользователей", которая предоставляет пользователям ограниченный и бесплатный доступ к дополнительным возможностям.  <br/> |[Power BI в организации](https://go.microsoft.com/fwlink/p/?LinkId=536626) <br/> |[Microsoft Power BI](https://go.microsoft.com/fwlink/p/?LinkId=536629) <br/> |
...
|**Microsoft Flow** <br/> |Microsoft Flow позволяет создавать автоматические рабочие процессы между вашими приложениями и службами, которые будут синхронизировать файлы, получать уведомления, собирать данные и выполнять другие задачи.  <br/> |[Регистрация и вход в Microsoft Flow](https://go.microsoft.com/fwlink/p/?linkid=841468) <br/> |[Microsoft Flow](https://go.microsoft.com/fwlink/p/?linkid=841465) <br/> |
