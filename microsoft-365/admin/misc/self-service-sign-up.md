...
ms.locfileid: "47324484"
---
# <a name="using-self-service-sign-up-in-your-organization"></a>Использование функции самостоятельной регистрации в организации

Самостоятельная регистрация позволяет пользователям в вашей организации подписываться на веб-службы корпорации Майкрософт. Мы вызываем этот процесс регистрации "Самостоятельная регистрация", так как пользователи могут подписаться на использование услуг, оплаченных вашей подпиской, или использовать бесплатные службы без запроса действий от их имени.
