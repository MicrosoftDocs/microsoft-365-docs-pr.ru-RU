...
|Лицензированные пользователи  <br/> |Этим пользователям назначена лицензия Microsoft 365, например Microsoft 365 бизнес стандарт или Office 365 корпоративный E3, чтобы они могли использовать службы Microsoft 365.  <br/> |
