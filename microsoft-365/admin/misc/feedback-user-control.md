...
Скоро мы будем делиться данными обратной связи, которые мы собираем для продуктов Майкрософт. Мы работаем над новым опытом в центре администрирования Microsoft 365, который позволит просматривать, удалять и экспортировать данные обратной связи для вашей организации. Это обеспечивает непосредственную прозрачность и полезные сведения о том, как пользователи могут работать с Microsoft 365 продуктами.
