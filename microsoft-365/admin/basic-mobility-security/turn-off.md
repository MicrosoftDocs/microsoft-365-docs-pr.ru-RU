...
---
# <a name="turn-off-basic-mobility-and-security"></a>Отключение базовой мобильности и безопасности
...
Эти параметры удаляют базовое обеспечение мобильности и безопасности для устройств в организации. К сожалению, вы не можете просто "отопреподавить" Базовые функции мобильности и безопасности после ее настройка. 
