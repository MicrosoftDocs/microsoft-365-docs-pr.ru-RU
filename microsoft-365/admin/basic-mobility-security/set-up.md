...
6. <span data-ttu-id="715d0-135">На странице Создание сертификата APNs:</span><span class="sxs-lookup"><span data-stu-id="715d0-135">On the Create an APNs certificate page:</span></span>
