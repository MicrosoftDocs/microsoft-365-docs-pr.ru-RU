...
---
# <a name="multifactor-authentication-for-microsoft-365"></a>Многофакторная проверка подлинности для Microsoft 365
...
Чтобы обеспечить дополнительный уровень безопасности для входных входов, необходимо использовать многофакторную проверку подлинности (MFA), которая использует как пароль, который должен быть прочным, так и дополнительный метод проверки на основе:
...
[Включите многофакторную проверку подлинности для телефона](../../business-video/set-up-mfa.md) (видео)