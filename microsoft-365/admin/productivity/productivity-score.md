...
Для взаимодействия с сотрудниками необходимо иметь подписку на Microsoft 365 для бизнеса с несколькими пользователями. 
