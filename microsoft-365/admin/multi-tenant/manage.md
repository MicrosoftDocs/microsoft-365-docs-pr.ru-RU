...
2. На  агрегированном представлении "Состояние службы" также можно просмотреть общее количество инцидентов, общее число консультантов, влияющих на все управляемые клиенты, и количество служб с активными инцидентами. Вы также можете узнать, сколько клиентов затронуты инцидентами и консультантами.
