...
> [!NOTE]
> Вы можете проверить, нет ли проблем с доменом, проверив его состояние. Перейдите **в "Домены**  >  **установки"** и просмотреть уведомления в **столбце "Состояние".** Если вы видите проблему, выберите дополнительные действия (три точки), а затем выберите **"Проверить состояние".** В открываемой области описываются все проблемы, которые произошли с вашим доменом.
