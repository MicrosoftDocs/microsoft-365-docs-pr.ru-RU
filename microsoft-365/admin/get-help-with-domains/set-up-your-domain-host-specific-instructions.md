...
Чтобы начать использовать пользовательский домен (contoso.com) с Microsoft 365, необходимо проверить свой домен и настроить записи DNS домена. 
...
Выберите свой доменный хост ниже для точных действий. Если вы не знаете, кто является вашим хост-компьютером, см. поиск [регистратора доменных имен.](find-your-domain-registrar.md)
...
|[GoDaddy](../dns/create-dns-records-at-godaddy.md)|[ DNS на основе Windows](../dns/create-dns-records-using-windows-based-dns.md)   |
