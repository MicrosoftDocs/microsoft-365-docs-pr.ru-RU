...
Вы можете добавлять DNS-записи и управлять ими с помощью средств администрирования на узле домена, а также предоставлять Office 365 управлять записями домена, а также настраивать их.
...
||
|---|---|
|[1&1 ИОНОС](../dns/change-nameservers-at-1-1-internet.md) |
|[Amazon Web Services (AWS)](../dns/change-nameservers-at-aws.md) |
 [Bluehost](../dns/change-nameservers-at-bluehost.md)|
|[Домены Google](../dns/change-nameservers-at-google-domains.md) |
...
|                           |                          |
|---------------------------|--------------------------|
| [1&1 ИОНОС](../dns/create-dns-records-at-1-1-internet.md) | [Hover](../dns/create-dns-records-at-hover.md) |
| [123-reg.co.uk](../dns/create-dns-records-at-123-reg-co-uk.md) | [Управляется Google (eNom Central)](../dns/create-dns-records-for-domain-managed-by-google-enom.md)|
...
[Мне нужны общие инструкции, так как узел домена не включен в этот список.](create-dns-records-at-any-dns-hosting-provider.md)
