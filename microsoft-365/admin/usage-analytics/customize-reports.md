...
2. Введите режим редактирования, выбрав кнопку **Редактирование** сверху с помощью кнопки ![ "Больше страницы" в кнопке Power ](../../media/d8da3c19-3f2d-4bf6-811e-faa804f74770.png) BI. 
...
2. Переключиться на режим редактирования, выбрав кнопку "Больше страницы" ![ в Power BI и ](../../media/d8da3c19-3f2d-4bf6-811e-faa804f74770.png) **Edit**. 
...
12. Чуть ниже списка визуализаций выберите значок **Формат** формата в ![ Power BI Visualizaions ](../../media/ee0602f3-3df5-4930-b862-db1d90ae4ae2.png) .
...
Вы можете начать с подключения непосредственно к API отчетов ODATA от Microsoft 365, которые питания этих отчетов.
...
3. Введите учетные данные администратора Microsoft 365 (организация или школа) для проверки подлинности в Microsoft 365 при запросе.
    
    Дополнительные сведения о том, кому разрешен доступ к отчетам по шаблонам microsoft 365, см. в [faq.ru.](usage-analytics.md#faq) 
...
### <a name="use-the-microsoft-365-usage-analytics-template"></a>Используйте шаблон аналитики использования Microsoft 365

В качестве отправной точки для подключения к данным можно также использовать файл шаблона Power BI, соответствующий отчетам аналитики использования Microsoft 365. Преимущество использования этого PBIT-файла заключается в том, что строка подключения уже задана. Кроме того, вы можете применять готовые настраиваемые меры в дополнение к тем, которые возвращаются основной схемой, и уточнять их.
  
Вы можете скачать файл шаблона Power BI из [Центра загрузки Майкрософт](https://download.microsoft.com/download/7/8/2/782ba8a7-8d89-4958-a315-dab04c3b620c/Microsoft%20365%20Usage%20Analytics.pbit). После загрузки файла шаблона Power BI выполните следующие действия, чтобы начать работу:
