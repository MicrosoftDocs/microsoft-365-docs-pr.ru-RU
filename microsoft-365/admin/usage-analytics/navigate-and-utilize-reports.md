...
- [Предоставление общего доступа к панели мониторинга и отчетам](https://docs.microsoft.com/power-bi/service-share-dashboards)
    ...
    Узнайте, как делиться отчетами с коллегами или людьми за пределами вашей организации. Вы также можете поделиться отчетом или отфильтрованной версией отчета.
