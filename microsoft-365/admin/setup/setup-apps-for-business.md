...
3. На первой странице будет предоставлена возможность установить приложения Office на своем компьютере. Это также можно сделать позже.
...
Вам нужны более подробные инструкции или сведения об установке 64-разрядной версии Office? Ознакомьтесь с [пошаговыми инструкциями по установке](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658#BKMK_InstallSteps).
