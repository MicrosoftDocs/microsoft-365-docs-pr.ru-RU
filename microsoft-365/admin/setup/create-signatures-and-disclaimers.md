...
# <a name="create-organization-wide-signatures-and-disclaimers"></a>Создание подписей на уровне Организации и заявления об отказе
 ...
 Вы можете управлять подписями электронной почты, добавив подпись электронной почты, Юридический отказ или раскрытие сообщений в сообщения электронной почты, которые вводят или выходят из Организации. Эта подпись может применяться ко всем входящим и исходящим сообщениям (см. инструкции ниже) или выборочно, например лишь к тем сообщениям, которые содержат определенные слова или текстовые шаблоны.
...
1. Выберите средство запуска приложений ![ и значок запуска приложений ](../../media/7502f4ec-3c9a-435d-a7b4-b9cda85189a7.png) , а затем выберите элемент **Администратор**.
    ...
    Не можете найти приложение, которое ищете? В средстве запуска приложений выберите **все приложения** , чтобы просмотреть алфавитный список доступных вам приложений. Оттуда вы можете искать определенное приложение. 
...
При управлении подписями электронной почты в Microsoft 365 вы не можете выполнять следующие действия:
...
Для получения данных и других возможностей по управлению подписями электронной почты используется сторонний инструмент. Выполните поиск **по программному обеспечению для подписи электронной почты** в Интернете. У некоторых из этих поставщиков есть золотых партнеров Майкрософт, и их программное обеспечение предоставляет эти возможности. 
  
## <a name="more-resources"></a>Дополнительные ресурсы

- Сведения об использовании PowerShell [можно найти в статье заявление об отказе, подписи или колонтитулы в Exchange Online для всей Организации](https://docs.microsoft.com/exchange/security-and-compliance/mail-flow-rules/disclaimers-signatures-footers-or-headers) .