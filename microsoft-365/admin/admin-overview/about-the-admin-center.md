...
**Если вы пользователь или у вас есть план для семьи Microsoft 365,** у вас нет центра администрирования. Чтобы настроить Microsoft 365, перейдите в окн. скачать и установить или переустановить [Microsoft 365 или Office 2019 на КОМПЬЮТЕРе или Mac.](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658)
...
2. В левом верхнем углу щелкните значок средства запуска приложений и выберите элемент **Администрирование**.
    ...
    **Плитка** администрирования отображается только для людей с разрешениями администратора Microsoft 365. [](../add-users/about-admin-roles.md) Если вы не видите плитку, у вас нет разрешений на доступ к Центру администрирования организации.
...
|**Меню**|**Назначение**|
|-----|-----|
|**Главная** <br/> |Это ничная страница в Центре администрирования. Здесь есть команды для управления пользователями, выставления счетов, просмотра сведений о работоспособности служб и отчетов.  <br/> |
...
|**Группы** <br/> |Создавайте и управляйте группами в организации, такими как группа Microsoft 365, группа рассылки, группа безопасности или общий почтовый ящик. Узнайте, как [создавать](../create-groups/create-groups.md) группы и [управлять](../create-groups/manage-groups.md) ими.  <br/> |
...
|**Отчеты** <br/> |Посмотрите, как ваша организация использует Microsoft 365 с подробными отчетами об использовании электронной почты, активациях Office и других службах. Узнайте, как использовать новые [отчеты об активности.](../activity-reports/activity-reports.md)<br/> |
...
- Управление пользователями: добавление пользователей и [назначение лицензий](../add-users/add-users.md) [одновременно,](../add-users/delete-a-user.md)удаление или восстановление пользователей или сброс пароля [пользователя.](../add-users/reset-passwords.md)
