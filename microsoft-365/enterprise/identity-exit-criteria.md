...
Прежде чем перейти к шагу 3, убедитесь, что используемая вами инфраструктура идентификации соответствует указанным ниже требованиям. Дополнительные рекомендации касательно инфраструктуры идентификации см. в статье о [необходимых компонентах](https://docs.microsoft.com/microsoft-365-enterprise/identity-access-policies#prerequisites).
...
|||
|:-------|:-----|
|![](./media/deploy-foundation-infrastructure/win10enterprise_icon-small.png)| Следующий шаг процесса сквозного развертывания Microsoft 365 корпоративный — [Windows 10 Корпоративная](windows10-infrastructure.md). |
