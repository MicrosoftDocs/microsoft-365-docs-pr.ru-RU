...
Хотя Microsoft 365 для предприятий и предназначено для крупных организаций, его также может использовать для средних и малых предприятий, которым необходимы самые передовые средства обеспечения безопасности и производительности. 
...
| Службы | Описание |
|:-------|:-----|
| Локальные и облачные приложения, а также службы для повышения производительности | Включает приложения Microsoft 365 для предприятий, новейшие приложения Office для вашего компьютера и Mac (например, Word, Excel, PowerPoint, Outlook и другие), а также полный набор веб-служб для электронной почты, хранения файлов и совместной работы, собраний и многих других задач. |
| Windows 10 Корпоративная | Удовлетворяет потребности как крупных, так и средних организаций, предоставляя пользователям наиболее эффективную и безопасную версию Windows, а ИТ-специалистам — полноценные средства управления развертыванием, устройствами и приложениями. |
| Управление устройствами и службы расширенной безопасности | Включает Microsoft Intune — облачную службу управления корпоративной мобильностью (EMM), которая повышает производительность труда персонала, при этом обеспечивая защиту данных организации. |
|||
...
|:-------|:-----|
| E3 | Получите доступ к основным продуктам и функциям Microsoft 365 для повышения производительности труда и безопасного внедрения инноваций. |
| E5 | Доступ к новейшим продуктам и функциям Microsoft 365, в том числе к средствам расширенной защиты от угроз, обеспечения безопасности и совместной работы. Включает все возможности E3, а также расширенные инструменты безопасности, голосовой связи и анализа данных. |
| F3 | Специализированные инструменты и ресурсы для сотрудников без компьютеров, которые помогут им трудиться с максимальной отдачей. |
|||
...
Эти продукты содержат дополнительные функции, которые включены в Microsoft 365 E5.
...
- Ключевые компоненты современного рабочего места, которые обеспечивает Microsoft 365 для предприятий
...
Чтобы скачать копию плаката, щелкните [здесь](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/Microsoft365Enterprise.pdf).
...
Этот двухстраничный плакат содержит быстрый способ определения элементов существующей инфраструктуры, получения руководства и перехода на соответствующий продукт или службу в Microsoft 365 для предприятий. На нем представлены продукты Windows и Office, а также другие элементы инфраструктуры и безопасности, например управление устройствами, удостоверения, защита информации и защита от угроз.
...
2. С помощью службы Microsoft Consulting Services или [партнера Microsoft](https://partner.microsoft.com/).

   Консультанты могут проанализировать вашу текущую инфраструктуру и помочь вам разработать план внедрения всего программного обеспечения и всех служб Microsoft 365 для предприятий.

3. Сделайте сами

   Начните со[стратегии развития сети](networking-roadmap-microsoft-365.md), чтобы выстроить или проверить существующую инфраструктуру и рабочие нагрузки для повышения производительности. 

См. статью с описанием показательного примера развертывания Microsoft 365 для предприятий в [корпорации Contoso](contoso-overview.md) — вымышленной глобальной организации.
...
Пройдите обучение и начните работать над сертификацией Microsoft 365. Начните с раздела[Основы Microsoft 365](https://docs.microsoft.com/learn/paths/m365-fundamentals/).
