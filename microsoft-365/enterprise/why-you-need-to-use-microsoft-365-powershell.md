...
## <a name="powershell-for-microsoft-365-can-reveal-information-that-you-cant-see-with-the-microsoft-365-admin-center"></a>PowerShell для Microsoft 365 может раскрывать сведения, которые вы не можете увидеть в центре администрирования Microsoft 365.

Центр Microsoft 365 администратора отображает множество полезных сведений. Но в нем не отображаются все возможные сведения, Microsoft 365 о пользователях, лицензиях, почтовых ящиках и сайтах. Вот пример для пользователей *и* групп в центре администрирования Microsoft 365:
...
В этом представлении содержится необходимая во многих случаях информация. Тем не менее, есть моменты, когда вам нужно больше. Например, Microsoft 365 лицензирование (и Microsoft 365, доступные пользователю) частично зависит от географического расположения пользователя. Политики и функции, которые можно распространить на пользователя, который живет в США, могут быть не теми, которые можно распространить на пользователя в Индии или Бельгии. Выполните следующие действия в центре администрирования Microsoft 365, чтобы определить географическое расположение пользователя:
...
Но если в большом наборе других вещей необходимо изменить многое или некоторые выбранные вещи, центр администрирования Microsoft 365 может оказаться не самым лучшим средством. Например, скажите, что необходимо изменить префикс на тысячах номеров телефонов или удалить определенного пользователя *Кена Myer* со всех SharePoint веб-сайтов. Как это сделать в центре Microsoft 365 администрирования?
  
В последнем примере скажем, что у вас несколько SharePoint веб-сайтов, и вы не знаете, какие из них Кен Мейер является членом. Вам придется начать с центра администрирования Microsoft 365 и выполнить эту процедуру для каждого сайта:
...
Чтобы сохранить эти сведения в файле, необходимо вклеить их в документ или Microsoft Excel таблицу. В любом случае может потребоваться дополнительное форматирование. Кроме того, Microsoft 365 центра администрирования не предоставляет способ непосредственной печати отображаемого списка.
...
Вы не можете легко создать такой отчет в центре Microsoft 365 администрирования. Вместо этого необходимо создать отдельный документ для хранения информации, например Excel таблицы. Затем получите все имена пользователей и сведения о лицензировании из центра администрирования Microsoft 365, получите сведения об почтовых ящиках из центра администрирования Exchange, получите сведения Skype для бизнеса Online из центра администрирования Skype для бизнеса Online, а затем объединяйте эти сведения.
