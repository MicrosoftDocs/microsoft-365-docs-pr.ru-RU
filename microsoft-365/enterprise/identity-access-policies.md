...
Чтобы создать новую политику защиты приложений, войдите на портал Microsoft Azure с помощью учетных данных администратора, а затем перейдите к **мобильным приложениям > политик защиты приложений**. Нажмите кнопку **Добавить политику**.
...
Чтобы создать политики соответствия требованиям устройств, войдите на портал Microsoft Azure с помощью учетных данных администратора, а затем перейдите в раздел **Intune > соответствие требованиям устройств**. Выберите **создать политику**.
...
**Пакет ATP для защитника Майкрософт**

|Type|Элемент Property|Значения|"Заметки"|
|:---|:---------|:-----|:----|
|Правила Advanced Threat Protection в защитнике Майкрософт|Потребовать, чтобы устройство было в показателе риска или на уровне машины|Средняя||
