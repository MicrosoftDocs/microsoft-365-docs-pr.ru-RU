...
ms.locfileid: "47358030"
---
# <a name="common-identity-and-device-access-policies"></a>Основные политики доступа для удостоверений и устройств
В этой статье описываются распространенные рекомендуемые политики для защиты доступа к облачным службам, в том числе локальные приложения, опубликованные с помощью прокси-сервера приложения Azure Active Directory (Azure AD). 
...
После регистрации пользователей можно включить MFA для входа.

Чтобы создать новую политику условного доступа, выполните указанные ниже действия. 
...
|Облачные приложения или действия|Include| **Выберите приложения**: выберите приложения, к которым необходимо применить это правило. Например, выберите Exchange Online.||
...
Наконец **, выберите** включить, чтобы **включить политику**.
...
||Требовать многофакторную идентификацию|Неверно||
||Требовать, чтобы устройство было помечено как соответствующее требованиям|Неверно||
||Требуется гибридное устройство, подключенное к Azure AD|Неверно||
