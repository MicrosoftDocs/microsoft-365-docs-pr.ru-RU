...
1. Используя частный экземпляр Интернет браузера, войдите на портал Office, [https://office.com](https://office.com) используя учетную запись глобального администратора для пробной подписки Office 365 и Office:
