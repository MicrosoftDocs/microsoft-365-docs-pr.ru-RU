...
3. Создание меток Azure Information Protection и их настройка для различных уровней информации

   В компании Contoso изменили метки Azure Information Protection, используемые по умолчанию, добавив в метки названия, соответствующие уровням данных. Кроме того, специалисты компании настроили метки Sensitive (Конфиденциальная информация) и Highly regulated (Строго регулируемая информация) для шифрования информации с помощью облачного ключа Azure. Специалисты создали метки второго уровня для метки Highly regulated (Строго регулируемая информация) для определенных типов секретных коммерческих данных и ограничили доступ к этим данным, оставив его только для ряда исследовательских и конструкторских групп. Специалисты компании Contoso также развернули Azure Information Protection на всех компьютерах и устройствах с ОС Windows.
...
4. Создание защищенных сайтов SharePoint Online для конфиденциальных и строго контролируемых данных с разрешениями, блокирующими доступ
   ...
   Сайты с конфиденциальной и строго контролируемой информацией были настроены в качестве [изолированных сайтов](https://docs.microsoft.com/office365/enterprise/isolated-sharepoint-online-team-sites), на которых исходные разрешения для сайтов групп SharePoint Online, используемые по умолчанию, были изменены на группы Azure AD. Кроме того, для сайтов SharePoint Online с конфиденциальной и строго контролируемой информацией была настроена метка Office 365, используемая по умолчанию. Файлы, которые хранятся на сайтах SharePoint Online с конфиденциальной и строго контролируемой информацией, защищены с помощью вложенной метки Azure Information Protection (AIP) для политики области. Для получения дополнительных сведений см. сценарий [Сайты Microsoft Teams и SharePoint Online для жестко регламентированных данных](teams-sharepoint-online-sites-highly-regulated-data.md).

5.  Перенос данных с локальных сайтов SharePoint и файловых ресурсов на новые сайты SharePoint Online компании

    Специалисты компании перенесли файлы на новые сайты SharePoint Online, которые унаследовали метки Office 365, используемые по умолчанию и назначенные сайтам.

6.  Обучение сотрудников порядку использования меток Azure Information Protection для новых документов, взаимодействию с ИТ-подразделением компании Contoso при создании сайтов SharePoint Online и постоянному хранению цифровых активов на сайтах SharePoint Online

    После обдумывания самой сложной части, касающейся переноса системы защиты информации в облако, ИТ-специалистам и руководителям компании Contoso потребовалось изменить плохие привычки сотрудников организации, связанные с хранением информации. Для этого было установлено требование всегда присваивать метки цифровым ресурсам и никогда не использовать локальные файловые ресурсы.
...
- Политики защиты приложений указывают, какие приложения разрешены и какие действия эти приложения могут выполнять над данными вашей организации.
...
| Уровень 1: базовая защита  | Политики условного доступа для SharePoint Online и Exchange Online <BR> Разрешения на сайтах SharePoint Online | Клиент Azure Information Protection <BR> BitLocker <BR> Windows Information Protection | Политики условного доступа для устройств и политики управления мобильными приложениями |
| Уровень 2: защита высококонфиденциальной информации | Уровень 1: расширенная базовая защита <BR> <BR> Метки Azure Information Protection <BR> Метки Office 365 на сайтах SharePoint Online <BR> Система защиты от потери данных в Office 365 для SharePoint Online и Exchange Online <BR> Изолированные сайты SharePoint Online  | Уровень 1: расширенная базовая защита <BR> <BR> Метки Azure Information Protection для цифровых ресурсов <BR> Расширенное управление данными Office 365 | Уровень 1: базовая защита |
| Уровень 3: защита строго контролируемой информации | Уровень 2: расширенная защита высококонфиденциальной информации <BR><BR> Шифрование Bring Your Own Key (BYOK) и защита секретной коммерческой информации <BR> Azure Key Vault для бизнес-приложений, взаимодействующих со службами Office 365 | Уровень 2: защита высококонфиденциальной информации | Уровень 1: базовая защита |
|||||
