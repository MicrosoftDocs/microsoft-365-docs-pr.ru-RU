...
Если в данный момент в вашей среде нет службы "Аналитика компьютеров" либо вы хотите зарегистрироваться, чтобы использовать пробную версию, перейдите на страницу Аналитики компьютеров](http://www.aka.ms/desktopanalytics) и начните работу.
