...
---
# <a name="policy-recommendations-for-securing-email"></a><span data-ttu-id="9964f-103">Рекомендуемые политики для защиты электронной почты</span><span class="sxs-lookup"><span data-stu-id="9964f-103">Policy recommendations for securing email</span></span>
<span data-ttu-id="9964f-p101">В этой статье описывается, как реализовать рекомендуемые удостоверения и политики доступа устройств для защиты электронной почты организации и клиентами электронной почты, которые поддерживают современных проверки подлинности и условного доступа. Данное руководство построена на [Общие удостоверения и устройства для доступа к политик](identity-access-policies.md) , а также некоторые дополнительные рекомендации.</span><span class="sxs-lookup"><span data-stu-id="9964f-p101">This article describes how to implement the recommended identity and device access policies to protect organizational email and email clients that support modern authentication and conditional access. This guidance builds on the [Common identity and device access policies](identity-access-policies.md) and also includes a few additional recommendations.</span></span>


<span data-ttu-id="9964f-p102">Эти рекомендации основаны на три разных уровня безопасности и защиты, могут быть применены на основании детализации вашим требованиям: **Базовое** **конфиденциальных**и **сильно регулируемого**. Дополнительные сведения об этих уровней безопасности и рекомендуемые клиентские операционные системы, ссылается этим рекомендациям в [рекомендуется введение политик и конфигураций безопасности](microsoft-365-policies-configurations.md).</span><span class="sxs-lookup"><span data-stu-id="9964f-p102">These recommendations are based on three different tiers of security and protection that can be applied based on the granularity of your needs: **baseline**, **sensitive**, and **highly regulated**. You can learn more about these security tiers, and the recommended client operating systems, referenced by these recommendations in the [recommended security policies and configurations introduction](microsoft-365-policies-configurations.md).</span></span>

<span data-ttu-id="9964f-p103">Эти рекомендации требовать, чтобы пользователи для использования клиентами современных электронной почты, включая Outlook для iOS и Android на мобильных устройствах. Outlook для iOS и Android обеспечивают поддержку наиболее функциональные возможности Office 365. Эти мобильные приложения Outlook также архитектурой безопасности используйте возможности, которые обеспечивают мобильных устройств и совместной работы с других возможностей безопасности Microsoft cloud. Дополнительные сведения см в [Outlook для операций ввода-вывода и вопросы и ответы по Android](https://docs.microsoft.com/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/outlook-for-ios-and-android-faq).</span><span class="sxs-lookup"><span data-stu-id="9964f-p103">These recommendations require your users to use modern email clients, including Outlook for iOS and Android on mobile devices. Outlook for iOS and Android provide support for the best features of Office 365. These mobile Outlook apps are also architected with security capabilities that support mobile use and work together with other Microsoft cloud security capabilities. For more information, see [Outlook for iOS and Android FAQ](https://docs.microsoft.com/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/outlook-for-ios-and-android-faq).</span></span>

## <a name="updating-common-policies-to-include-email"></a><span data-ttu-id="9964f-112">Обновление общих политик для включения электронной почты</span><span class="sxs-lookup"><span data-stu-id="9964f-112">Updating common policies to include email</span></span>
<span data-ttu-id="9964f-p104">На следующем рисунке показано распространенных удостоверения и устройства откройте политики и указывает, какие политики должны быть обновлены для защиты электронной почты. Обратите внимание, Добавление нового правила для Exchange Online для блокирования клиентов ActiveSync. Использование Outlook принудительное мобильных устройств.</span><span class="sxs-lookup"><span data-stu-id="9964f-p104">The following diagram illustrates the common identity and device access policies and indicates which policies need to be updated to protect email. Note the addition of a new rule for Exchange Online to block ActiveSync clients. This forces the use of Outlook mobile.</span></span>

![Сводка обновлений политики для защиты электронной почты](../images/identity-access-ruleset-mail.png)

<span data-ttu-id="9964f-p105">Если вы включили Exchange Online и Outlook в области политики при их настройке, необходимо создать новую политику для блокирования клиентов ActiveSync. Просмотрите политики, перечисленные в следующей таблице и либо дополнять рекомендуемые, или убедитесь, что они уже включен. Каждого правила ссылки на инструкции по настройке связанного в статье [распространенных политик доступа удостоверения и устройства](identity-access-policies.md) .</span><span class="sxs-lookup"><span data-stu-id="9964f-p105">If you included Exchange Online and Outlook in the scope of the policies when you set them up, you only need to create the new policy to block ActiveSync clients. Review the policies listed in the following table and either make the recommended additions, or confirm that these are already included. Each rule links to the associated configuration instructions in the [Common identity and device access policies](identity-access-policies.md) article.</span></span> 

|<span data-ttu-id="9964f-120">Уровень защиты</span><span class="sxs-lookup"><span data-stu-id="9964f-120">Protection level</span></span>|<span data-ttu-id="9964f-121">Политики.</span><span class="sxs-lookup"><span data-stu-id="9964f-121">Policies</span></span>|<span data-ttu-id="9964f-122">Дополнительные сведения</span><span class="sxs-lookup"><span data-stu-id="9964f-122">More information</span></span>|
|:---------------|:-------|:----------------|
|<span data-ttu-id="9964f-123">**Базовый уровень**</span><span class="sxs-lookup"><span data-stu-id="9964f-123">**Baseline**</span></span>|[<span data-ttu-id="9964f-124">После входа в риска *Средний* или *высокий* требуют многофакторной проверкой Подлинности</span><span class="sxs-lookup"><span data-stu-id="9964f-124">Require MFA when sign-in risk is *medium* or *high*</span></span>](identity-access-policies.md#require-mfa-based-on-sign-in-risk)|<span data-ttu-id="9964f-125">Включить Exchange Online в назначении облачных приложений</span><span class="sxs-lookup"><span data-stu-id="9964f-125">Include Exchange Online in the assignment of cloud apps</span></span>|
|        |[<span data-ttu-id="9964f-126">Блокировать клиенты, не поддерживающие современных проверки подлинности</span><span class="sxs-lookup"><span data-stu-id="9964f-126">Block clients that don't support modern authentication</span></span>](identity-access-policies.md#block-clients-that-dont-support-modern-authentication)|<span data-ttu-id="9964f-127">Включить Exchange Online в назначении облачных приложений</span><span class="sxs-lookup"><span data-stu-id="9964f-127">Include Exchange Online in the assignment of cloud apps</span></span>|
|        |[<span data-ttu-id="9964f-128">Определение политик защиты от приложения</span><span class="sxs-lookup"><span data-stu-id="9964f-128">Define app protection policies</span></span>](identity-access-policies.md#high-risk-users-must-change-password)|<span data-ttu-id="9964f-p106">Убедитесь, что Outlook включен в списке приложений. Не забудьте изменить политику для каждой платформы (операций ввода-вывода, Android, Windows)</span><span class="sxs-lookup"><span data-stu-id="9964f-p106">Be sure Outlook is included in the list of apps. Be sure to update the policy for each platform (iOS, Android, Windows)</span></span>|
|        |[<span data-ttu-id="9964f-131">Требовать одобренных приложений</span><span class="sxs-lookup"><span data-stu-id="9964f-131">Require approved apps</span></span>](identity-access-policies.md#require-approved-apps)|<span data-ttu-id="9964f-132">Включить Exchange Online в списке облачных приложений</span><span class="sxs-lookup"><span data-stu-id="9964f-132">Include Exchange Online in the list of cloud apps</span></span>|
|        |[<span data-ttu-id="9964f-133">Требовать спецификации ПК</span><span class="sxs-lookup"><span data-stu-id="9964f-133">Require compliant PCs</span></span>](identity-access-policies.md#require-compliant-pcs-but-not-compliant-phones-and-tablets)|<span data-ttu-id="9964f-134">Включить Exchange Online в список облачных приложений</span><span class="sxs-lookup"><span data-stu-id="9964f-134">Include Exchange Online in list of cloud apps</span></span>|
|        |[<span data-ttu-id="9964f-135">Блокировать ActiveSync клиентов</span><span class="sxs-lookup"><span data-stu-id="9964f-135">Block ActiveSync clients</span></span>](#block-activesync-clients)|<span data-ttu-id="9964f-136">Добавление этой новой политики</span><span class="sxs-lookup"><span data-stu-id="9964f-136">Add this new policy</span></span>| 
|<span data-ttu-id="9964f-137">**Конфиденциальный**</span><span class="sxs-lookup"><span data-stu-id="9964f-137">**Sensitive**</span></span>|[<span data-ttu-id="9964f-138">После входа в риска *низкий*, *Средний* или *высокий* требуют многофакторной проверкой Подлинности</span><span class="sxs-lookup"><span data-stu-id="9964f-138">Require MFA when sign-in risk is *low*, *medium* or *high*</span></span>](identity-access-policies.md#require-mfa-based-on-sign-in-risk)| <span data-ttu-id="9964f-139">Включить Exchange Online в назначении облачных приложений</span><span class="sxs-lookup"><span data-stu-id="9964f-139">Include Exchange Online in the assignment of cloud apps</span></span>|
|         |[<span data-ttu-id="9964f-140">Требовать спецификации ПК *и* мобильных устройств.</span><span class="sxs-lookup"><span data-stu-id="9964f-140">Require compliant PCs *and* mobile devices</span></span>](identity-access-policies.md#require-compliant-pcs-and-mobile-devices)|<span data-ttu-id="9964f-141">Включить Exchange Online в списке облачных приложений</span><span class="sxs-lookup"><span data-stu-id="9964f-141">Include Exchange Online in the list of cloud apps</span></span>|
|<span data-ttu-id="9964f-142">**Строго регулируемый уровень**</span><span class="sxs-lookup"><span data-stu-id="9964f-142">**Highly regulated**</span></span>|[<span data-ttu-id="9964f-143">*Всегда* требовать многофакторной проверкой Подлинности</span><span class="sxs-lookup"><span data-stu-id="9964f-143">*Always* require MFA</span></span>](identity-access-policies.md#require-mfa-based-on-sign-in-risk)|<span data-ttu-id="9964f-144">Включить Exchange Online в назначении облачных приложений</span><span class="sxs-lookup"><span data-stu-id="9964f-144">Include Exchange Online in the assignment of cloud apps</span></span>|

## <a name="block-activesync-clients"></a><span data-ttu-id="9964f-145">Блокировать ActiveSync клиентов</span><span class="sxs-lookup"><span data-stu-id="9964f-145">Block ActiveSync clients</span></span>
<span data-ttu-id="9964f-p107">Эта политика запрещает обход другие правила условного доступа клиентов ActiveSync. Конфигурация правило применяется только к клиентов ActiveSync. Выбрав **требуют утвержденных клиентского приложения**, эта политика блокирует клиентов ActiveSync. Чтобы настроить эту политику.</span><span class="sxs-lookup"><span data-stu-id="9964f-p107">This policy prevents ActiveSync clients from bypassing other conditional access rules. The rule configuration applies only to ActiveSync clients. By selecting **Require approved client app**, this policy blocks ActiveSync clients. To configure this policy:</span></span>

1. <span data-ttu-id="9964f-p108">Перейдите в [Azure портала](https://portal.azure.com)и выполнить вход. После того как вы успешно выполнили вход, вы изучите Azure панели мониторинга.</span><span class="sxs-lookup"><span data-stu-id="9964f-p108">Go to the [Azure portal](https://portal.azure.com), and sign in with your credentials. After you've successfully signed in, you see the Azure dashboard.</span></span>

2. <span data-ttu-id="9964f-152">В меню слева выберите **Azure Active Directory**.</span><span class="sxs-lookup"><span data-stu-id="9964f-152">Choose **Azure Active Directory** from the left menu.</span></span>

3. <span data-ttu-id="9964f-153">В разделе **Безопасность** выберите **Условный доступ**.</span><span class="sxs-lookup"><span data-stu-id="9964f-153">Under the **Security** section, choose **Conditional access**.</span></span>

4. <span data-ttu-id="9964f-154">Выберите **Создать политику**.</span><span class="sxs-lookup"><span data-stu-id="9964f-154">Choose **New policy**.</span></span>

5. <span data-ttu-id="9964f-155">Введите имя политики, а затем выберите **Пользователей и группы**, к которым нужно ее применить.</span><span class="sxs-lookup"><span data-stu-id="9964f-155">Enter a policy name, then choose the **Users and groups** you want to apply the policy for.</span></span>

6. <span data-ttu-id="9964f-156">Выберите **Облачные приложения**.</span><span class="sxs-lookup"><span data-stu-id="9964f-156">Choose **Cloud apps**.</span></span>

7. <span data-ttu-id="9964f-p109">Выберите команду **выбрать приложения**, выберите **Office 365 Exchange Online**. Нажмите кнопку **выбрать** и **сделано**.</span><span class="sxs-lookup"><span data-stu-id="9964f-p109">Choose **Select apps**, select **Office 365 Exchange Online**. Choose **Select** and **Done**.</span></span>

8. <span data-ttu-id="9964f-159">Выберите **условия**, а затем выберите **клиентских приложений**.</span><span class="sxs-lookup"><span data-stu-id="9964f-159">Choose **Conditions**, and then choose **Client apps**.</span></span>

9. <span data-ttu-id="9964f-p110">Для **настройки**нажмите кнопку **Да**. Проверьте следующие: **мобильных приложений и настольных клиентов** и **клиентов Exchange ActiveSync**. Нажмите кнопку **Готово**.</span><span class="sxs-lookup"><span data-stu-id="9964f-p110">For **Configure**, select **Yes**. Check only the following: **Mobile apps and desktop clients** and **Exchange ActiveSync clients**. Choose **Done**.</span></span>

10. <span data-ttu-id="9964f-163">Выберите **Предоставление** в разделе **Элементы управления доступом**.</span><span class="sxs-lookup"><span data-stu-id="9964f-163">Choose **Grant** from the **Access controls** section.</span></span>

11. <span data-ttu-id="9964f-p111">Нажмите кнопку **предоставить доступ**, выберите **Требовать утверждения клиентского приложения**.  Для нескольких элементов управления выберите **Требовать выбранные элементы управления**, а затем выберите команду **выбрать**.</span><span class="sxs-lookup"><span data-stu-id="9964f-p111">Choose **Grant access**, select **Require approved client app**.  For multiple controls, select **Require the selected controls**, then choose **Select**.</span></span> 

12. <span data-ttu-id="9964f-166">Нажмите кнопку **Создать**.</span><span class="sxs-lookup"><span data-stu-id="9964f-166">Choose **Create**.</span></span>

## <a name="setup-office-365-message-encryption"></a><span data-ttu-id="9964f-167">Настройка шифрования сообщений Office 365</span><span class="sxs-lookup"><span data-stu-id="9964f-167">Setup Office 365 message encryption</span></span>
<span data-ttu-id="9964f-p112">Благодаря новым функциям шифрования сообщений Office 365 (OME), которые использовать функции защиты в Azure защита информации, организации могут совместно использовать защищенный электронной почты с кем-либо на любом устройстве. Пользователи могут отправлять и принимать защищенные сообщения с другими организациями Office 365, а также клиенты Office 365 с помощью Outlook.com, Gmail и другие службы электронной почты.</span><span class="sxs-lookup"><span data-stu-id="9964f-p112">With the new Office 365 Message Encryption (OME) capabilities, which leverage the protection features in Azure Information Protection, your organization can easily share protected email with anyone on any device. Users can send and receive protected messages with other Office 365 organizations as well as non-Office 365 customers using Outlook.com, Gmail, and other email services.</span></span>

<span data-ttu-id="9964f-170">Дополнительные сведения можно [настроить новые возможности шифрования сообщений Office 365](https://support.office.com/article/set-up-new-office-365-message-encryption-capabilities-7ff0c040-b25c-4378-9904-b1b50210d00e).</span><span class="sxs-lookup"><span data-stu-id="9964f-170">For more information, see [Set up new Office 365 Message Encryption capabilities](https://support.office.com/article/set-up-new-office-365-message-encryption-capabilities-7ff0c040-b25c-4378-9904-b1b50210d00e).</span></span> 
...
## <a name="next-steps"></a><span data-ttu-id="9964f-171">Дальнейшие шаги</span><span class="sxs-lookup"><span data-stu-id="9964f-171">Next steps</span></span>

[<span data-ttu-id="9964f-172">Узнайте о рекомендуемых политиках для защиты сайтов и файлов SharePoint</span><span class="sxs-lookup"><span data-stu-id="9964f-172">Learn about policy recommendations for securing SharePoint Sites and files</span></span>](sharepoint-file-access-policies.md)
