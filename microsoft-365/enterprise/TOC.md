...
#### [Шаг 4: Настройка безопасной проверки подлинности пользователей](identity-multi-factor-authentication.md)
#### [Шаг 5: упрощение доступа для пользователей](identity-password-reset.md)
#### [Шаг 6: использование групп для упрощения управления](identity-self-service-group-management.md)
...
#### [Шаг 3: Настройка усиленной безопасности для Microsoft 365](infoprotect-configure-increased-security-office-365.md)
...
#### [Регистрация устройств iOS и Android](enroll-ios-and-android-devices-in-your-microsoft-enterprise-365-dev-test-environ.md)
#### [Политики соответствия требованиям устройств](mam-policies-for-your-microsoft-365-enterprise-dev-test-environment.md)
### [Защита информации]()
...
## [Этап 1. Проверка готовности устройств и приложений](step-1-device-and-app-readiness.md)
...
#### [Динамическо](../compliance/gdpr-dpia-dynamics.md)
