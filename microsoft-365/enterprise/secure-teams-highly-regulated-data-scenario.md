...
Полная настройка защищенной команды состоит из следующих этапов:
...
>[!Note]
>Если настроена метка конфиденциальности или вложенная метка для пользовательских разрешений или со сроком действия, вы не сможете открыть файл из Teams или SharePoint Online. Потребуется использовать приложение Office.
>

## <a name="using-the-team-and-a-sensitivity-label"></a>Использование команды и метки конфиденциальности
...
Вы можете узнать, каким файлам присвоены метки, просмотрев папку в SharePoint Online и добавив столбец **Конфиденциальность** с помощью параметра **Показать/скрыть столбцы** элемента **Добавить столбец**.
