...
<br>
<br>
План-график запуска Портала предназначен для того, чтобы помочь вам следовать поэтапному подходу к выкатыву, пакетив просмотры в волнах и управляя URL-адресами для нового портала. Во время запуска каждой волны можно собирать отзывы пользователей, отслеживать производительность портала и приостанавлить запуск, чтобы устранить проблемы перед началом следующей волны. Узнайте больше о планировании [запуска портала](https://docs.microsoft.com/microsoft-365/Enterprise/Planportallaunchroll-out?view=o365-worldwide)в SharePoint . 
...
Если вы планируете запустить портал с более чем 100 000 пользователей, отправьте запрос на поддержку после перечисленных ниже действий. Убедитесь в том, что вы включили всю необходимую информацию.
