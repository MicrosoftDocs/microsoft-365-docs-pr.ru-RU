...
Хотя вы можете использовать центр администрирования Microsoft 365, вы также можете использовать PowerShell для Microsoft 365 управления группами SharePoint веб-сайтов.
