...
> [!Note]
> Инструкции по установке модуля Azure Active Directory PowerShell для Graph и входу в систему в Office 365 см. в статье [Подключение к Office 365 PowerShell](https://docs.microsoft.com/office365/enterprise/powershell/connect-to-office-365-powershell).
...
1.  Создайте тестовую группу в доменных службах Active Directory (AD DS).
...
Если вы не выполните это требование, для сброса или разблокирования паролей AD DS пользователям, не подключенным к вашей локальной сети, придется обращаться к ИТ-администратору.
