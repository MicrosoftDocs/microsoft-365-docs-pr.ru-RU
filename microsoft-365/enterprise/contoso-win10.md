...
До широкого распространения Microsoft 365 для предприятия у Contoso были компьютеры и устройства, совместимые с Windows, со смесью Windows 7 (10%), Windows 8.1 (65%) и Windows 10 (25%). Contoso хотела обновить свои компьютеры для Windows 10 Enterprise, воспользовавшись расширенными преимуществами безопасности и снизив накладные расходы на ИТ-службы с автоматических развертывание обновлений. 
...
Contoso использовал готовность к обновлению в Windows Analytics для определения набора установленных приложений и их совместимости с Windows 10 Enterprise.
...
3. Используется Диспетчер конфигурации для развертывания пакетов Windows в точках распространения по всей сети, а развернутые сборки для трех групп проверки и развертывания.
...
5. На основе данных Windows Analytics Contoso определила версию Windows 10 Enterprise для развертывания в широкой группе развертывания.
6. Для развертывания выбранного пакета Windows в широкую группу развертывания запускать последовательности развертывания Диспетчер конфигурации.
7. Отслеживаются компьютеры и устройства в широкой группе развертывания с помощью решений для обеспечения соответствия требованиям к состоянию устройств и обновлению для устранения проблем.
...
- Компьютеры и устройства Windows в различных расположениях, которые получают и устанавливают пакеты развертывания для обновления на месте или текущих обновлений в зависимости от членства в группе.

## <a name="next-step"></a>Следующий шаг

Узнайте, как Contoso использует инфраструктуру Configuration Manager для развертывания и сохраняющихся [приложений Microsoft 365 для](contoso-o365pp.md) предприятия в организации. 

## <a name="see-also"></a>См. также

[Windows 10 Корпоративная](/windows/deployment/)
