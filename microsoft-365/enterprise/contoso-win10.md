...
До широкого распространения Microsoft 365 для предприятия у Contoso Windows компьютеры и устройства, совместимые с Windows 7 (10%), Windows 8.1 (65%) и Windows 10 (25%). Contoso хотела обновить свои компьютеры для Windows 10 Корпоративная, чтобы воспользоваться преимуществами расширенных систем безопасности и снизить накладные расходы на ИТ-службы от автоматического развертывания обновлений. 
...
Для определения набора установленных приложений и их совместимости с Windows Windows 10 Корпоративная Analytics contoso использовала Windows обновления.
...
3. Используется диспетчер конфигурации для развертывания Windows пакетов в точках распространения по всей сети, а развернутые сборки для трех групп проверки и развертывания.
...
5. На основе Windows аналитики Contoso определила версию Windows 10 Корпоративная для развертывания в широкую группу развертывания.
6. Чтобы развернуть выбранный пакет Windows в широкую группу развертывания, запустили последовательности задач развертывания Configuration Manager.
...
- Windows Компьютеры и устройства в различных расположениях, которые получают и устанавливают пакеты развертывания для обновления на месте или текущих обновлений в зависимости от членства в группе.

## <a name="next-step"></a>Следующий этап

Узнайте, как Contoso использует инфраструктуру Configuration Manager для развертывания и поддержания текущего Приложения Microsoft 365 для предприятий [всей](contoso-o365pp.md) организации. 
