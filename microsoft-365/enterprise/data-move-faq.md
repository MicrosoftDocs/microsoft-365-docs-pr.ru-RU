...
Это очень распространенный сценарий, который полностью поддерживается.  Миграция в облако между центрами обработки данных жеос не оказывает влияния на локальные и облачные миграции почтовых ящиков.
