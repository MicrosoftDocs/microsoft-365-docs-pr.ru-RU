...
|:---------------|:-------|:----------------|
|**Трудозатрат**|[Требовать, чтобы риск входа в систему был *средним* или *высоким*](identity-access-policies.md#require-mfa-based-on-sign-in-risk)|Включение SharePoint Online в назначение облачных приложений|
|        |[Блокировка клиентов, не поддерживающих современные проверки подлинности](identity-access-policies.md#block-clients-that-dont-support-modern-authentication)|Включение SharePoint Online в назначение облачных приложений|
...
|        |[Требовать соответствующие компьютеры](identity-access-policies.md#require-compliant-pcs-but-not-compliant-phones-and-tablets)|Включение SharePoint Online в список облачных приложений|
...
|**Строго регулируемая**|[*Всегда* требовать MFA](identity-access-policies.md#require-mfa-based-on-sign-in-risk)|Включение SharePoint Online в назначение облачных приложений|
