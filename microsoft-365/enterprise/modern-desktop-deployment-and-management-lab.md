---
title: Набор для лаборатории по развертыванию Windows и Office
f1.keywords:
- NOCSH
ms.author: josephd
...
- Облачный шлюз управления & облачной точки распространения 
...
- Обслуживание Windows 10 с помощью диспетчера конфигураций   
...
- Набор средств обеспечения готовности для Office  
- Упаковка и преобразование приложений Win32 в КОНТЕЙНЕРИЗАЦИЯ   

### <a name="deploy-windows-10"></a>Развертывание Windows 10   
- Последовательности задач развертывания ОС в диспетчере конфигураций
- Последовательности задач развертывания ОС в MDT   
- Windows Autopilot
...
- Управляемое облачное развертывание  
- Локальное управляемое развертывание    
- Приложения Microsoft 365 для корпоративного развертывания на устройствах, не подключенных к AD 
- Управляемое развертывание Enterprise с помощью диспетчера конфигураций
- Управляемое развертывание предприятия с помощью Microsoft Intune  
- БИЗНЕС-развертывание и управление с помощью Microsoft Intune
