...
Каждая подписка Microsoft 365 состоит из следующих элементов:

- **Планы лицензирования** Они также известны как планы лицензий или планы Microsoft 365. Планы лицензирования определяют службы Microsoft 365, доступные пользователям. Подписка на Microsoft 365 может содержать несколько планов лицензирования. Примером плана лицензирования является Microsoft 365 E3.
    
- **Службы** Они также называются планами службы. Службы — это продукты, функции и возможности Microsoft 365, доступные в каждом плане лицензирования, например Exchange Online и Microsoft 365 Apps для предприятия (ранее названные Office 365 ProPlus). Пользователям может быть назначено несколько лицензий из различных планов лицензирования, дающих доступ к различным службам.
...
Вы можете использовать PowerShell для Microsoft 365 для просмотра сведений о доступных планах лицензирования, лицензиях и службах в организации Microsoft 365. Дополнительные сведения о продуктах, особенностях и службах, доступных в различных подписках Office 365, см. в [журнале Office 365 Plan Options.](/office365/servicedescriptions/office-365-platform-service-description/office-365-plan-options)
...
- **SkuPartNumber:** Отображает доступные планы лицензирования для вашей организации. Например, `ENTERPRISEPACK` это имя плана лицензии для Office 365 Enterprise E3.
...
Чтобы просмотреть сведения о службах Microsoft 365, доступных во всех планах лицензий, сначала отобразите список планов лицензии.
...
>[!Note]
>Кроме того, вы можете воспользоваться сценарием PowerShell, который автоматизирует выполнение процедур, описанных в этой статье. В частности, скрипт позволяет просматривать и отключать службы в организации Microsoft 365, включая Sway. Дополнительные сведения см. [в обзоре Отключение доступа к Sway с Помощью PowerShell.](disable-access-to-sway-with-microsoft-365-powershell.md)
>
...
Чтобы просмотреть сведения о службах Microsoft 365, доступных во всех планах лицензий, запустите следующую команду:
...
В этом примере показаны службы, доступные в плане лицензирования litwareinc:ENTERPRISEPACK (Office 365 Enterprise E3).
