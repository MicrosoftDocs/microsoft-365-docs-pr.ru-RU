...
- [Функции обнаружения электронных данных и поиска](microsoft-365-ediscovery-and-search-features.md)
- [Функции создания отчетов в Microsoft 365](microsoft-365-reporting-features.md)
- [API действий управления Microsoft 365](microsoft-365-management-activity-api.md)
- [Перенос почтовых ящиков Microsoft 365](microsoft-365-mailbox-migrations.md)
- [Внутренняя регистрация для инженеров Microsoft 365](microsoft-365-internal-logging.md)
