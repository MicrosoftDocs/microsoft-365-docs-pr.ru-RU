...
Справочные Azure Active Directory PowerShell для Graph смдлетов находятся в справочном разделе [Azure Active Directory PowerShell для Graph документации](/powershell/azure/active-directory/install-adv2).

Модуль Azure Active Directory для справочных тем Windows PowerShell командлета находится в справочном разделе документации Azure Active Directory [MSOnline.](/powershell/azure/active-directory/overview)
