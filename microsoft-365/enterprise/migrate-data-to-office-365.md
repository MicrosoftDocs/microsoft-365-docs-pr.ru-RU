---
title: Перенос данных организации в Microsoft 365 Enterprise
ms.author: josephd
...
description: В этой статье будут ресурсы, которые помогут перенести данные организации в Microsoft 365.
ms.openlocfilehash: 084cd4f6b89cfa1b8c5ad89fade3f01a0bf53dce
ms.sourcegitcommit: 27b2b2e5c41934b918cac2c171556c45e36661bf
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/19/2021
ms.locfileid: "50924076"
---
# <a name="migrate-your-organization-data-to-microsoft-365-enterprise"></a>Перенос данных организации в Microsoft 365 Enterprise

## <a name="ready-to-migrate-your-data-to-microsoft-365"></a>Готовы перенести данные в Microsoft 365?

Наши [основные инструкции по](https://support.office.com/article/Set-up-Office-365-for-business-6a3a29a0-e616-4713-99d1-15eda62d04fa) настройкам помогут вам получить всех, кто использует службы и приложения Microsoft 365 в кратчайшие сроки. Это пропускает гибридные сценарии и более продвинутые методы для миграции в Microsoft 365. 
  
Если вам нужна помощь в настройке Microsoft 365, [FastTrack](https://fasttrack.microsoft.com/office) — это самый простой способ развертывания Microsoft 365, вы также можете войти и использовать руководство по настройке для служб [Microsoft 365.](setup-guides-for-microsoft-365.md)

## <a name="migrate-email-to-microsoft-365"></a>Перенос электронной почты в Microsoft 365
- Миграция с гибридной версией Exchange с помощью [помощника развертывания Exchange.](https://technet.microsoft.com/exdeploy2013) (Администратор)
...
- [Миграция в SharePoint Online и OneDrive.](/sharepointmigration/migrate-to-sharepoint-online) (Администратор)
- [Дорожные карты гибридной конфигурации SharePoint Server.](/SharePoint/hybrid/configuration-roadmaps) (Администратор)

## <a name="migrate-skype-for-business-users"></a>Миграция пользователей Skype для бизнеса
- [Миграция на Skype для бизнеса Online](/SkypeForBusiness/hybrid/move-users-between-on-premises-and-cloud?bc=%2fSkypeForBusiness%2fbreadcrumb%2ftoc.json&toc=%2fSkypeForBusiness%2ftoc.json). (Администратор)
