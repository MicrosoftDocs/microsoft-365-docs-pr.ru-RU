...
- Microsoft 365 Сайты, связанные с группой, в том числе связанные с Microsoft Teams
...
### <a name="sync-app"></a>Синхронизация приложения

Приложение синхронизации автоматически обнаруживает и плавно переносит синхронизацию на новое расположение сайта после завершения перемещения сайта. Пользователю не нужно выполнять повторный вход или любые другие действия. (Версия 17.3.6943.0625 или более поздней версии требуемого приложения синхронизации.)

Если пользователь обновляет файл во время перемещения, приложение синхронизации уведомляет его о том, что загрузка файлов ожидается во время перемещения.
