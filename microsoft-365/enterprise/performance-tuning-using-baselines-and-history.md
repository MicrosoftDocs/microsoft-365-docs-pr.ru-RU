...
Если вы не привыкли работать над вопросами производительности, эта статья предназначена для того, чтобы помочь вам рассмотреть некоторые распространенные вопросы, например как узнать о проблеме производительности, а не об инциденте Office 365 службы? Как планировать хорошую производительность, долгосрочную перспективу? Как следить за производительностью? Если ваша команда или клиенты видят медленную производительность при использовании Office 365, и вы задайте вопрос о любом из этих вопросов, прочитайте далее.
...
Office 365 в высокой емкости выделенной сети Майкрософт, которая постоянно контролируется не только автоматизацией, но и реальными людьми. Часть роли сохранения облачного Office 365 заключается в настройке производительности и оптимизации в тех случаях, когда это возможно. Поскольку клиенты Office 365 должны подключаться через Интернет, необходимо постоянно настраивать производительность в Office 365 службах. Улучшения производительности никогда не останавливаются в облаке, и существует большой опыт по поддержанию работоспособности и быстрости облака. Если вы испытываете проблему производительности, соединяющуюся с вашим расположением Office 365, лучше не начинать с и ждать, чтобы поддерживать дело. Вместо этого следует приступить к исследованию проблемы из "изнутри". То есть запустите внутри своей сети и отработать путь к Office 365. Прежде чем открыть дело с Office 365 службой поддержки, вы можете собрать данные и принять меры, которые будут изучать и могут устранять проблему.
...
Если у Office 365-службы возникли проблемы, это инцидент службы. Вы увидите красные или  желтые значки в текущих работоспособности в Центр администрирования Microsoft 365, вы также можете заметить медленную производительность на клиентских компьютерах, подключающихся к Office 365. Например, если текущее состояние здоровья сообщает  красный значок и вы видите исследование рядом с Exchange, вы также можете получить кучу звонков от людей в организации, которые жалуются, что клиентские почтовые ящики, Exchange Online используют плохо. В этом случае разумно предположить, что Exchange Online производительность только что стала жертвой проблем в службе. 
...
-  Если проблема является прерывной, по-прежнему существует шаблон, например, вы знаете, что к 10:00 утра у вас будут звонки от пользователей, которые не могут надежно получить доступ Office 365, и что вызовы будут умирать около полудня. 
