...
В компании Contoso следуют указанным ниже [принципам сетевого подключения для Microsoft 365](https://docs.microsoft.com/office365/enterprise/office-365-network-connectivity-principles):
...
2. Создание плана подключений к сети для работы с Microsoft 365 корпоративный
   ...
   Специалисты компании Contoso воспользовались [принципами сетевого подключения для Microsoft 365](https://docs.microsoft.com/office365/enterprise/office-365-network-connectivity-principles), разработали эталонные сетевые архитектуры и приняли SD-WAN в качестве предпочтительной топологии для подключения к Microsoft 365.
