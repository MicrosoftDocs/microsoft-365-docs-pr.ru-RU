...
ms.locfileid: "32287137"
---
# <a name="microsoft-365-enterprise-foundation-infrastructure"></a>Базовая инфраструктура Microsoft 365 корпоративный

Если вы выполняете полное развертывание Microsoft 365 корпоративный самостоятельно, понадобится надежная основа, на которой приложения и службы помогут раскрыть творческий потенциал и обеспечат командную работы в безопасной среде. 
