...
- Установить самую современную и безопасную версию Office на ваши устройства.
...
| Защита информации | Метки и группы Office 365 и Azure Information Protection. |
...
- У меня есть существующая инфраструктура для Office 365, Enterprise Mobility + Security (EMS) или Windows 10 Корпоративная:
  - См. [Развертывание в существующей инфраструктуре](deploy-with-existing-infrastructure.md) Эта статья поможет определить критерии завершения для каждого этапа.
- Я начинаю с нуля: 
   - Начните работу над полным развертыванием с [Этап 1: Сеть](networking-infrastructure.md).
