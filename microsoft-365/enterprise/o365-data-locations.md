...
Пользователям следует просмотреть сведения о расположении данных для конкретных клиентов в вашем Центре администрирования Microsoft 365 в разделе **Параметры | Параметры организации | Профиль организации | Расположение данных**. Если вы [запросили переход в новое географическое расположение](request-your-data-move.md), сведения о расположении данных в Центре администрирования Microsoft 365 могут содержать только ваше новое географическое расположение, даже если некоторые данные могут временно храниться в вашем предыдущем географическом расположении во время перехода. 
...
Для обеспечения соответствия национальным, региональным и отраслевым требованиям, регулирующим сбор и использование данных отдельных пользователей, в Microsoft 365 доступен самый полный набор предложений по обеспечению соответствия требованиям любого поставщика глобальной облачной службы. Ознакомьтесь с [нашими предложениями по обеспечению соответствия требованиям](/compliance/regulatory/offering-home) в разделе [Соответствие требованиям Microsoft 365](https://go.microsoft.com/fwlink/p/?linkid=862317) в центре управления безопасностью Майкрософт. Кроме того, некоторые планы Microsoft 365 предлагают дополнительные решения по соответствию требованиям для управления данными, соблюдения юридических и нормативных требований, а также отслеживания действий, выполняемых с данными.
