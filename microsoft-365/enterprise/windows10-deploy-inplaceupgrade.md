...
Ознакомьтесь с разработкой [обновлений Windows](https://docs.microsoft.com/windows/deployment/upgrade/manage-windows-upgrades-with-upgrade-readiness) , готовой к обновлению, для получения дополнительных сведений, начала работы, использования и устранения неполадок готовности к обновлению.
...
## <a name="part-5-start-the-windows-10-upgrade-task-sequence"></a>Часть 5: запуск последовательности задач обновления Windows 10
...
|||
|:-------|:-----|
|![](./media/stepnumbers/Step3.png)| [Развертывание Windows 10 Корпоративная для новых устройств с помощью Windows автопилот](windows10-deploy-autopilot.md) |
