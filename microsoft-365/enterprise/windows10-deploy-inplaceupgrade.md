...
## <a name="the-windows-10-deployment-with-system-center-configuration-manager-poster"></a>Плакат "Развертывание Windows 10 с помощью System Center Configuration Manager"
