...
Корпоративные клиенты с гибридным развертыванием Exchange Online и локальной Exchange Server мастером гибридной конфигурации (HCW) для поддержания и установки гибридной установки. При переходе из Microsoft Cloud Deutschland в область Office 365 в Германии администратор должен повторно запустить последнюю сборку HCW в режиме "Office 365 Germany" до начала миграции Exchange (фаза 5). Затем снова запустите HCW в режиме "Office 365 Worldwide" после завершения этапа 5, чтобы завершить локальное развертывание с помощью параметров региона Office 365 в Германии.

| Step(s) | Описание | Влияние |
|:-------|:-------|:-------|
| (Pre-Stage 5) — повторное запуск HCW с помощью параметров Office 365 Germany <br><br> <i>Вы можете начать это действие сразу после получения уведомления центра сообщений о начале миграции клиента Office 365 (этап 1).</i>| При отсечении и повторном запуске HCW (17.0.5378.0 или выше) перед этапом 5 будет обеспечиваться готовность локальной конфигурации к отправке и приему почты как с пользователями Microsoft Cloud Deutschland, так и с пользователями, которые мигрируют в [https://aka.ms/hybridwizard](https://aka.ms/hybridwizard) регион Office 365 Германии. <p><li> В HCW для списка под **организацией My Office 365** находится выбор Office **365 Germany.** | Невыполнение этой задачи до начала этапа 5 [Миграция exchange] может привести к NDRs для почты, маршрутной между локальной развертыванием Exchange и Office 365.  
| (Post-Stage 5) — повторное запуск HCW с использованием параметров Office 365 по всему миру <br><br> <i>Вы можете начать это действие после получения уведомления центра сообщений о том, что миграция Exchange завершена (этап 5).</i>| При отсечении и повторном запуске HCW после этапа 5 будет сброшена конфигурация локальной конфигурации для гибридной конфигурации только [https://aka.ms/hybridwizard](https://aka.ms/hybridwizard) с Office 365 глобальной. <p><li> В поле списка ниже **Организация My Office 365** находится на сайте , выберите **Office 365 По всему миру**. | Невыполнение этой задачи до этапа 9 [Миграция завершена] может привести к NDRs для почты, маршрутной между локальной развертыванием Exchange и Office 365.  
