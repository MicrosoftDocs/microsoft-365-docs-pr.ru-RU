...
| Обеспечение подключения сети к URL-адресам служб [Office 365 и IP-адресам.](https://aka.ms/o365urls) | Все клиенты и службы, используемые для доступа к службе Office 365, должны иметь доступ к конечным точкам глобальных служб Office 365. <br>В случае, если у вас или ваших партнеров по совместной работе есть правила брандмауэра, которые препятствуют доступу к URL-адресам и IP-адресам, указанным в URL-адресах служб [Office 365](https://aka.ms/o365urls) и IP-адресах, необходимо изменить правила брандмауэра, чтобы разрешить доступ к конечным точкам глобальной службы Office 365.| Сбои службы или клиентского программного обеспечения могут возникнуть, если это не будет сделано до этапа 4  |
