...
- Разверните основные [рабочие нагрузки](deploy-workloads.md) в инфраструктуре. Эти позволит открыть возможности для творчества и совместной работы в вашей организации.

Вот как базовая инфраструктура связана с нагрузками.

![Отношение между базовой инфраструктурой и нагрузками](../media/deploy-microsoft-365-enterprise/m365-deploy-content-arch.png)

Рабочие нагрузки выполняются, опираясь на базовую инфраструктуру.  Тем не менее, вам не обязательно выполнять все этапы создания базовой инфраструктуры, чтобы использовать рабочие нагрузки для эффективной работы и взаимодействия.

Самостоятельно приступите к комплексному развертыванию с помощью статьи [Базовая инфраструктура Microsoft 365 для предприятий](deploy-foundation-infrastructure.md).
...
Узнайте, как группа проектирования основных служб и операций (прежнее название — ИТ-отдел Майкрософт) [создает современное рабочее место с Microsoft 365](https://www.microsoft.com/ru-RU/itshowcase/microsoft-365).
