...
<p>Убедитесь, что ваши приложения упакованы и готовы к автоматической установке. Узнайте, как упаковка «нажми и работай» с приложениями Microsoft 365 для предприятий дает вам новые возможности по настройке, доставке и обновлению приложений Office.</p></td>
...
Еще один популярный способ доставки приложений — создание образа ПК. В этом случае приложения устанавливаются либо в ходе последовательности задач, либо вручную на эталонном компьютере, после чего создается образ системы, в которой уже установлены необходимые приложения. Создание образа для сборки и захвата приложений может сэкономить время при подготовке новых компьютеров, но помните, что операционные системы и приложения в образе могут быстро устареть. Модель накопительного обновления в приложениях для Windows 10 и Microsoft 365 для предприятий помогает решить эту проблему, но не устраняет ее полностью. Поэтому рекомендуем использовать подход с тонкими образами, устанавливая приложения извне образа во время развертывания.
...
Приложения Microsoft 365 для предприятий устанавливаются с использованием технологии «нажми и работай», а технология «нажми и работай» заменяет пакеты на основе MSI в каждой версии предстоящего выпуска Office 2019 для Windows. Это дает ряд преимуществ, в том числе более быструю и чистую установку, а также более быстрое и эффективное обновление. 
...
Если вы используете Configuration Manager, вы все равно можете использовать его для широкого развертывания приложений Microsoft 365 для предприятий. Configuration Manager (текущая ветвь) имеет встроенную поддержку обновленного средства настройки Office, настройку пакета для Click-to-Run во время установки и встроенную поддержку для управления обновлениями программного обеспечения после установки.
...
## <a name="step-4-user-files-and-settings"></a>[Этап 4. Файлы и параметры пользователей](https://aka.ms/mdd4)

## <a name="previous-step"></a>Предыдущий этап

## <a name="step-2-directory-and-network-readiness"></a>[Этап 2. Проверка готовности каталогов и сети](https://aka.ms/mdd2) 
