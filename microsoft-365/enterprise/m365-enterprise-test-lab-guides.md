...
TLGs предназначены для модульного использования. Они создают несколько конфигураций, которые более тесно соответствуют вашим потребностям в обучении или тестовой конфигурации. Практический опыт "Я создал его сам, и он работает" помогает вам понять требования к развертыванию нового продукта или сценария, чтобы можно было лучше планировать размещение в производстве.

Вы также можете использовать TLGs для создания представительных сред для разработки и тестирования приложений, также известных как среды разработки и тестирования.
  
![Руководства по лаборатории тестирования для облака Майкрософт](../media/m365-enterprise-test-lab-guides/cloud-tlg-icon.png)

Чтобы получить визуальную карту для всех статей в стеке Руководство по лаборатории тестирования для предприятий, разойдитесь по следующей графической карте или перейдите в [Microsoft 365](../downloads/Microsoft365EnterpriseTLGStack.pdf)для корпоративного руководства по тестовой лаборатории.
...
Сначала создайте тестовую среду [для Microsoft 365 для предприятия.](/microsoft-365-enterprise/) Можно создать два различных типа базовых конфигураций:

- [Облегченная](lightweight-base-configuration-microsoft-365-enterprise.md) базовая конфигурация . Используйте это, когда необходимо настроить и продемонстрировать Microsoft 365 для корпоративных функций и возможностей в облачной среде, которая не включает в себя какие-либо локально компоненты.

- Имитация корпоративной базовой конфигурации [.](simulated-ent-base-configuration-microsoft-365-enterprise.md) Используйте это, когда необходимо настроить и продемонстрировать Microsoft 365 для корпоративных функций и возможностей в гибридной облачной среде, в которой используются локально компоненты, такие как домен Active Directory Domain Services (AD DS).
...
- [Простой единый вход Azure AD](single-sign-on-m365-ent-test-environment.md)
   ...
   Включить и протестировать Azure AD Seamless Single Sign-on (Seamless SSO) с контроллером домена AD DS.
...
- [Сброс пароля](password-reset-m365-ent-test-environment.md)
   ...
   Для сброса пароля используйте сброс пароля самообслуживки.
