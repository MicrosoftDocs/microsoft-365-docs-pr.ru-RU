...
Чтобы получить визуальную карту для всех статей в стеке руководства по Microsoft 365 для корпоративной лаборатории тестирования, разойдите по следующему графику или перейдите Microsoft 365 для корпоративного руководства по лаборатории [тестирования.](../downloads/Microsoft365EnterpriseTLGStack.pdf)
...
- [Облегченная](lightweight-base-configuration-microsoft-365-enterprise.md) базовая конфигурация . Используйте это, если вы хотите настроить и Microsoft 365 для корпоративных функций и возможностей в облачной среде, которая не включает в себя какие-либо локального компонента.
