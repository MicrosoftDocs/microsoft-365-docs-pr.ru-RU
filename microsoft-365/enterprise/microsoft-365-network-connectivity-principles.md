...
Корпорация Майкрософт открыта в отношении безопасности центров обработки данных, операционной безопасности и снижения риска на серверах Microsoft 365 и в конечных точках сети, которые она представляет. В Microsoft 365 встроены функции обеспечения безопасности, например защита от потери данных, антивирусная защита, многофакторная проверка подлинности, защищенное хранилище, расширенная защита от угроз, Microsoft 365 Threat Intelligence, Оценка безопасности Microsoft 365, Exchange Online Protection и защита сети от DDOS-атак.
