...
Если в настоящее время вы не используете службу Azure Active Directory, существует [множество ресурсов](https://docs.microsoft.com/azure/active-directory/), которые помогут вам настроить ее. Возможно, вам доступна персонализированная поддержка через Microsoft FastTrack в рамках вашей лицензии на Office 365. Дополнительные сведения о Microsoft Fastrack см. [здесь](https://fasttrack.microsoft.com).
...
[Скачивание обновлений для Office 365](https://docs.microsoft.com/deployoffice/overview-of-the-update-process-for-office-365-proplus#download-the-updates-for-office-365-proplus)
