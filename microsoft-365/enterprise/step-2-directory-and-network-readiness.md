...
Если в настоящее время вы не используете службу Azure Active Directory, существует [множество ресурсов](https://docs.microsoft.com/azure/active-directory/), которые помогут вам настроить ее. Возможно, вам доступна индивидуальная поддержка через Microsoft FastTrack в рамках вашей лицензии. Дополнительные сведения о Microsoft Fastrack см. [здесь](https://fasttrack.microsoft.com).
