...
<ul>
<li><p><a href="http://aka.ms/MDAcustomerform">Оценка современного компьютера.</a> Соответствующий вашему региону партнер с помощью современных средств и процедур Microsoft тщательно анализирует совместимость приложений и устройств в вашей организации, а также оценивает их готовность к обновлению.</p>
...
<ul>
<li><p><a href="https://www.microsoft.com/en-us/microsoft-365/success/productivitylibrary/quickly-and-easily-transform-new-devices?rtc=2">Productivity Library.</a> Это набор интернет-ресурсов от корпорации Майкрософт для взаимодействия и обучения пользователей в Microsoft 365.</p></li>
...
## <a name="ask-the-tech-community"></a>**Задайте вопросы в сообществе Tech Community**

Чтобы получить ответы на вопросы по планированию или началу развертывания, присоединяйтесь к [сообществу Microsoft Tech Community](https://techcommunity.microsoft.com)
