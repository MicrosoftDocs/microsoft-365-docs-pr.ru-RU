...
5. Запустите сценарий со следующими параметрами и значениями.
    ...
    >[!Note]
    > Убедитесь, что перед запуском скриптов установлен модуль Azure AD PowerShell. Пожалуйста, обратитесь ![ сюда ](https://docs.microsoft.com/powershell/azure/install-az-ps?view=azps-5.1.0) для действий по установке
...
Перед перемещением почтовый ящик будет расшифровываться. Убедитесь, что клиентский ключ настроен в целевом клиенте, если он по-прежнему требуется. [Дополнительные](https://docs.microsoft.com/microsoft-365/compliance/customer-key-overview) сведения см. здесь.  
