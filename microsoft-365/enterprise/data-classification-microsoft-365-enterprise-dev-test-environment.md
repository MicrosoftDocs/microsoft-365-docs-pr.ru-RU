...
---
# <a name="data-classification-for-your-microsoft-365-for-enterprise-test-environment"></a>Классификация данных для microsoft 365 для корпоративной тестовой среды
...
На этом этапе создайте метки хранения для различных уровней хранения папок документов SharePoint Online:

1. Во входе в [центр безопасности Microsoft 365](https://security.microsoft.com/homepage) с учетной записью глобального администратора.
1. На **вкладке "Главная - Microsoft 365"** в браузере выберите метки **хранения**  >  **классификации.**
...
1. С помощью частного экземпляра браузера вопишитесь в центр администрирования [Microsoft 365](https://admin.microsoft.com) с помощью глобальной учетной записи администратора.
...
1. В поле **описание сайта Team** введите сайт **SharePoint для конфиденциальных файлов.**
...
1. В области **Who do you want to add?** выберите **Finish**.
...
1. В **метке Параметры-Применить** выберите **Sensitive** в выпадаемом поле, а затем выберите **Сохранить**.
