...
С помощью инструкций, описанных в этой статье, вы настраиваете классификацию данных с помощью меток хранения в тестовой среде Microsoft 365 Enterprise.
...
Сведения и ссылки на вопросы, посвященные развертыванию меток хранения в рабочей среде, можно найти в разделе [Настройка классификации для среды](infoprotect-configure-classification.md) на этапе **защиты информации** .
