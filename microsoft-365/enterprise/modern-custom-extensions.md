...
- **Общее** время загрузки и инициализации модуля. Это общее относительное время выполнения расширения на странице от начала до конца.
...
- **Инициализация** показывает время, необходимое расширению для инициализации данных.
