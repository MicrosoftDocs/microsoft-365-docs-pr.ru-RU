...
---
# <a name="manage-microsoft-365-identity-governance"></a>Управление управление удостоверением Microsoft 365
...
Управление правами Azure AD поможет вам более эффективно управлять доступом к группам, приложениям и сайтам SharePoint для внутренних и внешних пользователей.
