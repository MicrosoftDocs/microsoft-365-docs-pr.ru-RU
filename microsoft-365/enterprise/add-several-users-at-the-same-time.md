...
4. В области **Импорт нескольких пользователей** вы можете скачать шаблон CSV-файла с образцом сведений о пользователях или без него. 
    ...
    Электронная таблица должна содержать те **же заголовки столбцов** , что и один образец (имя пользователя, имя и т. д.). Если вы используете шаблон, откройте его в средстве редактирования текста, например в блокноте, и рассмотрите все данные только в строке 1 и вводите данные в строки 2 и ниже. 
