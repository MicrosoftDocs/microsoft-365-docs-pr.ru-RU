...
---
# <a name="add-several-users-at-the-same-time-to-microsoft-365---admin-help"></a>Добавление нескольких пользователей одновременно в Microsoft 365 справка для администраторов

Каждому пользователю в вашей команде требуется учетная запись пользователя, прежде чем он сможет войти и получить доступ к службам Microsoft 365, таким как электронная почта и Office. Если у вас много людей, вы можете добавить их учетные записи одновременно из таблицы Excel или другого файла, сохраненного в формате CSV. [Не знаете, что такое формат CSV?](add-several-users-at-the-same-time.md#not-sure-what-csv-format-is)
...
## <a name="add-multiple-users-in-the-microsoft-365-admin-center"></a>Добавление нескольких пользователей в Центр администрирования Microsoft 365
...
4. В области **Импорт нескольких пользователей** вы можете скачать шаблон CSV-файла с образцом сведений о пользователях или без него.
    ...
    Ваша таблица должна включать  те же заголовки столбцов, что и образец (имя пользователя, имя и так далее). Если вы используете шаблон, откройте его в средстве редактирования текста, например в Блокноте, и рассмотрите возможность оставить все данные в строке 1 отдельно и ввести данные только в строках 2 и ниже.
...
- Теперь, когда у этих пользователей есть учетные записи, им необходимо скачать и установить или переустановить [Microsoft 365 или Office 2016 на КОМПЬЮТЕРе или Mac.](https://support.office.com/article/4414eaaf-0478-48be-9c42-23adc4716658) Каждый человек в вашей команде может установить Microsoft 365 на 5 ПК или Mac.
...
- Кроме того, каждый пользователь может [настроить приложения Office и электронную почту на мобильных устройствах](https://support.office.com/article/7dabb6cb-0046-40b6-81fe-767e0b1f014f), используя до пяти планшетов и пяти смартфонов, таких как iPhone, iPad и устройства с Android. Таким образом, они смогут редактировать файлы Office где угодно.
    ...
    Полный список действий по настройке см. в подстройке [Microsoft 365](https://support.office.com/article/6a3a29a0-e616-4713-99d1-15eda62d04fa) для бизнеса.
...
Для начала вы можете загрузить и использовать [этот пример электронной таблицы](https://www.microsoft.com/download/details.aspx?id=45485). Помните, что Microsoft 365 требует заголовки столбцов в первой строке, поэтому не заменяйте их на что-то другое. 
...
- **Обязательно ли использовать такие же заголовки столбцов, как в примере электронной таблицы?** Да. Первая строка в примере таблицы содержит заголовки столбцов. Эти заголовки являются обязательными. Для каждого пользователя, который вы хотите добавить в Microsoft 365, создайте строку под заголовком. Если добавить, изменить или удалить какие-либо заголовки столбцов, Microsoft 365 не сможет создавать пользователей из данных в файле.
...
### <a name="still-having-problems-when-adding-users-to-microsoft-365"></a>По-прежнему возникают проблемы при добавлении пользователей в Microsoft 365?
...
- **Если вы не видите новых пользователей в Microsoft 365 сразу, подождите несколько минут.** Внесение изменений во все службы в Microsoft 365 может занять некоторое время. 

## <a name="related-articles"></a>Статьи по теме

[Добавление пользователей по отдельности или массово в Microsoft 365](https://docs.microsoft.com/office365/admin/add-users/add-users)
