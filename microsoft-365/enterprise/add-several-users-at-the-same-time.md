...
- **Если вы не видите новых пользователей в Microsoft 365 сразу, подождите несколько минут.** Внесение изменений во все службы Microsoft 365 может занять некоторое время. 
