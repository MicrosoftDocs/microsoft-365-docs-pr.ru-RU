...
Вы можете создавать и связывать новые домены с арендой клиента с PowerShell для Microsoft 365 быстрее, чем с помощью Центр администрирования Microsoft 365.
