...
- Извлечение или кэширование данных
  - Если веб-часть использует дополнительные вызовы сервера для получения данных для отображения, убедитесь, что эти серверные API быстро и/или реализуют кэширование на стороне клиента (например, использование _localStorage_ или _индекседдб_ для большего набора наборов).
