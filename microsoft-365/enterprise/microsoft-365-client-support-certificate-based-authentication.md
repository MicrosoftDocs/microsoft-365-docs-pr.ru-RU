...
| Корпоративный портал | ![Поддерживается](../media/check-mark.png) | ![Поддерживается](../media/check-mark.png) | ![Поддерживается](../media/check-mark.png) | ![Поддерживается](../media/check-mark.png) | Недоступно |
| Потребляет | Календар | Календар | Недоступно | ![Поддерживается](../media/check-mark.png) | Недоступно |
...
| Клейкие заметки | Н/Д | Н/Д | Н/Д | ![Поддерживается](../media/check-mark.png) | Недоступно |
...
| Teams | ![Поддерживается](../media/check-mark.png) | ![Поддерживается](../media/check-mark.png) | ![Поддерживается](../media/check-mark.png) | Недоступно | Календар |
...
| Доска | Календар | Календар | Недоступно | ![Поддерживается](../media/check-mark.png) | Недоступно |
