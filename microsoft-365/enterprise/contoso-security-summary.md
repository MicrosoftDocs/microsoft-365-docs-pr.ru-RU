...
ms.custom: ''
description: Как компания Contoso использует функции безопасности в Microsoft 365 для предприятий.
ms.openlocfilehash: fbbf8dfc1de831c2ef949b71f1cbdf4e97a02baa
ms.sourcegitcommit: cd17328baa58448214487e3e68c37590ab9fd08d
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/09/2020
ms.locfileid: "48399481"
---
...
Чтобы получить подпись от развертывания Microsoft 365 для предприятия ИТ отдела ИТ, проведена тщательная проверка безопасности. Ниже приведены требования к безопасности для облака Contoso:
...
Для подготовки системы безопасности к развертыванию Microsoft 365 для предприятий компания Contoso использовала следующие действия:
...
2. Классификация данных с разделением их на три уровня
   ...
   Компания Contoso провела тщательную проверку и определила три уровня, которые использовались для определения компонентов Microsoft 365 для предприятий для защиты самых ценных данных в компании Contoso.
...
В соответствии с рекомендациями по обеспечению безопасности и Microsoft 365 для корпоративных развертываний, администраторы безопасности Contoso и ИТ отдел развернули множество функций и возможностей безопасности, как описано в следующих разделах.
