...
Microsoft 365 и Office 365 руководства по настройке дают вам индивидуальные рекомендации и ресурсы для планирования и развертывания клиента, приложений и служб. Эти руководства создаются с использованием тех же методов, которые Microsoft 365 [специалисты onboarding FastTrack](https://www.microsoft.com/fasttrack/microsoft-365) совместно используют в отдельных взаимодействиях, и они доступны всем администраторам в Центр администрирования Microsoft 365. Они предоставляют сведения о настройке продукта, включая функции безопасности, развертывая средства совместной работы и предоставляя скрипты для ускорения расширенных развертывания.
