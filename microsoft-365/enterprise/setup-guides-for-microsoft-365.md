...
Руководства по настройке доступны на [странице](https://aka.ms/setupguidance) рекомендаций по установке в Центре администрирования Microsoft 365. Вы можете отслеживать состояние хода выполнения, и у вас есть возможность вернуться в любое время, чтобы завершить руководство. Чтобы добиться этого **на странице руководства по установке:**
...
Вы получите рекомендации по оптимизации трафика устройств удаленных сотрудников как к ресурсам Microsoft 365 в облаке, так и к сети вашей организации, что позволит снизить нагрузку на инфраструктуру VPN удаленного доступа. 
...
Пользователи [синхронизации из мастера каталогов](https://aka.ms/directorysyncsetup) вашей организации могут поохимить вас, включив синхронизацию каталогов. Это упрощает доступ к локальной и облачной удостоверениям и упрощает управление ими. Разблокировка новых возможностей, таких как единый вход, варианты самостоятельного обслуживания, автоматическая подготовка учетных записей, средства контроля условного доступа и политики соответствия требованиям. Это гарантирует, что ваши пользователи смогут получать доступ к нужным ресурсам из любого места.
...
Предопределяйте пользователям возможность независимо изменять или сбрасывать пароль, если их учетная запись заблокирована, или они забывают свой пароль без необходимости обращаться к инженеру в helpdesk. 
...
Помощник [По Microsoft Defender для конечных точек](https://aka.ms/mdatpsetup) предоставляет инструкции, которые помогут вашей корпоративной сети предотвращать, обнаруживать, исследовать и реагировать на сложные угрозы. Проинформайте об уязвимости вашей организации и определите, какой пакет развертывания и методы настройки лучше всего использовать. 
...
Используйте обновление на месте с помощью [configuration Manager при](https://aka.ms/win10upgradedemo) обновлении устройств с Windows 7 и Windows 8.1 до последней версии Windows 10. Вы будете использовать предоставленный сценарий для проверки необходимых условий и автоматической настройки обновления на месте.
