...
В этой задаче мы будем использовать cmdlet для добавления пользователя в группу SharePoint в `Add-SPOUser` коллекцию сайтов.
...
Этот комлет используется для создания SharePoint группы и добавления его `New-SPOSiteGroup` в коллекцию сайтов.
