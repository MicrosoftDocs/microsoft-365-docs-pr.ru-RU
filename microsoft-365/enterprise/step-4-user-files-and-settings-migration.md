...
ms.locfileid: "26870893"
---
# <a name="step-4-user-files-and-settings-migration"></a>Этап 4. Перенос файлов и параметров пользователя

Перенос файлов и параметров пользователей на их новые или восстановленные компьютеры — очень важный процесс, в котором нельзя допускать ошибок. Вы можете перенести каждый компьютер вручную или выбрать один из нескольких способов автоматизации этого процесса. Независимо от выбранного способа необходимо разобраться с тремя аспектами — переносом файлов пользователей, миграцией их параметров и управлением структурой панели задач и меню "Пуск" в Windows 10.
...
>[!NOTE]
>Вы продолжите использовать те же процессы миграции, что и раньше, но с переходом на Office 365 профессиональный плюс рекомендуем использовать функцию перемещения известных папок OneDrive (см. ниже). Полное описание процесса развертывания компьютеров см. в [центре развертывания современных компьютеров](https://aka.ms/HowToShift).
>
