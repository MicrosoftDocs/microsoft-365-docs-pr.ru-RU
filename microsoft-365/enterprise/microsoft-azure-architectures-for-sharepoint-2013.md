...
- Если Microsoft 365 не соответствует вашим бизнес-требованиям, рассмотрите стандартную реализацию SharePoint 2013 локально из Службы microsoft Consulting Services (MCS). Поддерживать стандартную архитектуру может быть дешевле и проще, чем персонализированное решение. 
