...
Возможности поддержки нескольких регионов в OneDrive и SharePoint Online позволяют управлять общими ресурсами, например сайтами групп SharePoint и почтовыми ящиками групп Microsoft 365, хранимых в стране или регионе.
