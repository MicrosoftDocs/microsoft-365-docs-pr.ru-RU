...
1. На отдельной вкладке того же браузера перейдите к [https://admin.microsoft.com](https://admin.microsoft.com), а затем выполните вход, используя новый пароль и имя учетной записи "Пользователь 3". Откроется **Домашняя страница Microsoft Office**.
