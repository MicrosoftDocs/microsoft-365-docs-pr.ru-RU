...
В этой статье описывается настройка и тестирование сброса пароля в тестовой среде Microsoft 365.
...
2. На портале Azure выберите **группу Azure Active Directory**  >    >  **New group**.
