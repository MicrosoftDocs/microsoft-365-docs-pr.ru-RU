...
11. В Internet Explorer откройте портал Office ([https://office.com](https://office.com)).
    
12. На главной странице портала нажмите **Администратор**.
    
13. На панели навигации слева выберите элементы **Пользователи > Активные пользователи**.
