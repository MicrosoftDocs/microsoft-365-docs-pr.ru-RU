...
В этой статье описывается настройка среды тестирования Microsoft 365, которая соответствует [](../security/office-365-security/identity-access-prerequisites.md#prerequisites) требованиям гибрида с предварительной конфигурацией синхронизации синхронизации паролей для удостоверения и доступа к устройствам.
