...
Следуйте указаниям из статьи [Microsoft Azure Architectures for SharePoint 2013](microsoft-azure-architectures-for-sharepoint-2013.md), чтобы разработать среду аварийного восстановления, включая ферму восстановления SharePoint. Для запуска процесса разработки можно использовать графику в решении аварийного восстановления SharePoint в [файле Azure](https://go.microsoft.com/fwlink/p/?LinkId=392554) Visio. Рекомендуем полностью разработать среду, прежде чем приступать к работе в среде Azure.
...
Мы использовали _параметр skipRegisterAsDistributedCachehost,_ когдаpsconfig.exeна командной строке.  Дополнительные сведения см. в раздел План каналов и службы распределенного кэша [в SharePoint Server 2013.](/sharepoint/administration/plan-for-feeds-and-the-distributed-cache-service) 
