...
Видеоролик о microsoft 365 с несколькими географическими решениями см. в sharePoint Online и [OneDrive с](https://www.youtube.com/watch?v=Do9U3JuROhk)несколькими географическими решениями для управления местом хранения данных.

## <a name="multi-geo-architecture"></a>Архитектура с несколькими географическими архитектурами
...
Microsoft 365 с несколькими географическими решениями доступен в качестве надстройки для следующих планов подписки Microsoft 365 для клиентов Соглашение Enterprise с не менее 250 мест Microsoft 365 в их клиенте и не менее 5 % этих мест с использованием поддержки нескольких географических служб. Лицензии на подписку пользователя должны быть на том же Соглашение Enterprise, что и лицензии на службы с несколькими географическими службами. За дополнительной информацией обращайтесь к команде, в которую входит ваша учетная запись.
...
1. Совместно с группой специалистов, занимающихся учетными записями, добавьте план обслуживания _с поддержкой нескольких регионов в Microsoft 365_. Они помогут вам добавить необходимое количество лицензий. Функция поддержки нескольких регионов доступна клиентам EA с не менее 250 подписками на Microsoft 365.
   ...
   Прежде чем вы сможете начать работу в Microsoft 365 Multi-Geo, корпорации Майкрософт потребуется настроить ваш клиент Exchange Online для поддержки нескольких регионов. Этот разовый процесс настройки запускается после заказа плана обслуживания с *поддержкой нескольких регионов в Microsoft 365* и появления лицензий в вашем клиенте. Вы будете получать уведомления о рабочих нагрузках в Центре сообщений [Microsoft 365](https://support.office.com/article/38FB3333-BFCC-4340-A37B-DEDA509C2093) после того, как клиент завершит настройку каждой рабочей нагрузки, а затем сможете приступить к настройке и использованию возможностей Microsoft 365 с несколькими географическими возможностями. Время, необходимое для настройки клиента для поддержки поддержки нескольких регионах, зависит от клиента, но большинство клиентов завершает работу в течение месяца после получения лицензий на функции. Для более крупных или более сложных клиентов может потребоваться больше времени для завершения процесса настройки. Обратитесь в вашу команду по учетной записи за подробными сведениями о конкретном клиенте, если это необходимо.
