...
Если лицензия назначена пользователю, а затем удалена, Teams данные чата будут перемещены обратно в центральное расположение. SharePoint и Exchange данные не перемещаются.
