...
Отличный способ обмениваться приоритетами, совместно использовать стратегические документы и выделять предстоящие события — использовать сайт для общения в SharePoint. Сайты для общения предназначены для общего доступа к общим данным в рамках всей кампании — это ваш внутренний сайт кампании.
...
1. Выполните вход в http://Office.comсистему.
