...
| Сотрудничайте с командами ключевых сотрудников, всех сотрудников, партнеров и поставщиков. [Создание команды](create-teams-for-collaboration.md) | Запланируйте собрание с использованием звука, видео и общего доступа в Microsoft Teams. [Организация собрания](set-up-meetings.md) |

| Шифрование или присвоение меток конфиденциальным сообщениям электронной почты | Создание информационного сайта |
| ------------- | ------------- |
...
| Пользуйтесь шифрованием и метками конфиденциальности для защиты сообщений электронной почты, содержащих конфиденциальные сведения. [Отправка зашифрованных писем](send-encrypted-email.md) | Делитесь событиями, сообщениями, изображениями и многим другим с вашей командой на внутреннем информационном сайте, созданном с помощью SharePoint. [Создание своего сайта](create-communications-site.md) |

| Общий доступ к файлам и видео |
| ------------- |
| ![совместное использование файлов в Microsoft Teams](../media/m365-democracy-teams-sharefiles.png) |
| Сохраняйте свои файлы и видео в облаке, чтобы они были доступны всем  <br><br>соответствующим лицам. [Начать совместное использование](share-files-and-videos.md) |
