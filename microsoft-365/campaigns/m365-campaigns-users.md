...
- Проверка подлинности электронных сообщений и поиск советов по безопасности от Advanced фишинга в защитнике для Office 365 Protection.
- Открытие только безопасных ссылок и вложений, проверенных с помощью безопасных ссылок и безопасных вложений.
...
## <a name="collaborate-using-microsoft-teams-onedrive-sharepoint-online-and-other-tools"></a>Совместная работа с помощью Microsoft Teams, OneDrive, SharePoint Online и других средств
